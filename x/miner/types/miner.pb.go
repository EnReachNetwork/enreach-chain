...
func (*Miner) Descriptor() ([]byte, []int) {
	return fileDescriptor_184d37e2837f972f, []int{0}
}
...
func (m *Miner) GetEvmAddress() string {
	if m != nil {
		return m.EvmAddress
	}
	return ""
...
func (m *Miner) GetRegionCode() string {
	if m != nil {
		return m.RegionCode
	}
	return ""
...
func init() {
	proto.RegisterType((*Miner)(nil), "enreach.miner.Miner")
}

func init() { proto.RegisterFile("enreach/miner/miner.proto", fileDescriptor_184d37e2837f972f) }

var fileDescriptor_184d37e2837f972f = []byte{
	// 207 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Miner) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Status) > 0 {
		...
		i = encodeVarintMiner(dAtA, i, uint64(len(m.Status)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.RegionCode) > 0 {
		...
		i = encodeVarintMiner(dAtA, i, uint64(len(m.RegionCode)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.EvmAddress) > 0 {
		...
		i = encodeVarintMiner(dAtA, i, uint64(len(m.EvmAddress)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.MinerId) > 0 {
	...
	if m.Id != 0 {
		i = encodeVarintMiner(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
