...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2634b46167869815, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2634b46167869815, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "enreach.enreach.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "enreach.enreach.QueryParamsResponse")
}

func init() { proto.RegisterFile("enreach/enreach/query.proto", fileDescriptor_2634b46167869815) }

var fileDescriptor_2634b46167869815 = []byte{
	// 292 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4e, 0xcd, 0x2b, 0x4a,
	0x4d, 0x4c, 0xce, 0xd0, 0x87, 0xd1, 0x85, 0xa5, 0xa9, 0x45, 0x95, 0x7a, 0x05, 0x45, 0xf9, 0x25,
	...
	0x9c, 0xc4, 0x06, 0x0e, 0x21, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6a, 0x91, 0xa8, 0x66,
	0xe2, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enreach.enreach.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enreach.enreach.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "enreach.enreach.Query",
	...
	Metadata: "enreach/enreach/query.proto",
}
