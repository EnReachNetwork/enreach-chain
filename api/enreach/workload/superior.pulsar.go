...
func init() {
	...
	md_Superior = File_enreach_workload_superior_proto.Messages().ByName("Superior")
...
func (x *Superior) slowProtoReflect() protoreflect.Message {
	mi := &file_enreach_workload_superior_proto_msgTypes[0]
...
func (x *fastReflection_Superior) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "enreach.workload.Superior.account":
		return x.Account != ""
	case "enreach.workload.Superior.creator":
		return x.Creator != ""
	case "enreach.workload.Superior.createAt":
		return x.CreateAt != uint64(0)
	case "enreach.workload.Superior.updator":
		return x.Updator != ""
	case "enreach.workload.Superior.updateAt":
		return x.UpdateAt != uint64(0)
	case "enreach.workload.Superior.signer":
		return x.Signer != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: enreach.workload.Superior"))
		}
		panic(fmt.Errorf("message enreach.workload.Superior does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Superior) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message enreach.workload.Superior does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Superior) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "enreach.workload.Superior.account":
		panic(fmt.Errorf("field account of message enreach.workload.Superior is not mutable"))
	case "enreach.workload.Superior.creator":
		panic(fmt.Errorf("field creator of message enreach.workload.Superior is not mutable"))
	case "enreach.workload.Superior.createAt":
		panic(fmt.Errorf("field createAt of message enreach.workload.Superior is not mutable"))
	case "enreach.workload.Superior.updator":
		panic(fmt.Errorf("field updator of message enreach.workload.Superior is not mutable"))
	case "enreach.workload.Superior.updateAt":
		panic(fmt.Errorf("field updateAt of message enreach.workload.Superior is not mutable"))
	case "enreach.workload.Superior.signer":
		panic(fmt.Errorf("field signer of message enreach.workload.Superior is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: enreach.workload.Superior"))
		}
...
func (x *fastReflection_Superior) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in enreach.workload.Superior", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: enreach/workload/superior.proto
...
func (*Superior) Descriptor() ([]byte, []int) {
	return file_enreach_workload_superior_proto_rawDescGZIP(), []int{0}
}
...
var File_enreach_workload_superior_proto protoreflect.FileDescriptor

var file_enreach_workload_superior_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x65, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x2f, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f,
	0x61, 0x64, 0x2f, 0x73, 0x75, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x10, 0x65, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c,
	0x6f, 0x61, 0x64, 0x22, 0xa8, 0x01, 0x0a, 0x08, 0x53, 0x75, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x72,
	...
	0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x0d, 0x53, 0x75, 0x70, 0x65, 0x72, 0x69, 0x6f,
...
var (
	file_enreach_workload_superior_proto_rawDescOnce sync.Once
	file_enreach_workload_superior_proto_rawDescData = file_enreach_workload_superior_proto_rawDesc
)

func file_enreach_workload_superior_proto_rawDescGZIP() []byte {
	file_enreach_workload_superior_proto_rawDescOnce.Do(func() {
		file_enreach_workload_superior_proto_rawDescData = protoimpl.X.CompressGZIP(file_enreach_workload_superior_proto_rawDescData)
	})
	return file_enreach_workload_superior_proto_rawDescData
}

var file_enreach_workload_superior_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enreach_workload_superior_proto_goTypes = []interface{}{
	(*Superior)(nil), // 0: enreach.workload.Superior
}
var file_enreach_workload_superior_proto_depIdxs = []int32{
...
func init() { file_enreach_workload_superior_proto_init() }
func file_enreach_workload_superior_proto_init() {
	if File_enreach_workload_superior_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enreach_workload_superior_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enreach_workload_superior_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enreach_workload_superior_proto_goTypes,
		DependencyIndexes: file_enreach_workload_superior_proto_depIdxs,
		MessageInfos:      file_enreach_workload_superior_proto_msgTypes,
	}.Build()
	File_enreach_workload_superior_proto = out.File
	file_enreach_workload_superior_proto_rawDesc = nil
	file_enreach_workload_superior_proto_goTypes = nil
	file_enreach_workload_superior_proto_depIdxs = nil
}
