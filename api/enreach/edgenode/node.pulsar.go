...
func (x *fastReflection_Node) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TrafficType != uint32(0) {
		...
		if !f(fd_Node_trafficType, value) {
			return
		}
	}
	if x.RegisterStatus != "" {
...
func (x *fastReflection_Node) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "enreach.edgenode.Node.regionCode":
		return x.RegionCode != ""
	case "enreach.edgenode.Node.trafficType":
...
func (x *fastReflection_Node) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "enreach.edgenode.Node.trafficType":
		panic(fmt.Errorf("field trafficType of message enreach.edgenode.Node is not mutable"))
	case "enreach.edgenode.Node.registerStatus":
...
func (x *Node) GetTrafficType() uint32 {
	if x != nil {
...
var file_enreach_edgenode_node_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x54,
	0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x74, 0x72, 0x61, 0x66, 0x66,
	0x69, 0x63, 0x54, 0x79, 0x70, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
