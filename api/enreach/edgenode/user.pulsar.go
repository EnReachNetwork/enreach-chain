...
var (
	...
	fd_User_evmAccount protoreflect.FieldDescriptor
	fd_User_creator    protoreflect.FieldDescriptor
	fd_User_createAt   protoreflect.FieldDescriptor
	fd_User_updator    protoreflect.FieldDescriptor
	fd_User_updateAt   protoreflect.FieldDescriptor
)

func init() {
	file_enreach_edgenode_user_proto_init()
	md_User = File_enreach_edgenode_user_proto.Messages().ByName("User")
	fd_User_userID = md_User.Fields().ByName("userID")
	fd_User_evmAccount = md_User.Fields().ByName("evmAccount")
	fd_User_creator = md_User.Fields().ByName("creator")
	fd_User_createAt = md_User.Fields().ByName("createAt")
	fd_User_updator = md_User.Fields().ByName("updator")
	fd_User_updateAt = md_User.Fields().ByName("updateAt")
}
...
func (x *User) slowProtoReflect() protoreflect.Message {
	mi := &file_enreach_edgenode_user_proto_msgTypes[0]
...
func (x *fastReflection_User) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "enreach.edgenode.User.userID":
		return x.UserID != ""
	case "enreach.edgenode.User.evmAccount":
		return x.EvmAccount != ""
	case "enreach.edgenode.User.creator":
		return x.Creator != ""
	case "enreach.edgenode.User.createAt":
		return x.CreateAt != uint64(0)
	case "enreach.edgenode.User.updator":
		return x.Updator != ""
	case "enreach.edgenode.User.updateAt":
		return x.UpdateAt != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: enreach.edgenode.User"))
		}
		panic(fmt.Errorf("message enreach.edgenode.User does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_User) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message enreach.edgenode.User does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_User) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "enreach.edgenode.User.userID":
		panic(fmt.Errorf("field userID of message enreach.edgenode.User is not mutable"))
	case "enreach.edgenode.User.evmAccount":
		panic(fmt.Errorf("field evmAccount of message enreach.edgenode.User is not mutable"))
	case "enreach.edgenode.User.creator":
		panic(fmt.Errorf("field creator of message enreach.edgenode.User is not mutable"))
	case "enreach.edgenode.User.createAt":
		panic(fmt.Errorf("field createAt of message enreach.edgenode.User is not mutable"))
	case "enreach.edgenode.User.updator":
		panic(fmt.Errorf("field updator of message enreach.edgenode.User is not mutable"))
	case "enreach.edgenode.User.updateAt":
		panic(fmt.Errorf("field updateAt of message enreach.edgenode.User is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: enreach.edgenode.User"))
		}
...
func (x *fastReflection_User) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in enreach.edgenode.User", d.FullName()))
	}
	panic("unreachable")
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_enreach_edgenode_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *User) GetEvmAccount() string {
	if x != nil {
		return x.EvmAccount
	}
	return ""
...
func (x *User) GetCreateAt() uint64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
func (x *User) GetUpdateAt() uint64 {
	if x != nil {
		return x.UpdateAt
	}
	return 0
...
var File_enreach_edgenode_user_proto protoreflect.FileDescriptor

var file_enreach_edgenode_user_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x65, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x2f, 0x65, 0x64, 0x67, 0x65, 0x6e, 0x6f,
	0x64, 0x65, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x65,
	0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x2e, 0x65, 0x64, 0x67, 0x65, 0x6e, 0x6f, 0x64, 0x65, 0x22,
	0xaa, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44,
	0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x76, 0x6d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02,
	...
	0x65, 0x61, 0x74, 0x65, 0x41, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x41, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x6f, 0x72,
	...
	0x65, 0x6e, 0x6f, 0x64, 0x65, 0x42, 0x09, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_enreach_edgenode_user_proto_rawDescOnce sync.Once
	file_enreach_edgenode_user_proto_rawDescData = file_enreach_edgenode_user_proto_rawDesc
)

func file_enreach_edgenode_user_proto_rawDescGZIP() []byte {
	file_enreach_edgenode_user_proto_rawDescOnce.Do(func() {
		file_enreach_edgenode_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_enreach_edgenode_user_proto_rawDescData)
	})
	return file_enreach_edgenode_user_proto_rawDescData
}

var file_enreach_edgenode_user_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enreach_edgenode_user_proto_goTypes = []interface{}{
	(*User)(nil), // 0: enreach.edgenode.User
}
var file_enreach_edgenode_user_proto_depIdxs = []int32{
...
func init() { file_enreach_edgenode_user_proto_init() }
func file_enreach_edgenode_user_proto_init() {
	if File_enreach_edgenode_user_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enreach_edgenode_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enreach_edgenode_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enreach_edgenode_user_proto_goTypes,
		DependencyIndexes: file_enreach_edgenode_user_proto_depIdxs,
		MessageInfos:      file_enreach_edgenode_user_proto_msgTypes,
	}.Build()
	File_enreach_edgenode_user_proto = out.File
	file_enreach_edgenode_user_proto_rawDesc = nil
	file_enreach_edgenode_user_proto_goTypes = nil
	file_enreach_edgenode_user_proto_depIdxs = nil
}
