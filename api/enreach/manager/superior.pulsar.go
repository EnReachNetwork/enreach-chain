...
func init() {
	...
	md_Superior = File_enreach_manager_superior_proto.Messages().ByName("Superior")
...
func (x *Superior) slowProtoReflect() protoreflect.Message {
	mi := &file_enreach_manager_superior_proto_msgTypes[0]
...
func (x *fastReflection_Superior) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "enreach.manager.Superior.account":
		return x.Account != ""
	case "enreach.manager.Superior.creator":
		return x.Creator != ""
	case "enreach.manager.Superior.createAt":
		return x.CreateAt != uint64(0)
	case "enreach.manager.Superior.updator":
		return x.Updator != ""
	case "enreach.manager.Superior.updateAt":
		return x.UpdateAt != uint64(0)
	case "enreach.manager.Superior.signer":
		return x.Signer != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: enreach.manager.Superior"))
		}
		panic(fmt.Errorf("message enreach.manager.Superior does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Superior) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message enreach.manager.Superior does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Superior) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "enreach.manager.Superior.account":
		panic(fmt.Errorf("field account of message enreach.manager.Superior is not mutable"))
	case "enreach.manager.Superior.creator":
		panic(fmt.Errorf("field creator of message enreach.manager.Superior is not mutable"))
	case "enreach.manager.Superior.createAt":
		panic(fmt.Errorf("field createAt of message enreach.manager.Superior is not mutable"))
	case "enreach.manager.Superior.updator":
		panic(fmt.Errorf("field updator of message enreach.manager.Superior is not mutable"))
	case "enreach.manager.Superior.updateAt":
		panic(fmt.Errorf("field updateAt of message enreach.manager.Superior is not mutable"))
	case "enreach.manager.Superior.signer":
		panic(fmt.Errorf("field signer of message enreach.manager.Superior is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: enreach.manager.Superior"))
		}
...
func (x *fastReflection_Superior) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in enreach.manager.Superior", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Superior) Descriptor() ([]byte, []int) {
	return file_enreach_manager_superior_proto_rawDescGZIP(), []int{0}
}
...
var File_enreach_manager_superior_proto protoreflect.FileDescriptor

var file_enreach_manager_superior_proto_rawDesc = []byte{
	,
	...
	0x74, 0x65, 0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x42, 0xa3, 0x01, 0x0a,
	0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x2e, 0x6d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x72, 0x42, 0x0d, 0x53, 0x75, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x72, 0x50, 0x72,
	...
	0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0xa2, 0x02, 0x03, 0x45, 0x4d, 0x58, 0xaa, 0x02, 0x0f,
	0x45, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x2e, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0xca,
	0x02, 0x0f, 0x45, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x5c, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x72, 0xe2, 0x02, 0x1b, 0x45, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x5c, 0x4d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x72, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea,
	0x02, 0x10, 0x45, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x3a, 0x3a, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_enreach_manager_superior_proto_rawDescOnce sync.Once
	file_enreach_manager_superior_proto_rawDescData = file_enreach_manager_superior_proto_rawDesc
)

func file_enreach_manager_superior_proto_rawDescGZIP() []byte {
	file_enreach_manager_superior_proto_rawDescOnce.Do(func() {
		file_enreach_manager_superior_proto_rawDescData = protoimpl.X.CompressGZIP(file_enreach_manager_superior_proto_rawDescData)
	})
	return file_enreach_manager_superior_proto_rawDescData
}

var file_enreach_manager_superior_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enreach_manager_superior_proto_goTypes = []interface{}{
	(*Superior)(nil), // 0: enreach.manager.Superior
}
var file_enreach_manager_superior_proto_depIdxs = []int32{
...
func init() { file_enreach_manager_superior_proto_init() }
func file_enreach_manager_superior_proto_init() {
	if File_enreach_manager_superior_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enreach_manager_superior_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enreach_manager_superior_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enreach_manager_superior_proto_goTypes,
		DependencyIndexes: file_enreach_manager_superior_proto_depIdxs,
		MessageInfos:      file_enreach_manager_superior_proto_msgTypes,
	}.Build()
	File_enreach_manager_superior_proto = out.File
	file_enreach_manager_superior_proto_rawDesc = nil
	file_enreach_manager_superior_proto_goTypes = nil
	file_enreach_manager_superior_proto_depIdxs = nil
}
