...
export const MsgRegisterManager: MessageFns<MsgRegisterManager> = {
  encode(message: MsgRegisterManager, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRegisterManager {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgRegisterManagerResponse: MessageFns<MsgRegisterManagerResponse> = {
  encode(message: MsgRegisterManagerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRegisterManagerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateManager: MessageFns<MsgUpdateManager> = {
  encode(message: MsgUpdateManager, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateManager {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateManagerResponse: MessageFns<MsgUpdateManagerResponse> = {
  encode(_: MsgUpdateManagerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateManagerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDeleteManager: MessageFns<MsgDeleteManager> = {
  encode(message: MsgDeleteManager, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteManager {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDeleteManagerResponse: MessageFns<MsgDeleteManagerResponse> = {
  encode(_: MsgDeleteManagerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteManagerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgClientImpl implements Msg {
  ...
  RegisterManager(request: MsgRegisterManager): Promise<MsgRegisterManagerResponse> {
    ...
    return promise.then((data) => MsgRegisterManagerResponse.decode(new BinaryReader(data)));
  }

  UpdateManager(request: MsgUpdateManager): Promise<MsgUpdateManagerResponse> {
    const data = MsgUpdateManager.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateManager", data);
    return promise.then((data) => MsgUpdateManagerResponse.decode(new BinaryReader(data)));
  }

  DeleteManager(request: MsgDeleteManager): Promise<MsgDeleteManagerResponse> {
    const data = MsgDeleteManager.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteManager", data);
    return promise.then((data) => MsgDeleteManagerResponse.decode(new BinaryReader(data)));
  }
}
