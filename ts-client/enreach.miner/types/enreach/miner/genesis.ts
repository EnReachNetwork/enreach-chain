...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.minerList) {
      Miner.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.minerList.push(Miner.decode(reader, reader.uint32()));
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.minerCount = longToNumber(reader.uint64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      minerList: Array.isArray(object?.minerList) ? object.minerList.map((e: any) => Miner.fromJSON(e)) : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.minerList?.length) {
      obj.minerList = message.minerList.map((e) => Miner.toJSON(e));
    }
    if (message.minerCount !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.params = (object.params !== undefined && object.params !== null)
      ...
      : undefined;
    message.minerList = object.minerList?.map((e) => Miner.fromPartial(e)) || [];
