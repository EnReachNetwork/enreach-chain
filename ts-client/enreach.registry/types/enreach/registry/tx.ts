...
export const MsgCreateRegion: MessageFns<MsgCreateRegion> = {
  encode(message: MsgCreateRegion, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateRegion {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgCreateRegionResponse: MessageFns<MsgCreateRegionResponse> = {
  encode(message: MsgCreateRegionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateRegionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateRegion: MessageFns<MsgUpdateRegion> = {
  encode(message: MsgUpdateRegion, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateRegion {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateRegionResponse: MessageFns<MsgUpdateRegionResponse> = {
  encode(_: MsgUpdateRegionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateRegionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDeleteRegion: MessageFns<MsgDeleteRegion> = {
  encode(message: MsgDeleteRegion, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteRegion {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDeleteRegionResponse: MessageFns<MsgDeleteRegionResponse> = {
  encode(_: MsgDeleteRegionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteRegionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgClientImpl implements Msg {
  ...
  CreateRegion(request: MsgCreateRegion): Promise<MsgCreateRegionResponse> {
    ...
    return promise.then((data) => MsgCreateRegionResponse.decode(new BinaryReader(data)));
  }

  UpdateRegion(request: MsgUpdateRegion): Promise<MsgUpdateRegionResponse> {
    const data = MsgUpdateRegion.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateRegion", data);
    return promise.then((data) => MsgUpdateRegionResponse.decode(new BinaryReader(data)));
  }

  DeleteRegion(request: MsgDeleteRegion): Promise<MsgDeleteRegionResponse> {
    const data = MsgDeleteRegion.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteRegion", data);
    return promise.then((data) => MsgDeleteRegionResponse.decode(new BinaryReader(data)));
  }
}
