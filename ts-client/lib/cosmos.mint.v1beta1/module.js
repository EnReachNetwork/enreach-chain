...
exports.queryClient = exports.txClient = exports.registry = exports.Minter = exports.QueryInflationRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.Params = exports.QueryAnnualProvisionsRequest = exports.MsgUpdateParamsResponse = exports.GenesisState = exports.QueryAnnualProvisionsResponse = exports.QueryInflationResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryInflationResponse", { enumerable: true, get: function () { return query_1.QueryInflationResponse; } });
const query_2 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryAnnualProvisionsResponse", { enumerable: true, get: function () { return query_2.QueryAnnualProvisionsResponse; } });
...
Object.defineProperty(exports, "QueryAnnualProvisionsRequest", { enumerable: true, get: function () { return query_3.QueryAnnualProvisionsRequest; } });
const mint_1 = require("./types/cosmos/mint/v1beta1/mint");
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return mint_1.Params; } });
...
Object.defineProperty(exports, "QueryInflationRequest", { enumerable: true, get: function () { return query_6.QueryInflationRequest; } });
const mint_2 = require("./types/cosmos/mint/v1beta1/mint");
Object.defineProperty(exports, "Minter", { enumerable: true, get: function () { return mint_2.Minter; } });
    ...
    return {
        async sendQueryInflationResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryInflationResponse({ value: query_1.QueryInflationResponse.fromPartial(value) });
        ...
        async sendQueryAnnualProvisionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsResponse({ value: query_2.QueryAnnualProvisionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAnnualProvisionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsRequest({ value: query_3.QueryAnnualProvisionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: mint_1.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInflationRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationRequest({ value: query_6.QueryInflationRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMinter({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.minter({ value: mint_2.Minter.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryInflationResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationResponse", value: query_1.QueryInflationResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAnnualProvisionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsResponse", value: query_2.QueryAnnualProvisionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAnnualProvisionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsRequest", value: query_3.QueryAnnualProvisionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.Params", value: mint_1.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsRequest", value: query_4.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsResponse", value: query_5.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInflationRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationRequest", value: query_6.QueryInflationRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        minter({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.Minter", value: mint_2.Minter.fromPartial(value) };
            }
            catch (e) {
