...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.QueryInflationResponse = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.Minter = exports.QueryAnnualProvisionsResponse = exports.QueryAnnualProvisionsRequest = exports.QueryInflationRequest = exports.Params = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "QueryInflationRequest", { enumerable: true, get: function () { return query_1.QueryInflationRequest; } });
const query_2 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryAnnualProvisionsRequest", { enumerable: true, get: function () { return query_2.QueryAnnualProvisionsRequest; } });
const query_3 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryAnnualProvisionsResponse", { enumerable: true, get: function () { return query_3.QueryAnnualProvisionsResponse; } });
    ...
    return {
        ...
        async sendQueryInflationRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationRequest({ value: query_1.QueryInflationRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAnnualProvisionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsRequest({ value: query_2.QueryAnnualProvisionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAnnualProvisionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsResponse({ value: query_3.QueryAnnualProvisionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryInflationRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationRequest", value: query_1.QueryInflationRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAnnualProvisionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsRequest", value: query_2.QueryAnnualProvisionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAnnualProvisionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsResponse", value: query_3.QueryAnnualProvisionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsRequest", value: query_5.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsResponse", value: query_6.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
