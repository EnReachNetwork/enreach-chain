...
exports.queryClient = exports.txClient = exports.registry = exports.Minter = exports.MsgUpdateParamsResponse = exports.QueryAnnualProvisionsResponse = exports.QueryParamsRequest = exports.GenesisState = exports.QueryInflationResponse = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.QueryAnnualProvisionsRequest = exports.QueryInflationRequest = exports.Params = void 0;
...
Object.defineProperty(exports, "QueryAnnualProvisionsResponse", { enumerable: true, get: function () { return query_6.QueryAnnualProvisionsResponse; } });
    ...
    return {
        ...
        async sendQueryAnnualProvisionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsResponse({ value: query_6.QueryAnnualProvisionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAnnualProvisionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsResponse", value: query_6.QueryAnnualProvisionsResponse.fromPartial(value) };
            }
            catch (e) {
