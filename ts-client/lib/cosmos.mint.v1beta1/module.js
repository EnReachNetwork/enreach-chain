...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.QueryInflationResponse = exports.QueryParamsResponse = exports.Params = exports.QueryInflationRequest = exports.Minter = exports.GenesisState = exports.QueryAnnualProvisionsResponse = exports.QueryAnnualProvisionsRequest = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsResponse", value: query_4.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
