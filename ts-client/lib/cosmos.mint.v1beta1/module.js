...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAnnualProvisionsResponse = exports.GenesisState = exports.QueryInflationRequest = exports.QueryParamsRequest = exports.Minter = exports.MsgUpdateParams = exports.QueryInflationResponse = exports.MsgUpdateParamsResponse = exports.QueryAnnualProvisionsRequest = exports.QueryParamsResponse = exports.Params = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
