...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.Params = exports.GenesisState = exports.QueryAnnualProvisionsResponse = exports.Minter = exports.MsgUpdateParamsResponse = exports.QueryInflationResponse = exports.QueryInflationRequest = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.QueryAnnualProvisionsRequest = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsRequest", value: query_6.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
