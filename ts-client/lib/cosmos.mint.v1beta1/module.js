...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAnnualProvisionsRequest = exports.QueryInflationResponse = exports.QueryInflationRequest = exports.QueryParamsResponse = exports.Minter = exports.GenesisState = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.QueryParamsRequest = exports.QueryAnnualProvisionsResponse = exports.Params = void 0;
...
Object.defineProperty(exports, "QueryAnnualProvisionsResponse", { enumerable: true, get: function () { return query_1.QueryAnnualProvisionsResponse; } });
...
Object.defineProperty(exports, "QueryInflationRequest", { enumerable: true, get: function () { return query_4.QueryInflationRequest; } });
const query_5 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryInflationResponse", { enumerable: true, get: function () { return query_5.QueryInflationResponse; } });
    ...
    return {
        ...
        async sendQueryAnnualProvisionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsResponse({ value: query_1.QueryAnnualProvisionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInflationRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationRequest({ value: query_4.QueryInflationRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInflationResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationResponse({ value: query_5.QueryInflationResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAnnualProvisionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsResponse", value: query_1.QueryAnnualProvisionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInflationRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationRequest", value: query_4.QueryInflationRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInflationResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationResponse", value: query_5.QueryInflationResponse.fromPartial(value) };
            }
            catch (e) {
