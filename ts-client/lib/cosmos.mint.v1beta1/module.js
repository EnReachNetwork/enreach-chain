...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.Minter = exports.Params = exports.QueryAnnualProvisionsRequest = exports.MsgUpdateParamsResponse = exports.QueryAnnualProvisionsResponse = exports.QueryInflationResponse = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.QueryInflationRequest = exports.QueryParamsRequest = void 0;
...
Object.defineProperty(exports, "QueryInflationRequest", { enumerable: true, get: function () { return query_2.QueryInflationRequest; } });
...
Object.defineProperty(exports, "QueryInflationResponse", { enumerable: true, get: function () { return query_4.QueryInflationResponse; } });
const query_5 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryAnnualProvisionsResponse", { enumerable: true, get: function () { return query_5.QueryAnnualProvisionsResponse; } });
    ...
    return {
        ...
        async sendQueryInflationRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationRequest({ value: query_2.QueryInflationRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInflationResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationResponse({ value: query_4.QueryInflationResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAnnualProvisionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsResponse({ value: query_5.QueryAnnualProvisionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryInflationRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationRequest", value: query_2.QueryInflationRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsResponse", value: query_3.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInflationResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationResponse", value: query_4.QueryInflationResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAnnualProvisionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsResponse", value: query_5.QueryAnnualProvisionsResponse.fromPartial(value) };
            }
            catch (e) {
