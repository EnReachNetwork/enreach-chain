...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParamsResponse = exports.QueryAnnualProvisionsResponse = exports.QueryParamsRequest = exports.GenesisState = exports.QueryInflationRequest = exports.QueryAnnualProvisionsRequest = exports.QueryInflationResponse = exports.QueryParamsResponse = exports.Params = exports.Minter = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "QueryInflationResponse", { enumerable: true, get: function () { return query_2.QueryInflationResponse; } });
    ...
    return {
        ...
        async sendQueryInflationResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationResponse({ value: query_2.QueryInflationResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryInflationResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationResponse", value: query_2.QueryInflationResponse.fromPartial(value) };
            }
            catch (e) {
