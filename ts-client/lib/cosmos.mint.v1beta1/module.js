...
exports.queryClient = exports.txClient = exports.registry = exports.Minter = exports.MsgUpdateParams = exports.GenesisState = exports.QueryInflationRequest = exports.Params = exports.QueryAnnualProvisionsResponse = exports.QueryInflationResponse = exports.QueryParamsRequest = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.QueryAnnualProvisionsRequest = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryParamsRequest", value: query_3.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
