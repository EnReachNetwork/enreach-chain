...
exports.queryClient = exports.txClient = exports.registry = exports.Params = exports.MsgUpdateParamsResponse = exports.QueryInflationResponse = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.Minter = exports.MsgUpdateParams = exports.QueryInflationRequest = exports.GenesisState = exports.QueryAnnualProvisionsResponse = exports.QueryAnnualProvisionsRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/mint/v1beta1/query");
Object.defineProperty(exports, "QueryAnnualProvisionsRequest", { enumerable: true, get: function () { return query_1.QueryAnnualProvisionsRequest; } });
...
Object.defineProperty(exports, "QueryInflationRequest", { enumerable: true, get: function () { return query_3.QueryInflationRequest; } });
...
Object.defineProperty(exports, "QueryInflationResponse", { enumerable: true, get: function () { return query_6.QueryInflationResponse; } });
    ...
    return {
        async sendQueryAnnualProvisionsRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryAnnualProvisionsRequest({ value: query_1.QueryAnnualProvisionsRequest.fromPartial(value) });
        ...
        async sendQueryInflationRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationRequest({ value: query_3.QueryInflationRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInflationResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInflationResponse({ value: query_6.QueryInflationResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAnnualProvisionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsRequest", value: query_1.QueryAnnualProvisionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInflationRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationRequest", value: query_3.QueryInflationRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.MsgUpdateParams", value: tx_1.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInflationResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryInflationResponse", value: query_6.QueryInflationResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.MsgUpdateParamsResponse", value: tx_2.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
