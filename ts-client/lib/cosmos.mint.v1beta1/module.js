...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.MsgUpdateParamsResponse = exports.QueryInflationResponse = exports.Params = exports.QueryAnnualProvisionsRequest = exports.QueryInflationRequest = exports.QueryParamsRequest = exports.QueryAnnualProvisionsResponse = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.Minter = void 0;
...
Object.defineProperty(exports, "QueryAnnualProvisionsRequest", { enumerable: true, get: function () { return query_5.QueryAnnualProvisionsRequest; } });
    ...
    return {
        ...
        async sendQueryAnnualProvisionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAnnualProvisionsRequest({ value: query_5.QueryAnnualProvisionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAnnualProvisionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.mint.v1beta1.QueryAnnualProvisionsRequest", value: query_5.QueryAnnualProvisionsRequest.fromPartial(value) };
            }
            catch (e) {
