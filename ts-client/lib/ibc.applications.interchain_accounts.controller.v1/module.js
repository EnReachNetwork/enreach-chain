...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.MsgRegisterInterchainAccount = exports.MsgUpdateParamsResponse = exports.MsgSendTx = exports.Params = exports.QueryParamsRequest = exports.QueryInterchainAccountResponse = exports.MsgSendTxResponse = exports.QueryParamsResponse = exports.QueryInterchainAccountRequest = exports.MsgRegisterInterchainAccountResponse = void 0;
...
Object.defineProperty(exports, "MsgSendTx", { enumerable: true, get: function () { return tx_3.MsgSendTx; } });
    ...
    return {
        ...
        async sendMsgSendTx({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTx({ value: tx_3.MsgSendTx.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSendTx({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTx", value: tx_3.MsgSendTx.fromPartial(value) };
            }
            catch (e) {
