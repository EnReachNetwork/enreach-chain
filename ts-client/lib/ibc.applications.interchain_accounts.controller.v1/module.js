...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.Params = exports.QueryInterchainAccountResponse = exports.QueryInterchainAccountRequest = exports.MsgSendTx = exports.QueryParamsRequest = exports.MsgRegisterInterchainAccountResponse = exports.MsgUpdateParamsResponse = exports.MsgSendTxResponse = exports.MsgRegisterInterchainAccount = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/ibc/applications/interchain_accounts/controller/v1/tx");
Object.defineProperty(exports, "MsgRegisterInterchainAccount", { enumerable: true, get: function () { return tx_1.MsgRegisterInterchainAccount; } });
const tx_2 = require("./types/ibc/applications/interchain_accounts/controller/v1/tx");
Object.defineProperty(exports, "MsgSendTxResponse", { enumerable: true, get: function () { return tx_2.MsgSendTxResponse; } });
...
Object.defineProperty(exports, "MsgRegisterInterchainAccountResponse", { enumerable: true, get: function () { return tx_4.MsgRegisterInterchainAccountResponse; } });
...
Object.defineProperty(exports, "QueryInterchainAccountRequest", { enumerable: true, get: function () { return query_2.QueryInterchainAccountRequest; } });
const query_3 = require("./types/ibc/applications/interchain_accounts/controller/v1/query");
Object.defineProperty(exports, "QueryInterchainAccountResponse", { enumerable: true, get: function () { return query_3.QueryInterchainAccountResponse; } });
    ...
    return {
        async sendMsgRegisterInterchainAccount({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgRegisterInterchainAccount({ value: tx_1.MsgRegisterInterchainAccount.fromPartial(value) });
        ...
        async sendMsgSendTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTxResponse({ value: tx_2.MsgSendTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccountResponse({ value: tx_4.MsgRegisterInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInterchainAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInterchainAccountRequest({ value: query_2.QueryInterchainAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInterchainAccountResponse({ value: query_3.QueryInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRegisterInterchainAccount({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccount", value: tx_1.MsgRegisterInterchainAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSendTxResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTxResponse", value: tx_2.MsgSendTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccountResponse", value: tx_4.MsgRegisterInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryParamsRequest", value: query_1.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInterchainAccountRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryInterchainAccountRequest", value: query_2.QueryInterchainAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryInterchainAccountResponse", value: query_3.QueryInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParams", value: tx_6.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryParamsResponse", value: query_4.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
