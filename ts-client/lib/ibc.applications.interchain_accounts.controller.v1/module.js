...
exports.queryClient = exports.txClient = exports.registry = exports.MsgRegisterInterchainAccountResponse = exports.QueryInterchainAccountResponse = exports.QueryInterchainAccountRequest = exports.MsgRegisterInterchainAccount = exports.Params = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.MsgSendTxResponse = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.MsgSendTx = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParamsResponse", value: tx_4.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
