...
exports.queryClient = exports.txClient = exports.registry = exports.QueryInterchainAccountRequest = exports.Params = exports.MsgSendTxResponse = exports.MsgRegisterInterchainAccountResponse = exports.MsgSendTx = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.MsgUpdateParamsResponse = exports.MsgRegisterInterchainAccount = exports.QueryInterchainAccountResponse = exports.MsgUpdateParams = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryParamsResponse", value: query_3.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
