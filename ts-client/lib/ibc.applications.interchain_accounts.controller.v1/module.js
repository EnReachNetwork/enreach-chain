...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.QueryInterchainAccountRequest = exports.Params = exports.MsgSendTxResponse = exports.MsgRegisterInterchainAccountResponse = exports.MsgRegisterInterchainAccount = exports.QueryParamsResponse = exports.QueryInterchainAccountResponse = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgSendTx = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/ibc/applications/interchain_accounts/controller/v1/tx");
Object.defineProperty(exports, "MsgSendTx", { enumerable: true, get: function () { return tx_1.MsgSendTx; } });
...
Object.defineProperty(exports, "MsgRegisterInterchainAccount", { enumerable: true, get: function () { return tx_4.MsgRegisterInterchainAccount; } });
const tx_5 = require("./types/ibc/applications/interchain_accounts/controller/v1/tx");
Object.defineProperty(exports, "MsgRegisterInterchainAccountResponse", { enumerable: true, get: function () { return tx_5.MsgRegisterInterchainAccountResponse; } });
const tx_6 = require("./types/ibc/applications/interchain_accounts/controller/v1/tx");
Object.defineProperty(exports, "MsgSendTxResponse", { enumerable: true, get: function () { return tx_6.MsgSendTxResponse; } });
...
Object.defineProperty(exports, "QueryInterchainAccountRequest", { enumerable: true, get: function () { return query_3.QueryInterchainAccountRequest; } });
    ...
    return {
        async sendMsgSendTx({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgSendTx({ value: tx_1.MsgSendTx.fromPartial(value) });
        ...
        async sendQueryInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInterchainAccountResponse({ value: query_1.QueryInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterInterchainAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccount({ value: tx_4.MsgRegisterInterchainAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccountResponse({ value: tx_5.MsgRegisterInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSendTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTxResponse({ value: tx_6.MsgSendTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInterchainAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInterchainAccountRequest({ value: query_3.QueryInterchainAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSendTx({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTx", value: tx_1.MsgSendTx.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParams", value: tx_2.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParamsResponse", value: tx_3.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryInterchainAccountResponse", value: query_1.QueryInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryParamsResponse", value: query_2.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterInterchainAccount({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccount", value: tx_4.MsgRegisterInterchainAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccountResponse", value: tx_5.MsgRegisterInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSendTxResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTxResponse", value: tx_6.MsgSendTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInterchainAccountRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryInterchainAccountRequest", value: query_3.QueryInterchainAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryParamsRequest", value: query_4.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
