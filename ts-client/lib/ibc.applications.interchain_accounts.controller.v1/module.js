...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSendTxResponse = exports.QueryParamsResponse = exports.Params = exports.QueryParamsRequest = exports.MsgUpdateParamsResponse = exports.MsgSendTx = exports.MsgRegisterInterchainAccountResponse = exports.QueryInterchainAccountRequest = exports.MsgUpdateParams = exports.QueryInterchainAccountResponse = exports.MsgRegisterInterchainAccount = void 0;
...
Object.defineProperty(exports, "MsgRegisterInterchainAccountResponse", { enumerable: true, get: function () { return tx_3.MsgRegisterInterchainAccountResponse; } });
const tx_4 = require("./types/ibc/applications/interchain_accounts/controller/v1/tx");
Object.defineProperty(exports, "MsgSendTx", { enumerable: true, get: function () { return tx_4.MsgSendTx; } });
    ...
    return {
        ...
        async sendMsgRegisterInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccountResponse({ value: tx_3.MsgRegisterInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSendTx({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTx({ value: tx_4.MsgSendTx.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRegisterInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccountResponse", value: tx_3.MsgRegisterInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSendTx({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTx", value: tx_4.MsgSendTx.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParamsResponse", value: tx_5.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
