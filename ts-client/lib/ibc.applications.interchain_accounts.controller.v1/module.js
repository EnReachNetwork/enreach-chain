...
exports.queryClient = exports.txClient = exports.registry = exports.QueryInterchainAccountResponse = exports.MsgRegisterInterchainAccountResponse = exports.QueryInterchainAccountRequest = exports.MsgSendTx = exports.MsgRegisterInterchainAccount = exports.QueryParamsRequest = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgSendTxResponse = exports.Params = void 0;
...
Object.defineProperty(exports, "MsgSendTxResponse", { enumerable: true, get: function () { return tx_1.MsgSendTxResponse; } });
...
Object.defineProperty(exports, "MsgSendTx", { enumerable: true, get: function () { return tx_5.MsgSendTx; } });
...
Object.defineProperty(exports, "MsgRegisterInterchainAccountResponse", { enumerable: true, get: function () { return tx_6.MsgRegisterInterchainAccountResponse; } });
const query_4 = require("./types/ibc/applications/interchain_accounts/controller/v1/query");
Object.defineProperty(exports, "QueryInterchainAccountResponse", { enumerable: true, get: function () { return query_4.QueryInterchainAccountResponse; } });
    ...
    return {
        ...
        async sendMsgSendTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTxResponse({ value: tx_1.MsgSendTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSendTx({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTx({ value: tx_5.MsgSendTx.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccountResponse({ value: tx_6.MsgRegisterInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryInterchainAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryInterchainAccountResponse({ value: query_4.QueryInterchainAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSendTxResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTxResponse", value: tx_1.MsgSendTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSendTx({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTx", value: tx_5.MsgSendTx.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccountResponse", value: tx_6.MsgRegisterInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryInterchainAccountResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.QueryInterchainAccountResponse", value: query_4.QueryInterchainAccountResponse.fromPartial(value) };
            }
            catch (e) {
