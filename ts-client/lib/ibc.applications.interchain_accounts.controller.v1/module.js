...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.Params = exports.MsgSendTxResponse = exports.QueryInterchainAccountRequest = exports.MsgSendTx = exports.MsgRegisterInterchainAccountResponse = exports.MsgUpdateParams = exports.MsgRegisterInterchainAccount = exports.MsgUpdateParamsResponse = exports.QueryParamsResponse = exports.QueryInterchainAccountResponse = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParamsResponse", value: tx_1.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParams", value: tx_3.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
