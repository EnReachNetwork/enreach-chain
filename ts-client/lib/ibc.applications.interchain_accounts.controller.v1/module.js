...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.QueryInterchainAccountRequest = exports.Params = exports.MsgSendTxResponse = exports.MsgRegisterInterchainAccountResponse = exports.MsgRegisterInterchainAccount = exports.MsgUpdateParams = exports.QueryInterchainAccountResponse = exports.MsgUpdateParamsResponse = exports.MsgSendTx = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParamsResponse", value: tx_2.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
