...
exports.queryClient = exports.txClient = exports.registry = exports.MsgRegisterInterchainAccountResponse = exports.Params = exports.MsgSendTxResponse = exports.MsgSendTx = exports.QueryParamsRequest = exports.QueryInterchainAccountRequest = exports.MsgUpdateParamsResponse = exports.MsgRegisterInterchainAccount = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.QueryInterchainAccountResponse = void 0;
...
Object.defineProperty(exports, "MsgRegisterInterchainAccount", { enumerable: true, get: function () { return tx_2.MsgRegisterInterchainAccount; } });
...
Object.defineProperty(exports, "MsgSendTxResponse", { enumerable: true, get: function () { return tx_5.MsgSendTxResponse; } });
    ...
    return {
        ...
        async sendMsgRegisterInterchainAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccount({ value: tx_2.MsgRegisterInterchainAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSendTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSendTxResponse({ value: tx_5.MsgSendTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgUpdateParams", value: tx_1.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterInterchainAccount({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccount", value: tx_2.MsgRegisterInterchainAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSendTxResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgSendTxResponse", value: tx_5.MsgSendTxResponse.fromPartial(value) };
            }
            catch (e) {
