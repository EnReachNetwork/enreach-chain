...
exports.queryClient = exports.txClient = exports.registry = exports.MsgRegisterInterchainAccount = exports.QueryParamsRequest = exports.QueryInterchainAccountResponse = exports.QueryInterchainAccountRequest = exports.MsgUpdateParamsResponse = exports.MsgRegisterInterchainAccountResponse = exports.Params = exports.MsgUpdateParams = exports.MsgSendTxResponse = exports.MsgSendTx = exports.QueryParamsResponse = void 0;
...
Object.defineProperty(exports, "MsgRegisterInterchainAccount", { enumerable: true, get: function () { return tx_6.MsgRegisterInterchainAccount; } });
    ...
    return {
        ...
        async sendMsgRegisterInterchainAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterInterchainAccount({ value: tx_6.MsgRegisterInterchainAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRegisterInterchainAccount({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccount", value: tx_6.MsgRegisterInterchainAccount.fromPartial(value) };
            }
            catch (e) {
