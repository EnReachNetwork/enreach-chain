...
exports.queryClient = exports.txClient = exports.registry = exports.QueryBalanceRequest = exports.QueryClassResponse = exports.QueryOwnerRequest = exports.EventSend = exports.MsgSend = exports.QueryClassesRequest = exports.QueryNFTsResponse = exports.QueryNFTsRequest = exports.Class = exports.EventMint = exports.QuerySupplyRequest = exports.QueryOwnerResponse = exports.QueryBalanceResponse = exports.GenesisState = exports.Entry = exports.QueryClassesResponse = exports.MsgSendResponse = exports.EventBurn = exports.NFT = exports.QuerySupplyResponse = exports.QueryClassRequest = exports.QueryNFTResponse = exports.QueryNFTRequest = void 0;
...
Object.defineProperty(exports, "QuerySupplyRequest", { enumerable: true, get: function () { return query_8.QuerySupplyRequest; } });
    ...
    return {
        ...
        async sendQuerySupplyRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyRequest({ value: query_8.QuerySupplyRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySupplyRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyRequest", value: query_8.QuerySupplyRequest.fromPartial(value) };
            }
            catch (e) {
