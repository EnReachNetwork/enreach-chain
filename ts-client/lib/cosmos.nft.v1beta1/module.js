...
exports.queryClient = exports.txClient = exports.registry = exports.Entry = exports.QuerySupplyResponse = exports.QueryOwnerRequest = exports.Class = exports.MsgSendResponse = exports.QueryBalanceResponse = exports.EventMint = exports.QueryOwnerResponse = exports.QueryBalanceRequest = exports.EventBurn = exports.EventSend = exports.MsgSend = exports.QuerySupplyRequest = exports.QueryClassesResponse = exports.QueryClassRequest = exports.QueryNFTsRequest = exports.NFT = exports.GenesisState = exports.QueryClassesRequest = exports.QueryClassResponse = exports.QueryNFTResponse = exports.QueryNFTRequest = exports.QueryNFTsResponse = void 0;
...
Object.defineProperty(exports, "QueryClassRequest", { enumerable: true, get: function () { return query_7.QueryClassRequest; } });
...
Object.defineProperty(exports, "QueryOwnerResponse", { enumerable: true, get: function () { return query_11.QueryOwnerResponse; } });
...
Object.defineProperty(exports, "QuerySupplyResponse", { enumerable: true, get: function () { return query_14.QuerySupplyResponse; } });
    ...
    return {
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryNftsResponse({ value: query_1.QueryNFTsResponse.fromPartial(value) });
        ...
        async sendQueryClassRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassRequest({ value: query_7.QueryClassRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryOwnerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerResponse({ value: query_11.QueryOwnerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyResponse({ value: query_14.QuerySupplyResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_1.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassRequest", value: query_7.QueryClassRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceRequest", value: query_10.QueryBalanceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerResponse", value: query_11.QueryOwnerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_14.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
