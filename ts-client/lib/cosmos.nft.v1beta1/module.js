...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySupplyRequest = exports.EventSend = exports.Class = exports.MsgSendResponse = exports.QueryNFTsResponse = exports.QueryOwnerRequest = exports.NFT = exports.Entry = exports.EventBurn = exports.EventMint = exports.QueryClassResponse = exports.QueryNFTResponse = exports.QueryClassRequest = exports.QueryNFTRequest = exports.MsgSend = exports.QueryClassesRequest = exports.QueryClassesResponse = exports.QueryNFTsRequest = exports.QueryBalanceRequest = exports.QueryOwnerResponse = exports.QueryBalanceResponse = exports.GenesisState = exports.QuerySupplyResponse = void 0;
...
Object.defineProperty(exports, "QueryOwnerResponse", { enumerable: true, get: function () { return query_3.QueryOwnerResponse; } });
...
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_5.QueryNFTsRequest; } });
const query_6 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassesResponse", { enumerable: true, get: function () { return query_6.QueryClassesResponse; } });
...
Object.defineProperty(exports, "QueryClassRequest", { enumerable: true, get: function () { return query_9.QueryClassRequest; } });
...
Object.defineProperty(exports, "QueryClassResponse", { enumerable: true, get: function () { return query_11.QueryClassResponse; } });
    ...
    return {
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.querySupplyResponse({ value: query_1.QuerySupplyResponse.fromPartial(value) });
        ...
        async sendQueryOwnerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerResponse({ value: query_3.QueryOwnerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_5.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesResponse({ value: query_6.QueryClassesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassRequest({ value: query_9.QueryClassRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassResponse({ value: query_11.QueryClassResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_1.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerResponse", value: query_3.QueryOwnerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_5.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesResponse", value: query_6.QueryClassesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassRequest", value: query_9.QueryClassRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassResponse", value: query_11.QueryClassResponse.fromPartial(value) };
            }
            catch (e) {
