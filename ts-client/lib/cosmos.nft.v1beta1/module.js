...
exports.queryClient = exports.txClient = exports.registry = exports.QueryClassesRequest = exports.QueryNFTsResponse = exports.EventMint = exports.QueryClassRequest = exports.QueryOwnerRequest = exports.QueryBalanceResponse = exports.QueryClassesResponse = exports.QueryOwnerResponse = exports.NFT = exports.Class = exports.QueryNFTRequest = exports.Entry = exports.QueryNFTResponse = exports.GenesisState = exports.QueryBalanceRequest = exports.EventBurn = exports.EventSend = exports.MsgSend = exports.QueryClassResponse = exports.QueryNFTsRequest = exports.QuerySupplyResponse = exports.QuerySupplyRequest = exports.MsgSendResponse = void 0;
...
Object.defineProperty(exports, "QuerySupplyResponse", { enumerable: true, get: function () { return query_2.QuerySupplyResponse; } });
const query_3 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_3.QueryNFTsRequest; } });
...
Object.defineProperty(exports, "QueryNFTResponse", { enumerable: true, get: function () { return query_6.QueryNFTResponse; } });
...
Object.defineProperty(exports, "QueryNFTRequest", { enumerable: true, get: function () { return query_7.QueryNFTRequest; } });
...
Object.defineProperty(exports, "QueryClassesResponse", { enumerable: true, get: function () { return query_9.QueryClassesResponse; } });
const query_10 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryBalanceResponse", { enumerable: true, get: function () { return query_10.QueryBalanceResponse; } });
const query_11 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryOwnerRequest", { enumerable: true, get: function () { return query_11.QueryOwnerRequest; } });
...
Object.defineProperty(exports, "QueryNFTsResponse", { enumerable: true, get: function () { return query_13.QueryNFTsResponse; } });
    ...
    return {
        ...
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyResponse({ value: query_2.QuerySupplyResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_3.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftresponse({ value: query_6.QueryNFTResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftrequest({ value: query_7.QueryNFTRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesResponse({ value: query_9.QueryClassesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceResponse({ value: query_10.QueryBalanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryOwnerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerRequest({ value: query_11.QueryOwnerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsResponse({ value: query_13.QueryNFTsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_2.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_3.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTResponse", value: query_6.QueryNFTResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTRequest", value: query_7.QueryNFTRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesResponse", value: query_9.QueryClassesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceResponse", value: query_10.QueryBalanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerRequest", value: query_11.QueryOwnerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_13.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
