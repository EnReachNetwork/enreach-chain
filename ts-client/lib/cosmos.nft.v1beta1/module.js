...
exports.queryClient = exports.txClient = exports.registry = exports.QueryBalanceRequest = exports.Class = exports.QueryClassesResponse = exports.QueryClassResponse = exports.Entry = exports.QueryClassRequest = exports.QueryClassesRequest = exports.QuerySupplyResponse = exports.MsgSendResponse = exports.QueryOwnerResponse = exports.QueryNFTsRequest = exports.NFT = exports.GenesisState = exports.QueryNFTRequest = exports.QueryNFTsResponse = exports.EventBurn = exports.QueryOwnerRequest = exports.QueryBalanceResponse = exports.EventMint = exports.QueryNFTResponse = exports.QuerySupplyRequest = exports.EventSend = exports.MsgSend = void 0;
...
Object.defineProperty(exports, "QueryOwnerRequest", { enumerable: true, get: function () { return query_4.QueryOwnerRequest; } });
...
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_7.QueryNFTsRequest; } });
...
Object.defineProperty(exports, "QuerySupplyResponse", { enumerable: true, get: function () { return query_9.QuerySupplyResponse; } });
...
Object.defineProperty(exports, "QueryClassResponse", { enumerable: true, get: function () { return query_12.QueryClassResponse; } });
    ...
    return {
        ...
        async sendQueryOwnerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerRequest({ value: query_4.QueryOwnerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_7.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyResponse({ value: query_9.QuerySupplyResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassResponse({ value: query_12.QueryClassResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryBalanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceResponse", value: query_3.QueryBalanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerRequest", value: query_4.QueryOwnerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_7.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_9.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassResponse", value: query_12.QueryClassResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceRequest", value: query_14.QueryBalanceRequest.fromPartial(value) };
            }
            catch (e) {
