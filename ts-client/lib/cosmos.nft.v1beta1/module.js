...
exports.queryClient = exports.txClient = exports.registry = exports.QueryBalanceRequest = exports.NFT = exports.QueryOwnerResponse = exports.QueryOwnerRequest = exports.Entry = exports.QueryNFTsResponse = exports.QueryNFTsRequest = exports.QueryClassResponse = exports.QueryNFTResponse = exports.GenesisState = exports.EventBurn = exports.MsgSend = exports.QueryClassesResponse = exports.QueryBalanceResponse = exports.QuerySupplyResponse = exports.Class = exports.MsgSendResponse = exports.QueryNFTRequest = exports.EventMint = exports.EventSend = exports.QueryClassRequest = exports.QuerySupplyRequest = exports.QueryClassesRequest = void 0;
...
Object.defineProperty(exports, "QuerySupplyRequest", { enumerable: true, get: function () { return query_2.QuerySupplyRequest; } });
...
Object.defineProperty(exports, "QueryBalanceResponse", { enumerable: true, get: function () { return query_6.QueryBalanceResponse; } });
...
Object.defineProperty(exports, "QueryNFTResponse", { enumerable: true, get: function () { return query_8.QueryNFTResponse; } });
const query_9 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassResponse", { enumerable: true, get: function () { return query_9.QueryClassResponse; } });
const query_10 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_10.QueryNFTsRequest; } });
const query_11 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTsResponse", { enumerable: true, get: function () { return query_11.QueryNFTsResponse; } });
    ...
    return {
        async sendQueryClassesRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryClassesRequest({ value: query_1.QueryClassesRequest.fromPartial(value) });
        ...
        async sendQuerySupplyRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyRequest({ value: query_2.QuerySupplyRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceResponse({ value: query_6.QueryBalanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftresponse({ value: query_8.QueryNFTResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassResponse({ value: query_9.QueryClassResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_10.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsResponse({ value: query_11.QueryNFTsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryClassesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesRequest", value: query_1.QueryClassesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyRequest", value: query_2.QuerySupplyRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceResponse", value: query_6.QueryBalanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTResponse", value: query_8.QueryNFTResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassResponse", value: query_9.QueryClassResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_10.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_11.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
