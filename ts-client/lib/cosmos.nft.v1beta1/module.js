...
exports.queryClient = exports.txClient = exports.registry = exports.QueryClassResponse = exports.QueryClassesResponse = exports.MsgSendResponse = exports.EventMint = exports.GenesisState = exports.EventBurn = exports.MsgSend = exports.QueryNFTRequest = exports.QueryBalanceRequest = exports.EventSend = exports.QueryNFTsResponse = exports.QueryNFTsRequest = exports.QuerySupplyResponse = exports.QueryBalanceResponse = exports.QueryOwnerRequest = exports.Class = exports.QueryClassesRequest = exports.QueryClassRequest = exports.QueryNFTResponse = exports.QueryOwnerResponse = exports.Entry = exports.NFT = exports.QuerySupplyRequest = void 0;
...
Object.defineProperty(exports, "QueryOwnerResponse", { enumerable: true, get: function () { return query_2.QueryOwnerResponse; } });
...
Object.defineProperty(exports, "QueryOwnerRequest", { enumerable: true, get: function () { return query_6.QueryOwnerRequest; } });
const query_7 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryBalanceResponse", { enumerable: true, get: function () { return query_7.QueryBalanceResponse; } });
const query_8 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QuerySupplyResponse", { enumerable: true, get: function () { return query_8.QuerySupplyResponse; } });
const query_9 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_9.QueryNFTsRequest; } });
const query_10 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTsResponse", { enumerable: true, get: function () { return query_10.QueryNFTsResponse; } });
...
Object.defineProperty(exports, "QueryNFTRequest", { enumerable: true, get: function () { return query_12.QueryNFTRequest; } });
...
Object.defineProperty(exports, "QueryClassesResponse", { enumerable: true, get: function () { return query_13.QueryClassesResponse; } });
    ...
    return {
        async sendQuerySupplyRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.querySupplyRequest({ value: query_1.QuerySupplyRequest.fromPartial(value) });
        ...
        async sendQueryOwnerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerResponse({ value: query_2.QueryOwnerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryOwnerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerRequest({ value: query_6.QueryOwnerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceResponse({ value: query_7.QueryBalanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyResponse({ value: query_8.QuerySupplyResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_9.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsResponse({ value: query_10.QueryNFTsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftrequest({ value: query_12.QueryNFTRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesResponse({ value: query_13.QueryClassesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySupplyRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyRequest", value: query_1.QuerySupplyRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerResponse", value: query_2.QueryOwnerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerRequest", value: query_6.QueryOwnerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceResponse", value: query_7.QueryBalanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_8.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_9.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_10.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTRequest", value: query_12.QueryNFTRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesResponse", value: query_13.QueryClassesResponse.fromPartial(value) };
            }
            catch (e) {
