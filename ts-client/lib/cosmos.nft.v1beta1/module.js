...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSendResponse = exports.QueryClassesRequest = exports.QueryBalanceResponse = exports.QueryNFTResponse = exports.QueryClassRequest = exports.QueryNFTRequest = exports.QueryOwnerRequest = exports.QueryBalanceRequest = exports.Entry = exports.EventMint = exports.NFT = exports.MsgSend = exports.QueryClassesResponse = exports.QuerySupplyRequest = exports.Class = exports.EventSend = exports.QueryNFTsResponse = exports.QuerySupplyResponse = exports.EventBurn = exports.QueryClassResponse = exports.GenesisState = exports.QueryNFTsRequest = exports.QueryOwnerResponse = void 0;
...
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_2.QueryNFTsRequest; } });
...
Object.defineProperty(exports, "QueryClassResponse", { enumerable: true, get: function () { return query_3.QueryClassResponse; } });
...
Object.defineProperty(exports, "QuerySupplyResponse", { enumerable: true, get: function () { return query_4.QuerySupplyResponse; } });
const query_5 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTsResponse", { enumerable: true, get: function () { return query_5.QueryNFTsResponse; } });
const event_2 = require("./types/cosmos/nft/v1beta1/event");
Object.defineProperty(exports, "EventSend", { enumerable: true, get: function () { return event_2.EventSend; } });
...
Object.defineProperty(exports, "QuerySupplyRequest", { enumerable: true, get: function () { return query_6.QuerySupplyRequest; } });
const query_7 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassesResponse", { enumerable: true, get: function () { return query_7.QueryClassesResponse; } });
...
Object.defineProperty(exports, "EventMint", { enumerable: true, get: function () { return event_3.EventMint; } });
const genesis_2 = require("./types/cosmos/nft/v1beta1/genesis");
Object.defineProperty(exports, "Entry", { enumerable: true, get: function () { return genesis_2.Entry; } });
const query_8 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryBalanceRequest", { enumerable: true, get: function () { return query_8.QueryBalanceRequest; } });
const query_9 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryOwnerRequest", { enumerable: true, get: function () { return query_9.QueryOwnerRequest; } });
const query_10 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTRequest", { enumerable: true, get: function () { return query_10.QueryNFTRequest; } });
const query_11 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassRequest", { enumerable: true, get: function () { return query_11.QueryClassRequest; } });
const query_12 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTResponse", { enumerable: true, get: function () { return query_12.QueryNFTResponse; } });
const query_13 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryBalanceResponse", { enumerable: true, get: function () { return query_13.QueryBalanceResponse; } });
const query_14 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassesRequest", { enumerable: true, get: function () { return query_14.QueryClassesRequest; } });
    ...
    return {
        async sendQueryOwnerResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryOwnerResponse({ value: query_1.QueryOwnerResponse.fromPartial(value) });
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_2.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassResponse({ value: query_3.QueryClassResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendEventBurn({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.eventBurn({ value: event_1.EventBurn.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyResponse({ value: query_4.QuerySupplyResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsResponse({ value: query_5.QueryNFTsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendEventSend({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.eventSend({ value: event_2.EventSend.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendClass({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.class({ value: nft_1.Class.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyRequest({ value: query_6.QuerySupplyRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesResponse({ value: query_7.QueryClassesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendNFT({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.nft({ value: nft_2.NFT.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendEventMint({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.eventMint({ value: event_3.EventMint.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendEntry({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.entry({ value: genesis_2.Entry.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceRequest({ value: query_8.QueryBalanceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryOwnerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerRequest({ value: query_9.QueryOwnerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftrequest({ value: query_10.QueryNFTRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassRequest({ value: query_11.QueryClassRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftresponse({ value: query_12.QueryNFTResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceResponse({ value: query_13.QueryBalanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesRequest({ value: query_14.QueryClassesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryOwnerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerResponse", value: query_1.QueryOwnerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_2.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        genesisState({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.GenesisState", value: genesis_1.GenesisState.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassResponse", value: query_3.QueryClassResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        eventBurn({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.EventBurn", value: event_1.EventBurn.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_4.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_5.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        eventSend({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.EventSend", value: event_2.EventSend.fromPartial(value) };
            }
            catch (e) {
        ...
        class({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.Class", value: nft_1.Class.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyRequest", value: query_6.QuerySupplyRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesResponse", value: query_7.QueryClassesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSend({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.MsgSend", value: tx_1.MsgSend.fromPartial(value) };
            }
            catch (e) {
        ...
        nft({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.NFT", value: nft_2.NFT.fromPartial(value) };
            }
            catch (e) {
        ...
        eventMint({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.EventMint", value: event_3.EventMint.fromPartial(value) };
            }
            catch (e) {
        ...
        entry({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.Entry", value: genesis_2.Entry.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceRequest", value: query_8.QueryBalanceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerRequest", value: query_9.QueryOwnerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTRequest", value: query_10.QueryNFTRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassRequest", value: query_11.QueryClassRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTResponse", value: query_12.QueryNFTResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceResponse", value: query_13.QueryBalanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesRequest", value: query_14.QueryClassesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSendResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.MsgSendResponse", value: tx_2.MsgSendResponse.fromPartial(value) };
            }
            catch (e) {
