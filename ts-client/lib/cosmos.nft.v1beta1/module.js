...
exports.queryClient = exports.txClient = exports.registry = exports.QueryNFTRequest = exports.QueryNFTsResponse = exports.QuerySupplyResponse = exports.QueryNFTsRequest = exports.MsgSend = exports.QuerySupplyRequest = exports.GenesisState = exports.EventSend = exports.QueryOwnerRequest = exports.QueryClassesResponse = exports.MsgSendResponse = exports.EventBurn = exports.NFT = exports.QueryClassesRequest = exports.QueryClassRequest = exports.QueryBalanceRequest = exports.Entry = exports.Class = exports.QueryClassResponse = exports.QueryOwnerResponse = exports.QueryBalanceResponse = exports.EventMint = exports.QueryNFTResponse = void 0;
...
Object.defineProperty(exports, "QueryClassRequest", { enumerable: true, get: function () { return query_6.QueryClassRequest; } });
...
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_11.QueryNFTsRequest; } });
...
Object.defineProperty(exports, "QueryNFTRequest", { enumerable: true, get: function () { return query_14.QueryNFTRequest; } });
    ...
    return {
        async sendQueryNFTResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryNftresponse({ value: query_1.QueryNFTResponse.fromPartial(value) });
        ...
        async sendQueryClassRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassRequest({ value: query_6.QueryClassRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_11.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftrequest({ value: query_14.QueryNFTRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryNftresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTResponse", value: query_1.QueryNFTResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassRequest", value: query_6.QueryClassRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_11.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTRequest", value: query_14.QueryNFTRequest.fromPartial(value) };
            }
            catch (e) {
