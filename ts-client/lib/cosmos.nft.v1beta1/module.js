...
exports.queryClient = exports.txClient = exports.registry = exports.QueryClassRequest = exports.EventMint = exports.QueryNFTsRequest = exports.QueryBalanceResponse = exports.QueryBalanceRequest = exports.Entry = exports.QuerySupplyResponse = exports.QueryOwnerResponse = exports.EventBurn = exports.Class = exports.QueryClassesResponse = exports.QueryNFTsResponse = exports.GenesisState = exports.MsgSendResponse = exports.MsgSend = exports.QueryNFTRequest = exports.QueryClassesRequest = exports.QuerySupplyRequest = exports.EventSend = exports.QueryClassResponse = exports.NFT = exports.QueryNFTResponse = exports.QueryOwnerRequest = void 0;
...
Object.defineProperty(exports, "QueryNFTResponse", { enumerable: true, get: function () { return query_2.QueryNFTResponse; } });
...
Object.defineProperty(exports, "QuerySupplyRequest", { enumerable: true, get: function () { return query_4.QuerySupplyRequest; } });
const query_5 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassesRequest", { enumerable: true, get: function () { return query_5.QueryClassesRequest; } });
const query_6 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryNFTRequest", { enumerable: true, get: function () { return query_6.QueryNFTRequest; } });
...
Object.defineProperty(exports, "QueryNFTsResponse", { enumerable: true, get: function () { return query_7.QueryNFTsResponse; } });
const query_8 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryClassesResponse", { enumerable: true, get: function () { return query_8.QueryClassesResponse; } });
...
Object.defineProperty(exports, "QueryOwnerResponse", { enumerable: true, get: function () { return query_9.QueryOwnerResponse; } });
const query_10 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QuerySupplyResponse", { enumerable: true, get: function () { return query_10.QuerySupplyResponse; } });
...
Object.defineProperty(exports, "QueryBalanceRequest", { enumerable: true, get: function () { return query_11.QueryBalanceRequest; } });
const query_12 = require("./types/cosmos/nft/v1beta1/query");
Object.defineProperty(exports, "QueryBalanceResponse", { enumerable: true, get: function () { return query_12.QueryBalanceResponse; } });
...
Object.defineProperty(exports, "QueryClassRequest", { enumerable: true, get: function () { return query_14.QueryClassRequest; } });
    ...
    return {
        async sendQueryOwnerRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryOwnerRequest({ value: query_1.QueryOwnerRequest.fromPartial(value) });
        ...
        async sendQueryNFTResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftresponse({ value: query_2.QueryNFTResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyRequest({ value: query_4.QuerySupplyRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesRequest({ value: query_5.QueryClassesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftrequest({ value: query_6.QueryNFTRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsResponse({ value: query_7.QueryNFTsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesResponse({ value: query_8.QueryClassesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryOwnerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerResponse({ value: query_9.QueryOwnerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySupplyResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySupplyResponse({ value: query_10.QuerySupplyResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceRequest({ value: query_11.QueryBalanceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryBalanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryBalanceResponse({ value: query_12.QueryBalanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassRequest({ value: query_14.QueryClassRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryOwnerRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerRequest", value: query_1.QueryOwnerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTResponse", value: query_2.QueryNFTResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyRequest", value: query_4.QuerySupplyRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesRequest", value: query_5.QueryClassesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTRequest", value: query_6.QueryNFTRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_7.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesResponse", value: query_8.QueryClassesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerResponse", value: query_9.QueryOwnerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySupplyResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QuerySupplyResponse", value: query_10.QuerySupplyResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceRequest", value: query_11.QueryBalanceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryBalanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryBalanceResponse", value: query_12.QueryBalanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassRequest", value: query_14.QueryClassRequest.fromPartial(value) };
            }
            catch (e) {
