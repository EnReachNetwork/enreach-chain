...
exports.queryClient = exports.txClient = exports.registry = exports.QueryBalanceRequest = exports.QueryBalanceResponse = exports.Entry = exports.MsgSend = exports.QueryNFTsRequest = exports.QueryOwnerResponse = exports.NFT = exports.GenesisState = exports.EventBurn = exports.QueryClassesRequest = exports.QueryOwnerRequest = exports.Class = exports.MsgSendResponse = exports.QueryClassResponse = exports.QueryNFTRequest = exports.QuerySupplyResponse = exports.EventMint = exports.QueryClassesResponse = exports.QueryClassRequest = exports.QueryNFTsResponse = exports.EventSend = exports.QueryNFTResponse = exports.QuerySupplyRequest = void 0;
...
Object.defineProperty(exports, "QueryNFTsResponse", { enumerable: true, get: function () { return query_3.QueryNFTsResponse; } });
...
Object.defineProperty(exports, "QueryClassesResponse", { enumerable: true, get: function () { return query_5.QueryClassesResponse; } });
...
Object.defineProperty(exports, "QueryClassResponse", { enumerable: true, get: function () { return query_8.QueryClassResponse; } });
...
Object.defineProperty(exports, "QueryNFTsRequest", { enumerable: true, get: function () { return query_12.QueryNFTsRequest; } });
    ...
    return {
        ...
        async sendQueryNFTsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsResponse({ value: query_3.QueryNFTsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesResponse({ value: query_5.QueryClassesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClassResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassResponse({ value: query_8.QueryClassResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryNFTsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryNftsRequest({ value: query_12.QueryNFTsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryNftsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsResponse", value: query_3.QueryNFTsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesResponse", value: query_5.QueryClassesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClassResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassResponse", value: query_8.QueryClassResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryNftsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryNFTsRequest", value: query_12.QueryNFTsRequest.fromPartial(value) };
            }
            catch (e) {
