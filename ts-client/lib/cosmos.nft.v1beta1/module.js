...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySupplyRequest = exports.QueryOwnerResponse = exports.QueryOwnerRequest = exports.EventSend = exports.QueryClassesRequest = exports.QueryNFTResponse = exports.QueryBalanceResponse = exports.QueryNFTRequest = exports.MsgSendResponse = exports.QueryClassesResponse = exports.QueryClassRequest = exports.Entry = exports.Class = exports.QueryNFTsRequest = exports.QuerySupplyResponse = exports.MsgSend = exports.EventMint = exports.NFT = exports.GenesisState = exports.QueryClassResponse = exports.QueryNFTsResponse = exports.QueryBalanceRequest = exports.EventBurn = void 0;
...
Object.defineProperty(exports, "QueryClassesRequest", { enumerable: true, get: function () { return query_11.QueryClassesRequest; } });
...
Object.defineProperty(exports, "QueryOwnerResponse", { enumerable: true, get: function () { return query_13.QueryOwnerResponse; } });
    ...
    return {
        ...
        async sendQueryClassesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClassesRequest({ value: query_11.QueryClassesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryOwnerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryOwnerResponse({ value: query_13.QueryOwnerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryClassesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryClassesRequest", value: query_11.QueryClassesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryOwnerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.nft.v1beta1.QueryOwnerResponse", value: query_13.QueryOwnerResponse.fromPartial(value) };
            }
            catch (e) {
