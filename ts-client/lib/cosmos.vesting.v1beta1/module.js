...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreatePermanentLockedAccount = exports.PeriodicVestingAccount = exports.BaseVestingAccount = exports.MsgCreateVestingAccountResponse = exports.MsgCreateVestingAccount = exports.PermanentLockedAccount = exports.ContinuousVestingAccount = exports.Period = exports.MsgCreatePermanentLockedAccountResponse = exports.MsgCreatePeriodicVestingAccountResponse = exports.DelayedVestingAccount = void 0;
...
Object.defineProperty(exports, "ContinuousVestingAccount", { enumerable: true, get: function () { return vesting_3.ContinuousVestingAccount; } });
...
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccount", { enumerable: true, get: function () { return tx_6.MsgCreatePeriodicVestingAccount; } });
    ...
    return {
        ...
        async sendContinuousVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.continuousVestingAccount({ value: vesting_3.ContinuousVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccount({ value: tx_6.MsgCreatePeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        continuousVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.ContinuousVestingAccount", value: vesting_3.ContinuousVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount", value: tx_6.MsgCreatePeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
