...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreateVestingAccount = exports.PeriodicVestingAccount = exports.BaseVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreateVestingAccountResponse = exports.MsgCreatePeriodicVestingAccount = exports.DelayedVestingAccount = exports.MsgCreatePermanentLockedAccount = exports.Period = exports.PermanentLockedAccount = exports.ContinuousVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreatePermanentLockedAccountResponse", { enumerable: true, get: function () { return tx_1.MsgCreatePermanentLockedAccountResponse; } });
...
Object.defineProperty(exports, "PermanentLockedAccount", { enumerable: true, get: function () { return vesting_2.PermanentLockedAccount; } });
...
Object.defineProperty(exports, "DelayedVestingAccount", { enumerable: true, get: function () { return vesting_4.DelayedVestingAccount; } });
const tx_3 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccount", { enumerable: true, get: function () { return tx_3.MsgCreatePeriodicVestingAccount; } });
const tx_4 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreateVestingAccountResponse", { enumerable: true, get: function () { return tx_4.MsgCreateVestingAccountResponse; } });
...
Object.defineProperty(exports, "PeriodicVestingAccount", { enumerable: true, get: function () { return vesting_6.PeriodicVestingAccount; } });
    ...
    return {
        async sendMsgCreatePermanentLockedAccountResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgCreatePermanentLockedAccountResponse({ value: tx_1.MsgCreatePermanentLockedAccountResponse.fromPartial(value) });
        ...
        async sendContinuousVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.continuousVestingAccount({ value: vesting_1.ContinuousVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPermanentLockedAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.permanentLockedAccount({ value: vesting_2.PermanentLockedAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDelayedVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.delayedVestingAccount({ value: vesting_4.DelayedVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccount({ value: tx_3.MsgCreatePeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccountResponse({ value: tx_4.MsgCreateVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.periodicVestingAccount({ value: vesting_6.PeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreatePermanentLockedAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse", value: tx_1.MsgCreatePermanentLockedAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        continuousVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.ContinuousVestingAccount", value: vesting_1.ContinuousVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        permanentLockedAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PermanentLockedAccount", value: vesting_2.PermanentLockedAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        delayedVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.DelayedVestingAccount", value: vesting_4.DelayedVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount", value: tx_3.MsgCreatePeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse", value: tx_4.MsgCreateVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        periodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PeriodicVestingAccount", value: vesting_6.PeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
