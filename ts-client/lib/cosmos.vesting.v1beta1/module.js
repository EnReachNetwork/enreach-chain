...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePermanentLockedAccount = exports.Period = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccountResponse = exports.PeriodicVestingAccount = exports.MsgCreateVestingAccountResponse = exports.MsgCreateVestingAccount = exports.PermanentLockedAccount = exports.DelayedVestingAccount = exports.ContinuousVestingAccount = exports.MsgCreatePeriodicVestingAccount = exports.BaseVestingAccount = void 0;
...
Object.defineProperty(exports, "PermanentLockedAccount", { enumerable: true, get: function () { return vesting_4.PermanentLockedAccount; } });
const tx_2 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreateVestingAccount", { enumerable: true, get: function () { return tx_2.MsgCreateVestingAccount; } });
...
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccountResponse", { enumerable: true, get: function () { return tx_5.MsgCreatePeriodicVestingAccountResponse; } });
const vesting_6 = require("./types/cosmos/vesting/v1beta1/vesting");
Object.defineProperty(exports, "Period", { enumerable: true, get: function () { return vesting_6.Period; } });
const tx_6 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreatePermanentLockedAccount", { enumerable: true, get: function () { return tx_6.MsgCreatePermanentLockedAccount; } });
    ...
    return {
        async sendBaseVestingAccount({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.baseVestingAccount({ value: vesting_1.BaseVestingAccount.fromPartial(value) });
        ...
        async sendContinuousVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.continuousVestingAccount({ value: vesting_2.ContinuousVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDelayedVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.delayedVestingAccount({ value: vesting_3.DelayedVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPermanentLockedAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.permanentLockedAccount({ value: vesting_4.PermanentLockedAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccount({ value: tx_2.MsgCreateVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.periodicVestingAccount({ value: vesting_5.PeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePeriodicVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccountResponse({ value: tx_5.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriod({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.period({ value: vesting_6.Period.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePermanentLockedAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePermanentLockedAccount({ value: tx_6.MsgCreatePermanentLockedAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        baseVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.BaseVestingAccount", value: vesting_1.BaseVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        continuousVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.ContinuousVestingAccount", value: vesting_2.ContinuousVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        delayedVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.DelayedVestingAccount", value: vesting_3.DelayedVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        permanentLockedAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PermanentLockedAccount", value: vesting_4.PermanentLockedAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccount", value: tx_2.MsgCreateVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        periodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PeriodicVestingAccount", value: vesting_5.PeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse", value: tx_5.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        period({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.Period", value: vesting_6.Period.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePermanentLockedAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount", value: tx_6.MsgCreatePermanentLockedAccount.fromPartial(value) };
            }
            catch (e) {
