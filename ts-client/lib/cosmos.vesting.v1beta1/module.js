...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePeriodicVestingAccountResponse = exports.ContinuousVestingAccount = exports.BaseVestingAccount = exports.Period = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = exports.MsgCreateVestingAccountResponse = exports.MsgCreateVestingAccount = exports.DelayedVestingAccount = exports.PeriodicVestingAccount = exports.PermanentLockedAccount = exports.MsgCreatePermanentLockedAccount = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreatePermanentLockedAccount", { enumerable: true, get: function () { return tx_1.MsgCreatePermanentLockedAccount; } });
const vesting_1 = require("./types/cosmos/vesting/v1beta1/vesting");
Object.defineProperty(exports, "PermanentLockedAccount", { enumerable: true, get: function () { return vesting_1.PermanentLockedAccount; } });
...
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccount", { enumerable: true, get: function () { return tx_5.MsgCreatePeriodicVestingAccount; } });
...
Object.defineProperty(exports, "BaseVestingAccount", { enumerable: true, get: function () { return vesting_5.BaseVestingAccount; } });
...
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccountResponse", { enumerable: true, get: function () { return tx_6.MsgCreatePeriodicVestingAccountResponse; } });
    ...
    return {
        async sendMsgCreatePermanentLockedAccount({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgCreatePermanentLockedAccount({ value: tx_1.MsgCreatePermanentLockedAccount.fromPartial(value) });
        ...
        async sendPermanentLockedAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.permanentLockedAccount({ value: vesting_1.PermanentLockedAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccount({ value: tx_5.MsgCreatePeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriod({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.period({ value: vesting_4.Period.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBaseVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.baseVestingAccount({ value: vesting_5.BaseVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePeriodicVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccountResponse({ value: tx_6.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreatePermanentLockedAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount", value: tx_1.MsgCreatePermanentLockedAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        permanentLockedAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PermanentLockedAccount", value: vesting_1.PermanentLockedAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount", value: tx_5.MsgCreatePeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        period({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.Period", value: vesting_4.Period.fromPartial(value) };
            }
            catch (e) {
        ...
        baseVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.BaseVestingAccount", value: vesting_5.BaseVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse", value: tx_6.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
