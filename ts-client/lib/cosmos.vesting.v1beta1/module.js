...
exports.queryClient = exports.txClient = exports.registry = exports.PermanentLockedAccount = exports.BaseVestingAccount = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = exports.MsgCreateVestingAccountResponse = exports.DelayedVestingAccount = exports.PeriodicVestingAccount = exports.ContinuousVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccount = exports.MsgCreateVestingAccount = exports.Period = void 0;
...
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccountResponse", { enumerable: true, get: function () { return tx_3.MsgCreatePeriodicVestingAccountResponse; } });
...
Object.defineProperty(exports, "PeriodicVestingAccount", { enumerable: true, get: function () { return vesting_3.PeriodicVestingAccount; } });
...
Object.defineProperty(exports, "MsgCreatePermanentLockedAccountResponse", { enumerable: true, get: function () { return tx_5.MsgCreatePermanentLockedAccountResponse; } });
    ...
    return {
        ...
        async sendMsgCreatePeriodicVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccountResponse({ value: tx_3.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.periodicVestingAccount({ value: vesting_3.PeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreatePermanentLockedAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePermanentLockedAccountResponse({ value: tx_5.MsgCreatePermanentLockedAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse", value: tx_3.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        periodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PeriodicVestingAccount", value: vesting_3.PeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePermanentLockedAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse", value: tx_5.MsgCreatePermanentLockedAccountResponse.fromPartial(value) };
            }
            catch (e) {
