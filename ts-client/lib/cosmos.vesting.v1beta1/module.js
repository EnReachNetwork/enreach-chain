...
exports.queryClient = exports.txClient = exports.registry = exports.Period = exports.DelayedVestingAccount = exports.MsgCreatePermanentLockedAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreateVestingAccountResponse = exports.MsgCreateVestingAccount = exports.PermanentLockedAccount = exports.BaseVestingAccount = exports.PeriodicVestingAccount = exports.ContinuousVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = void 0;
...
Object.defineProperty(exports, "DelayedVestingAccount", { enumerable: true, get: function () { return vesting_5.DelayedVestingAccount; } });
    ...
    return {
        ...
        async sendDelayedVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.delayedVestingAccount({ value: vesting_5.DelayedVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        delayedVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.DelayedVestingAccount", value: vesting_5.DelayedVestingAccount.fromPartial(value) };
            }
            catch (e) {
