...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreateVestingAccountResponse = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePeriodicVestingAccount = exports.PeriodicVestingAccount = exports.DelayedVestingAccount = exports.MsgCreatePermanentLockedAccount = exports.ContinuousVestingAccount = exports.BaseVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = exports.MsgCreateVestingAccount = exports.PermanentLockedAccount = exports.Period = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const vesting_1 = require("./types/cosmos/vesting/v1beta1/vesting");
Object.defineProperty(exports, "Period", { enumerable: true, get: function () { return vesting_1.Period; } });
...
Object.defineProperty(exports, "MsgCreatePermanentLockedAccountResponse", { enumerable: true, get: function () { return tx_2.MsgCreatePermanentLockedAccountResponse; } });
...
Object.defineProperty(exports, "ContinuousVestingAccount", { enumerable: true, get: function () { return vesting_4.ContinuousVestingAccount; } });
...
Object.defineProperty(exports, "MsgCreateVestingAccountResponse", { enumerable: true, get: function () { return tx_6.MsgCreateVestingAccountResponse; } });
    ...
    return {
        async sendPeriod({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.period({ value: vesting_1.Period.fromPartial(value) });
        ...
        async sendMsgCreatePermanentLockedAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePermanentLockedAccountResponse({ value: tx_2.MsgCreatePermanentLockedAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendContinuousVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.continuousVestingAccount({ value: vesting_4.ContinuousVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccountResponse({ value: tx_6.MsgCreateVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        period({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.Period", value: vesting_1.Period.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreatePermanentLockedAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse", value: tx_2.MsgCreatePermanentLockedAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        continuousVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.ContinuousVestingAccount", value: vesting_4.ContinuousVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse", value: tx_6.MsgCreateVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
