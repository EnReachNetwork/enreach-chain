...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePermanentLockedAccountResponse = exports.Period = exports.PermanentLockedAccount = exports.PeriodicVestingAccount = exports.MsgCreatePeriodicVestingAccount = exports.DelayedVestingAccount = exports.MsgCreateVestingAccount = exports.BaseVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccount = exports.MsgCreateVestingAccountResponse = exports.ContinuousVestingAccount = void 0;
...
Object.defineProperty(exports, "MsgCreateVestingAccountResponse", { enumerable: true, get: function () { return tx_1.MsgCreateVestingAccountResponse; } });
...
Object.defineProperty(exports, "BaseVestingAccount", { enumerable: true, get: function () { return vesting_2.BaseVestingAccount; } });
const tx_4 = require("./types/cosmos/vesting/v1beta1/tx");
Object.defineProperty(exports, "MsgCreateVestingAccount", { enumerable: true, get: function () { return tx_4.MsgCreateVestingAccount; } });
    ...
    return {
        ...
        async sendMsgCreateVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccountResponse({ value: tx_1.MsgCreateVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBaseVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.baseVestingAccount({ value: vesting_2.BaseVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccount({ value: tx_4.MsgCreateVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreateVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse", value: tx_1.MsgCreateVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        baseVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.BaseVestingAccount", value: vesting_2.BaseVestingAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccount", value: tx_4.MsgCreateVestingAccount.fromPartial(value) };
            }
            catch (e) {
