...
exports.queryClient = exports.txClient = exports.registry = exports.ContinuousVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = exports.Period = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreateVestingAccount = exports.DelayedVestingAccount = exports.PermanentLockedAccount = exports.PeriodicVestingAccount = exports.BaseVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccount = exports.MsgCreateVestingAccountResponse = void 0;
...
Object.defineProperty(exports, "PermanentLockedAccount", { enumerable: true, get: function () { return vesting_3.PermanentLockedAccount; } });
    ...
    return {
        ...
        async sendPermanentLockedAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.permanentLockedAccount({ value: vesting_3.PermanentLockedAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        permanentLockedAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PermanentLockedAccount", value: vesting_3.PermanentLockedAccount.fromPartial(value) };
            }
            catch (e) {
