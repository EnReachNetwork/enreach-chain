...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePermanentLockedAccountResponse = exports.MsgCreatePermanentLockedAccount = exports.DelayedVestingAccount = exports.ContinuousVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePeriodicVestingAccount = exports.PermanentLockedAccount = exports.PeriodicVestingAccount = exports.Period = exports.MsgCreateVestingAccountResponse = exports.MsgCreateVestingAccount = exports.BaseVestingAccount = void 0;
...
Object.defineProperty(exports, "MsgCreatePeriodicVestingAccountResponse", { enumerable: true, get: function () { return tx_4.MsgCreatePeriodicVestingAccountResponse; } });
    ...
    return {
        ...
        async sendMsgCreatePeriodicVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreatePeriodicVestingAccountResponse({ value: tx_4.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreatePeriodicVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse", value: tx_4.MsgCreatePeriodicVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
