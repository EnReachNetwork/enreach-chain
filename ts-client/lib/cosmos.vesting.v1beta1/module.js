...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreateVestingAccount = exports.PermanentLockedAccount = exports.PeriodicVestingAccount = exports.BaseVestingAccount = exports.Period = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccount = exports.ContinuousVestingAccount = exports.MsgCreatePermanentLockedAccountResponse = exports.DelayedVestingAccount = exports.MsgCreateVestingAccountResponse = void 0;
...
Object.defineProperty(exports, "MsgCreateVestingAccount", { enumerable: true, get: function () { return tx_5.MsgCreateVestingAccount; } });
    ...
    return {
        ...
        async sendMsgCreateVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccount({ value: tx_5.MsgCreateVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreateVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccount", value: tx_5.MsgCreateVestingAccount.fromPartial(value) };
            }
            catch (e) {
