...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccountResponse = exports.BaseVestingAccount = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreateVestingAccount = exports.PermanentLockedAccount = exports.DelayedVestingAccount = exports.Period = exports.PeriodicVestingAccount = exports.ContinuousVestingAccount = exports.MsgCreatePermanentLockedAccount = exports.MsgCreateVestingAccountResponse = void 0;
...
Object.defineProperty(exports, "BaseVestingAccount", { enumerable: true, get: function () { return vesting_6.BaseVestingAccount; } });
    ...
    return {
        ...
        async sendBaseVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.baseVestingAccount({ value: vesting_6.BaseVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        baseVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.BaseVestingAccount", value: vesting_6.BaseVestingAccount.fromPartial(value) };
            }
            catch (e) {
