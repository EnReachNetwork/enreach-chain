...
exports.queryClient = exports.txClient = exports.registry = exports.DelayedVestingAccount = exports.MsgCreatePeriodicVestingAccount = exports.Period = exports.PermanentLockedAccount = exports.ContinuousVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.MsgCreatePermanentLockedAccountResponse = exports.MsgCreatePermanentLockedAccount = exports.MsgCreateVestingAccountResponse = exports.PeriodicVestingAccount = exports.BaseVestingAccount = exports.MsgCreateVestingAccount = void 0;
...
Object.defineProperty(exports, "MsgCreateVestingAccountResponse", { enumerable: true, get: function () { return tx_2.MsgCreateVestingAccountResponse; } });
...
Object.defineProperty(exports, "Period", { enumerable: true, get: function () { return vesting_5.Period; } });
...
Object.defineProperty(exports, "DelayedVestingAccount", { enumerable: true, get: function () { return vesting_6.DelayedVestingAccount; } });
    ...
    return {
        ...
        async sendMsgCreateVestingAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateVestingAccountResponse({ value: tx_2.MsgCreateVestingAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriod({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.period({ value: vesting_5.Period.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDelayedVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.delayedVestingAccount({ value: vesting_6.DelayedVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreateVestingAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse", value: tx_2.MsgCreateVestingAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        period({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.Period", value: vesting_5.Period.fromPartial(value) };
            }
            catch (e) {
        ...
        delayedVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.DelayedVestingAccount", value: vesting_6.DelayedVestingAccount.fromPartial(value) };
            }
            catch (e) {
