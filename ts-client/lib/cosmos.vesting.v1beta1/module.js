...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreatePermanentLockedAccountResponse = exports.PermanentLockedAccount = exports.Period = exports.DelayedVestingAccount = exports.ContinuousVestingAccount = exports.BaseVestingAccount = exports.MsgCreatePeriodicVestingAccount = exports.MsgCreatePeriodicVestingAccountResponse = exports.PeriodicVestingAccount = exports.MsgCreatePermanentLockedAccount = exports.MsgCreateVestingAccountResponse = exports.MsgCreateVestingAccount = void 0;
...
Object.defineProperty(exports, "PeriodicVestingAccount", { enumerable: true, get: function () { return vesting_1.PeriodicVestingAccount; } });
    ...
    return {
        ...
        async sendPeriodicVestingAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.periodicVestingAccount({ value: vesting_1.PeriodicVestingAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        periodicVestingAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.vesting.v1beta1.PeriodicVestingAccount", value: vesting_1.PeriodicVestingAccount.fromPartial(value) };
            }
            catch (e) {
