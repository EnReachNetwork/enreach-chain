...
exports.queryClient = exports.txClient = exports.registry = exports.ConfigResponse = exports.ConfigRequest = exports.StatusResponse = exports.StatusRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/base/node/v1beta1/query");
Object.defineProperty(exports, "StatusRequest", { enumerable: true, get: function () { return query_1.StatusRequest; } });
const query_2 = require("./types/cosmos/base/node/v1beta1/query");
Object.defineProperty(exports, "StatusResponse", { enumerable: true, get: function () { return query_2.StatusResponse; } });
const query_3 = require("./types/cosmos/base/node/v1beta1/query");
Object.defineProperty(exports, "ConfigRequest", { enumerable: true, get: function () { return query_3.ConfigRequest; } });
const query_4 = require("./types/cosmos/base/node/v1beta1/query");
Object.defineProperty(exports, "ConfigResponse", { enumerable: true, get: function () { return query_4.ConfigResponse; } });
    ...
    return {
        async sendStatusRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.statusRequest({ value: query_1.StatusRequest.fromPartial(value) });
        ...
        async sendStatusResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.statusResponse({ value: query_2.StatusResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConfigRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.configRequest({ value: query_3.ConfigRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConfigResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.configResponse({ value: query_4.ConfigResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        statusRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.node.v1beta1.StatusRequest", value: query_1.StatusRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        statusResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.node.v1beta1.StatusResponse", value: query_2.StatusResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        configRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.node.v1beta1.ConfigRequest", value: query_3.ConfigRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        configResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.node.v1beta1.ConfigResponse", value: query_4.ConfigResponse.fromPartial(value) };
            }
            catch (e) {
