...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.MsgUpdateParamsResponse = exports.QueryParamsResponse = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.consensus.v1.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.consensus.v1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
