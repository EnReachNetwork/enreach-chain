...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSubmitEvidence = exports.QueryEvidenceRequest = exports.Equivocation = exports.QueryAllEvidenceRequest = exports.QueryEvidenceResponse = exports.MsgSubmitEvidenceResponse = exports.QueryAllEvidenceResponse = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "QueryEvidenceRequest", { enumerable: true, get: function () { return query_4.QueryEvidenceRequest; } });
    ...
    return {
        ...
        async sendQueryAllEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllEvidenceResponse({ value: query_1.QueryAllEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEvidenceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEvidenceRequest({ value: query_4.QueryEvidenceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryAllEvidenceResponse", value: query_1.QueryAllEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEvidenceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryEvidenceRequest", value: query_4.QueryEvidenceRequest.fromPartial(value) };
            }
            catch (e) {
