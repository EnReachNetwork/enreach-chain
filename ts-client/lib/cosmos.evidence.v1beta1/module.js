...
exports.queryClient = exports.txClient = exports.registry = exports.QueryEvidenceResponse = exports.Equivocation = exports.QueryAllEvidenceRequest = exports.MsgSubmitEvidence = exports.QueryEvidenceRequest = exports.GenesisState = exports.QueryAllEvidenceResponse = exports.MsgSubmitEvidenceResponse = void 0;
...
Object.defineProperty(exports, "QueryEvidenceResponse", { enumerable: true, get: function () { return query_4.QueryEvidenceResponse; } });
    ...
    return {
        ...
        async sendQueryEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEvidenceResponse({ value: query_4.QueryEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryEvidenceResponse", value: query_4.QueryEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
