...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.QueryAllEvidenceResponse = exports.QueryEvidenceResponse = exports.MsgSubmitEvidence = exports.Equivocation = exports.QueryEvidenceRequest = exports.QueryAllEvidenceRequest = exports.MsgSubmitEvidenceResponse = void 0;
...
Object.defineProperty(exports, "QueryEvidenceRequest", { enumerable: true, get: function () { return query_2.QueryEvidenceRequest; } });
...
Object.defineProperty(exports, "QueryEvidenceResponse", { enumerable: true, get: function () { return query_3.QueryEvidenceResponse; } });
    ...
    return {
        ...
        async sendQueryAllEvidenceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllEvidenceRequest({ value: query_1.QueryAllEvidenceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEvidenceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEvidenceRequest({ value: query_2.QueryEvidenceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEvidenceResponse({ value: query_3.QueryEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllEvidenceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryAllEvidenceRequest", value: query_1.QueryAllEvidenceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEvidenceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryEvidenceRequest", value: query_2.QueryEvidenceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryEvidenceResponse", value: query_3.QueryEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
