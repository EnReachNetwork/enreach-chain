...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllEvidenceResponse = exports.QueryAllEvidenceRequest = exports.QueryEvidenceResponse = exports.MsgSubmitEvidence = exports.QueryEvidenceRequest = exports.GenesisState = exports.MsgSubmitEvidenceResponse = exports.Equivocation = void 0;
...
Object.defineProperty(exports, "MsgSubmitEvidence", { enumerable: true, get: function () { return tx_2.MsgSubmitEvidence; } });
const query_2 = require("./types/cosmos/evidence/v1beta1/query");
Object.defineProperty(exports, "QueryEvidenceResponse", { enumerable: true, get: function () { return query_2.QueryEvidenceResponse; } });
const query_3 = require("./types/cosmos/evidence/v1beta1/query");
Object.defineProperty(exports, "QueryAllEvidenceRequest", { enumerable: true, get: function () { return query_3.QueryAllEvidenceRequest; } });
const query_4 = require("./types/cosmos/evidence/v1beta1/query");
Object.defineProperty(exports, "QueryAllEvidenceResponse", { enumerable: true, get: function () { return query_4.QueryAllEvidenceResponse; } });
    ...
    return {
        ...
        async sendMsgSubmitEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitEvidenceResponse({ value: tx_1.MsgSubmitEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEvidenceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEvidenceRequest({ value: query_1.QueryEvidenceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitEvidence({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitEvidence({ value: tx_2.MsgSubmitEvidence.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEvidenceResponse({ value: query_2.QueryEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllEvidenceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllEvidenceRequest({ value: query_3.QueryAllEvidenceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllEvidenceResponse({ value: query_4.QueryAllEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSubmitEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.MsgSubmitEvidenceResponse", value: tx_1.MsgSubmitEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEvidenceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryEvidenceRequest", value: query_1.QueryEvidenceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitEvidence({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.MsgSubmitEvidence", value: tx_2.MsgSubmitEvidence.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryEvidenceResponse", value: query_2.QueryEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllEvidenceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryAllEvidenceRequest", value: query_3.QueryAllEvidenceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryAllEvidenceResponse", value: query_4.QueryAllEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
