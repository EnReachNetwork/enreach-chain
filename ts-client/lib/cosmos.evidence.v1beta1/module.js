...
exports.queryClient = exports.txClient = exports.registry = exports.QueryEvidenceResponse = exports.GenesisState = exports.MsgSubmitEvidenceResponse = exports.QueryAllEvidenceResponse = exports.QueryAllEvidenceRequest = exports.QueryEvidenceRequest = exports.MsgSubmitEvidence = exports.Equivocation = void 0;
...
Object.defineProperty(exports, "QueryAllEvidenceRequest", { enumerable: true, get: function () { return query_2.QueryAllEvidenceRequest; } });
const query_3 = require("./types/cosmos/evidence/v1beta1/query");
Object.defineProperty(exports, "QueryAllEvidenceResponse", { enumerable: true, get: function () { return query_3.QueryAllEvidenceResponse; } });
    ...
    return {
        ...
        async sendQueryAllEvidenceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllEvidenceRequest({ value: query_2.QueryAllEvidenceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllEvidenceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllEvidenceResponse({ value: query_3.QueryAllEvidenceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllEvidenceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryAllEvidenceRequest", value: query_2.QueryAllEvidenceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllEvidenceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.evidence.v1beta1.QueryAllEvidenceResponse", value: query_3.QueryAllEvidenceResponse.fromPartial(value) };
            }
            catch (e) {
