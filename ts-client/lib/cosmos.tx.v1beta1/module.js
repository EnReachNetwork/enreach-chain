...
exports.queryClient = exports.txClient = exports.registry = exports.TxDecodeAminoRequest = exports.ModeInfo = exports.SignerInfo = exports.TxDecodeAminoResponse = exports.GetTxsEventRequest = exports.Tip = exports.AuthInfo = exports.TxEncodeResponse = exports.GetBlockWithTxsResponse = exports.SimulateRequest = exports.GetTxsEventResponse = exports.SignDoc = exports.TxEncodeRequest = exports.SimulateResponse = exports.TxEncodeAminoResponse = exports.ModeInfo_Multi = exports.GetTxRequest = exports.Fee = exports.Tx = exports.TxEncodeAminoRequest = exports.GetBlockWithTxsRequest = exports.AuxSignerData = exports.ModeInfo_Single = exports.TxRaw = exports.GetTxResponse = exports.BroadcastTxRequest = exports.TxBody = exports.SignDocDirectAux = exports.TxDecodeResponse = exports.TxDecodeRequest = exports.BroadcastTxResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const service_1 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "BroadcastTxResponse", { enumerable: true, get: function () { return service_1.BroadcastTxResponse; } });
...
Object.defineProperty(exports, "TxDecodeResponse", { enumerable: true, get: function () { return service_3.TxDecodeResponse; } });
...
Object.defineProperty(exports, "AuxSignerData", { enumerable: true, get: function () { return tx_5.AuxSignerData; } });
const service_6 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetBlockWithTxsRequest", { enumerable: true, get: function () { return service_6.GetBlockWithTxsRequest; } });
...
Object.defineProperty(exports, "GetTxRequest", { enumerable: true, get: function () { return service_8.GetTxRequest; } });
...
Object.defineProperty(exports, "TxEncodeAminoResponse", { enumerable: true, get: function () { return service_9.TxEncodeAminoResponse; } });
const service_10 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "SimulateResponse", { enumerable: true, get: function () { return service_10.SimulateResponse; } });
const service_11 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxEncodeRequest", { enumerable: true, get: function () { return service_11.TxEncodeRequest; } });
...
Object.defineProperty(exports, "GetTxsEventResponse", { enumerable: true, get: function () { return service_12.GetTxsEventResponse; } });
const service_13 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "SimulateRequest", { enumerable: true, get: function () { return service_13.SimulateRequest; } });
const service_14 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetBlockWithTxsResponse", { enumerable: true, get: function () { return service_14.GetBlockWithTxsResponse; } });
...
Object.defineProperty(exports, "AuthInfo", { enumerable: true, get: function () { return tx_10.AuthInfo; } });
const tx_11 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "Tip", { enumerable: true, get: function () { return tx_11.Tip; } });
    ...
    return {
        async sendBroadcastTxResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.broadcastTxResponse({ value: service_1.BroadcastTxResponse.fromPartial(value) });
        ...
        async sendTxDecodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeResponse({ value: service_3.TxDecodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAuxSignerData({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.auxSignerData({ value: tx_5.AuxSignerData.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockWithTxsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockWithTxsRequest({ value: service_6.GetBlockWithTxsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxRequest({ value: service_8.GetTxRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeAminoResponse({ value: service_9.TxEncodeAminoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateResponse({ value: service_10.SimulateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeRequest({ value: service_11.TxEncodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventResponse({ value: service_12.GetTxsEventResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateRequest({ value: service_13.SimulateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockWithTxsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockWithTxsResponse({ value: service_14.GetBlockWithTxsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAuthInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.authInfo({ value: tx_10.AuthInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTip({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tip({ value: tx_11.Tip.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        broadcastTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.BroadcastTxResponse", value: service_1.BroadcastTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeResponse", value: service_3.TxDecodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        auxSignerData({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.AuxSignerData", value: tx_5.AuxSignerData.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockWithTxsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetBlockWithTxsRequest", value: service_6.GetBlockWithTxsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxRequest", value: service_8.GetTxRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeAminoResponse", value: service_9.TxEncodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateResponse", value: service_10.SimulateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeRequest", value: service_11.TxEncodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventResponse", value: service_12.GetTxsEventResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateRequest", value: service_13.SimulateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockWithTxsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetBlockWithTxsResponse", value: service_14.GetBlockWithTxsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        authInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.AuthInfo", value: tx_10.AuthInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        tip({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.Tip", value: tx_11.Tip.fromPartial(value) };
            }
            catch (e) {
