...
exports.queryClient = exports.txClient = exports.registry = exports.ModeInfo_Single = exports.TxBody = exports.TxDecodeAminoRequest = exports.GetTxRequest = exports.BroadcastTxResponse = exports.BroadcastTxRequest = exports.SimulateResponse = exports.Tx = exports.TxEncodeAminoResponse = exports.TxEncodeAminoRequest = exports.Fee = exports.SignerInfo = exports.TxDecodeResponse = exports.TxDecodeRequest = exports.GetTxResponse = exports.GetTxsEventRequest = exports.AuxSignerData = exports.ModeInfo_Multi = exports.ModeInfo = exports.AuthInfo = exports.SignDocDirectAux = exports.TxEncodeRequest = exports.GetBlockWithTxsResponse = exports.GetBlockWithTxsRequest = exports.Tip = exports.TxRaw = exports.TxDecodeAminoResponse = exports.SignDoc = exports.TxEncodeResponse = exports.SimulateRequest = exports.GetTxsEventResponse = void 0;
...
Object.defineProperty(exports, "SimulateRequest", { enumerable: true, get: function () { return service_2.SimulateRequest; } });
...
Object.defineProperty(exports, "TxDecodeAminoResponse", { enumerable: true, get: function () { return service_4.TxDecodeAminoResponse; } });
...
Object.defineProperty(exports, "TxEncodeRequest", { enumerable: true, get: function () { return service_7.TxEncodeRequest; } });
...
Object.defineProperty(exports, "ModeInfo", { enumerable: true, get: function () { return tx_6.ModeInfo; } });
const tx_7 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "ModeInfo_Multi", { enumerable: true, get: function () { return tx_7.ModeInfo_Multi; } });
...
Object.defineProperty(exports, "GetTxResponse", { enumerable: true, get: function () { return service_9.GetTxResponse; } });
const service_10 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxDecodeRequest", { enumerable: true, get: function () { return service_10.TxDecodeRequest; } });
...
Object.defineProperty(exports, "SimulateResponse", { enumerable: true, get: function () { return service_14.SimulateResponse; } });
const service_15 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "BroadcastTxRequest", { enumerable: true, get: function () { return service_15.BroadcastTxRequest; } });
...
Object.defineProperty(exports, "TxDecodeAminoRequest", { enumerable: true, get: function () { return service_18.TxDecodeAminoRequest; } });
    ...
    return {
        ...
        async sendSimulateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateRequest({ value: service_2.SimulateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoResponse({ value: service_4.TxDecodeAminoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeRequest({ value: service_7.TxEncodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignDocDirectAux({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signDocDirectAux({ value: tx_4.SignDocDirectAux.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfo({ value: tx_6.ModeInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Multi({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoMulti({ value: tx_7.ModeInfo_Multi.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxResponse({ value: service_9.GetTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeRequest({ value: service_10.TxDecodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateResponse({ value: service_14.SimulateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBroadcastTxRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.broadcastTxRequest({ value: service_15.BroadcastTxRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoRequest({ value: service_18.TxDecodeAminoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        simulateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateRequest", value: service_2.SimulateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoResponse", value: service_4.TxDecodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeRequest", value: service_7.TxEncodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        signDocDirectAux({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignDocDirectAux", value: tx_4.SignDocDirectAux.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo", value: tx_6.ModeInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoMulti({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Multi", value: tx_7.ModeInfo_Multi.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxResponse", value: service_9.GetTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeRequest", value: service_10.TxDecodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateResponse", value: service_14.SimulateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        broadcastTxRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.BroadcastTxRequest", value: service_15.BroadcastTxRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoRequest", value: service_18.TxDecodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
