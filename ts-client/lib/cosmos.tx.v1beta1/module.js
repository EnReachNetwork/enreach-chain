...
exports.queryClient = exports.txClient = exports.registry = exports.TxBody = exports.SignDoc = exports.GetBlockWithTxsRequest = exports.GetTxResponse = exports.SignerInfo = exports.AuthInfo = exports.TxEncodeResponse = exports.GetTxRequest = exports.BroadcastTxResponse = exports.Fee = exports.GetBlockWithTxsResponse = exports.TxDecodeResponse = exports.SimulateResponse = exports.AuxSignerData = exports.ModeInfo = exports.TxEncodeAminoResponse = exports.TxEncodeAminoRequest = exports.Tx = exports.BroadcastTxRequest = exports.GetTxsEventRequest = exports.SignDocDirectAux = exports.TxRaw = exports.TxDecodeAminoRequest = exports.GetTxsEventResponse = exports.ModeInfo_Single = exports.Tip = exports.TxEncodeRequest = exports.TxDecodeRequest = exports.SimulateRequest = exports.ModeInfo_Multi = exports.TxDecodeAminoResponse = void 0;
...
Object.defineProperty(exports, "TxDecodeRequest", { enumerable: true, get: function () { return service_3.TxDecodeRequest; } });
...
Object.defineProperty(exports, "Tip", { enumerable: true, get: function () { return tx_2.Tip; } });
const tx_3 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "ModeInfo_Single", { enumerable: true, get: function () { return tx_3.ModeInfo_Single; } });
...
Object.defineProperty(exports, "SignDocDirectAux", { enumerable: true, get: function () { return tx_5.SignDocDirectAux; } });
const service_7 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetTxsEventRequest", { enumerable: true, get: function () { return service_7.GetTxsEventRequest; } });
...
Object.defineProperty(exports, "TxEncodeAminoRequest", { enumerable: true, get: function () { return service_9.TxEncodeAminoRequest; } });
...
Object.defineProperty(exports, "Fee", { enumerable: true, get: function () { return tx_9.Fee; } });
...
Object.defineProperty(exports, "GetTxRequest", { enumerable: true, get: function () { return service_15.GetTxRequest; } });
const service_16 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxEncodeResponse", { enumerable: true, get: function () { return service_16.TxEncodeResponse; } });
...
Object.defineProperty(exports, "GetTxResponse", { enumerable: true, get: function () { return service_17.GetTxResponse; } });
...
Object.defineProperty(exports, "TxBody", { enumerable: true, get: function () { return tx_13.TxBody; } });
    ...
    return {
        async sendTxDecodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.txDecodeAminoResponse({ value: service_1.TxDecodeAminoResponse.fromPartial(value) });
        ...
        async sendTxDecodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeRequest({ value: service_3.TxDecodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTip({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tip({ value: tx_2.Tip.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Single({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoSingle({ value: tx_3.ModeInfo_Single.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignDocDirectAux({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signDocDirectAux({ value: tx_5.SignDocDirectAux.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventRequest({ value: service_7.GetTxsEventRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeAminoRequest({ value: service_9.TxEncodeAminoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendFee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.fee({ value: tx_9.Fee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxRequest({ value: service_15.GetTxRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeResponse({ value: service_16.TxEncodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxResponse({ value: service_17.GetTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxBody({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txBody({ value: tx_13.TxBody.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        txDecodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoResponse", value: service_1.TxDecodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeRequest", value: service_3.TxDecodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        tip({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.Tip", value: tx_2.Tip.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoSingle({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Single", value: tx_3.ModeInfo_Single.fromPartial(value) };
            }
            catch (e) {
        ...
        signDocDirectAux({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignDocDirectAux", value: tx_5.SignDocDirectAux.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventRequest", value: service_7.GetTxsEventRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeAminoRequest", value: service_9.TxEncodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        fee({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.Fee", value: tx_9.Fee.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxRequest", value: service_15.GetTxRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeResponse", value: service_16.TxEncodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxResponse", value: service_17.GetTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txBody({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxBody", value: tx_13.TxBody.fromPartial(value) };
            }
            catch (e) {
