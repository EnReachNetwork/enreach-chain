...
exports.queryClient = exports.txClient = exports.registry = exports.TxRaw = exports.TxEncodeAminoRequest = exports.GetBlockWithTxsResponse = exports.SignDoc = exports.TxDecodeAminoResponse = exports.TxDecodeRequest = exports.BroadcastTxRequest = exports.AuxSignerData = exports.ModeInfo_Multi = exports.ModeInfo = exports.SignerInfo = exports.GetTxResponse = exports.GetTxRequest = exports.SimulateRequest = exports.GetTxsEventRequest = exports.Fee = exports.TxDecodeAminoRequest = exports.TxEncodeResponse = exports.GetTxsEventResponse = exports.ModeInfo_Single = exports.TxBody = exports.Tx = exports.SimulateResponse = exports.Tip = exports.AuthInfo = exports.SignDocDirectAux = exports.TxEncodeRequest = exports.GetBlockWithTxsRequest = exports.BroadcastTxResponse = exports.TxEncodeAminoResponse = exports.TxDecodeResponse = void 0;
...
Object.defineProperty(exports, "TxEncodeAminoResponse", { enumerable: true, get: function () { return service_2.TxEncodeAminoResponse; } });
...
Object.defineProperty(exports, "TxEncodeRequest", { enumerable: true, get: function () { return service_5.TxEncodeRequest; } });
...
Object.defineProperty(exports, "AuthInfo", { enumerable: true, get: function () { return tx_2.AuthInfo; } });
...
Object.defineProperty(exports, "Tx", { enumerable: true, get: function () { return tx_4.Tx; } });
...
Object.defineProperty(exports, "TxEncodeResponse", { enumerable: true, get: function () { return service_8.TxEncodeResponse; } });
...
Object.defineProperty(exports, "SimulateRequest", { enumerable: true, get: function () { return service_11.SimulateRequest; } });
...
Object.defineProperty(exports, "GetTxResponse", { enumerable: true, get: function () { return service_13.GetTxResponse; } });
...
Object.defineProperty(exports, "TxDecodeRequest", { enumerable: true, get: function () { return service_15.TxDecodeRequest; } });
const service_16 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxDecodeAminoResponse", { enumerable: true, get: function () { return service_16.TxDecodeAminoResponse; } });
...
Object.defineProperty(exports, "GetBlockWithTxsResponse", { enumerable: true, get: function () { return service_17.GetBlockWithTxsResponse; } });
...
Object.defineProperty(exports, "TxRaw", { enumerable: true, get: function () { return tx_13.TxRaw; } });
    ...
    return {
        async sendTxDecodeResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.txDecodeResponse({ value: service_1.TxDecodeResponse.fromPartial(value) });
        ...
        async sendTxEncodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeAminoResponse({ value: service_2.TxEncodeAminoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeRequest({ value: service_5.TxEncodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAuthInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.authInfo({ value: tx_2.AuthInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTx({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tx({ value: tx_4.Tx.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeResponse({ value: service_8.TxEncodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateRequest({ value: service_11.SimulateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxResponse({ value: service_13.GetTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Multi({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoMulti({ value: tx_10.ModeInfo_Multi.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeRequest({ value: service_15.TxDecodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoResponse({ value: service_16.TxDecodeAminoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockWithTxsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockWithTxsResponse({ value: service_17.GetBlockWithTxsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxRaw({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txRaw({ value: tx_13.TxRaw.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        txDecodeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeResponse", value: service_1.TxDecodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeAminoResponse", value: service_2.TxEncodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeRequest", value: service_5.TxEncodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        authInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.AuthInfo", value: tx_2.AuthInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        tx({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.Tx", value: tx_4.Tx.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeResponse", value: service_8.TxEncodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateRequest", value: service_11.SimulateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxResponse", value: service_13.GetTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoMulti({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Multi", value: tx_10.ModeInfo_Multi.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeRequest", value: service_15.TxDecodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoResponse", value: service_16.TxDecodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockWithTxsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetBlockWithTxsResponse", value: service_17.GetBlockWithTxsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txRaw({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxRaw", value: tx_13.TxRaw.fromPartial(value) };
            }
            catch (e) {
