...
exports.queryClient = exports.txClient = exports.registry = exports.TxDecodeRequest = exports.GetTxsEventRequest = exports.SignDocDirectAux = exports.ModeInfo_Multi = exports.AuthInfo = exports.SignDoc = exports.TxEncodeAminoRequest = exports.TxEncodeResponse = exports.BroadcastTxResponse = exports.AuxSignerData = exports.Tip = exports.TxDecodeAminoResponse = exports.GetBlockWithTxsRequest = exports.SimulateRequest = exports.TxBody = exports.TxRaw = exports.Tx = exports.TxDecodeResponse = exports.GetTxsEventResponse = exports.TxDecodeAminoRequest = exports.SimulateResponse = exports.SignerInfo = exports.TxEncodeRequest = exports.Fee = exports.ModeInfo_Single = exports.GetTxResponse = exports.BroadcastTxRequest = exports.ModeInfo = exports.TxEncodeAminoResponse = exports.GetBlockWithTxsResponse = exports.GetTxRequest = void 0;
...
Object.defineProperty(exports, "GetTxResponse", { enumerable: true, get: function () { return service_5.GetTxResponse; } });
const tx_2 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "ModeInfo_Single", { enumerable: true, get: function () { return tx_2.ModeInfo_Single; } });
...
Object.defineProperty(exports, "TxEncodeRequest", { enumerable: true, get: function () { return service_6.TxEncodeRequest; } });
const tx_4 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "SignerInfo", { enumerable: true, get: function () { return tx_4.SignerInfo; } });
const service_7 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "SimulateResponse", { enumerable: true, get: function () { return service_7.SimulateResponse; } });
const service_8 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxDecodeAminoRequest", { enumerable: true, get: function () { return service_8.TxDecodeAminoRequest; } });
...
Object.defineProperty(exports, "TxRaw", { enumerable: true, get: function () { return tx_6.TxRaw; } });
const tx_7 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "TxBody", { enumerable: true, get: function () { return tx_7.TxBody; } });
...
Object.defineProperty(exports, "GetBlockWithTxsRequest", { enumerable: true, get: function () { return service_12.GetBlockWithTxsRequest; } });
...
Object.defineProperty(exports, "TxDecodeRequest", { enumerable: true, get: function () { return service_18.TxDecodeRequest; } });
    ...
    return {
        ...
        async sendGetTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxResponse({ value: service_5.GetTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Single({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoSingle({ value: tx_2.ModeInfo_Single.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeRequest({ value: service_6.TxEncodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignerInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signerInfo({ value: tx_4.SignerInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateResponse({ value: service_7.SimulateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoRequest({ value: service_8.TxDecodeAminoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxRaw({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txRaw({ value: tx_6.TxRaw.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxBody({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txBody({ value: tx_7.TxBody.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockWithTxsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockWithTxsRequest({ value: service_12.GetBlockWithTxsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeRequest({ value: service_18.TxDecodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        getTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxResponse", value: service_5.GetTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoSingle({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Single", value: tx_2.ModeInfo_Single.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeRequest", value: service_6.TxEncodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        signerInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignerInfo", value: tx_4.SignerInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateResponse", value: service_7.SimulateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoRequest", value: service_8.TxDecodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txRaw({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxRaw", value: tx_6.TxRaw.fromPartial(value) };
            }
            catch (e) {
        ...
        txBody({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxBody", value: tx_7.TxBody.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockWithTxsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetBlockWithTxsRequest", value: service_12.GetBlockWithTxsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeRequest", value: service_18.TxDecodeRequest.fromPartial(value) };
            }
            catch (e) {
