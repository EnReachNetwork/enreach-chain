...
exports.queryClient = exports.txClient = exports.registry = exports.BroadcastTxRequest = exports.SignDocDirectAux = exports.TxBody = exports.TxDecodeAminoResponse = exports.TxEncodeRequest = exports.SignerInfo = exports.TxEncodeResponse = exports.TxDecodeRequest = exports.GetTxsEventResponse = exports.Tip = exports.AuthInfo = exports.SimulateResponse = exports.AuxSignerData = exports.ModeInfo_Single = exports.TxDecodeResponse = exports.GetTxResponse = exports.SimulateRequest = exports.GetTxsEventRequest = exports.Fee = exports.TxDecodeAminoRequest = exports.GetBlockWithTxsResponse = exports.TxEncodeAminoRequest = exports.GetBlockWithTxsRequest = exports.ModeInfo = exports.TxRaw = exports.GetTxRequest = exports.BroadcastTxResponse = exports.ModeInfo_Multi = exports.TxEncodeAminoResponse = exports.SignDoc = exports.Tx = void 0;
...
Object.defineProperty(exports, "SignDoc", { enumerable: true, get: function () { return tx_2.SignDoc; } });
...
Object.defineProperty(exports, "ModeInfo_Multi", { enumerable: true, get: function () { return tx_3.ModeInfo_Multi; } });
...
Object.defineProperty(exports, "GetTxRequest", { enumerable: true, get: function () { return service_3.GetTxRequest; } });
const tx_4 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "TxRaw", { enumerable: true, get: function () { return tx_4.TxRaw; } });
...
Object.defineProperty(exports, "TxEncodeAminoRequest", { enumerable: true, get: function () { return service_5.TxEncodeAminoRequest; } });
const service_6 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetBlockWithTxsResponse", { enumerable: true, get: function () { return service_6.GetBlockWithTxsResponse; } });
const service_7 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxDecodeAminoRequest", { enumerable: true, get: function () { return service_7.TxDecodeAminoRequest; } });
const tx_6 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "Fee", { enumerable: true, get: function () { return tx_6.Fee; } });
const service_8 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetTxsEventRequest", { enumerable: true, get: function () { return service_8.GetTxsEventRequest; } });
const service_9 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "SimulateRequest", { enumerable: true, get: function () { return service_9.SimulateRequest; } });
const service_10 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetTxResponse", { enumerable: true, get: function () { return service_10.GetTxResponse; } });
const service_11 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxDecodeResponse", { enumerable: true, get: function () { return service_11.TxDecodeResponse; } });
...
Object.defineProperty(exports, "SimulateResponse", { enumerable: true, get: function () { return service_12.SimulateResponse; } });
const tx_9 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "AuthInfo", { enumerable: true, get: function () { return tx_9.AuthInfo; } });
...
Object.defineProperty(exports, "GetTxsEventResponse", { enumerable: true, get: function () { return service_13.GetTxsEventResponse; } });
...
Object.defineProperty(exports, "TxEncodeResponse", { enumerable: true, get: function () { return service_15.TxEncodeResponse; } });
const tx_11 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "SignerInfo", { enumerable: true, get: function () { return tx_11.SignerInfo; } });
...
Object.defineProperty(exports, "TxDecodeAminoResponse", { enumerable: true, get: function () { return service_17.TxDecodeAminoResponse; } });
const tx_12 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "TxBody", { enumerable: true, get: function () { return tx_12.TxBody; } });
const tx_13 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "SignDocDirectAux", { enumerable: true, get: function () { return tx_13.SignDocDirectAux; } });
const service_18 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "BroadcastTxRequest", { enumerable: true, get: function () { return service_18.BroadcastTxRequest; } });
    ...
    return {
        ...
        async sendSignDoc({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signDoc({ value: tx_2.SignDoc.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeAminoResponse({ value: service_1.TxEncodeAminoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Multi({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoMulti({ value: tx_3.ModeInfo_Multi.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxRequest({ value: service_3.GetTxRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxRaw({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txRaw({ value: tx_4.TxRaw.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeAminoRequest({ value: service_5.TxEncodeAminoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockWithTxsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockWithTxsResponse({ value: service_6.GetBlockWithTxsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoRequest({ value: service_7.TxDecodeAminoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendFee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.fee({ value: tx_6.Fee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventRequest({ value: service_8.GetTxsEventRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateRequest({ value: service_9.SimulateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxResponse({ value: service_10.GetTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeResponse({ value: service_11.TxDecodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSimulateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.simulateResponse({ value: service_12.SimulateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAuthInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.authInfo({ value: tx_9.AuthInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventResponse({ value: service_13.GetTxsEventResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxEncodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txEncodeResponse({ value: service_15.TxEncodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignerInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signerInfo({ value: tx_11.SignerInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoResponse({ value: service_17.TxDecodeAminoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxBody({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txBody({ value: tx_12.TxBody.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignDocDirectAux({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signDocDirectAux({ value: tx_13.SignDocDirectAux.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBroadcastTxRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.broadcastTxRequest({ value: service_18.BroadcastTxRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        signDoc({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignDoc", value: tx_2.SignDoc.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeAminoResponse", value: service_1.TxEncodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoMulti({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Multi", value: tx_3.ModeInfo_Multi.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxRequest", value: service_3.GetTxRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        txRaw({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxRaw", value: tx_4.TxRaw.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeAminoRequest", value: service_5.TxEncodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockWithTxsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetBlockWithTxsResponse", value: service_6.GetBlockWithTxsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoRequest", value: service_7.TxDecodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        fee({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.Fee", value: tx_6.Fee.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventRequest", value: service_8.GetTxsEventRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateRequest", value: service_9.SimulateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxResponse", value: service_10.GetTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeResponse", value: service_11.TxDecodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        simulateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SimulateResponse", value: service_12.SimulateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        authInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.AuthInfo", value: tx_9.AuthInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventResponse", value: service_13.GetTxsEventResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txEncodeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeResponse", value: service_15.TxEncodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        signerInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignerInfo", value: tx_11.SignerInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoResponse", value: service_17.TxDecodeAminoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txBody({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxBody", value: tx_12.TxBody.fromPartial(value) };
            }
            catch (e) {
        ...
        signDocDirectAux({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignDocDirectAux", value: tx_13.SignDocDirectAux.fromPartial(value) };
            }
            catch (e) {
        ...
        broadcastTxRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.BroadcastTxRequest", value: service_18.BroadcastTxRequest.fromPartial(value) };
            }
            catch (e) {
