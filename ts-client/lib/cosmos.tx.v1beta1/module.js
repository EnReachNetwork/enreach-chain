...
exports.queryClient = exports.txClient = exports.registry = exports.Tip = exports.ModeInfo_Multi = exports.SignerInfo = exports.GetTxsEventResponse = exports.TxDecodeRequest = exports.SimulateRequest = exports.BroadcastTxResponse = exports.SignDocDirectAux = exports.SignDoc = exports.TxDecodeAminoRequest = exports.TxEncodeAminoResponse = exports.TxEncodeRequest = exports.GetTxResponse = exports.ModeInfo_Single = exports.TxEncodeAminoRequest = exports.TxDecodeResponse = exports.GetBlockWithTxsRequest = exports.GetTxRequest = exports.BroadcastTxRequest = exports.ModeInfo = exports.TxDecodeAminoResponse = exports.Fee = exports.TxBody = exports.Tx = exports.GetTxsEventRequest = exports.AuxSignerData = exports.TxEncodeResponse = exports.GetBlockWithTxsResponse = exports.SimulateResponse = exports.AuthInfo = exports.TxRaw = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "TxRaw", { enumerable: true, get: function () { return tx_1.TxRaw; } });
...
Object.defineProperty(exports, "AuxSignerData", { enumerable: true, get: function () { return tx_3.AuxSignerData; } });
const service_4 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetTxsEventRequest", { enumerable: true, get: function () { return service_4.GetTxsEventRequest; } });
...
Object.defineProperty(exports, "GetTxResponse", { enumerable: true, get: function () { return service_11.GetTxResponse; } });
...
Object.defineProperty(exports, "TxDecodeAminoRequest", { enumerable: true, get: function () { return service_14.TxDecodeAminoRequest; } });
...
Object.defineProperty(exports, "GetTxsEventResponse", { enumerable: true, get: function () { return service_18.GetTxsEventResponse; } });
    ...
    return {
        async sendTxRaw({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.txRaw({ value: tx_1.TxRaw.fromPartial(value) });
        ...
        async sendAuxSignerData({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.auxSignerData({ value: tx_3.AuxSignerData.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventRequest({ value: service_4.GetTxsEventRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Single({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoSingle({ value: tx_8.ModeInfo_Single.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxResponse({ value: service_11.GetTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeAminoRequest({ value: service_14.TxDecodeAminoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventResponse({ value: service_18.GetTxsEventResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        txRaw({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxRaw", value: tx_1.TxRaw.fromPartial(value) };
            }
            catch (e) {
        ...
        auxSignerData({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.AuxSignerData", value: tx_3.AuxSignerData.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventRequest", value: service_4.GetTxsEventRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoSingle({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Single", value: tx_8.ModeInfo_Single.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxResponse", value: service_11.GetTxResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeAminoRequest", value: service_14.TxDecodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventResponse", value: service_18.GetTxsEventResponse.fromPartial(value) };
            }
            catch (e) {
