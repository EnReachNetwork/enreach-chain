...
exports.queryClient = exports.txClient = exports.registry = exports.Tx = exports.TxDecodeAminoResponse = exports.SimulateRequest = exports.TxEncodeAminoResponse = exports.BroadcastTxResponse = exports.AuxSignerData = exports.ModeInfo_Multi = exports.SignerInfo = exports.SignDocDirectAux = exports.GetTxRequest = exports.SignDoc = exports.TxDecodeRequest = exports.GetBlockWithTxsResponse = exports.GetTxsEventResponse = exports.GetTxsEventRequest = exports.Tip = exports.ModeInfo_Single = exports.AuthInfo = exports.TxDecodeAminoRequest = exports.TxRaw = exports.TxEncodeResponse = exports.ModeInfo = exports.TxBody = exports.TxEncodeRequest = exports.BroadcastTxRequest = exports.Fee = exports.TxDecodeResponse = exports.GetBlockWithTxsRequest = exports.GetTxResponse = exports.SimulateResponse = exports.TxEncodeAminoRequest = void 0;
...
Object.defineProperty(exports, "Fee", { enumerable: true, get: function () { return tx_1.Fee; } });
...
Object.defineProperty(exports, "ModeInfo", { enumerable: true, get: function () { return tx_3.ModeInfo; } });
...
Object.defineProperty(exports, "GetTxsEventResponse", { enumerable: true, get: function () { return service_11.GetTxsEventResponse; } });
const service_12 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "GetBlockWithTxsResponse", { enumerable: true, get: function () { return service_12.GetBlockWithTxsResponse; } });
const service_13 = require("./types/cosmos/tx/v1beta1/service");
Object.defineProperty(exports, "TxDecodeRequest", { enumerable: true, get: function () { return service_13.TxDecodeRequest; } });
const tx_8 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "SignDoc", { enumerable: true, get: function () { return tx_8.SignDoc; } });
...
Object.defineProperty(exports, "SignerInfo", { enumerable: true, get: function () { return tx_10.SignerInfo; } });
const tx_11 = require("./types/cosmos/tx/v1beta1/tx");
Object.defineProperty(exports, "ModeInfo_Multi", { enumerable: true, get: function () { return tx_11.ModeInfo_Multi; } });
...
Object.defineProperty(exports, "BroadcastTxResponse", { enumerable: true, get: function () { return service_15.BroadcastTxResponse; } });
    ...
    return {
        async sendTxEncodeAminoRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.txEncodeAminoRequest({ value: service_1.TxEncodeAminoRequest.fromPartial(value) });
        ...
        async sendFee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.fee({ value: tx_1.Fee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfo({ value: tx_3.ModeInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetTxsEventResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getTxsEventResponse({ value: service_11.GetTxsEventResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockWithTxsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockWithTxsResponse({ value: service_12.GetBlockWithTxsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTxDecodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.txDecodeRequest({ value: service_13.TxDecodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignDoc({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signDoc({ value: tx_8.SignDoc.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSignerInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signerInfo({ value: tx_10.SignerInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModeInfo_Multi({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.modeInfoMulti({ value: tx_11.ModeInfo_Multi.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBroadcastTxResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.broadcastTxResponse({ value: service_15.BroadcastTxResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        txEncodeAminoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxEncodeAminoRequest", value: service_1.TxEncodeAminoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        fee({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.Fee", value: tx_1.Fee.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo", value: tx_3.ModeInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        getTxsEventResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetTxsEventResponse", value: service_11.GetTxsEventResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockWithTxsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.GetBlockWithTxsResponse", value: service_12.GetBlockWithTxsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        txDecodeRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.TxDecodeRequest", value: service_13.TxDecodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        signDoc({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignDoc", value: tx_8.SignDoc.fromPartial(value) };
            }
            catch (e) {
        ...
        signerInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.SignerInfo", value: tx_10.SignerInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        modeInfoMulti({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.ModeInfo_Multi", value: tx_11.ModeInfo_Multi.fromPartial(value) };
            }
            catch (e) {
        ...
        broadcastTxResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.tx.v1beta1.BroadcastTxResponse", value: service_15.BroadcastTxResponse.fromPartial(value) };
            }
            catch (e) {
