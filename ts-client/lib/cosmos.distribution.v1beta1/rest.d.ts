...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryCommunityPool: (params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryDelegationTotalRewards: (delegatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryDelegationRewards: (delegatorAddress: string, validatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryDelegatorValidators: (delegatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryDelegatorWithdrawAddress: (delegatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryValidatorDistributionInfo: (validatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryValidatorCommission: (validatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryValidatorOutstandingRewards: (validatorAddress: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
