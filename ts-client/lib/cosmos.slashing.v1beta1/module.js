...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySigningInfoRequest = exports.MsgUpdateParamsResponse = exports.MsgUnjail = exports.GenesisState = exports.MissedBlock = exports.SigningInfo = exports.Params = exports.QueryParamsRequest = exports.QueryParamsResponse = exports.ValidatorSigningInfo = exports.ValidatorMissedBlocks = exports.MsgUpdateParams = exports.MsgUnjailResponse = exports.QuerySigningInfosResponse = exports.QuerySigningInfosRequest = exports.QuerySigningInfoResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfoResponse", { enumerable: true, get: function () { return query_1.QuerySigningInfoResponse; } });
...
Object.defineProperty(exports, "ValidatorMissedBlocks", { enumerable: true, get: function () { return genesis_1.ValidatorMissedBlocks; } });
    ...
    return {
        async sendQuerySigningInfoResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.querySigningInfoResponse({ value: query_1.QuerySigningInfoResponse.fromPartial(value) });
        ...
        async sendValidatorMissedBlocks({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validatorMissedBlocks({ value: genesis_1.ValidatorMissedBlocks.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendValidatorSigningInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validatorSigningInfo({ value: slashing_1.ValidatorSigningInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: slashing_2.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoResponse", value: query_1.QuerySigningInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        validatorMissedBlocks({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.ValidatorMissedBlocks", value: genesis_1.ValidatorMissedBlocks.fromPartial(value) };
            }
            catch (e) {
        ...
        validatorSigningInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.ValidatorSigningInfo", value: slashing_1.ValidatorSigningInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsResponse", value: query_4.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.Params", value: slashing_2.Params.fromPartial(value) };
            }
            catch (e) {
