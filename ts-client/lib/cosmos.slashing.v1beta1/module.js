...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.MsgUpdateParams = exports.MsgUnjail = exports.QuerySigningInfoResponse = exports.QuerySigningInfoRequest = exports.QueryParamsRequest = exports.SigningInfo = exports.QuerySigningInfosRequest = exports.QueryParamsResponse = exports.Params = exports.MissedBlock = exports.ValidatorMissedBlocks = exports.MsgUpdateParamsResponse = exports.MsgUnjailResponse = exports.QuerySigningInfosResponse = exports.ValidatorSigningInfo = void 0;
...
Object.defineProperty(exports, "QuerySigningInfosResponse", { enumerable: true, get: function () { return query_1.QuerySigningInfosResponse; } });
...
Object.defineProperty(exports, "QuerySigningInfosRequest", { enumerable: true, get: function () { return query_3.QuerySigningInfosRequest; } });
const genesis_3 = require("./types/cosmos/slashing/v1beta1/genesis");
Object.defineProperty(exports, "SigningInfo", { enumerable: true, get: function () { return genesis_3.SigningInfo; } });
    ...
    return {
        ...
        async sendQuerySigningInfosResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosResponse({ value: query_1.QuerySigningInfosResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfosRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosRequest({ value: query_3.QuerySigningInfosRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSigningInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signingInfo({ value: genesis_3.SigningInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfosResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosResponse", value: query_1.QuerySigningInfosResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfosRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosRequest", value: query_3.QuerySigningInfosRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        signingInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.SigningInfo", value: genesis_3.SigningInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsRequest", value: query_4.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
