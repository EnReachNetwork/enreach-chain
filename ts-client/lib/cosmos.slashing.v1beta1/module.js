...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.MissedBlock = exports.ValidatorMissedBlocks = exports.ValidatorSigningInfo = exports.MsgUnjailResponse = exports.MsgUnjail = exports.QuerySigningInfosRequest = exports.Params = exports.QuerySigningInfosResponse = exports.QuerySigningInfoResponse = exports.QuerySigningInfoRequest = exports.SigningInfo = exports.GenesisState = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "SigningInfo", { enumerable: true, get: function () { return genesis_2.SigningInfo; } });
...
Object.defineProperty(exports, "ValidatorMissedBlocks", { enumerable: true, get: function () { return genesis_3.ValidatorMissedBlocks; } });
const genesis_4 = require("./types/cosmos/slashing/v1beta1/genesis");
Object.defineProperty(exports, "MissedBlock", { enumerable: true, get: function () { return genesis_4.MissedBlock; } });
    ...
    return {
        ...
        async sendSigningInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signingInfo({ value: genesis_2.SigningInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendValidatorMissedBlocks({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validatorMissedBlocks({ value: genesis_3.ValidatorMissedBlocks.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMissedBlock({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.missedBlock({ value: genesis_4.MissedBlock.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUpdateParams", value: tx_1.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        signingInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.SigningInfo", value: genesis_2.SigningInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        validatorMissedBlocks({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.ValidatorMissedBlocks", value: genesis_3.ValidatorMissedBlocks.fromPartial(value) };
            }
            catch (e) {
        ...
        missedBlock({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MissedBlock", value: genesis_4.MissedBlock.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsResponse", value: query_6.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
