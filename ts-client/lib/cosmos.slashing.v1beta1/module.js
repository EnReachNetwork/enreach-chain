...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.MissedBlock = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgUnjailResponse = exports.QueryParamsRequest = exports.ValidatorMissedBlocks = exports.ValidatorSigningInfo = exports.QuerySigningInfosResponse = exports.QuerySigningInfoRequest = exports.Params = exports.SigningInfo = exports.MsgUnjail = exports.QuerySigningInfosRequest = exports.QuerySigningInfoResponse = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "QuerySigningInfoRequest", { enumerable: true, get: function () { return query_3.QuerySigningInfoRequest; } });
    ...
    return {
        ...
        async sendQuerySigningInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoRequest({ value: query_3.QuerySigningInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoRequest", value: query_3.QuerySigningInfoRequest.fromPartial(value) };
            }
            catch (e) {
