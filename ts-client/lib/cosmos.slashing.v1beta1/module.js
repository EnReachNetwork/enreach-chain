...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySigningInfoResponse = exports.ValidatorSigningInfo = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.MsgUnjailResponse = exports.GenesisState = exports.QuerySigningInfoRequest = exports.MsgUnjail = exports.MissedBlock = exports.ValidatorMissedBlocks = exports.SigningInfo = exports.QuerySigningInfosResponse = exports.QuerySigningInfosRequest = exports.QueryParamsRequest = exports.MsgUpdateParamsResponse = exports.Params = void 0;
...
Object.defineProperty(exports, "QuerySigningInfosRequest", { enumerable: true, get: function () { return query_2.QuerySigningInfosRequest; } });
...
Object.defineProperty(exports, "QuerySigningInfoResponse", { enumerable: true, get: function () { return query_6.QuerySigningInfoResponse; } });
    ...
    return {
        ...
        async sendQuerySigningInfosRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosRequest({ value: query_2.QuerySigningInfosRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoResponse({ value: query_6.QuerySigningInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfosRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosRequest", value: query_2.QuerySigningInfosRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        genesisState({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.GenesisState", value: genesis_4.GenesisState.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoResponse", value: query_6.QuerySigningInfoResponse.fromPartial(value) };
            }
            catch (e) {
