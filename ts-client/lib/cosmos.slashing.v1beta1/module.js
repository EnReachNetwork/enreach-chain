...
exports.queryClient = exports.txClient = exports.registry = exports.MissedBlock = exports.MsgUpdateParamsResponse = exports.Params = exports.QueryParamsRequest = exports.ValidatorMissedBlocks = exports.SigningInfo = exports.GenesisState = exports.ValidatorSigningInfo = exports.QuerySigningInfosResponse = exports.QuerySigningInfosRequest = exports.QuerySigningInfoResponse = exports.QuerySigningInfoRequest = exports.QueryParamsResponse = exports.MsgUpdateParams = exports.MsgUnjail = exports.MsgUnjailResponse = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUpdateParams", value: tx_3.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsRequest", value: query_6.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
