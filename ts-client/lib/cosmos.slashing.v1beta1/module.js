...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySigningInfosRequest = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.MsgUnjailResponse = exports.MsgUnjail = exports.QuerySigningInfosResponse = exports.ValidatorMissedBlocks = exports.MissedBlock = exports.SigningInfo = exports.QuerySigningInfoResponse = exports.QuerySigningInfoRequest = exports.QueryParamsRequest = exports.ValidatorSigningInfo = exports.Params = exports.GenesisState = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "QuerySigningInfoRequest", { enumerable: true, get: function () { return query_2.QuerySigningInfoRequest; } });
const query_3 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfoResponse", { enumerable: true, get: function () { return query_3.QuerySigningInfoResponse; } });
...
Object.defineProperty(exports, "QuerySigningInfosResponse", { enumerable: true, get: function () { return query_4.QuerySigningInfosResponse; } });
const tx_2 = require("./types/cosmos/slashing/v1beta1/tx");
Object.defineProperty(exports, "MsgUnjail", { enumerable: true, get: function () { return tx_2.MsgUnjail; } });
const tx_3 = require("./types/cosmos/slashing/v1beta1/tx");
Object.defineProperty(exports, "MsgUnjailResponse", { enumerable: true, get: function () { return tx_3.MsgUnjailResponse; } });
    ...
    return {
        ...
        async sendQuerySigningInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoRequest({ value: query_2.QuerySigningInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoResponse({ value: query_3.QuerySigningInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfosResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosResponse({ value: query_4.QuerySigningInfosResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnjail({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnjail({ value: tx_2.MsgUnjail.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnjailResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnjailResponse({ value: tx_3.MsgUnjailResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoRequest", value: query_2.QuerySigningInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoResponse", value: query_3.QuerySigningInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfosResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosResponse", value: query_4.QuerySigningInfosResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnjail({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUnjail", value: tx_2.MsgUnjail.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnjailResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUnjailResponse", value: tx_3.MsgUnjailResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUpdateParamsResponse", value: tx_4.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsResponse", value: query_5.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
