...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySigningInfosResponse = exports.MissedBlock = exports.ValidatorMissedBlocks = exports.ValidatorSigningInfo = exports.Params = exports.MsgUpdateParamsResponse = exports.QuerySigningInfoRequest = exports.QueryParamsResponse = exports.SigningInfo = exports.GenesisState = exports.MsgUnjailResponse = exports.MsgUnjail = exports.QuerySigningInfoResponse = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.QuerySigningInfosRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfosRequest", { enumerable: true, get: function () { return query_1.QuerySigningInfosRequest; } });
...
Object.defineProperty(exports, "QuerySigningInfoRequest", { enumerable: true, get: function () { return query_5.QuerySigningInfoRequest; } });
...
Object.defineProperty(exports, "QuerySigningInfosResponse", { enumerable: true, get: function () { return query_6.QuerySigningInfosResponse; } });
    ...
    return {
        async sendQuerySigningInfosRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.querySigningInfosRequest({ value: query_1.QuerySigningInfosRequest.fromPartial(value) });
        ...
        async sendQuerySigningInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoRequest({ value: query_5.QuerySigningInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfosResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosResponse({ value: query_6.QuerySigningInfosResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfosRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosRequest", value: query_1.QuerySigningInfosRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoRequest", value: query_5.QuerySigningInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfosResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosResponse", value: query_6.QuerySigningInfosResponse.fromPartial(value) };
            }
            catch (e) {
