...
exports.queryClient = exports.txClient = exports.registry = exports.ValidatorMissedBlocks = exports.GenesisState = exports.MsgUnjail = exports.ValidatorSigningInfo = exports.QuerySigningInfoRequest = exports.MissedBlock = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgUnjailResponse = exports.QuerySigningInfosResponse = exports.QuerySigningInfosRequest = exports.QueryParamsResponse = exports.SigningInfo = exports.QuerySigningInfoResponse = exports.QueryParamsRequest = exports.Params = void 0;
...
Object.defineProperty(exports, "QuerySigningInfoResponse", { enumerable: true, get: function () { return query_2.QuerySigningInfoResponse; } });
...
Object.defineProperty(exports, "QuerySigningInfosRequest", { enumerable: true, get: function () { return query_4.QuerySigningInfosRequest; } });
const query_5 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfosResponse", { enumerable: true, get: function () { return query_5.QuerySigningInfosResponse; } });
...
Object.defineProperty(exports, "MissedBlock", { enumerable: true, get: function () { return genesis_2.MissedBlock; } });
const query_6 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfoRequest", { enumerable: true, get: function () { return query_6.QuerySigningInfoRequest; } });
...
Object.defineProperty(exports, "MsgUnjail", { enumerable: true, get: function () { return tx_4.MsgUnjail; } });
...
Object.defineProperty(exports, "ValidatorMissedBlocks", { enumerable: true, get: function () { return genesis_4.ValidatorMissedBlocks; } });
    ...
    return {
        ...
        async sendQuerySigningInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoResponse({ value: query_2.QuerySigningInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSigningInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.signingInfo({ value: genesis_1.SigningInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfosRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosRequest({ value: query_4.QuerySigningInfosRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfosResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosResponse({ value: query_5.QuerySigningInfosResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMissedBlock({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.missedBlock({ value: genesis_2.MissedBlock.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoRequest({ value: query_6.QuerySigningInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnjail({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnjail({ value: tx_4.MsgUnjail.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendValidatorMissedBlocks({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validatorMissedBlocks({ value: genesis_4.ValidatorMissedBlocks.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoResponse", value: query_2.QuerySigningInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        signingInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.SigningInfo", value: genesis_1.SigningInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsResponse", value: query_3.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfosRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosRequest", value: query_4.QuerySigningInfosRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfosResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosResponse", value: query_5.QuerySigningInfosResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUpdateParams", value: tx_2.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUpdateParamsResponse", value: tx_3.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        missedBlock({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MissedBlock", value: genesis_2.MissedBlock.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoRequest", value: query_6.QuerySigningInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnjail({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUnjail", value: tx_4.MsgUnjail.fromPartial(value) };
            }
            catch (e) {
        ...
        genesisState({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.GenesisState", value: genesis_3.GenesisState.fromPartial(value) };
            }
            catch (e) {
        ...
        validatorMissedBlocks({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.ValidatorMissedBlocks", value: genesis_4.ValidatorMissedBlocks.fromPartial(value) };
            }
            catch (e) {
