...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.SigningInfo = exports.MsgUpdateParamsResponse = exports.MsgUnjail = exports.QuerySigningInfoResponse = exports.Params = exports.MsgUnjailResponse = exports.QuerySigningInfoRequest = exports.QueryParamsRequest = exports.ValidatorMissedBlocks = exports.GenesisState = exports.QuerySigningInfosResponse = exports.QuerySigningInfosRequest = exports.ValidatorSigningInfo = exports.MissedBlock = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "MissedBlock", { enumerable: true, get: function () { return genesis_1.MissedBlock; } });
...
Object.defineProperty(exports, "MsgUnjailResponse", { enumerable: true, get: function () { return tx_2.MsgUnjailResponse; } });
    ...
    return {
        ...
        async sendMissedBlock({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.missedBlock({ value: genesis_1.MissedBlock.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnjailResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnjailResponse({ value: tx_2.MsgUnjailResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        missedBlock({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MissedBlock", value: genesis_1.MissedBlock.fromPartial(value) };
            }
            catch (e) {
        ...
        genesisState({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.GenesisState", value: genesis_2.GenesisState.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsRequest", value: query_3.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnjailResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUnjailResponse", value: tx_2.MsgUnjailResponse.fromPartial(value) };
            }
            catch (e) {
