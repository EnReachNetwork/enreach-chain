...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUnjailResponse = exports.MsgUnjail = exports.ValidatorSigningInfo = exports.QuerySigningInfosRequest = exports.QueryParamsRequest = exports.ValidatorMissedBlocks = exports.GenesisState = exports.MissedBlock = exports.MsgUpdateParams = exports.SigningInfo = exports.QuerySigningInfoResponse = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.Params = exports.QuerySigningInfosResponse = exports.QuerySigningInfoRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfoRequest", { enumerable: true, get: function () { return query_1.QuerySigningInfoRequest; } });
const query_2 = require("./types/cosmos/slashing/v1beta1/query");
Object.defineProperty(exports, "QuerySigningInfosResponse", { enumerable: true, get: function () { return query_2.QuerySigningInfosResponse; } });
...
Object.defineProperty(exports, "QuerySigningInfoResponse", { enumerable: true, get: function () { return query_4.QuerySigningInfoResponse; } });
...
Object.defineProperty(exports, "MsgUnjailResponse", { enumerable: true, get: function () { return tx_4.MsgUnjailResponse; } });
    ...
    return {
        async sendQuerySigningInfoRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.querySigningInfoRequest({ value: query_1.QuerySigningInfoRequest.fromPartial(value) });
        ...
        async sendQuerySigningInfosResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfosResponse({ value: query_2.QuerySigningInfosResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySigningInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySigningInfoResponse({ value: query_4.QuerySigningInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnjailResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnjailResponse({ value: tx_4.MsgUnjailResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySigningInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoRequest", value: query_1.QuerySigningInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfosResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosResponse", value: query_2.QuerySigningInfosResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUpdateParamsResponse", value: tx_1.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySigningInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoResponse", value: query_4.QuerySigningInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.QueryParamsRequest", value: query_5.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnjailResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.slashing.v1beta1.MsgUnjailResponse", value: tx_4.MsgUnjailResponse.fromPartial(value) };
            }
            catch (e) {
