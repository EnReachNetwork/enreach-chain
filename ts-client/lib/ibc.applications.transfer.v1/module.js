...
exports.queryClient = exports.txClient = exports.registry = exports.QueryTotalEscrowForDenomResponse = exports.QueryDenomHashRequest = exports.QueryDenomTracesResponse = exports.QueryEscrowAddressRequest = exports.QueryDenomTracesRequest = exports.QueryDenomTraceResponse = exports.MsgUpdateParamsResponse = exports.QueryDenomHashResponse = exports.QueryParamsResponse = exports.TransferAuthorization = exports.Params = exports.QueryParamsRequest = exports.GenesisState = exports.Allocation = exports.DenomTrace = exports.QueryDenomTraceRequest = exports.QueryTotalEscrowForDenomRequest = exports.MsgTransferResponse = exports.QueryEscrowAddressResponse = exports.MsgTransfer = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "MsgTransfer", { enumerable: true, get: function () { return tx_2.MsgTransfer; } });
...
Object.defineProperty(exports, "QueryDenomHashResponse", { enumerable: true, get: function () { return query_6.QueryDenomHashResponse; } });
    ...
    return {
        ...
        async sendMsgTransfer({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTransfer({ value: tx_2.MsgTransfer.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_1.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashResponse({ value: query_6.QueryDenomHashResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgTransfer({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.MsgTransfer", value: tx_2.MsgTransfer.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_1.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashResponse", value: query_6.QueryDenomHashResponse.fromPartial(value) };
            }
            catch (e) {
