...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDenomHashResponse = exports.QueryParamsResponse = exports.QueryDenomTraceRequest = exports.QueryParamsRequest = exports.QueryEscrowAddressRequest = exports.QueryDenomTraceResponse = exports.MsgTransferResponse = exports.DenomTrace = exports.QueryEscrowAddressResponse = exports.QueryDenomHashRequest = exports.QueryDenomTracesRequest = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgTransfer = exports.QueryTotalEscrowForDenomResponse = exports.Params = exports.TransferAuthorization = exports.QueryDenomTracesResponse = exports.GenesisState = exports.Allocation = exports.QueryTotalEscrowForDenomRequest = void 0;
...
Object.defineProperty(exports, "QueryEscrowAddressResponse", { enumerable: true, get: function () { return query_6.QueryEscrowAddressResponse; } });
    ...
    return {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_6.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_6.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsRequest", value: query_9.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
