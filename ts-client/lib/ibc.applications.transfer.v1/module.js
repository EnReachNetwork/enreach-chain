...
exports.queryClient = exports.txClient = exports.registry = exports.MsgTransferResponse = exports.MsgUpdateParams = exports.Params = exports.QueryDenomHashRequest = exports.QueryDenomTraceResponse = exports.Allocation = exports.MsgUpdateParamsResponse = exports.QueryEscrowAddressResponse = exports.QueryEscrowAddressRequest = exports.QueryParamsRequest = exports.QueryDenomTracesResponse = exports.MsgTransfer = exports.QueryTotalEscrowForDenomResponse = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomTracesRequest = exports.DenomTrace = exports.QueryDenomHashResponse = exports.QueryParamsResponse = exports.GenesisState = exports.TransferAuthorization = exports.QueryDenomTraceRequest = void 0;
...
Object.defineProperty(exports, "QueryDenomHashResponse", { enumerable: true, get: function () { return query_3.QueryDenomHashResponse; } });
...
Object.defineProperty(exports, "QueryDenomTracesRequest", { enumerable: true, get: function () { return query_4.QueryDenomTracesRequest; } });
const query_5 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryTotalEscrowForDenomRequest", { enumerable: true, get: function () { return query_5.QueryTotalEscrowForDenomRequest; } });
const query_6 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryTotalEscrowForDenomResponse", { enumerable: true, get: function () { return query_6.QueryTotalEscrowForDenomResponse; } });
...
Object.defineProperty(exports, "QueryDenomTracesResponse", { enumerable: true, get: function () { return query_7.QueryDenomTracesResponse; } });
...
Object.defineProperty(exports, "QueryDenomTraceResponse", { enumerable: true, get: function () { return query_11.QueryDenomTraceResponse; } });
const query_12 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryDenomHashRequest", { enumerable: true, get: function () { return query_12.QueryDenomHashRequest; } });
    ...
    return {
        ...
        async sendQueryDenomHashResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashResponse({ value: query_3.QueryDenomHashResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTracesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesRequest({ value: query_4.QueryDenomTracesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalEscrowForDenomRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomRequest({ value: query_5.QueryTotalEscrowForDenomRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalEscrowForDenomResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomResponse({ value: query_6.QueryTotalEscrowForDenomResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTracesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesResponse({ value: query_7.QueryDenomTracesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTraceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceResponse({ value: query_11.QueryDenomTraceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashRequest({ value: query_12.QueryDenomHashRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsResponse", value: query_2.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashResponse", value: query_3.QueryDenomHashResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTracesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesRequest", value: query_4.QueryDenomTracesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomRequest", value: query_5.QueryTotalEscrowForDenomRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomResponse", value: query_6.QueryTotalEscrowForDenomResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTracesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesResponse", value: query_7.QueryDenomTracesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsRequest", value: query_8.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTraceResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceResponse", value: query_11.QueryDenomTraceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashRequest", value: query_12.QueryDenomHashRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.MsgUpdateParams", value: tx_3.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
