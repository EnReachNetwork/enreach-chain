...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.QueryEscrowAddressRequest = exports.QueryDenomTracesResponse = exports.Params = exports.TransferAuthorization = exports.GenesisState = exports.QueryTotalEscrowForDenomResponse = exports.QueryDenomHashResponse = exports.QueryDenomTraceResponse = exports.MsgTransfer = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomTracesRequest = exports.QueryDenomTraceRequest = exports.Allocation = exports.DenomTrace = exports.QueryDenomHashRequest = exports.QueryParamsRequest = exports.QueryEscrowAddressResponse = exports.MsgUpdateParamsResponse = exports.MsgTransferResponse = exports.QueryParamsResponse = void 0;
...
Object.defineProperty(exports, "QueryEscrowAddressResponse", { enumerable: true, get: function () { return query_2.QueryEscrowAddressResponse; } });
...
Object.defineProperty(exports, "QueryDenomHashRequest", { enumerable: true, get: function () { return query_4.QueryDenomHashRequest; } });
...
Object.defineProperty(exports, "QueryTotalEscrowForDenomRequest", { enumerable: true, get: function () { return query_7.QueryTotalEscrowForDenomRequest; } });
...
Object.defineProperty(exports, "QueryDenomHashResponse", { enumerable: true, get: function () { return query_9.QueryDenomHashResponse; } });
...
Object.defineProperty(exports, "QueryEscrowAddressRequest", { enumerable: true, get: function () { return query_12.QueryEscrowAddressRequest; } });
    ...
    return {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_2.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashRequest({ value: query_4.QueryDenomHashRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalEscrowForDenomRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomRequest({ value: query_7.QueryTotalEscrowForDenomRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashResponse({ value: query_9.QueryDenomHashResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressRequest({ value: query_12.QueryEscrowAddressRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_2.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashRequest", value: query_4.QueryDenomHashRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomRequest", value: query_7.QueryTotalEscrowForDenomRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashResponse", value: query_9.QueryDenomHashResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressRequest", value: query_12.QueryEscrowAddressRequest.fromPartial(value) };
            }
            catch (e) {
