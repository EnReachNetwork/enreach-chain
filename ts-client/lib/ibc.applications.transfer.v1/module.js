...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.MsgUpdateParamsResponse = exports.MsgTransferResponse = exports.QueryParamsResponse = exports.Params = exports.MsgUpdateParams = exports.QueryDenomTraceRequest = exports.QueryEscrowAddressResponse = exports.QueryDenomHashResponse = exports.QueryDenomTraceResponse = exports.TransferAuthorization = exports.MsgTransfer = exports.QueryTotalEscrowForDenomResponse = exports.Allocation = exports.QueryTotalEscrowForDenomRequest = exports.QueryEscrowAddressRequest = exports.QueryDenomHashRequest = exports.QueryDenomTracesResponse = exports.QueryDenomTracesRequest = exports.GenesisState = exports.DenomTrace = void 0;
...
Object.defineProperty(exports, "QueryDenomHashRequest", { enumerable: true, get: function () { return query_3.QueryDenomHashRequest; } });
const query_4 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryEscrowAddressRequest", { enumerable: true, get: function () { return query_4.QueryEscrowAddressRequest; } });
...
Object.defineProperty(exports, "QueryDenomHashResponse", { enumerable: true, get: function () { return query_8.QueryDenomHashResponse; } });
const query_9 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryEscrowAddressResponse", { enumerable: true, get: function () { return query_9.QueryEscrowAddressResponse; } });
const query_10 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryDenomTraceRequest", { enumerable: true, get: function () { return query_10.QueryDenomTraceRequest; } });
    ...
    return {
        ...
        async sendQueryDenomHashRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashRequest({ value: query_3.QueryDenomHashRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressRequest({ value: query_4.QueryEscrowAddressRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashResponse({ value: query_8.QueryDenomHashResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_9.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTraceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceRequest({ value: query_10.QueryDenomTraceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgTransferResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTransferResponse({ value: tx_3.MsgTransferResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDenomHashRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashRequest", value: query_3.QueryDenomHashRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressRequest", value: query_4.QueryEscrowAddressRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashResponse", value: query_8.QueryDenomHashResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_9.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTraceRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceRequest", value: query_10.QueryDenomTraceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTransferResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.MsgTransferResponse", value: tx_3.MsgTransferResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsRequest", value: query_12.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
