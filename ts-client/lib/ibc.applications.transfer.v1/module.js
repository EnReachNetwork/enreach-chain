...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.QueryDenomTracesResponse = exports.QueryDenomTraceRequest = exports.Params = exports.QueryEscrowAddressRequest = exports.QueryDenomTracesRequest = exports.TransferAuthorization = exports.QueryEscrowAddressResponse = exports.MsgTransferResponse = exports.QueryTotalEscrowForDenomRequest = exports.Allocation = exports.MsgUpdateParamsResponse = exports.QueryDenomTraceResponse = exports.GenesisState = exports.MsgTransfer = exports.DenomTrace = exports.QueryDenomHashResponse = exports.QueryDenomHashRequest = exports.QueryParamsResponse = exports.QueryTotalEscrowForDenomResponse = exports.QueryParamsRequest = void 0;
...
Object.defineProperty(exports, "QueryDenomTraceResponse", { enumerable: true, get: function () { return query_6.QueryDenomTraceResponse; } });
...
Object.defineProperty(exports, "QueryDenomTraceRequest", { enumerable: true, get: function () { return query_11.QueryDenomTraceRequest; } });
    ...
    return {
        ...
        async sendQueryDenomTraceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceResponse({ value: query_6.QueryDenomTraceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTraceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceRequest({ value: query_11.QueryDenomTraceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDenomTraceResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceResponse", value: query_6.QueryDenomTraceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTraceRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceRequest", value: query_11.QueryDenomTraceRequest.fromPartial(value) };
            }
            catch (e) {
