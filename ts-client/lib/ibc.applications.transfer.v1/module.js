...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDenomTracesResponse = exports.QueryTotalEscrowForDenomResponse = exports.DenomTrace = exports.QueryEscrowAddressResponse = exports.QueryEscrowAddressRequest = exports.QueryDenomHashResponse = exports.Allocation = exports.QueryParamsResponse = exports.GenesisState = exports.QueryDenomTraceRequest = exports.MsgTransfer = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomHashRequest = exports.MsgUpdateParams = exports.MsgTransferResponse = exports.QueryParamsRequest = exports.QueryDenomTraceResponse = exports.Params = exports.MsgUpdateParamsResponse = exports.QueryDenomTracesRequest = exports.TransferAuthorization = void 0;
...
Object.defineProperty(exports, "QueryDenomTraceRequest", { enumerable: true, get: function () { return query_6.QueryDenomTraceRequest; } });
...
Object.defineProperty(exports, "QueryTotalEscrowForDenomResponse", { enumerable: true, get: function () { return query_11.QueryTotalEscrowForDenomResponse; } });
    ...
    return {
        ...
        async sendQueryDenomTraceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceRequest({ value: query_6.QueryDenomTraceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalEscrowForDenomResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomResponse({ value: query_11.QueryTotalEscrowForDenomResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDenomTraceRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceRequest", value: query_6.QueryDenomTraceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsResponse", value: query_7.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomResponse", value: query_11.QueryTotalEscrowForDenomResponse.fromPartial(value) };
            }
            catch (e) {
