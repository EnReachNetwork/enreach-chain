...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDenomHashResponse = exports.QueryDenomTracesRequest = exports.QueryDenomHashRequest = exports.QueryDenomTraceResponse = exports.MsgUpdateParamsResponse = exports.QueryEscrowAddressResponse = exports.Allocation = exports.QueryDenomTracesResponse = exports.MsgTransfer = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomTraceRequest = exports.QueryTotalEscrowForDenomResponse = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.Params = exports.DenomTrace = exports.MsgUpdateParams = exports.MsgTransferResponse = exports.QueryEscrowAddressRequest = exports.GenesisState = exports.TransferAuthorization = void 0;
...
Object.defineProperty(exports, "QueryEscrowAddressResponse", { enumerable: true, get: function () { return query_8.QueryEscrowAddressResponse; } });
    ...
    return {
        ...
        async sendQueryEscrowAddressRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressRequest({ value: query_1.QueryEscrowAddressRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_8.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryEscrowAddressRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressRequest", value: query_1.QueryEscrowAddressRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsResponse", value: query_3.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_8.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
