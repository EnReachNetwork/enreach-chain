...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.QueryEscrowAddressResponse = exports.QueryDenomTracesResponse = exports.MsgTransferResponse = exports.QueryDenomHashRequest = exports.QueryDenomTraceResponse = exports.QueryDenomTraceRequest = exports.MsgUpdateParams = exports.TransferAuthorization = exports.MsgUpdateParamsResponse = exports.Allocation = exports.QueryEscrowAddressRequest = exports.QueryParamsResponse = exports.MsgTransfer = exports.Params = exports.DenomTrace = exports.QueryDenomHashResponse = exports.QueryParamsRequest = exports.QueryTotalEscrowForDenomResponse = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomTracesRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryDenomTracesRequest", { enumerable: true, get: function () { return query_1.QueryDenomTracesRequest; } });
const query_2 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryTotalEscrowForDenomRequest", { enumerable: true, get: function () { return query_2.QueryTotalEscrowForDenomRequest; } });
const query_3 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryTotalEscrowForDenomResponse", { enumerable: true, get: function () { return query_3.QueryTotalEscrowForDenomResponse; } });
...
Object.defineProperty(exports, "QueryEscrowAddressRequest", { enumerable: true, get: function () { return query_7.QueryEscrowAddressRequest; } });
...
Object.defineProperty(exports, "QueryDenomTraceResponse", { enumerable: true, get: function () { return query_9.QueryDenomTraceResponse; } });
const query_10 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryDenomHashRequest", { enumerable: true, get: function () { return query_10.QueryDenomHashRequest; } });
...
Object.defineProperty(exports, "QueryDenomTracesResponse", { enumerable: true, get: function () { return query_11.QueryDenomTracesResponse; } });
const query_12 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryEscrowAddressResponse", { enumerable: true, get: function () { return query_12.QueryEscrowAddressResponse; } });
    ...
    return {
        async sendQueryDenomTracesRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryDenomTracesRequest({ value: query_1.QueryDenomTracesRequest.fromPartial(value) });
        ...
        async sendQueryTotalEscrowForDenomRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomRequest({ value: query_2.QueryTotalEscrowForDenomRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalEscrowForDenomResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomResponse({ value: query_3.QueryTotalEscrowForDenomResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressRequest({ value: query_7.QueryEscrowAddressRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTraceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceResponse({ value: query_9.QueryDenomTraceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashRequest({ value: query_10.QueryDenomHashRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTracesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesResponse({ value: query_11.QueryDenomTracesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_12.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDenomTracesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesRequest", value: query_1.QueryDenomTracesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomRequest", value: query_2.QueryTotalEscrowForDenomRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomResponse", value: query_3.QueryTotalEscrowForDenomResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressRequest", value: query_7.QueryEscrowAddressRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTraceResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceResponse", value: query_9.QueryDenomTraceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashRequest", value: query_10.QueryDenomHashRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTracesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesResponse", value: query_11.QueryDenomTracesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_12.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
