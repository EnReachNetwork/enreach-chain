...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDenomHashResponse = exports.QueryDenomHashRequest = exports.Allocation = exports.GenesisState = exports.QueryTotalEscrowForDenomRequest = exports.QueryEscrowAddressRequest = exports.DenomTrace = exports.QueryDenomTracesRequest = exports.TransferAuthorization = exports.QueryEscrowAddressResponse = exports.QueryDenomTracesResponse = exports.MsgTransfer = exports.QueryParamsResponse = exports.Params = exports.MsgUpdateParamsResponse = exports.MsgTransferResponse = exports.QueryParamsRequest = exports.QueryTotalEscrowForDenomResponse = exports.QueryDenomTraceResponse = exports.QueryDenomTraceRequest = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "QueryDenomTracesResponse", { enumerable: true, get: function () { return query_6.QueryDenomTracesResponse; } });
...
Object.defineProperty(exports, "QueryDenomTracesRequest", { enumerable: true, get: function () { return query_8.QueryDenomTracesRequest; } });
    ...
    return {
        ...
        async sendQueryDenomTracesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesResponse({ value: query_6.QueryDenomTracesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTracesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesRequest({ value: query_8.QueryDenomTracesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDenomTracesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesResponse", value: query_6.QueryDenomTracesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTracesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesRequest", value: query_8.QueryDenomTracesRequest.fromPartial(value) };
            }
            catch (e) {
