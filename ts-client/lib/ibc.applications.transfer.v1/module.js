...
exports.queryClient = exports.txClient = exports.registry = exports.Allocation = exports.MsgTransfer = exports.QueryDenomHashResponse = exports.QueryDenomHashRequest = exports.QueryEscrowAddressRequest = exports.Params = exports.MsgTransferResponse = exports.QueryEscrowAddressResponse = exports.QueryDenomTraceResponse = exports.QueryParamsResponse = exports.GenesisState = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomTracesRequest = exports.QueryDenomTraceRequest = exports.MsgUpdateParamsResponse = exports.TransferAuthorization = exports.QueryDenomTracesResponse = exports.DenomTrace = exports.MsgUpdateParams = exports.QueryTotalEscrowForDenomResponse = exports.QueryParamsRequest = void 0;
...
Object.defineProperty(exports, "QueryDenomTraceRequest", { enumerable: true, get: function () { return query_4.QueryDenomTraceRequest; } });
const query_5 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryDenomTracesRequest", { enumerable: true, get: function () { return query_5.QueryDenomTracesRequest; } });
...
Object.defineProperty(exports, "QueryDenomHashRequest", { enumerable: true, get: function () { return query_11.QueryDenomHashRequest; } });
    ...
    return {
        ...
        async sendQueryDenomTraceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceRequest({ value: query_4.QueryDenomTraceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTracesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesRequest({ value: query_5.QueryDenomTracesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashRequest({ value: query_11.QueryDenomHashRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDenomTraceRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceRequest", value: query_4.QueryDenomTraceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTracesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesRequest", value: query_5.QueryDenomTracesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashRequest", value: query_11.QueryDenomHashRequest.fromPartial(value) };
            }
            catch (e) {
