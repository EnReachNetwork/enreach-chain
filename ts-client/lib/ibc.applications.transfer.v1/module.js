...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDenomTraceResponse = exports.MsgUpdateParams = exports.GenesisState = exports.QueryEscrowAddressRequest = exports.QueryDenomTracesResponse = exports.QueryDenomTracesRequest = exports.QueryTotalEscrowForDenomRequest = exports.QueryDenomHashRequest = exports.QueryParamsResponse = exports.QueryDenomTraceRequest = exports.DenomTrace = exports.MsgTransfer = exports.QueryTotalEscrowForDenomResponse = exports.QueryEscrowAddressResponse = exports.QueryDenomHashResponse = exports.MsgUpdateParamsResponse = exports.Allocation = exports.Params = exports.QueryParamsRequest = exports.TransferAuthorization = exports.MsgTransferResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/ibc/applications/transfer/v1/tx");
Object.defineProperty(exports, "MsgTransferResponse", { enumerable: true, get: function () { return tx_1.MsgTransferResponse; } });
const authz_1 = require("./types/ibc/applications/transfer/v1/authz");
Object.defineProperty(exports, "TransferAuthorization", { enumerable: true, get: function () { return authz_1.TransferAuthorization; } });
...
Object.defineProperty(exports, "Allocation", { enumerable: true, get: function () { return authz_2.Allocation; } });
...
Object.defineProperty(exports, "QueryEscrowAddressResponse", { enumerable: true, get: function () { return query_3.QueryEscrowAddressResponse; } });
...
Object.defineProperty(exports, "QueryDenomTraceRequest", { enumerable: true, get: function () { return query_5.QueryDenomTraceRequest; } });
...
Object.defineProperty(exports, "QueryDenomHashRequest", { enumerable: true, get: function () { return query_7.QueryDenomHashRequest; } });
const query_8 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryTotalEscrowForDenomRequest", { enumerable: true, get: function () { return query_8.QueryTotalEscrowForDenomRequest; } });
...
Object.defineProperty(exports, "QueryDenomTracesResponse", { enumerable: true, get: function () { return query_10.QueryDenomTracesResponse; } });
const query_11 = require("./types/ibc/applications/transfer/v1/query");
Object.defineProperty(exports, "QueryEscrowAddressRequest", { enumerable: true, get: function () { return query_11.QueryEscrowAddressRequest; } });
...
Object.defineProperty(exports, "QueryDenomTraceResponse", { enumerable: true, get: function () { return query_12.QueryDenomTraceResponse; } });
    ...
    return {
        async sendMsgTransferResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgTransferResponse({ value: tx_1.MsgTransferResponse.fromPartial(value) });
        ...
        async sendTransferAuthorization({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.transferAuthorization({ value: authz_1.TransferAuthorization.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAllocation({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.allocation({ value: authz_2.Allocation.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressResponse({ value: query_3.QueryEscrowAddressResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTraceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceRequest({ value: query_5.QueryDenomTraceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomHashRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomHashRequest({ value: query_7.QueryDenomHashRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalEscrowForDenomRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalEscrowForDenomRequest({ value: query_8.QueryTotalEscrowForDenomRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTracesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTracesResponse({ value: query_10.QueryDenomTracesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryEscrowAddressRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryEscrowAddressRequest({ value: query_11.QueryEscrowAddressRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomTraceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomTraceResponse({ value: query_12.QueryDenomTraceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgTransferResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.MsgTransferResponse", value: tx_1.MsgTransferResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        transferAuthorization({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.TransferAuthorization", value: authz_1.TransferAuthorization.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsRequest", value: query_1.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        allocation({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.Allocation", value: authz_2.Allocation.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.MsgUpdateParamsResponse", value: tx_2.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressResponse", value: query_3.QueryEscrowAddressResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTraceRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceRequest", value: query_5.QueryDenomTraceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryParamsResponse", value: query_6.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomHashRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomHashRequest", value: query_7.QueryDenomHashRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalEscrowForDenomRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryTotalEscrowForDenomRequest", value: query_8.QueryTotalEscrowForDenomRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTracesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTracesResponse", value: query_10.QueryDenomTracesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryEscrowAddressRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryEscrowAddressRequest", value: query_11.QueryEscrowAddressRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.MsgUpdateParams", value: tx_4.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomTraceResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.transfer.v1.QueryDenomTraceResponse", value: query_12.QueryDenomTraceResponse.fromPartial(value) };
            }
            catch (e) {
