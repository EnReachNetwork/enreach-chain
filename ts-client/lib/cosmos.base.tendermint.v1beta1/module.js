...
exports.queryClient = exports.txClient = exports.registry = exports.Module = exports.GetValidatorSetByHeightResponse = exports.Block = exports.ProofOps = exports.GetLatestBlockResponse = exports.GetBlockByHeightResponse = exports.GetValidatorSetByHeightRequest = exports.ProofOp = exports.GetLatestBlockRequest = exports.Validator = exports.GetSyncingResponse = exports.Header = exports.VersionInfo = exports.GetNodeInfoRequest = exports.GetSyncingRequest = exports.GetBlockByHeightRequest = exports.GetNodeInfoResponse = exports.GetLatestValidatorSetRequest = exports.ABCIQueryResponse = exports.ABCIQueryRequest = exports.GetLatestValidatorSetResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestValidatorSetResponse", { enumerable: true, get: function () { return query_1.GetLatestValidatorSetResponse; } });
...
Object.defineProperty(exports, "ABCIQueryResponse", { enumerable: true, get: function () { return query_3.ABCIQueryResponse; } });
const query_4 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestValidatorSetRequest", { enumerable: true, get: function () { return query_4.GetLatestValidatorSetRequest; } });
const query_5 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetNodeInfoResponse", { enumerable: true, get: function () { return query_5.GetNodeInfoResponse; } });
...
Object.defineProperty(exports, "GetSyncingRequest", { enumerable: true, get: function () { return query_7.GetSyncingRequest; } });
...
Object.defineProperty(exports, "VersionInfo", { enumerable: true, get: function () { return query_9.VersionInfo; } });
...
Object.defineProperty(exports, "GetSyncingResponse", { enumerable: true, get: function () { return query_10.GetSyncingResponse; } });
const query_11 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "Validator", { enumerable: true, get: function () { return query_11.Validator; } });
const query_12 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestBlockRequest", { enumerable: true, get: function () { return query_12.GetLatestBlockRequest; } });
const query_13 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "ProofOp", { enumerable: true, get: function () { return query_13.ProofOp; } });
const query_14 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetValidatorSetByHeightRequest", { enumerable: true, get: function () { return query_14.GetValidatorSetByHeightRequest; } });
...
Object.defineProperty(exports, "GetLatestBlockResponse", { enumerable: true, get: function () { return query_16.GetLatestBlockResponse; } });
...
Object.defineProperty(exports, "GetValidatorSetByHeightResponse", { enumerable: true, get: function () { return query_18.GetValidatorSetByHeightResponse; } });
const query_19 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "Module", { enumerable: true, get: function () { return query_19.Module; } });
    ...
    return {
        async sendGetLatestValidatorSetResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.getLatestValidatorSetResponse({ value: query_1.GetLatestValidatorSetResponse.fromPartial(value) });
        ...
        async sendABCIQueryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.abciqueryResponse({ value: query_3.ABCIQueryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestValidatorSetRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestValidatorSetRequest({ value: query_4.GetLatestValidatorSetRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetNodeInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getNodeInfoResponse({ value: query_5.GetNodeInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetSyncingRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getSyncingRequest({ value: query_7.GetSyncingRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersionInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.versionInfo({ value: query_9.VersionInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetSyncingResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getSyncingResponse({ value: query_10.GetSyncingResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendValidator({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validator({ value: query_11.Validator.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestBlockRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestBlockRequest({ value: query_12.GetLatestBlockRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProofOp({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proofOp({ value: query_13.ProofOp.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetValidatorSetByHeightRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getValidatorSetByHeightRequest({ value: query_14.GetValidatorSetByHeightRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestBlockResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestBlockResponse({ value: query_16.GetLatestBlockResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetValidatorSetByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getValidatorSetByHeightResponse({ value: query_18.GetValidatorSetByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModule({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.module({ value: query_19.Module.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        getLatestValidatorSetResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestValidatorSetResponse", value: query_1.GetLatestValidatorSetResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        abciqueryResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ABCIQueryResponse", value: query_3.ABCIQueryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestValidatorSetRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestValidatorSetRequest", value: query_4.GetLatestValidatorSetRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getNodeInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetNodeInfoResponse", value: query_5.GetNodeInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getSyncingRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetSyncingRequest", value: query_7.GetSyncingRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        versionInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.VersionInfo", value: query_9.VersionInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        getSyncingResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetSyncingResponse", value: query_10.GetSyncingResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        validator({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.Validator", value: query_11.Validator.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestBlockRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestBlockRequest", value: query_12.GetLatestBlockRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        proofOp({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ProofOp", value: query_13.ProofOp.fromPartial(value) };
            }
            catch (e) {
        ...
        getValidatorSetByHeightRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightRequest", value: query_14.GetValidatorSetByHeightRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestBlockResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestBlockResponse", value: query_16.GetLatestBlockResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getValidatorSetByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightResponse", value: query_18.GetValidatorSetByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        module({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.Module", value: query_19.Module.fromPartial(value) };
            }
            catch (e) {
