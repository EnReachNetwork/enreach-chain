...
exports.queryClient = exports.txClient = exports.registry = exports.ProofOps = exports.Validator = exports.ProofOp = exports.ABCIQueryRequest = exports.GetLatestBlockResponse = exports.GetBlockByHeightResponse = exports.GetSyncingRequest = exports.Module = exports.GetValidatorSetByHeightRequest = exports.Header = exports.ABCIQueryResponse = exports.GetLatestValidatorSetRequest = exports.GetValidatorSetByHeightResponse = exports.GetLatestValidatorSetResponse = exports.Block = exports.GetLatestBlockRequest = exports.GetBlockByHeightRequest = exports.GetSyncingResponse = exports.GetNodeInfoRequest = exports.VersionInfo = exports.GetNodeInfoResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetNodeInfoResponse", { enumerable: true, get: function () { return query_1.GetNodeInfoResponse; } });
...
Object.defineProperty(exports, "GetNodeInfoRequest", { enumerable: true, get: function () { return query_3.GetNodeInfoRequest; } });
const query_4 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetSyncingResponse", { enumerable: true, get: function () { return query_4.GetSyncingResponse; } });
const query_5 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetBlockByHeightRequest", { enumerable: true, get: function () { return query_5.GetBlockByHeightRequest; } });
...
Object.defineProperty(exports, "GetValidatorSetByHeightResponse", { enumerable: true, get: function () { return query_8.GetValidatorSetByHeightResponse; } });
const query_9 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestValidatorSetRequest", { enumerable: true, get: function () { return query_9.GetLatestValidatorSetRequest; } });
const query_10 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "ABCIQueryResponse", { enumerable: true, get: function () { return query_10.ABCIQueryResponse; } });
...
Object.defineProperty(exports, "GetBlockByHeightResponse", { enumerable: true, get: function () { return query_14.GetBlockByHeightResponse; } });
const query_15 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestBlockResponse", { enumerable: true, get: function () { return query_15.GetLatestBlockResponse; } });
const query_16 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "ABCIQueryRequest", { enumerable: true, get: function () { return query_16.ABCIQueryRequest; } });
const query_17 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "ProofOp", { enumerable: true, get: function () { return query_17.ProofOp; } });
const query_18 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "Validator", { enumerable: true, get: function () { return query_18.Validator; } });
    ...
    return {
        async sendGetNodeInfoResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.getNodeInfoResponse({ value: query_1.GetNodeInfoResponse.fromPartial(value) });
        ...
        async sendVersionInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.versionInfo({ value: query_2.VersionInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetNodeInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getNodeInfoRequest({ value: query_3.GetNodeInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetSyncingResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getSyncingResponse({ value: query_4.GetSyncingResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockByHeightRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockByHeightRequest({ value: query_5.GetBlockByHeightRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetValidatorSetByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getValidatorSetByHeightResponse({ value: query_8.GetValidatorSetByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestValidatorSetRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestValidatorSetRequest({ value: query_9.GetLatestValidatorSetRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendABCIQueryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.abciqueryResponse({ value: query_10.ABCIQueryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockByHeightResponse({ value: query_14.GetBlockByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestBlockResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestBlockResponse({ value: query_15.GetLatestBlockResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendABCIQueryRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.abciqueryRequest({ value: query_16.ABCIQueryRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProofOp({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proofOp({ value: query_17.ProofOp.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendValidator({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validator({ value: query_18.Validator.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        getNodeInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetNodeInfoResponse", value: query_1.GetNodeInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        versionInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.VersionInfo", value: query_2.VersionInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        getNodeInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetNodeInfoRequest", value: query_3.GetNodeInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getSyncingResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetSyncingResponse", value: query_4.GetSyncingResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockByHeightRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetBlockByHeightRequest", value: query_5.GetBlockByHeightRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getValidatorSetByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightResponse", value: query_8.GetValidatorSetByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestValidatorSetRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestValidatorSetRequest", value: query_9.GetLatestValidatorSetRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        abciqueryResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ABCIQueryResponse", value: query_10.ABCIQueryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse", value: query_14.GetBlockByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestBlockResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestBlockResponse", value: query_15.GetLatestBlockResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        abciqueryRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ABCIQueryRequest", value: query_16.ABCIQueryRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        proofOp({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ProofOp", value: query_17.ProofOp.fromPartial(value) };
            }
            catch (e) {
        ...
        validator({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.Validator", value: query_18.Validator.fromPartial(value) };
            }
            catch (e) {
