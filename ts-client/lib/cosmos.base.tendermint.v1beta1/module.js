...
exports.queryClient = exports.txClient = exports.registry = exports.Module = exports.GetLatestValidatorSetResponse = exports.GetLatestValidatorSetRequest = exports.GetValidatorSetByHeightRequest = exports.ABCIQueryResponse = exports.Block = exports.ProofOps = exports.VersionInfo = exports.GetNodeInfoResponse = exports.GetSyncingRequest = exports.GetBlockByHeightRequest = exports.ABCIQueryRequest = exports.GetBlockByHeightResponse = exports.ProofOp = exports.GetSyncingResponse = exports.GetNodeInfoRequest = exports.GetValidatorSetByHeightResponse = exports.Header = exports.GetLatestBlockResponse = exports.GetLatestBlockRequest = exports.Validator = void 0;
...
Object.defineProperty(exports, "GetLatestBlockRequest", { enumerable: true, get: function () { return query_2.GetLatestBlockRequest; } });
...
Object.defineProperty(exports, "GetNodeInfoRequest", { enumerable: true, get: function () { return query_5.GetNodeInfoRequest; } });
...
Object.defineProperty(exports, "ProofOp", { enumerable: true, get: function () { return query_7.ProofOp; } });
const query_8 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetBlockByHeightResponse", { enumerable: true, get: function () { return query_8.GetBlockByHeightResponse; } });
...
Object.defineProperty(exports, "GetNodeInfoResponse", { enumerable: true, get: function () { return query_12.GetNodeInfoResponse; } });
...
Object.defineProperty(exports, "GetLatestValidatorSetRequest", { enumerable: true, get: function () { return query_17.GetLatestValidatorSetRequest; } });
    ...
    return {
        async sendValidator({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.validator({ value: query_1.Validator.fromPartial(value) });
        ...
        async sendGetLatestBlockRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestBlockRequest({ value: query_2.GetLatestBlockRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetNodeInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getNodeInfoRequest({ value: query_5.GetNodeInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProofOp({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proofOp({ value: query_7.ProofOp.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockByHeightResponse({ value: query_8.GetBlockByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetNodeInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getNodeInfoResponse({ value: query_12.GetNodeInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestValidatorSetRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestValidatorSetRequest({ value: query_17.GetLatestValidatorSetRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        validator({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.Validator", value: query_1.Validator.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestBlockRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestBlockRequest", value: query_2.GetLatestBlockRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getNodeInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetNodeInfoRequest", value: query_5.GetNodeInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        proofOp({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ProofOp", value: query_7.ProofOp.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse", value: query_8.GetBlockByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getNodeInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetNodeInfoResponse", value: query_12.GetNodeInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestValidatorSetRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestValidatorSetRequest", value: query_17.GetLatestValidatorSetRequest.fromPartial(value) };
            }
            catch (e) {
