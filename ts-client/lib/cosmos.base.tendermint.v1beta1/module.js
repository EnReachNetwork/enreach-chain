...
exports.queryClient = exports.txClient = exports.registry = exports.GetBlockByHeightRequest = exports.ABCIQueryRequest = exports.GetNodeInfoRequest = exports.GetLatestBlockResponse = exports.GetSyncingResponse = exports.Module = exports.GetValidatorSetByHeightResponse = exports.Header = exports.ProofOp = exports.ABCIQueryResponse = exports.Block = exports.VersionInfo = exports.ProofOps = exports.GetLatestBlockRequest = exports.GetBlockByHeightResponse = exports.Validator = exports.GetValidatorSetByHeightRequest = exports.GetLatestValidatorSetResponse = exports.GetSyncingRequest = exports.GetNodeInfoResponse = exports.GetLatestValidatorSetRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestValidatorSetRequest", { enumerable: true, get: function () { return query_1.GetLatestValidatorSetRequest; } });
...
Object.defineProperty(exports, "GetLatestValidatorSetResponse", { enumerable: true, get: function () { return query_4.GetLatestValidatorSetResponse; } });
...
Object.defineProperty(exports, "Validator", { enumerable: true, get: function () { return query_6.Validator; } });
const query_7 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetBlockByHeightResponse", { enumerable: true, get: function () { return query_7.GetBlockByHeightResponse; } });
...
Object.defineProperty(exports, "VersionInfo", { enumerable: true, get: function () { return query_10.VersionInfo; } });
...
Object.defineProperty(exports, "ProofOp", { enumerable: true, get: function () { return query_12.ProofOp; } });
...
Object.defineProperty(exports, "GetValidatorSetByHeightResponse", { enumerable: true, get: function () { return query_13.GetValidatorSetByHeightResponse; } });
...
Object.defineProperty(exports, "ABCIQueryRequest", { enumerable: true, get: function () { return query_18.ABCIQueryRequest; } });
const query_19 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetBlockByHeightRequest", { enumerable: true, get: function () { return query_19.GetBlockByHeightRequest; } });
    ...
    return {
        async sendGetLatestValidatorSetRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.getLatestValidatorSetRequest({ value: query_1.GetLatestValidatorSetRequest.fromPartial(value) });
        ...
        async sendGetLatestValidatorSetResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestValidatorSetResponse({ value: query_4.GetLatestValidatorSetResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendValidator({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.validator({ value: query_6.Validator.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockByHeightResponse({ value: query_7.GetBlockByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersionInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.versionInfo({ value: query_10.VersionInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProofOp({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proofOp({ value: query_12.ProofOp.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetValidatorSetByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getValidatorSetByHeightResponse({ value: query_13.GetValidatorSetByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendABCIQueryRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.abciqueryRequest({ value: query_18.ABCIQueryRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetBlockByHeightRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getBlockByHeightRequest({ value: query_19.GetBlockByHeightRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        getLatestValidatorSetRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestValidatorSetRequest", value: query_1.GetLatestValidatorSetRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestValidatorSetResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestValidatorSetResponse", value: query_4.GetLatestValidatorSetResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        validator({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.Validator", value: query_6.Validator.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse", value: query_7.GetBlockByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        versionInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.VersionInfo", value: query_10.VersionInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        proofOp({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ProofOp", value: query_12.ProofOp.fromPartial(value) };
            }
            catch (e) {
        ...
        getValidatorSetByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightResponse", value: query_13.GetValidatorSetByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        abciqueryRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ABCIQueryRequest", value: query_18.ABCIQueryRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getBlockByHeightRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetBlockByHeightRequest", value: query_19.GetBlockByHeightRequest.fromPartial(value) };
            }
            catch (e) {
