...
exports.queryClient = exports.txClient = exports.registry = exports.GetLatestBlockRequest = exports.ProofOp = exports.GetNodeInfoRequest = exports.GetLatestValidatorSetRequest = exports.GetValidatorSetByHeightRequest = exports.ProofOps = exports.GetBlockByHeightResponse = exports.Block = exports.VersionInfo = exports.GetLatestValidatorSetResponse = exports.GetSyncingRequest = exports.Module = exports.GetSyncingResponse = exports.Validator = exports.Header = exports.ABCIQueryResponse = exports.GetLatestBlockResponse = exports.GetValidatorSetByHeightResponse = exports.ABCIQueryRequest = exports.GetNodeInfoResponse = exports.GetBlockByHeightRequest = void 0;
...
Object.defineProperty(exports, "ABCIQueryRequest", { enumerable: true, get: function () { return query_3.ABCIQueryRequest; } });
const query_4 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetValidatorSetByHeightResponse", { enumerable: true, get: function () { return query_4.GetValidatorSetByHeightResponse; } });
const query_5 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetLatestBlockResponse", { enumerable: true, get: function () { return query_5.GetLatestBlockResponse; } });
const query_6 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "ABCIQueryResponse", { enumerable: true, get: function () { return query_6.ABCIQueryResponse; } });
...
Object.defineProperty(exports, "GetSyncingResponse", { enumerable: true, get: function () { return query_8.GetSyncingResponse; } });
const query_9 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "Module", { enumerable: true, get: function () { return query_9.Module; } });
const query_10 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetSyncingRequest", { enumerable: true, get: function () { return query_10.GetSyncingRequest; } });
...
Object.defineProperty(exports, "VersionInfo", { enumerable: true, get: function () { return query_12.VersionInfo; } });
...
Object.defineProperty(exports, "ProofOps", { enumerable: true, get: function () { return query_14.ProofOps; } });
const query_15 = require("./types/cosmos/base/tendermint/v1beta1/query");
Object.defineProperty(exports, "GetValidatorSetByHeightRequest", { enumerable: true, get: function () { return query_15.GetValidatorSetByHeightRequest; } });
...
Object.defineProperty(exports, "GetLatestBlockRequest", { enumerable: true, get: function () { return query_19.GetLatestBlockRequest; } });
    ...
    return {
        ...
        async sendABCIQueryRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.abciqueryRequest({ value: query_3.ABCIQueryRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetValidatorSetByHeightResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getValidatorSetByHeightResponse({ value: query_4.GetValidatorSetByHeightResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestBlockResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestBlockResponse({ value: query_5.GetLatestBlockResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendABCIQueryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.abciqueryResponse({ value: query_6.ABCIQueryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetSyncingResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getSyncingResponse({ value: query_8.GetSyncingResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModule({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.module({ value: query_9.Module.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetSyncingRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getSyncingRequest({ value: query_10.GetSyncingRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersionInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.versionInfo({ value: query_12.VersionInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProofOps({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proofOps({ value: query_14.ProofOps.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetValidatorSetByHeightRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getValidatorSetByHeightRequest({ value: query_15.GetValidatorSetByHeightRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGetLatestBlockRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.getLatestBlockRequest({ value: query_19.GetLatestBlockRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        abciqueryRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ABCIQueryRequest", value: query_3.ABCIQueryRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getValidatorSetByHeightResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightResponse", value: query_4.GetValidatorSetByHeightResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestBlockResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestBlockResponse", value: query_5.GetLatestBlockResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        abciqueryResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ABCIQueryResponse", value: query_6.ABCIQueryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        getSyncingResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetSyncingResponse", value: query_8.GetSyncingResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        module({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.Module", value: query_9.Module.fromPartial(value) };
            }
            catch (e) {
        ...
        getSyncingRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetSyncingRequest", value: query_10.GetSyncingRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        versionInfo({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.VersionInfo", value: query_12.VersionInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        proofOps({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.ProofOps", value: query_14.ProofOps.fromPartial(value) };
            }
            catch (e) {
        ...
        getValidatorSetByHeightRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightRequest", value: query_15.GetValidatorSetByHeightRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        getLatestBlockRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.base.tendermint.v1beta1.GetLatestBlockRequest", value: query_19.GetLatestBlockRequest.fromPartial(value) };
            }
            catch (e) {
