...
const msgTypes = [
    ["/cosmos.gov.v1.MsgCancelProposal", tx_1.MsgCancelProposal],
    ["/cosmos.gov.v1.MsgCancelProposalResponse", tx_2.MsgCancelProposalResponse],
    ...
    ["/cosmos.gov.v1.MsgExecLegacyContent", tx_4.MsgExecLegacyContent],
    ...
    ["/cosmos.gov.v1.QueryVoteRequest", query_2.QueryVoteRequest],
    ["/cosmos.gov.v1.QueryVoteResponse", query_3.QueryVoteResponse],
    ["/cosmos.gov.v1.WeightedVoteOption", gov_3.WeightedVoteOption],
    ["/cosmos.gov.v1.MsgDeposit", tx_8.MsgDeposit],
    ["/cosmos.gov.v1.MsgUpdateParamsResponse", tx_9.MsgUpdateParamsResponse],
    ["/cosmos.gov.v1.QueryConstitutionRequest", query_4.QueryConstitutionRequest],
    ...
    ["/cosmos.gov.v1.MsgSubmitProposalResponse", tx_11.MsgSubmitProposalResponse],
    ["/cosmos.gov.v1.MsgVote", tx_12.MsgVote],
    ["/cosmos.gov.v1.QueryProposalRequest", query_10.QueryProposalRequest],
    ["/cosmos.gov.v1.QueryVotesRequest", query_11.QueryVotesRequest],
    ["/cosmos.gov.v1.QueryTallyResultRequest", query_12.QueryTallyResultRequest],
    ["/cosmos.gov.v1.GenesisState", genesis_1.GenesisState],
    ["/cosmos.gov.v1.QueryParamsRequest", query_13.QueryParamsRequest],
    ["/cosmos.gov.v1.TallyParams", gov_4.TallyParams],
    ...
    ["/cosmos.gov.v1.QueryProposalsRequest", query_18.QueryProposalsRequest],
];
