...
const msgTypes = [
    ["/cosmos.gov.v1.QueryProposalsResponse", query_1.QueryProposalsResponse],
    ["/cosmos.gov.v1.QueryVotesRequest", query_2.QueryVotesRequest],
    ...
    ["/cosmos.gov.v1.WeightedVoteOption", gov_1.WeightedVoteOption],
    ["/cosmos.gov.v1.MsgCancelProposalResponse", tx_3.MsgCancelProposalResponse],
    ...
    ["/cosmos.gov.v1.Vote", gov_4.Vote],
    ["/cosmos.gov.v1.QueryVoteResponse", query_4.QueryVoteResponse],
    ["/cosmos.gov.v1.TallyParams", gov_5.TallyParams],
    ["/cosmos.gov.v1.QueryProposalRequest", query_5.QueryProposalRequest],
    ["/cosmos.gov.v1.QueryVotesResponse", query_6.QueryVotesResponse],
    ...
    ["/cosmos.gov.v1.QueryConstitutionRequest", query_9.QueryConstitutionRequest],
    ...
    ["/cosmos.gov.v1.QueryTallyResultResponse", query_16.QueryTallyResultResponse],
    ...
    ["/cosmos.gov.v1.QueryVoteRequest", query_18.QueryVoteRequest],
    ["/cosmos.gov.v1.MsgSubmitProposal", tx_14.MsgSubmitProposal],
];
