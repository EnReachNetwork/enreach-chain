...
exports.queryClient = exports.txClient = exports.registry = exports.QueryConstitutionRequest = exports.QueryDepositsRequest = exports.Vote = exports.MsgVoteResponse = exports.QueryVotesRequest = exports.Params = exports.WeightedVoteOption = exports.MsgUpdateParamsResponse = exports.QueryParamsResponse = exports.TallyParams = exports.QueryTallyResultRequest = exports.QueryVoteRequest = exports.Proposal = exports.QueryProposalRequest = exports.MsgExecLegacyContent = exports.TallyResult = exports.QueryVoteResponse = exports.QueryProposalResponse = exports.DepositParams = exports.MsgVoteWeightedResponse = exports.MsgVoteWeighted = exports.QueryParamsRequest = exports.MsgCancelProposal = exports.MsgDeposit = exports.MsgVote = exports.QueryConstitutionResponse = exports.MsgUpdateParams = exports.QueryDepositResponse = exports.MsgCancelProposalResponse = exports.QueryProposalsRequest = exports.VotingParams = exports.MsgDepositResponse = exports.MsgExecLegacyContentResponse = exports.QueryDepositRequest = exports.QueryProposalsResponse = exports.QueryVotesResponse = exports.QueryDepositsResponse = exports.MsgSubmitProposal = exports.QueryTallyResultResponse = exports.Deposit = exports.GenesisState = exports.MsgSubmitProposalResponse = void 0;
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_2.QueryDepositsResponse; } });
...
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_5.QueryDepositRequest; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_6.QueryProposalsRequest; } });
const tx_5 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgCancelProposalResponse", { enumerable: true, get: function () { return tx_5.MsgCancelProposalResponse; } });
const query_7 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_7.QueryDepositResponse; } });
...
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_8.QueryConstitutionResponse; } });
...
Object.defineProperty(exports, "MsgVoteWeighted", { enumerable: true, get: function () { return tx_10.MsgVoteWeighted; } });
...
Object.defineProperty(exports, "QueryProposalResponse", { enumerable: true, get: function () { return query_10.QueryProposalResponse; } });
const query_11 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_11.QueryVoteResponse; } });
...
Object.defineProperty(exports, "MsgExecLegacyContent", { enumerable: true, get: function () { return tx_12.MsgExecLegacyContent; } });
...
Object.defineProperty(exports, "QueryTallyResultRequest", { enumerable: true, get: function () { return query_14.QueryTallyResultRequest; } });
const gov_6 = require("./types/cosmos/gov/v1/gov");
Object.defineProperty(exports, "TallyParams", { enumerable: true, get: function () { return gov_6.TallyParams; } });
...
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return gov_8.Params; } });
const query_16 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_16.QueryVotesRequest; } });
const tx_14 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgVoteResponse", { enumerable: true, get: function () { return tx_14.MsgVoteResponse; } });
...
Object.defineProperty(exports, "QueryConstitutionRequest", { enumerable: true, get: function () { return query_18.QueryConstitutionRequest; } });
    ...
    return {
        ...
        async sendQueryTallyResultResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTallyResultResponse({ value: query_1.QueryTallyResultResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_2.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_5.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_6.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposalResponse({ value: tx_5.MsgCancelProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_7.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_8.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeighted({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeighted({ value: tx_10.MsgVoteWeighted.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalResponse({ value: query_10.QueryProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_11.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContent({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContent({ value: tx_12.MsgExecLegacyContent.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTallyResultRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTallyResultRequest({ value: query_14.QueryTallyResultRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTallyParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyParams({ value: gov_6.TallyParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: gov_8.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_16.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteResponse({ value: tx_14.MsgVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionRequest({ value: query_18.QueryConstitutionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultResponse", value: query_1.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsResponse", value: query_2.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_5.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsRequest", value: query_6.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposalResponse", value: tx_5.MsgCancelProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositResponse", value: query_7.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_8.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVote", value: tx_7.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeighted({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeighted", value: tx_10.MsgVoteWeighted.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalResponse", value: query_10.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteResponse", value: query_11.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContent({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContent", value: tx_12.MsgExecLegacyContent.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_12.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_14.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyParams", value: gov_6.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.WeightedVoteOption", value: gov_7.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Params", value: gov_8.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_16.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteResponse", value: tx_14.MsgVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionRequest", value: query_18.QueryConstitutionRequest.fromPartial(value) };
            }
            catch (e) {
