...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDepositsRequest = exports.QueryTallyResultResponse = exports.MsgSubmitProposalResponse = exports.VotingParams = exports.Params = exports.WeightedVoteOption = exports.QueryDepositResponse = exports.QueryVotesResponse = exports.QueryVoteRequest = exports.QueryTallyResultRequest = exports.QueryVotesRequest = exports.QueryProposalResponse = exports.QueryConstitutionRequest = exports.MsgUpdateParams = exports.QueryDepositRequest = exports.TallyParams = exports.MsgVote = exports.MsgVoteWeightedResponse = exports.DepositParams = exports.MsgCancelProposal = exports.MsgDeposit = exports.MsgExecLegacyContentResponse = exports.MsgCancelProposalResponse = exports.MsgVoteWeighted = exports.QueryProposalRequest = exports.Deposit = exports.MsgUpdateParamsResponse = exports.QueryVoteResponse = exports.QueryParamsRequest = exports.QueryProposalsResponse = exports.QueryConstitutionResponse = exports.GenesisState = exports.Vote = exports.MsgVoteResponse = exports.QueryProposalsRequest = exports.TallyResult = exports.Proposal = exports.QueryDepositsResponse = exports.QueryParamsResponse = exports.MsgDepositResponse = exports.MsgExecLegacyContent = exports.MsgSubmitProposal = void 0;
...
Object.defineProperty(exports, "QueryProposalRequest", { enumerable: true, get: function () { return query_8.QueryProposalRequest; } });
...
Object.defineProperty(exports, "MsgCancelProposalResponse", { enumerable: true, get: function () { return tx_7.MsgCancelProposalResponse; } });
...
Object.defineProperty(exports, "MsgDeposit", { enumerable: true, get: function () { return tx_9.MsgDeposit; } });
...
Object.defineProperty(exports, "QueryConstitutionRequest", { enumerable: true, get: function () { return query_10.QueryConstitutionRequest; } });
...
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_12.QueryVotesRequest; } });
    ...
    return {
        ...
        async sendQueryProposalRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalRequest({ value: query_8.QueryProposalRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposalResponse({ value: tx_7.MsgCancelProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeposit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeposit({ value: tx_9.MsgDeposit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionRequest({ value: query_10.QueryConstitutionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_12.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsRequest", value: query_3.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_8.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposalResponse", value: tx_7.MsgCancelProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDeposit", value: tx_9.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionRequest", value: query_10.QueryConstitutionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_12.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteRequest", value: query_14.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposalResponse", value: tx_14.MsgSubmitProposalResponse.fromPartial(value) };
            }
            catch (e) {
