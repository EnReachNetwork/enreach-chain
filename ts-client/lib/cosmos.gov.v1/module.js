...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSubmitProposal = exports.QueryVoteRequest = exports.MsgUpdateParams = exports.VotingParams = exports.QueryConstitutionResponse = exports.Params = exports.MsgExecLegacyContentResponse = exports.MsgSubmitProposalResponse = exports.QueryTallyResultResponse = exports.QueryDepositResponse = exports.MsgUpdateParamsResponse = exports.QueryProposalsRequest = exports.QueryDepositsRequest = exports.MsgDepositResponse = exports.TallyResult = exports.MsgCancelProposal = exports.MsgVote = exports.QueryDepositRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.QueryConstitutionRequest = exports.DepositParams = exports.MsgDeposit = exports.MsgVoteWeighted = exports.QueryProposalResponse = exports.GenesisState = exports.QueryDepositsResponse = exports.QueryVotesResponse = exports.QueryProposalRequest = exports.TallyParams = exports.QueryVoteResponse = exports.Vote = exports.Proposal = exports.MsgVoteWeightedResponse = exports.Deposit = exports.MsgCancelProposalResponse = exports.WeightedVoteOption = exports.MsgVoteResponse = exports.MsgExecLegacyContent = exports.QueryTallyResultRequest = exports.QueryVotesRequest = exports.QueryProposalsResponse = void 0;
...
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_2.QueryVotesRequest; } });
const query_3 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryTallyResultRequest", { enumerable: true, get: function () { return query_3.QueryTallyResultRequest; } });
...
Object.defineProperty(exports, "MsgCancelProposalResponse", { enumerable: true, get: function () { return tx_3.MsgCancelProposalResponse; } });
...
Object.defineProperty(exports, "MsgVoteWeightedResponse", { enumerable: true, get: function () { return tx_4.MsgVoteWeightedResponse; } });
...
Object.defineProperty(exports, "Vote", { enumerable: true, get: function () { return gov_4.Vote; } });
...
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_6.QueryVotesResponse; } });
...
Object.defineProperty(exports, "QueryConstitutionRequest", { enumerable: true, get: function () { return query_9.QueryConstitutionRequest; } });
...
Object.defineProperty(exports, "MsgCancelProposal", { enumerable: true, get: function () { return tx_8.MsgCancelProposal; } });
...
Object.defineProperty(exports, "MsgDepositResponse", { enumerable: true, get: function () { return tx_9.MsgDepositResponse; } });
const query_13 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositsRequest", { enumerable: true, get: function () { return query_13.QueryDepositsRequest; } });
const query_14 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_14.QueryProposalsRequest; } });
...
Object.defineProperty(exports, "QueryVoteRequest", { enumerable: true, get: function () { return query_18.QueryVoteRequest; } });
    ...
    return {
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryProposalsResponse({ value: query_1.QueryProposalsResponse.fromPartial(value) });
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_2.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTallyResultRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTallyResultRequest({ value: query_3.QueryTallyResultRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposalResponse({ value: tx_3.MsgCancelProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeightedResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeightedResponse({ value: tx_4.MsgVoteWeightedResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVote({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.vote({ value: gov_4.Vote.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_6.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionRequest({ value: query_9.QueryConstitutionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposal({ value: tx_8.MsgCancelProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDepositResponse({ value: tx_9.MsgDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsRequest({ value: query_13.QueryDepositsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_14.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteRequest({ value: query_18.QueryVoteRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsResponse", value: query_1.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_2.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_3.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.WeightedVoteOption", value: gov_1.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposalResponse", value: tx_3.MsgCancelProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_4.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Vote", value: gov_4.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_5.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_6.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsResponse", value: query_7.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionRequest", value: query_9.QueryConstitutionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsRequest", value: query_10.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsResponse", value: query_11.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposal", value: tx_8.MsgCancelProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDepositResponse", value: tx_9.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsRequest", value: query_13.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsRequest", value: query_14.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParamsResponse", value: tx_10.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultResponse", value: query_16.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        votingParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.VotingParams", value: gov_9.VotingParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParams", value: tx_13.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteRequest", value: query_18.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposal", value: tx_14.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
