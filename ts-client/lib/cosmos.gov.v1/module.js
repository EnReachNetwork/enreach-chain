...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.MsgVoteWeighted = exports.QueryProposalsResponse = exports.MsgCancelProposalResponse = exports.MsgVoteWeightedResponse = exports.MsgExecLegacyContentResponse = exports.QueryTallyResultResponse = exports.QueryDepositsRequest = exports.QueryVoteRequest = exports.MsgVote = exports.QueryParamsRequest = exports.TallyParams = exports.VotingParams = exports.Proposal = exports.MsgUpdateParamsResponse = exports.QueryTallyResultRequest = exports.QueryParamsResponse = exports.QueryProposalResponse = exports.QueryDepositsResponse = exports.QueryDepositRequest = exports.QueryVotesRequest = exports.QueryConstitutionRequest = exports.MsgExecLegacyContent = exports.TallyResult = exports.MsgDepositResponse = exports.QueryDepositResponse = exports.WeightedVoteOption = exports.QueryVotesResponse = exports.QueryVoteResponse = exports.DepositParams = exports.Vote = exports.MsgSubmitProposal = exports.MsgDeposit = exports.MsgSubmitProposalResponse = exports.Params = exports.MsgCancelProposal = exports.QueryProposalRequest = exports.MsgVoteResponse = exports.QueryProposalsRequest = exports.QueryConstitutionResponse = exports.Deposit = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_1.QueryConstitutionResponse; } });
...
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_5.QueryVotesResponse; } });
...
Object.defineProperty(exports, "MsgExecLegacyContent", { enumerable: true, get: function () { return tx_7.MsgExecLegacyContent; } });
...
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_8.QueryVotesRequest; } });
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_10.QueryDepositsResponse; } });
...
Object.defineProperty(exports, "MsgVote", { enumerable: true, get: function () { return tx_9.MsgVote; } });
const query_15 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryVoteRequest", { enumerable: true, get: function () { return query_15.QueryVoteRequest; } });
const query_16 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositsRequest", { enumerable: true, get: function () { return query_16.QueryDepositsRequest; } });
...
Object.defineProperty(exports, "MsgExecLegacyContentResponse", { enumerable: true, get: function () { return tx_10.MsgExecLegacyContentResponse; } });
const tx_11 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgVoteWeightedResponse", { enumerable: true, get: function () { return tx_11.MsgVoteWeightedResponse; } });
...
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_18.QueryProposalsResponse; } });
const tx_13 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgVoteWeighted", { enumerable: true, get: function () { return tx_13.MsgVoteWeighted; } });
    ...
    return {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_1.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_5.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContent({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContent({ value: tx_7.MsgExecLegacyContent.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_8.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_10.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVote({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVote({ value: tx_9.MsgVote.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteRequest({ value: query_15.QueryVoteRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsRequest({ value: query_16.QueryDepositsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContentResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContentResponse({ value: tx_10.MsgExecLegacyContentResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeightedResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeightedResponse({ value: tx_11.MsgVoteWeightedResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_18.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeighted({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeighted({ value: tx_13.MsgVoteWeighted.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        deposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Deposit", value: gov_1.Deposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_1.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_3.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposal", value: tx_5.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_5.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyResult", value: gov_6.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContent({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContent", value: tx_7.MsgExecLegacyContent.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_8.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsResponse", value: query_10.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalResponse", value: query_11.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_13.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVote", value: tx_9.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteRequest", value: query_15.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsRequest", value: query_16.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContentResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContentResponse", value: tx_10.MsgExecLegacyContentResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_11.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsResponse", value: query_18.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeighted({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeighted", value: tx_13.MsgVoteWeighted.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParams", value: tx_14.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
