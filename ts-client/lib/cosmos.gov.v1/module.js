...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDepositsResponse = exports.WeightedVoteOption = exports.QueryParamsRequest = exports.VotingParams = exports.MsgVoteWeighted = exports.QueryTallyResultRequest = exports.QueryProposalResponse = exports.QueryDepositResponse = exports.MsgVoteResponse = exports.TallyParams = exports.DepositParams = exports.MsgCancelProposalResponse = exports.MsgCancelProposal = exports.MsgUpdateParamsResponse = exports.Vote = exports.QueryVoteResponse = exports.QueryProposalsRequest = exports.QueryConstitutionResponse = exports.MsgUpdateParams = exports.MsgVoteWeightedResponse = exports.QueryTallyResultResponse = exports.QueryVotesRequest = exports.QueryVoteRequest = exports.QueryDepositsRequest = exports.QueryParamsResponse = exports.QueryProposalsResponse = exports.MsgDeposit = exports.MsgExecLegacyContentResponse = exports.Params = exports.MsgDepositResponse = exports.MsgVote = exports.QueryVotesResponse = exports.QueryConstitutionRequest = exports.MsgSubmitProposal = exports.MsgExecLegacyContent = exports.TallyResult = exports.QueryDepositRequest = exports.MsgSubmitProposalResponse = exports.Proposal = exports.GenesisState = exports.Deposit = exports.QueryProposalRequest = void 0;
...
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_2.QueryDepositRequest; } });
...
Object.defineProperty(exports, "QueryConstitutionRequest", { enumerable: true, get: function () { return query_3.QueryConstitutionRequest; } });
const query_4 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_4.QueryVotesResponse; } });
const tx_4 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgVote", { enumerable: true, get: function () { return tx_4.MsgVote; } });
...
Object.defineProperty(exports, "MsgExecLegacyContentResponse", { enumerable: true, get: function () { return tx_6.MsgExecLegacyContentResponse; } });
...
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_11.QueryConstitutionResponse; } });
const query_12 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_12.QueryProposalsRequest; } });
const query_13 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_13.QueryVoteResponse; } });
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_14.QueryDepositResponse; } });
...
Object.defineProperty(exports, "QueryParamsRequest", { enumerable: true, get: function () { return query_17.QueryParamsRequest; } });
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_18.QueryDepositsResponse; } });
    ...
    return {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_2.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionRequest({ value: query_3.QueryConstitutionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_4.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVote({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVote({ value: tx_4.MsgVote.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContentResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContentResponse({ value: tx_6.MsgExecLegacyContentResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_11.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_12.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_13.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_14.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryParamsRequest({ value: query_17.QueryParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_18.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_1.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Proposal", value: gov_2.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_2.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyResult", value: gov_3.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionRequest", value: query_3.QueryConstitutionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_4.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVote", value: tx_4.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContentResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContentResponse", value: tx_6.MsgExecLegacyContentResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_8.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_11.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsRequest", value: query_12.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteResponse", value: query_13.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositResponse", value: query_14.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_16.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsRequest", value: query_17.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsResponse", value: query_18.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
