...
exports.queryClient = exports.txClient = exports.registry = exports.QueryProposalResponse = exports.Proposal = exports.QueryDepositRequest = exports.QueryProposalsResponse = exports.QueryConstitutionResponse = exports.MsgVoteWeightedResponse = exports.Vote = exports.MsgDeposit = exports.DepositParams = exports.MsgVote = exports.MsgExecLegacyContentResponse = exports.QueryProposalRequest = exports.QueryConstitutionRequest = exports.MsgUpdateParams = exports.QueryParamsResponse = exports.Deposit = exports.QueryTallyResultRequest = exports.MsgCancelProposalResponse = exports.MsgSubmitProposal = exports.WeightedVoteOption = exports.QueryTallyResultResponse = exports.QueryVotesRequest = exports.GenesisState = exports.QueryVoteRequest = exports.MsgUpdateParamsResponse = exports.QueryDepositsRequest = exports.QueryVoteResponse = exports.MsgDepositResponse = exports.MsgVoteWeighted = exports.TallyResult = exports.QueryDepositResponse = exports.QueryProposalsRequest = exports.QueryVotesResponse = exports.MsgVoteResponse = exports.MsgSubmitProposalResponse = exports.QueryParamsRequest = exports.MsgCancelProposal = exports.QueryDepositsResponse = exports.VotingParams = exports.Params = exports.TallyParams = exports.MsgExecLegacyContent = void 0;
...
Object.defineProperty(exports, "MsgCancelProposal", { enumerable: true, get: function () { return tx_2.MsgCancelProposal; } });
...
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_3.QueryVotesResponse; } });
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_5.QueryDepositResponse; } });
...
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_6.QueryVoteResponse; } });
const query_7 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositsRequest", { enumerable: true, get: function () { return query_7.QueryDepositsRequest; } });
...
Object.defineProperty(exports, "QueryVoteRequest", { enumerable: true, get: function () { return query_8.QueryVoteRequest; } });
...
Object.defineProperty(exports, "WeightedVoteOption", { enumerable: true, get: function () { return gov_5.WeightedVoteOption; } });
const tx_8 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgSubmitProposal", { enumerable: true, get: function () { return tx_8.MsgSubmitProposal; } });
...
Object.defineProperty(exports, "QueryTallyResultRequest", { enumerable: true, get: function () { return query_11.QueryTallyResultRequest; } });
...
Object.defineProperty(exports, "MsgExecLegacyContentResponse", { enumerable: true, get: function () { return tx_11.MsgExecLegacyContentResponse; } });
...
Object.defineProperty(exports, "MsgDeposit", { enumerable: true, get: function () { return tx_13.MsgDeposit; } });
...
Object.defineProperty(exports, "MsgVoteWeightedResponse", { enumerable: true, get: function () { return tx_14.MsgVoteWeightedResponse; } });
const query_15 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_15.QueryConstitutionResponse; } });
const query_16 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_16.QueryProposalsResponse; } });
const query_17 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_17.QueryDepositRequest; } });
const gov_9 = require("./types/cosmos/gov/v1/gov");
Object.defineProperty(exports, "Proposal", { enumerable: true, get: function () { return gov_9.Proposal; } });
    ...
    return {
        async sendMsgExecLegacyContent({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgExecLegacyContent({ value: tx_1.MsgExecLegacyContent.fromPartial(value) });
        ...
        async sendTallyParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyParams({ value: gov_1.TallyParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposal({ value: tx_2.MsgCancelProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_3.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_5.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTallyResult({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyResult({ value: gov_4.TallyResult.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_6.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsRequest({ value: query_7.QueryDepositsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteRequest({ value: query_8.QueryVoteRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendWeightedVoteOption({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.weightedVoteOption({ value: gov_5.WeightedVoteOption.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitProposal({ value: tx_8.MsgSubmitProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTallyResultRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTallyResultRequest({ value: query_11.QueryTallyResultRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContentResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContentResponse({ value: tx_11.MsgExecLegacyContentResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeposit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeposit({ value: tx_13.MsgDeposit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeightedResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeightedResponse({ value: tx_14.MsgVoteWeightedResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_15.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_16.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_17.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proposal({ value: gov_9.Proposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgExecLegacyContent({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContent", value: tx_1.MsgExecLegacyContent.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyParams", value: gov_1.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        votingParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.VotingParams", value: gov_3.VotingParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposal", value: tx_2.MsgCancelProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_3.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositResponse", value: query_5.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyResult", value: gov_4.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteResponse", value: query_6.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsRequest", value: query_7.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteRequest", value: query_8.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_9.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.WeightedVoteOption", value: gov_5.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposal", value: tx_8.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_11.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsResponse", value: query_12.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContentResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContentResponse", value: tx_11.MsgExecLegacyContentResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        depositParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.DepositParams", value: gov_7.DepositParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDeposit", value: tx_13.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Vote", value: gov_8.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_14.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_15.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsResponse", value: query_16.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_17.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Proposal", value: gov_9.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalResponse", value: query_18.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
