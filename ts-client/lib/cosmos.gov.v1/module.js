...
exports.queryClient = exports.txClient = exports.registry = exports.WeightedVoteOption = exports.QueryConstitutionRequest = exports.QueryProposalsResponse = exports.QueryProposalsRequest = exports.QueryProposalRequest = exports.MsgExecLegacyContentResponse = exports.MsgUpdateParamsResponse = exports.MsgVote = exports.QueryTallyResultResponse = exports.QueryDepositsRequest = exports.QueryVotesResponse = exports.MsgVoteResponse = exports.TallyParams = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.QueryProposalResponse = exports.MsgSubmitProposal = exports.QueryDepositsResponse = exports.QueryVotesRequest = exports.Proposal = exports.MsgSubmitProposalResponse = exports.DepositParams = exports.MsgDeposit = exports.GenesisState = exports.QueryConstitutionResponse = exports.QueryVoteResponse = exports.MsgExecLegacyContent = exports.MsgCancelProposalResponse = exports.MsgCancelProposal = exports.MsgUpdateParams = exports.MsgVoteWeighted = exports.Vote = exports.VotingParams = exports.Params = exports.MsgDepositResponse = exports.QueryDepositRequest = exports.Deposit = exports.MsgVoteWeightedResponse = exports.TallyResult = exports.QueryTallyResultRequest = exports.QueryDepositResponse = exports.QueryVoteRequest = void 0;
...
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_4.QueryDepositRequest; } });
const tx_2 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgDepositResponse", { enumerable: true, get: function () { return tx_2.MsgDepositResponse; } });
const gov_3 = require("./types/cosmos/gov/v1/gov");
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return gov_3.Params; } });
...
Object.defineProperty(exports, "MsgCancelProposal", { enumerable: true, get: function () { return tx_5.MsgCancelProposal; } });
const tx_6 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgCancelProposalResponse", { enumerable: true, get: function () { return tx_6.MsgCancelProposalResponse; } });
...
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_6.QueryConstitutionResponse; } });
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_8.QueryDepositsResponse; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_16.QueryProposalsRequest; } });
const query_17 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_17.QueryProposalsResponse; } });
    ...
    return {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_4.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDepositResponse({ value: tx_2.MsgDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: gov_3.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposal({ value: tx_5.MsgCancelProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposalResponse({ value: tx_6.MsgCancelProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_6.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_8.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_16.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_17.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_4.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDepositResponse", value: tx_2.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Params", value: gov_3.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposal", value: tx_5.MsgCancelProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposalResponse", value: tx_6.MsgCancelProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_6.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposalResponse", value: tx_9.MsgSubmitProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsResponse", value: query_8.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalResponse", value: query_9.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_12.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsRequest", value: query_16.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsResponse", value: query_17.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
