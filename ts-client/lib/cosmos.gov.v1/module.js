...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelProposalResponse = exports.MsgCancelProposal = exports.MsgExecLegacyContentResponse = exports.TallyParams = exports.TallyResult = exports.QueryTallyResultRequest = exports.QueryProposalsRequest = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.Params = exports.WeightedVoteOption = exports.MsgSubmitProposal = exports.Vote = exports.QueryDepositResponse = exports.MsgDeposit = exports.MsgVoteWeighted = exports.QueryVotesResponse = exports.MsgVoteWeightedResponse = exports.VotingParams = exports.QueryVotesRequest = exports.QueryProposalResponse = exports.QueryConstitutionResponse = exports.GenesisState = exports.QueryDepositRequest = exports.MsgDepositResponse = exports.DepositParams = exports.QueryTallyResultResponse = exports.QueryProposalsResponse = exports.MsgVoteResponse = exports.MsgSubmitProposalResponse = exports.Deposit = exports.QueryParamsRequest = exports.QueryProposalRequest = exports.QueryConstitutionRequest = exports.QueryParamsResponse = exports.QueryVoteResponse = exports.QueryVoteRequest = exports.MsgExecLegacyContent = exports.QueryDepositsRequest = exports.Proposal = exports.QueryDepositsResponse = exports.MsgVote = void 0;
...
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_4.QueryVoteResponse; } });
...
Object.defineProperty(exports, "QueryConstitutionRequest", { enumerable: true, get: function () { return query_6.QueryConstitutionRequest; } });
...
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_9.QueryProposalsResponse; } });
...
Object.defineProperty(exports, "DepositParams", { enumerable: true, get: function () { return gov_3.DepositParams; } });
...
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_11.QueryDepositRequest; } });
...
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_12.QueryConstitutionResponse; } });
...
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_14.QueryVotesRequest; } });
...
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return gov_7.Params; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_17.QueryProposalsRequest; } });
const query_18 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryTallyResultRequest", { enumerable: true, get: function () { return query_18.QueryTallyResultRequest; } });
...
Object.defineProperty(exports, "MsgCancelProposal", { enumerable: true, get: function () { return tx_13.MsgCancelProposal; } });
const tx_14 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgCancelProposalResponse", { enumerable: true, get: function () { return tx_14.MsgCancelProposalResponse; } });
    ...
    return {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_4.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionRequest({ value: query_6.QueryConstitutionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_9.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDepositParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.depositParams({ value: gov_3.DepositParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_11.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_12.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_14.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: gov_7.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_17.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTallyResultRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTallyResultRequest({ value: query_18.QueryTallyResultRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTallyParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyParams({ value: gov_9.TallyParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposal({ value: tx_13.MsgCancelProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposalResponse({ value: tx_14.MsgCancelProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Proposal", value: gov_1.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsRequest", value: query_2.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteResponse", value: query_4.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsResponse", value: query_5.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionRequest", value: query_6.QueryConstitutionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_7.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsRequest", value: query_8.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteResponse", value: tx_4.MsgVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsResponse", value: query_9.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultResponse", value: query_10.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        depositParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.DepositParams", value: gov_3.DepositParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDepositResponse", value: tx_5.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_11.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_12.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_14.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        votingParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.VotingParams", value: gov_4.VotingParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_6.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_15.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Vote", value: gov_5.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposal", value: tx_9.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.WeightedVoteOption", value: gov_6.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Params", value: gov_7.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParamsResponse", value: tx_11.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsRequest", value: query_17.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_18.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyParams", value: gov_9.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposal", value: tx_13.MsgCancelProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposalResponse", value: tx_14.MsgCancelProposalResponse.fromPartial(value) };
            }
            catch (e) {
