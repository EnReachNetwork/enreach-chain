...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelProposalResponse = exports.MsgCancelProposal = exports.Proposal = exports.MsgVoteWeightedResponse = exports.QueryConstitutionResponse = exports.DepositParams = exports.QueryTallyResultRequest = exports.MsgVoteResponse = exports.MsgExecLegacyContent = exports.QueryVotesResponse = exports.QueryVotesRequest = exports.Deposit = exports.QueryProposalsRequest = exports.MsgDepositResponse = exports.MsgExecLegacyContentResponse = exports.VotingParams = exports.QueryDepositRequest = exports.QueryConstitutionRequest = exports.Params = exports.MsgUpdateParams = exports.QueryTallyResultResponse = exports.QueryDepositsResponse = exports.QueryDepositsRequest = exports.QueryParamsResponse = exports.MsgVoteWeighted = exports.WeightedVoteOption = exports.QueryVoteResponse = exports.QueryProposalsResponse = exports.QueryProposalResponse = exports.MsgUpdateParamsResponse = exports.MsgDeposit = exports.MsgVote = exports.MsgSubmitProposal = exports.GenesisState = exports.Vote = exports.QueryDepositResponse = exports.QueryProposalRequest = exports.QueryParamsRequest = exports.QueryVoteRequest = exports.TallyParams = exports.MsgSubmitProposalResponse = exports.TallyResult = void 0;
...
Object.defineProperty(exports, "TallyParams", { enumerable: true, get: function () { return gov_2.TallyParams; } });
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_4.QueryDepositResponse; } });
...
Object.defineProperty(exports, "QueryProposalResponse", { enumerable: true, get: function () { return query_5.QueryProposalResponse; } });
const query_6 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_6.QueryProposalsResponse; } });
...
Object.defineProperty(exports, "MsgVoteWeighted", { enumerable: true, get: function () { return tx_6.MsgVoteWeighted; } });
...
Object.defineProperty(exports, "QueryTallyResultResponse", { enumerable: true, get: function () { return query_11.QueryTallyResultResponse; } });
...
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return gov_5.Params; } });
...
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_13.QueryDepositRequest; } });
const gov_6 = require("./types/cosmos/gov/v1/gov");
Object.defineProperty(exports, "VotingParams", { enumerable: true, get: function () { return gov_6.VotingParams; } });
const tx_8 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgExecLegacyContentResponse", { enumerable: true, get: function () { return tx_8.MsgExecLegacyContentResponse; } });
...
Object.defineProperty(exports, "Deposit", { enumerable: true, get: function () { return gov_7.Deposit; } });
...
Object.defineProperty(exports, "MsgVoteResponse", { enumerable: true, get: function () { return tx_11.MsgVoteResponse; } });
...
Object.defineProperty(exports, "DepositParams", { enumerable: true, get: function () { return gov_8.DepositParams; } });
const query_18 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryConstitutionResponse", { enumerable: true, get: function () { return query_18.QueryConstitutionResponse; } });
const tx_12 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgVoteWeightedResponse", { enumerable: true, get: function () { return tx_12.MsgVoteWeightedResponse; } });
    ...
    return {
        ...
        async sendTallyParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyParams({ value: gov_2.TallyParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_4.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalResponse({ value: query_5.QueryProposalResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_6.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeighted({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeighted({ value: tx_6.MsgVoteWeighted.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTallyResultResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTallyResultResponse({ value: query_11.QueryTallyResultResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: gov_5.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_13.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVotingParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.votingParams({ value: gov_6.VotingParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContentResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContentResponse({ value: tx_8.MsgExecLegacyContentResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDeposit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.deposit({ value: gov_7.Deposit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteResponse({ value: tx_11.MsgVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDepositParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.depositParams({ value: gov_8.DepositParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConstitutionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConstitutionResponse({ value: query_18.QueryConstitutionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeightedResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeightedResponse({ value: tx_12.MsgVoteWeightedResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyParams", value: gov_2.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteRequest", value: query_1.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositResponse", value: query_4.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVote", value: tx_3.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParamsResponse", value: tx_5.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalResponse", value: query_5.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalsResponse", value: query_6.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeighted({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeighted", value: tx_6.MsgVoteWeighted.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsResponse", value: query_8.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsRequest", value: query_9.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultResponse", value: query_11.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParams", value: tx_7.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Params", value: gov_5.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_13.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        votingParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.VotingParams", value: gov_6.VotingParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContentResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContentResponse", value: tx_8.MsgExecLegacyContentResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        deposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Deposit", value: gov_7.Deposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_15.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteResponse", value: tx_11.MsgVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultRequest", value: query_17.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        depositParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.DepositParams", value: gov_8.DepositParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConstitutionResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryConstitutionResponse", value: query_18.QueryConstitutionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_12.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
