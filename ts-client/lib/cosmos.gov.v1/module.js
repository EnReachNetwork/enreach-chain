...
exports.queryClient = exports.txClient = exports.registry = exports.WeightedVoteOption = exports.QueryDepositResponse = exports.QueryConstitutionResponse = exports.QueryVotesResponse = exports.QueryProposalRequest = exports.GenesisState = exports.Deposit = exports.QueryTallyResultResponse = exports.QueryDepositsResponse = exports.QueryConstitutionRequest = exports.MsgDeposit = exports.TallyParams = exports.QueryTallyResultRequest = exports.MsgUpdateParamsResponse = exports.MsgExecLegacyContentResponse = exports.TallyResult = exports.DepositParams = exports.MsgCancelProposal = exports.MsgCancelProposalResponse = exports.QueryDepositsRequest = exports.QueryVoteResponse = exports.QueryProposalResponse = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.Proposal = exports.MsgVote = exports.QueryProposalsResponse = exports.MsgVoteWeightedResponse = exports.QueryVotesRequest = exports.QueryVoteRequest = exports.Vote = exports.QueryProposalsRequest = exports.MsgVoteResponse = exports.MsgExecLegacyContent = exports.MsgDepositResponse = exports.MsgVoteWeighted = exports.VotingParams = exports.MsgSubmitProposal = exports.Params = exports.QueryDepositRequest = exports.MsgSubmitProposalResponse = void 0;
...
Object.defineProperty(exports, "MsgExecLegacyContent", { enumerable: true, get: function () { return tx_5.MsgExecLegacyContent; } });
...
Object.defineProperty(exports, "MsgVote", { enumerable: true, get: function () { return tx_8.MsgVote; } });
...
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_9.QueryVoteResponse; } });
...
Object.defineProperty(exports, "MsgCancelProposal", { enumerable: true, get: function () { return tx_11.MsgCancelProposal; } });
const gov_5 = require("./types/cosmos/gov/v1/gov");
Object.defineProperty(exports, "DepositParams", { enumerable: true, get: function () { return gov_5.DepositParams; } });
...
Object.defineProperty(exports, "MsgDeposit", { enumerable: true, get: function () { return tx_14.MsgDeposit; } });
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_13.QueryDepositsResponse; } });
...
Object.defineProperty(exports, "Deposit", { enumerable: true, get: function () { return gov_8.Deposit; } });
...
Object.defineProperty(exports, "QueryProposalRequest", { enumerable: true, get: function () { return query_15.QueryProposalRequest; } });
const query_16 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_16.QueryVotesResponse; } });
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_18.QueryDepositResponse; } });
    ...
    return {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_1.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContent({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContent({ value: tx_5.MsgExecLegacyContent.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVote({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVote({ value: tx_8.MsgVote.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_9.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelProposal({ value: tx_11.MsgCancelProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDepositParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.depositParams({ value: gov_5.DepositParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeposit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeposit({ value: tx_14.MsgDeposit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_13.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDeposit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.deposit({ value: gov_8.Deposit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalRequest({ value: query_15.QueryProposalRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_16.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_18.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSubmitProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposalResponse", value: tx_1.MsgSubmitProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_1.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContent({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContent", value: tx_5.MsgExecLegacyContent.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVote", value: tx_8.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Proposal", value: gov_4.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParams", value: tx_9.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsRequest", value: query_6.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsResponse", value: query_7.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalResponse", value: query_8.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteResponse", value: query_9.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposal", value: tx_11.MsgCancelProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        depositParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.DepositParams", value: gov_5.DepositParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParamsResponse", value: tx_13.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDeposit", value: tx_14.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsResponse", value: query_13.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultResponse", value: query_14.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        deposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Deposit", value: gov_8.Deposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryProposalRequest", value: query_15.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_16.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositResponse", value: query_18.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
