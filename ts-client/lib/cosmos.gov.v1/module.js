...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.QueryTallyResultRequest = exports.MsgExecLegacyContent = exports.Vote = exports.MsgCancelProposal = exports.QueryVotesRequest = exports.QueryDepositResponse = exports.VotingParams = exports.QueryProposalResponse = exports.MsgUpdateParams = exports.MsgDepositResponse = exports.QueryDepositRequest = exports.QueryVoteRequest = exports.MsgSubmitProposal = exports.TallyResult = exports.Proposal = exports.QueryConstitutionRequest = exports.TallyParams = exports.QueryProposalsResponse = exports.WeightedVoteOption = exports.MsgVote = exports.QueryVotesResponse = exports.DepositParams = exports.MsgVoteWeighted = exports.QueryConstitutionResponse = exports.MsgDeposit = exports.MsgVoteResponse = exports.QueryTallyResultResponse = exports.Deposit = exports.MsgVoteWeightedResponse = exports.QueryVoteResponse = exports.MsgSubmitProposalResponse = exports.QueryDepositsResponse = exports.QueryParamsResponse = exports.QueryDepositsRequest = exports.Params = exports.MsgExecLegacyContentResponse = exports.QueryProposalRequest = exports.MsgUpdateParamsResponse = exports.QueryProposalsRequest = exports.QueryParamsRequest = exports.MsgCancelProposalResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgCancelProposalResponse", { enumerable: true, get: function () { return tx_1.MsgCancelProposalResponse; } });
...
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return gov_1.Params; } });
const query_4 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositsRequest", { enumerable: true, get: function () { return query_4.QueryDepositsRequest; } });
...
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_7.QueryVoteResponse; } });
...
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_10.QueryVotesResponse; } });
...
Object.defineProperty(exports, "Proposal", { enumerable: true, get: function () { return gov_6.Proposal; } });
const gov_7 = require("./types/cosmos/gov/v1/gov");
Object.defineProperty(exports, "TallyResult", { enumerable: true, get: function () { return gov_7.TallyResult; } });
...
Object.defineProperty(exports, "QueryVoteRequest", { enumerable: true, get: function () { return query_13.QueryVoteRequest; } });
const query_14 = require("./types/cosmos/gov/v1/query");
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_14.QueryDepositRequest; } });
const tx_11 = require("./types/cosmos/gov/v1/tx");
Object.defineProperty(exports, "MsgDepositResponse", { enumerable: true, get: function () { return tx_11.MsgDepositResponse; } });
...
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_17.QueryVotesRequest; } });
...
Object.defineProperty(exports, "MsgExecLegacyContent", { enumerable: true, get: function () { return tx_14.MsgExecLegacyContent; } });
    ...
    return {
        async sendMsgCancelProposalResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgCancelProposalResponse({ value: tx_1.MsgCancelProposalResponse.fromPartial(value) });
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: gov_1.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsRequest({ value: query_4.QueryDepositsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_7.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_10.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.proposal({ value: gov_6.Proposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTallyResult({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyResult({ value: gov_7.TallyResult.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteRequest({ value: query_13.QueryVoteRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_14.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDepositResponse({ value: tx_11.MsgDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_17.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExecLegacyContent({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecLegacyContent({ value: tx_14.MsgExecLegacyContent.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCancelProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgCancelProposalResponse", value: tx_1.MsgCancelProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryParamsRequest", value: query_1.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParamsResponse", value: tx_2.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Params", value: gov_1.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositsRequest", value: query_4.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteResponse", value: query_7.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteWeightedResponse", value: tx_5.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryTallyResultResponse", value: query_8.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgVoteResponse", value: tx_6.MsgVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDeposit", value: tx_7.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesResponse", value: query_10.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.WeightedVoteOption", value: gov_4.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyParams", value: gov_5.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Proposal", value: gov_6.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.TallyResult", value: gov_7.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgSubmitProposal", value: tx_10.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVoteRequest", value: query_13.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryDepositRequest", value: query_14.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgDepositResponse", value: tx_11.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgUpdateParams", value: tx_12.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.QueryVotesRequest", value: query_17.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.Vote", value: gov_9.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecLegacyContent({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1.MsgExecLegacyContent", value: tx_14.MsgExecLegacyContent.fromPartial(value) };
            }
            catch (e) {
