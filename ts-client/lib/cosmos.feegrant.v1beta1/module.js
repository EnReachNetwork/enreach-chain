...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllowanceRequest = exports.MsgPruneAllowancesResponse = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesRequest = exports.MsgRevokeAllowanceResponse = exports.MsgGrantAllowanceResponse = exports.MsgGrantAllowance = exports.Grant = exports.AllowedMsgAllowance = exports.BasicAllowance = exports.MsgPruneAllowances = exports.QueryAllowancesResponse = exports.QueryAllowanceResponse = exports.QueryAllowancesByGranterRequest = exports.MsgRevokeAllowance = exports.GenesisState = exports.PeriodicAllowance = void 0;
...
Object.defineProperty(exports, "QueryAllowanceResponse", { enumerable: true, get: function () { return query_2.QueryAllowanceResponse; } });
...
Object.defineProperty(exports, "MsgRevokeAllowanceResponse", { enumerable: true, get: function () { return tx_5.MsgRevokeAllowanceResponse; } });
const query_4 = require("./types/cosmos/feegrant/v1beta1/query");
Object.defineProperty(exports, "QueryAllowancesRequest", { enumerable: true, get: function () { return query_4.QueryAllowancesRequest; } });
...
Object.defineProperty(exports, "QueryAllowanceRequest", { enumerable: true, get: function () { return query_6.QueryAllowanceRequest; } });
    ...
    return {
        ...
        async sendQueryAllowancesByGranterRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesByGranterRequest({ value: query_1.QueryAllowancesByGranterRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowanceResponse({ value: query_2.QueryAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevokeAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeAllowanceResponse({ value: tx_5.MsgRevokeAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesRequest({ value: query_4.QueryAllowancesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowanceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowanceRequest({ value: query_6.QueryAllowanceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllowancesByGranterRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesByGranterRequest", value: query_1.QueryAllowancesByGranterRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowanceResponse", value: query_2.QueryAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevokeAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse", value: tx_5.MsgRevokeAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesRequest", value: query_4.QueryAllowancesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowanceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowanceRequest", value: query_6.QueryAllowanceRequest.fromPartial(value) };
            }
            catch (e) {
