...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllowancesResponse = exports.MsgGrantAllowanceResponse = exports.QueryAllowancesRequest = exports.GenesisState = exports.PeriodicAllowance = exports.MsgPruneAllowances = exports.MsgRevokeAllowanceResponse = exports.MsgRevokeAllowance = exports.MsgPruneAllowancesResponse = exports.BasicAllowance = exports.QueryAllowanceResponse = exports.MsgGrantAllowance = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesByGranterRequest = exports.QueryAllowanceRequest = exports.AllowedMsgAllowance = exports.Grant = void 0;
...
Object.defineProperty(exports, "BasicAllowance", { enumerable: true, get: function () { return feegrant_3.BasicAllowance; } });
    ...
    return {
        ...
        async sendBasicAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.basicAllowance({ value: feegrant_3.BasicAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        basicAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.BasicAllowance", value: feegrant_3.BasicAllowance.fromPartial(value) };
            }
            catch (e) {
