...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllowanceResponse = exports.QueryAllowanceRequest = exports.PeriodicAllowance = exports.MsgGrantAllowance = exports.Grant = exports.MsgGrantAllowanceResponse = exports.AllowedMsgAllowance = exports.QueryAllowancesResponse = exports.GenesisState = exports.MsgPruneAllowances = exports.MsgRevokeAllowanceResponse = exports.MsgPruneAllowancesResponse = exports.MsgRevokeAllowance = exports.BasicAllowance = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesByGranterRequest = exports.QueryAllowancesRequest = void 0;
...
Object.defineProperty(exports, "AllowedMsgAllowance", { enumerable: true, get: function () { return feegrant_2.AllowedMsgAllowance; } });
    ...
    return {
        ...
        async sendAllowedMsgAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.allowedMsgAllowance({ value: feegrant_2.AllowedMsgAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        allowedMsgAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.AllowedMsgAllowance", value: feegrant_2.AllowedMsgAllowance.fromPartial(value) };
            }
            catch (e) {
