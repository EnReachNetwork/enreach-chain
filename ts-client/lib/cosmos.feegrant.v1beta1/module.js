...
exports.queryClient = exports.txClient = exports.registry = exports.PeriodicAllowance = exports.AllowedMsgAllowance = exports.MsgGrantAllowanceResponse = exports.MsgGrantAllowance = exports.Grant = exports.QueryAllowancesResponse = exports.QueryAllowancesByGranterRequest = exports.GenesisState = exports.MsgPruneAllowances = exports.MsgRevokeAllowanceResponse = exports.QueryAllowancesByGranterResponse = exports.QueryAllowanceRequest = exports.BasicAllowance = exports.MsgPruneAllowancesResponse = exports.MsgRevokeAllowance = exports.QueryAllowancesRequest = exports.QueryAllowanceResponse = void 0;
...
Object.defineProperty(exports, "MsgPruneAllowancesResponse", { enumerable: true, get: function () { return tx_2.MsgPruneAllowancesResponse; } });
...
Object.defineProperty(exports, "MsgRevokeAllowanceResponse", { enumerable: true, get: function () { return tx_3.MsgRevokeAllowanceResponse; } });
const tx_4 = require("./types/cosmos/feegrant/v1beta1/tx");
Object.defineProperty(exports, "MsgPruneAllowances", { enumerable: true, get: function () { return tx_4.MsgPruneAllowances; } });
...
Object.defineProperty(exports, "QueryAllowancesResponse", { enumerable: true, get: function () { return query_6.QueryAllowancesResponse; } });
const feegrant_2 = require("./types/cosmos/feegrant/v1beta1/feegrant");
Object.defineProperty(exports, "Grant", { enumerable: true, get: function () { return feegrant_2.Grant; } });
const tx_5 = require("./types/cosmos/feegrant/v1beta1/tx");
Object.defineProperty(exports, "MsgGrantAllowance", { enumerable: true, get: function () { return tx_5.MsgGrantAllowance; } });
const tx_6 = require("./types/cosmos/feegrant/v1beta1/tx");
Object.defineProperty(exports, "MsgGrantAllowanceResponse", { enumerable: true, get: function () { return tx_6.MsgGrantAllowanceResponse; } });
...
Object.defineProperty(exports, "PeriodicAllowance", { enumerable: true, get: function () { return feegrant_4.PeriodicAllowance; } });
    ...
    return {
        ...
        async sendMsgRevokeAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeAllowance({ value: tx_1.MsgRevokeAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPruneAllowancesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPruneAllowancesResponse({ value: tx_2.MsgPruneAllowancesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevokeAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeAllowanceResponse({ value: tx_3.MsgRevokeAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPruneAllowances({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPruneAllowances({ value: tx_4.MsgPruneAllowances.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesResponse({ value: query_6.QueryAllowancesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.grant({ value: feegrant_2.Grant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrantAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantAllowance({ value: tx_5.MsgGrantAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrantAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantAllowanceResponse({ value: tx_6.MsgGrantAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriodicAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.periodicAllowance({ value: feegrant_4.PeriodicAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRevokeAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgRevokeAllowance", value: tx_1.MsgRevokeAllowance.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPruneAllowancesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgPruneAllowancesResponse", value: tx_2.MsgPruneAllowancesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevokeAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse", value: tx_3.MsgRevokeAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPruneAllowances({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgPruneAllowances", value: tx_4.MsgPruneAllowances.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesResponse", value: query_6.QueryAllowancesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        grant({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.Grant", value: feegrant_2.Grant.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrantAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgGrantAllowance", value: tx_5.MsgGrantAllowance.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrantAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse", value: tx_6.MsgGrantAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        periodicAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.PeriodicAllowance", value: feegrant_4.PeriodicAllowance.fromPartial(value) };
            }
            catch (e) {
