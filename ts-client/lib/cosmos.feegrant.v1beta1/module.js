...
exports.queryClient = exports.txClient = exports.registry = exports.Grant = exports.MsgPruneAllowancesResponse = exports.QueryAllowancesByGranterRequest = exports.MsgGrantAllowance = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesRequest = exports.MsgRevokeAllowance = exports.PeriodicAllowance = exports.BasicAllowance = exports.GenesisState = exports.QueryAllowancesResponse = exports.QueryAllowanceResponse = exports.QueryAllowanceRequest = exports.AllowedMsgAllowance = exports.MsgPruneAllowances = exports.MsgRevokeAllowanceResponse = exports.MsgGrantAllowanceResponse = void 0;
    ...
    return {
        ...
        async sendAllowedMsgAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.allowedMsgAllowance({ value: feegrant_1.AllowedMsgAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        allowedMsgAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.AllowedMsgAllowance", value: feegrant_1.AllowedMsgAllowance.fromPartial(value) };
            }
            catch (e) {
