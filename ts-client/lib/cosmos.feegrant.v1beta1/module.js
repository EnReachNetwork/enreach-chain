...
exports.queryClient = exports.txClient = exports.registry = exports.BasicAllowance = exports.MsgPruneAllowancesResponse = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesRequest = exports.MsgPruneAllowances = exports.QueryAllowancesByGranterRequest = exports.QueryAllowanceResponse = exports.GenesisState = exports.MsgGrantAllowance = exports.MsgRevokeAllowance = exports.MsgGrantAllowanceResponse = exports.QueryAllowancesResponse = exports.QueryAllowanceRequest = exports.AllowedMsgAllowance = exports.PeriodicAllowance = exports.MsgRevokeAllowanceResponse = exports.Grant = void 0;
...
Object.defineProperty(exports, "MsgGrantAllowanceResponse", { enumerable: true, get: function () { return tx_2.MsgGrantAllowanceResponse; } });
...
Object.defineProperty(exports, "MsgGrantAllowance", { enumerable: true, get: function () { return tx_4.MsgGrantAllowance; } });
...
Object.defineProperty(exports, "QueryAllowanceResponse", { enumerable: true, get: function () { return query_3.QueryAllowanceResponse; } });
const query_4 = require("./types/cosmos/feegrant/v1beta1/query");
Object.defineProperty(exports, "QueryAllowancesByGranterRequest", { enumerable: true, get: function () { return query_4.QueryAllowancesByGranterRequest; } });
const tx_5 = require("./types/cosmos/feegrant/v1beta1/tx");
Object.defineProperty(exports, "MsgPruneAllowances", { enumerable: true, get: function () { return tx_5.MsgPruneAllowances; } });
const query_5 = require("./types/cosmos/feegrant/v1beta1/query");
Object.defineProperty(exports, "QueryAllowancesRequest", { enumerable: true, get: function () { return query_5.QueryAllowancesRequest; } });
const query_6 = require("./types/cosmos/feegrant/v1beta1/query");
Object.defineProperty(exports, "QueryAllowancesByGranterResponse", { enumerable: true, get: function () { return query_6.QueryAllowancesByGranterResponse; } });
    ...
    return {
        ...
        async sendMsgRevokeAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeAllowanceResponse({ value: tx_1.MsgRevokeAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrantAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantAllowanceResponse({ value: tx_2.MsgGrantAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrantAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantAllowance({ value: tx_4.MsgGrantAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowanceResponse({ value: query_3.QueryAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesByGranterRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesByGranterRequest({ value: query_4.QueryAllowancesByGranterRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPruneAllowances({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPruneAllowances({ value: tx_5.MsgPruneAllowances.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesRequest({ value: query_5.QueryAllowancesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesByGranterResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesByGranterResponse({ value: query_6.QueryAllowancesByGranterResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRevokeAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse", value: tx_1.MsgRevokeAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrantAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse", value: tx_2.MsgGrantAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrantAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgGrantAllowance", value: tx_4.MsgGrantAllowance.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowanceResponse", value: query_3.QueryAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesByGranterRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesByGranterRequest", value: query_4.QueryAllowancesByGranterRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPruneAllowances({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgPruneAllowances", value: tx_5.MsgPruneAllowances.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesRequest", value: query_5.QueryAllowancesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesByGranterResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponse", value: query_6.QueryAllowancesByGranterResponse.fromPartial(value) };
            }
            catch (e) {
