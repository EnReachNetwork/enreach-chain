...
exports.queryClient = exports.txClient = exports.registry = exports.AllowedMsgAllowance = exports.PeriodicAllowance = exports.BasicAllowance = exports.MsgRevokeAllowance = exports.MsgGrantAllowance = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesByGranterRequest = exports.QueryAllowancesResponse = exports.Grant = exports.MsgPruneAllowances = exports.MsgRevokeAllowanceResponse = exports.QueryAllowanceRequest = exports.GenesisState = exports.MsgPruneAllowancesResponse = exports.MsgGrantAllowanceResponse = exports.QueryAllowancesRequest = exports.QueryAllowanceResponse = void 0;
...
Object.defineProperty(exports, "MsgRevokeAllowance", { enumerable: true, get: function () { return tx_6.MsgRevokeAllowance; } });
...
Object.defineProperty(exports, "PeriodicAllowance", { enumerable: true, get: function () { return feegrant_3.PeriodicAllowance; } });
    ...
    return {
        ...
        async sendMsgRevokeAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeAllowance({ value: tx_6.MsgRevokeAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPeriodicAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.periodicAllowance({ value: feegrant_3.PeriodicAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRevokeAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgRevokeAllowance", value: tx_6.MsgRevokeAllowance.fromPartial(value) };
            }
            catch (e) {
        ...
        periodicAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.PeriodicAllowance", value: feegrant_3.PeriodicAllowance.fromPartial(value) };
            }
            catch (e) {
