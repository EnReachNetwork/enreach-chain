...
exports.queryClient = exports.txClient = exports.registry = exports.MsgGrantAllowance = exports.QueryAllowanceResponse = exports.QueryAllowanceRequest = exports.MsgRevokeAllowanceResponse = exports.MsgRevokeAllowance = exports.AllowedMsgAllowance = exports.QueryAllowancesResponse = exports.QueryAllowancesRequest = exports.Grant = exports.MsgPruneAllowancesResponse = exports.MsgPruneAllowances = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesByGranterRequest = exports.MsgGrantAllowanceResponse = exports.GenesisState = exports.PeriodicAllowance = exports.BasicAllowance = void 0;
...
Object.defineProperty(exports, "QueryAllowancesByGranterResponse", { enumerable: true, get: function () { return query_2.QueryAllowancesByGranterResponse; } });
...
Object.defineProperty(exports, "MsgPruneAllowancesResponse", { enumerable: true, get: function () { return tx_3.MsgPruneAllowancesResponse; } });
...
Object.defineProperty(exports, "QueryAllowancesRequest", { enumerable: true, get: function () { return query_3.QueryAllowancesRequest; } });
    ...
    return {
        ...
        async sendQueryAllowancesByGranterResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesByGranterResponse({ value: query_2.QueryAllowancesByGranterResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPruneAllowancesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPruneAllowancesResponse({ value: tx_3.MsgPruneAllowancesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesRequest({ value: query_3.QueryAllowancesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllowancesByGranterResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponse", value: query_2.QueryAllowancesByGranterResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPruneAllowancesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgPruneAllowancesResponse", value: tx_3.MsgPruneAllowancesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesRequest", value: query_3.QueryAllowancesRequest.fromPartial(value) };
            }
            catch (e) {
