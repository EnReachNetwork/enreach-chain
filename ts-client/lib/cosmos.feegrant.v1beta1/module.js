...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesResponse = exports.QueryAllowancesRequest = exports.MsgGrantAllowance = exports.Grant = exports.AllowedMsgAllowance = exports.PeriodicAllowance = exports.MsgPruneAllowances = exports.MsgRevokeAllowance = exports.MsgGrantAllowanceResponse = exports.QueryAllowancesByGranterRequest = exports.QueryAllowanceResponse = exports.QueryAllowanceRequest = exports.BasicAllowance = exports.MsgRevokeAllowanceResponse = exports.MsgPruneAllowancesResponse = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "MsgPruneAllowancesResponse", { enumerable: true, get: function () { return tx_1.MsgPruneAllowancesResponse; } });
...
Object.defineProperty(exports, "QueryAllowancesByGranterRequest", { enumerable: true, get: function () { return query_3.QueryAllowancesByGranterRequest; } });
...
Object.defineProperty(exports, "MsgRevokeAllowance", { enumerable: true, get: function () { return tx_4.MsgRevokeAllowance; } });
    ...
    return {
        ...
        async sendMsgPruneAllowancesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPruneAllowancesResponse({ value: tx_1.MsgPruneAllowancesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesByGranterRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesByGranterRequest({ value: query_3.QueryAllowancesByGranterRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevokeAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeAllowance({ value: tx_4.MsgRevokeAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgPruneAllowancesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgPruneAllowancesResponse", value: tx_1.MsgPruneAllowancesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesByGranterRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesByGranterRequest", value: query_3.QueryAllowancesByGranterRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevokeAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgRevokeAllowance", value: tx_4.MsgRevokeAllowance.fromPartial(value) };
            }
            catch (e) {
