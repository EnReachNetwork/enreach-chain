...
exports.queryClient = exports.txClient = exports.registry = exports.MsgPruneAllowancesResponse = exports.MsgRevokeAllowance = exports.QueryAllowancesByGranterResponse = exports.QueryAllowancesResponse = exports.QueryAllowanceRequest = exports.AllowedMsgAllowance = exports.QueryAllowanceResponse = exports.MsgGrantAllowance = exports.Grant = exports.PeriodicAllowance = exports.MsgGrantAllowanceResponse = exports.QueryAllowancesByGranterRequest = exports.BasicAllowance = exports.GenesisState = exports.MsgPruneAllowances = exports.MsgRevokeAllowanceResponse = exports.QueryAllowancesRequest = void 0;
...
Object.defineProperty(exports, "MsgGrantAllowanceResponse", { enumerable: true, get: function () { return tx_3.MsgGrantAllowanceResponse; } });
...
Object.defineProperty(exports, "QueryAllowanceRequest", { enumerable: true, get: function () { return query_4.QueryAllowanceRequest; } });
const query_5 = require("./types/cosmos/feegrant/v1beta1/query");
Object.defineProperty(exports, "QueryAllowancesResponse", { enumerable: true, get: function () { return query_5.QueryAllowancesResponse; } });
    ...
    return {
        ...
        async sendMsgGrantAllowanceResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantAllowanceResponse({ value: tx_3.MsgGrantAllowanceResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowanceRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowanceRequest({ value: query_4.QueryAllowanceRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllowancesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllowancesResponse({ value: query_5.QueryAllowancesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgGrantAllowanceResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse", value: tx_3.MsgGrantAllowanceResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowanceRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowanceRequest", value: query_4.QueryAllowanceRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllowancesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.QueryAllowancesResponse", value: query_5.QueryAllowancesResponse.fromPartial(value) };
            }
            catch (e) {
