...
exports.queryClient = exports.txClient = exports.registry = exports.Operator = exports.QueryGetManagerByRegionRequest = exports.QueryAllManagerRequest = exports.MsgUpdateOperatorBasicInfoResponse = exports.MsgUpdateManagerConnParams = exports.QueryAllOperatorResponse = exports.QueryAllOperatorRequest = exports.QueryGetOperatorRequest = exports.MsgRegisterManagerResponse = exports.MsgUpdateParamsResponse = exports.Params = exports.GenesisState = exports.MsgCreateOperatorResponse = exports.QueryGetManagerByRegionResponse = exports.MsgActivateManager = exports.MsgBindOperatorManagerAccount = exports.MsgRegisterManager = exports.MsgGoWorkingResponse = exports.MsgBindOperatorEVMAccount = exports.Manager = exports.QueryParamsResponse = exports.MsgSetManagerRegion = exports.MsgBindOperatorManagerAccountResponse = exports.QueryGetManagerRequest = exports.QueryGetOperatorResponse = exports.QueryParamsRequest = exports.MsgUpdateOperatorBasicInfo = exports.MsgBindOperatorEVMAccountResponse = exports.MsgUpdateParams = exports.QueryAllManagerResponse = exports.QueryGetManagerResponse = exports.MsgUpdateManagerConnParamsResponse = exports.MsgSetManagerRegionResponse = exports.MsgCreateOperator = exports.MsgGoWorking = exports.MsgActivateManagerResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgActivateManagerResponse", { enumerable: true, get: function () { return tx_1.MsgActivateManagerResponse; } });
const tx_2 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgGoWorking", { enumerable: true, get: function () { return tx_2.MsgGoWorking; } });
const tx_3 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgCreateOperator", { enumerable: true, get: function () { return tx_3.MsgCreateOperator; } });
...
Object.defineProperty(exports, "MsgUpdateManagerConnParamsResponse", { enumerable: true, get: function () { return tx_5.MsgUpdateManagerConnParamsResponse; } });
...
Object.defineProperty(exports, "MsgUpdateOperatorBasicInfo", { enumerable: true, get: function () { return tx_8.MsgUpdateOperatorBasicInfo; } });
...
Object.defineProperty(exports, "QueryGetOperatorResponse", { enumerable: true, get: function () { return query_4.QueryGetOperatorResponse; } });
const query_5 = require("./types/enreach/manager/query");
Object.defineProperty(exports, "QueryGetManagerRequest", { enumerable: true, get: function () { return query_5.QueryGetManagerRequest; } });
const tx_9 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgBindOperatorManagerAccountResponse", { enumerable: true, get: function () { return tx_9.MsgBindOperatorManagerAccountResponse; } });
const tx_10 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgSetManagerRegion", { enumerable: true, get: function () { return tx_10.MsgSetManagerRegion; } });
...
Object.defineProperty(exports, "MsgBindOperatorManagerAccount", { enumerable: true, get: function () { return tx_14.MsgBindOperatorManagerAccount; } });
const tx_15 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgActivateManager", { enumerable: true, get: function () { return tx_15.MsgActivateManager; } });
...
Object.defineProperty(exports, "MsgUpdateParamsResponse", { enumerable: true, get: function () { return tx_17.MsgUpdateParamsResponse; } });
const tx_18 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgRegisterManagerResponse", { enumerable: true, get: function () { return tx_18.MsgRegisterManagerResponse; } });
...
Object.defineProperty(exports, "MsgUpdateManagerConnParams", { enumerable: true, get: function () { return tx_19.MsgUpdateManagerConnParams; } });
const tx_20 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgUpdateOperatorBasicInfoResponse", { enumerable: true, get: function () { return tx_20.MsgUpdateOperatorBasicInfoResponse; } });
...
Object.defineProperty(exports, "QueryGetManagerByRegionRequest", { enumerable: true, get: function () { return query_12.QueryGetManagerByRegionRequest; } });
    ...
    return {
        async sendMsgActivateManagerResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgActivateManagerResponse({ value: tx_1.MsgActivateManagerResponse.fromPartial(value) });
        ...
        async sendMsgGoWorking({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGoWorking({ value: tx_2.MsgGoWorking.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateOperator({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateOperator({ value: tx_3.MsgCreateOperator.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateManagerConnParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateManagerConnParamsResponse({ value: tx_5.MsgUpdateManagerConnParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateOperatorBasicInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateOperatorBasicInfo({ value: tx_8.MsgUpdateOperatorBasicInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetOperatorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetOperatorResponse({ value: query_4.QueryGetOperatorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetManagerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetManagerRequest({ value: query_5.QueryGetManagerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorManagerAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorManagerAccountResponse({ value: tx_9.MsgBindOperatorManagerAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSetManagerRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSetManagerRegion({ value: tx_10.MsgSetManagerRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorManagerAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorManagerAccount({ value: tx_14.MsgBindOperatorManagerAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgActivateManager({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgActivateManager({ value: tx_15.MsgActivateManager.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateParamsResponse({ value: tx_17.MsgUpdateParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterManagerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterManagerResponse({ value: tx_18.MsgRegisterManagerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateManagerConnParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateManagerConnParams({ value: tx_19.MsgUpdateManagerConnParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateOperatorBasicInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateOperatorBasicInfoResponse({ value: tx_20.MsgUpdateOperatorBasicInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetManagerByRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetManagerByRegionRequest({ value: query_12.QueryGetManagerByRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgActivateManagerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgActivateManagerResponse", value: tx_1.MsgActivateManagerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGoWorking({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgGoWorking", value: tx_2.MsgGoWorking.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateOperator({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgCreateOperator", value: tx_3.MsgCreateOperator.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateManagerConnParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateManagerConnParamsResponse", value: tx_5.MsgUpdateManagerConnParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateOperatorBasicInfo({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateOperatorBasicInfo", value: tx_8.MsgUpdateOperatorBasicInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetOperatorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetOperatorResponse", value: query_4.QueryGetOperatorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetManagerRequest({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetManagerRequest", value: query_5.QueryGetManagerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorManagerAccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorManagerAccountResponse", value: tx_9.MsgBindOperatorManagerAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSetManagerRegion({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgSetManagerRegion", value: tx_10.MsgSetManagerRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryParamsResponse", value: query_6.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorManagerAccount({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorManagerAccount", value: tx_14.MsgBindOperatorManagerAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgActivateManager({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgActivateManager", value: tx_15.MsgActivateManager.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateParamsResponse", value: tx_17.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterManagerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgRegisterManagerResponse", value: tx_18.MsgRegisterManagerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateManagerConnParams({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateManagerConnParams", value: tx_19.MsgUpdateManagerConnParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateOperatorBasicInfoResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateOperatorBasicInfoResponse", value: tx_20.MsgUpdateOperatorBasicInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetManagerByRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetManagerByRegionRequest", value: query_12.QueryGetManagerByRegionRequest.fromPartial(value) };
            }
            catch (e) {
