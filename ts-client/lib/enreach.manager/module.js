...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetManagerRequest = exports.QueryAllOperatorResponse = exports.QueryAllOperatorRequest = exports.MsgBindOperatorManagerAccount = exports.MsgUpdateOperatorBasicInfoResponse = exports.MsgBindOperatorEVMAccountResponse = exports.QueryGetSuperiorResponse = exports.QueryGetManagerByRegionResponse = exports.QueryGetOperatorResponse = exports.MsgUpdateOperatorBasicInfo = exports.MsgUpdateSuperiorResponse = exports.MsgGoWorking = exports.MsgCreateSuperiorResponse = exports.MsgRegisterManager = exports.MsgUpdateManagerConnParamsResponse = exports.QueryGetManagerByRegionRequest = exports.MsgRegisterManagerResponse = exports.MsgSetManagerRegionResponse = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorRequest = exports.MsgUpdateManagerConnParams = exports.MsgSetManagerRegion = exports.Operator = exports.MsgCreateSuperior = exports.MsgGoWorkingResponse = exports.MsgCreateOperatorResponse = exports.QueryAllManagerRequest = exports.QueryGetOperatorRequest = exports.QueryParamsResponse = exports.MsgBindOperatorEVMAccount = exports.MsgActivateManager = exports.GenesisState = exports.Superior = exports.MsgBindOperatorManagerAccountResponse = exports.QueryAllManagerResponse = exports.QueryGetManagerResponse = exports.MsgCreateOperator = exports.Params = exports.MsgActivateManagerResponse = exports.Manager = exports.MsgUpdateSuperior = exports.QueryParamsRequest = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "MsgActivateManagerResponse", { enumerable: true, get: function () { return tx_3.MsgActivateManagerResponse; } });
...
Object.defineProperty(exports, "MsgCreateOperator", { enumerable: true, get: function () { return tx_4.MsgCreateOperator; } });
...
Object.defineProperty(exports, "MsgBindOperatorManagerAccountResponse", { enumerable: true, get: function () { return tx_5.MsgBindOperatorManagerAccountResponse; } });
...
Object.defineProperty(exports, "MsgBindOperatorEVMAccount", { enumerable: true, get: function () { return tx_7.MsgBindOperatorEVMAccount; } });
...
Object.defineProperty(exports, "MsgGoWorkingResponse", { enumerable: true, get: function () { return tx_9.MsgGoWorkingResponse; } });
...
Object.defineProperty(exports, "MsgSetManagerRegion", { enumerable: true, get: function () { return tx_11.MsgSetManagerRegion; } });
const tx_12 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgUpdateManagerConnParams", { enumerable: true, get: function () { return tx_12.MsgUpdateManagerConnParams; } });
...
Object.defineProperty(exports, "MsgSetManagerRegionResponse", { enumerable: true, get: function () { return tx_14.MsgSetManagerRegionResponse; } });
const tx_15 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgRegisterManagerResponse", { enumerable: true, get: function () { return tx_15.MsgRegisterManagerResponse; } });
...
Object.defineProperty(exports, "MsgUpdateManagerConnParamsResponse", { enumerable: true, get: function () { return tx_16.MsgUpdateManagerConnParamsResponse; } });
const tx_17 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgRegisterManager", { enumerable: true, get: function () { return tx_17.MsgRegisterManager; } });
const tx_18 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgCreateSuperiorResponse", { enumerable: true, get: function () { return tx_18.MsgCreateSuperiorResponse; } });
...
Object.defineProperty(exports, "MsgUpdateSuperiorResponse", { enumerable: true, get: function () { return tx_20.MsgUpdateSuperiorResponse; } });
...
Object.defineProperty(exports, "QueryGetOperatorResponse", { enumerable: true, get: function () { return query_9.QueryGetOperatorResponse; } });
const query_10 = require("./types/enreach/manager/query");
Object.defineProperty(exports, "QueryGetManagerByRegionResponse", { enumerable: true, get: function () { return query_10.QueryGetManagerByRegionResponse; } });
...
Object.defineProperty(exports, "MsgBindOperatorEVMAccountResponse", { enumerable: true, get: function () { return tx_22.MsgBindOperatorEVMAccountResponse; } });
const tx_23 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgUpdateOperatorBasicInfoResponse", { enumerable: true, get: function () { return tx_23.MsgUpdateOperatorBasicInfoResponse; } });
    ...
    return {
        ...
        async sendMsgActivateManagerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgActivateManagerResponse({ value: tx_3.MsgActivateManagerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateOperator({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateOperator({ value: tx_4.MsgCreateOperator.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorManagerAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorManagerAccountResponse({ value: tx_5.MsgBindOperatorManagerAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorEVMAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorEvmaccount({ value: tx_7.MsgBindOperatorEVMAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGoWorkingResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGoWorkingResponse({ value: tx_9.MsgGoWorkingResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSetManagerRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSetManagerRegion({ value: tx_11.MsgSetManagerRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateManagerConnParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateManagerConnParams({ value: tx_12.MsgUpdateManagerConnParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSetManagerRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSetManagerRegionResponse({ value: tx_14.MsgSetManagerRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterManagerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterManagerResponse({ value: tx_15.MsgRegisterManagerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateManagerConnParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateManagerConnParamsResponse({ value: tx_16.MsgUpdateManagerConnParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterManager({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterManager({ value: tx_17.MsgRegisterManager.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateSuperiorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateSuperiorResponse({ value: tx_18.MsgCreateSuperiorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateSuperiorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateSuperiorResponse({ value: tx_20.MsgUpdateSuperiorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetOperatorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetOperatorResponse({ value: query_9.QueryGetOperatorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetManagerByRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetManagerByRegionResponse({ value: query_10.QueryGetManagerByRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorEvmaccountResponse({ value: tx_22.MsgBindOperatorEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateOperatorBasicInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateOperatorBasicInfoResponse({ value: tx_23.MsgUpdateOperatorBasicInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgActivateManagerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgActivateManagerResponse", value: tx_3.MsgActivateManagerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateOperator({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgCreateOperator", value: tx_4.MsgCreateOperator.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorManagerAccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorManagerAccountResponse", value: tx_5.MsgBindOperatorManagerAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorEvmaccount({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorEVMAccount", value: tx_7.MsgBindOperatorEVMAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGoWorkingResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgGoWorkingResponse", value: tx_9.MsgGoWorkingResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSetManagerRegion({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgSetManagerRegion", value: tx_11.MsgSetManagerRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateManagerConnParams({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateManagerConnParams", value: tx_12.MsgUpdateManagerConnParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateParamsResponse", value: tx_13.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSetManagerRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgSetManagerRegionResponse", value: tx_14.MsgSetManagerRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterManagerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgRegisterManagerResponse", value: tx_15.MsgRegisterManagerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateManagerConnParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateManagerConnParamsResponse", value: tx_16.MsgUpdateManagerConnParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterManager({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgRegisterManager", value: tx_17.MsgRegisterManager.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgCreateSuperiorResponse", value: tx_18.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateSuperiorResponse", value: tx_20.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetOperatorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetOperatorResponse", value: query_9.QueryGetOperatorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetManagerByRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetManagerByRegionResponse", value: query_10.QueryGetManagerByRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorEVMAccountResponse", value: tx_22.MsgBindOperatorEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateOperatorBasicInfoResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateOperatorBasicInfoResponse", value: tx_23.MsgUpdateOperatorBasicInfoResponse.fromPartial(value) };
            }
            catch (e) {
