...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateSuperiorResponse = exports.MsgRegisterManager = exports.MsgBindOperatorManagerAccountResponse = exports.MsgUpdateSuperior = exports.Params = exports.MsgBindOperatorEVMAccountResponse = exports.MsgUpdateManagerConnParamsResponse = exports.MsgBindOperatorManagerAccount = exports.MsgUpdateParams = exports.QueryGetManagerRequest = exports.QueryGetOperatorResponse = exports.MsgUpdateOperatorBasicInfoResponse = exports.MsgSetManagerRegion = exports.Superior = exports.MsgCreateSuperior = exports.QueryGetSuperiorRequest = exports.QueryGetManagerByRegionRequest = exports.QueryGetManagerResponse = exports.QueryParamsRequest = exports.Manager = exports.MsgActivateManagerResponse = exports.MsgUpdateOperatorBasicInfo = exports.MsgBindOperatorEVMAccount = exports.QueryAllManagerResponse = exports.QueryAllOperatorRequest = exports.MsgRegisterManagerResponse = exports.MsgActivateManager = exports.MsgCreateOperatorResponse = exports.QueryGetSuperiorResponse = exports.QueryGetManagerByRegionResponse = exports.QueryAllManagerRequest = exports.Operator = exports.MsgCreateOperator = exports.MsgUpdateParamsResponse = exports.QueryAllOperatorResponse = exports.QueryGetOperatorRequest = exports.MsgGoWorkingResponse = exports.MsgSetManagerRegionResponse = exports.MsgUpdateManagerConnParams = exports.GenesisState = exports.QueryParamsResponse = exports.MsgCreateSuperiorResponse = exports.MsgGoWorking = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgGoWorking", { enumerable: true, get: function () { return tx_1.MsgGoWorking; } });
...
Object.defineProperty(exports, "MsgUpdateManagerConnParams", { enumerable: true, get: function () { return tx_3.MsgUpdateManagerConnParams; } });
...
Object.defineProperty(exports, "MsgGoWorkingResponse", { enumerable: true, get: function () { return tx_5.MsgGoWorkingResponse; } });
const query_2 = require("./types/enreach/manager/query");
Object.defineProperty(exports, "QueryGetOperatorRequest", { enumerable: true, get: function () { return query_2.QueryGetOperatorRequest; } });
...
Object.defineProperty(exports, "MsgCreateOperator", { enumerable: true, get: function () { return tx_7.MsgCreateOperator; } });
...
Object.defineProperty(exports, "QueryAllManagerRequest", { enumerable: true, get: function () { return query_4.QueryAllManagerRequest; } });
...
Object.defineProperty(exports, "QueryGetSuperiorResponse", { enumerable: true, get: function () { return query_6.QueryGetSuperiorResponse; } });
...
Object.defineProperty(exports, "MsgUpdateOperatorBasicInfo", { enumerable: true, get: function () { return tx_12.MsgUpdateOperatorBasicInfo; } });
...
Object.defineProperty(exports, "QueryGetManagerResponse", { enumerable: true, get: function () { return query_10.QueryGetManagerResponse; } });
...
Object.defineProperty(exports, "MsgCreateSuperior", { enumerable: true, get: function () { return tx_14.MsgCreateSuperior; } });
...
Object.defineProperty(exports, "QueryGetOperatorResponse", { enumerable: true, get: function () { return query_13.QueryGetOperatorResponse; } });
...
Object.defineProperty(exports, "MsgUpdateManagerConnParamsResponse", { enumerable: true, get: function () { return tx_19.MsgUpdateManagerConnParamsResponse; } });
const tx_20 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgBindOperatorEVMAccountResponse", { enumerable: true, get: function () { return tx_20.MsgBindOperatorEVMAccountResponse; } });
...
Object.defineProperty(exports, "MsgUpdateSuperior", { enumerable: true, get: function () { return tx_21.MsgUpdateSuperior; } });
const tx_22 = require("./types/enreach/manager/tx");
Object.defineProperty(exports, "MsgBindOperatorManagerAccountResponse", { enumerable: true, get: function () { return tx_22.MsgBindOperatorManagerAccountResponse; } });
...
Object.defineProperty(exports, "MsgUpdateSuperiorResponse", { enumerable: true, get: function () { return tx_24.MsgUpdateSuperiorResponse; } });
    ...
    return {
        async sendMsgGoWorking({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgGoWorking({ value: tx_1.MsgGoWorking.fromPartial(value) });
        ...
        async sendMsgUpdateManagerConnParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateManagerConnParams({ value: tx_3.MsgUpdateManagerConnParams.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGoWorkingResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGoWorkingResponse({ value: tx_5.MsgGoWorkingResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetOperatorRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetOperatorRequest({ value: query_2.QueryGetOperatorRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateOperator({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateOperator({ value: tx_7.MsgCreateOperator.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllManagerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllManagerRequest({ value: query_4.QueryAllManagerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetSuperiorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetSuperiorResponse({ value: query_6.QueryGetSuperiorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateOperatorBasicInfo({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateOperatorBasicInfo({ value: tx_12.MsgUpdateOperatorBasicInfo.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetManagerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetManagerResponse({ value: query_10.QueryGetManagerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateSuperior({ value: tx_14.MsgCreateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetOperatorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetOperatorResponse({ value: query_13.QueryGetOperatorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateManagerConnParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateManagerConnParamsResponse({ value: tx_19.MsgUpdateManagerConnParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorEvmaccountResponse({ value: tx_20.MsgBindOperatorEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateSuperior({ value: tx_21.MsgUpdateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindOperatorManagerAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindOperatorManagerAccountResponse({ value: tx_22.MsgBindOperatorManagerAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateSuperiorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateSuperiorResponse({ value: tx_24.MsgUpdateSuperiorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgGoWorking({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgGoWorking", value: tx_1.MsgGoWorking.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgCreateSuperiorResponse", value: tx_2.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateManagerConnParams({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateManagerConnParams", value: tx_3.MsgUpdateManagerConnParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGoWorkingResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgGoWorkingResponse", value: tx_5.MsgGoWorkingResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetOperatorRequest({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetOperatorRequest", value: query_2.QueryGetOperatorRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateParamsResponse", value: tx_6.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateOperator({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgCreateOperator", value: tx_7.MsgCreateOperator.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllManagerRequest({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryAllManagerRequest", value: query_4.QueryAllManagerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetSuperiorResponse", value: query_6.QueryGetSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateOperatorBasicInfo({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateOperatorBasicInfo", value: tx_12.MsgUpdateOperatorBasicInfo.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryParamsRequest", value: query_9.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetManagerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetManagerResponse", value: query_10.QueryGetManagerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgCreateSuperior", value: tx_14.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetOperatorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.QueryGetOperatorResponse", value: query_13.QueryGetOperatorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateParams", value: tx_17.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateManagerConnParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateManagerConnParamsResponse", value: tx_19.MsgUpdateManagerConnParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorEVMAccountResponse", value: tx_20.MsgBindOperatorEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateSuperior", value: tx_21.MsgUpdateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindOperatorManagerAccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgBindOperatorManagerAccountResponse", value: tx_22.MsgBindOperatorManagerAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.manager.MsgUpdateSuperiorResponse", value: tx_24.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
