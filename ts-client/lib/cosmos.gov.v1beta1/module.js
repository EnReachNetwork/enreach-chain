...
exports.queryClient = exports.txClient = exports.registry = exports.Proposal = exports.GenesisState = exports.QueryVoteRequest = exports.QueryTallyResultRequest = exports.WeightedVoteOption = exports.QueryProposalResponse = exports.VotingParams = exports.MsgDepositResponse = exports.MsgVoteResponse = exports.QueryVoteResponse = exports.MsgSubmitProposal = exports.MsgVote = exports.MsgSubmitProposalResponse = exports.QueryDepositsResponse = exports.QueryDepositResponse = exports.Vote = exports.MsgVoteWeightedResponse = exports.QueryProposalsResponse = exports.TallyParams = exports.Deposit = exports.QueryDepositRequest = exports.QueryVotesResponse = exports.QueryProposalsRequest = exports.DepositParams = exports.TextProposal = exports.QueryParamsRequest = exports.TallyResult = exports.MsgDeposit = exports.QueryTallyResultResponse = exports.QueryDepositsRequest = exports.QueryParamsResponse = exports.QueryVotesRequest = exports.QueryProposalRequest = exports.MsgVoteWeighted = void 0;
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_11.QueryDepositResponse; } });
...
Object.defineProperty(exports, "QueryVoteRequest", { enumerable: true, get: function () { return query_16.QueryVoteRequest; } });
    ...
    return {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_11.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteRequest({ value: query_16.QueryVoteRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesRequest", value: query_2.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TallyResult", value: gov_1.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesResponse", value: query_8.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositResponse", value: query_11.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteResponse", value: query_13.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        votingParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.VotingParams", value: gov_7.VotingParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryTallyResultRequest", value: query_15.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteRequest", value: query_16.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
