...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSubmitProposal = exports.TallyResult = exports.QueryDepositsResponse = exports.MsgVoteWeightedResponse = exports.MsgSubmitProposalResponse = exports.WeightedVoteOption = exports.QueryProposalResponse = exports.QueryProposalRequest = exports.Vote = exports.MsgDeposit = exports.QueryTallyResultRequest = exports.Proposal = exports.DepositParams = exports.QueryProposalsResponse = exports.MsgVoteWeighted = exports.QueryVotesResponse = exports.QueryVoteResponse = exports.Deposit = exports.GenesisState = exports.QueryDepositRequest = exports.QueryParamsRequest = exports.QueryProposalsRequest = exports.MsgDepositResponse = exports.MsgVoteResponse = exports.QueryParamsResponse = exports.QueryVotesRequest = exports.TextProposal = exports.MsgVote = exports.TallyParams = exports.QueryDepositResponse = exports.QueryTallyResultResponse = exports.QueryDepositsRequest = exports.QueryVoteRequest = exports.VotingParams = void 0;
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_7.QueryProposalsRequest; } });
...
Object.defineProperty(exports, "QueryVoteResponse", { enumerable: true, get: function () { return query_10.QueryVoteResponse; } });
const query_11 = require("./types/cosmos/gov/v1beta1/query");
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_11.QueryVotesResponse; } });
const tx_4 = require("./types/cosmos/gov/v1beta1/tx");
Object.defineProperty(exports, "MsgVoteWeighted", { enumerable: true, get: function () { return tx_4.MsgVoteWeighted; } });
const query_12 = require("./types/cosmos/gov/v1beta1/query");
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_12.QueryProposalsResponse; } });
...
Object.defineProperty(exports, "TallyResult", { enumerable: true, get: function () { return gov_9.TallyResult; } });
    ...
    return {
        async sendVotingParams({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.votingParams({ value: gov_1.VotingParams.fromPartial(value) });
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_7.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteResponse({ value: query_10.QueryVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_11.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeighted({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeighted({ value: tx_4.MsgVoteWeighted.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_12.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTallyResult({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.tallyResult({ value: gov_9.TallyResult.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        votingParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.VotingParams", value: gov_1.VotingParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositResponse", value: query_4.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TallyParams", value: gov_2.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesRequest", value: query_5.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsResponse", value: query_6.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgDepositResponse", value: tx_3.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsRequest", value: query_7.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsRequest", value: query_8.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositRequest", value: query_9.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        deposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Deposit", value: gov_4.Deposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteResponse", value: query_10.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesResponse", value: query_11.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeighted({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeighted", value: tx_4.MsgVoteWeighted.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsResponse", value: query_12.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        depositParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.DepositParams", value: gov_5.DepositParams.fromPartial(value) };
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Proposal", value: gov_6.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryTallyResultRequest", value: query_13.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgDeposit", value: tx_5.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Vote", value: gov_7.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalResponse", value: query_15.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.WeightedVoteOption", value: gov_8.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeightedResponse", value: tx_7.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TallyResult", value: gov_9.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgSubmitProposal", value: tx_8.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
