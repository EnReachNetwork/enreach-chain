...
exports.queryClient = exports.txClient = exports.registry = exports.MsgDepositResponse = exports.QueryTallyResultResponse = exports.QueryTallyResultRequest = exports.QueryDepositsResponse = exports.QueryDepositResponse = exports.QueryProposalResponse = exports.TallyParams = exports.TallyResult = exports.WeightedVoteOption = exports.QueryDepositRequest = exports.QueryParamsResponse = exports.QueryVotesRequest = exports.QueryProposalsRequest = exports.QueryProposalRequest = exports.Deposit = exports.GenesisState = exports.QueryProposalsResponse = exports.QueryVoteResponse = exports.QueryVotesResponse = exports.MsgVoteWeightedResponse = exports.QueryParamsRequest = exports.MsgVoteWeighted = exports.QueryDepositsRequest = exports.QueryVoteRequest = exports.MsgSubmitProposal = exports.DepositParams = exports.MsgDeposit = exports.Vote = exports.TextProposal = exports.Proposal = exports.VotingParams = exports.MsgVoteResponse = exports.MsgVote = exports.MsgSubmitProposalResponse = void 0;
...
Object.defineProperty(exports, "MsgVoteResponse", { enumerable: true, get: function () { return tx_3.MsgVoteResponse; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_8.QueryProposalsRequest; } });
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_14.QueryDepositsResponse; } });
    ...
    return {
        ...
        async sendMsgVoteResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteResponse({ value: tx_3.MsgVoteResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_8.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_14.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteResponse", value: tx_3.MsgVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteResponse", value: query_5.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsResponse", value: query_6.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalRequest", value: query_7.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsRequest", value: query_8.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsResponse", value: query_10.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositRequest", value: query_11.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsResponse", value: query_14.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
