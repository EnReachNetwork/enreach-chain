...
exports.queryClient = exports.txClient = exports.registry = exports.QueryProposalResponse = exports.Deposit = exports.GenesisState = exports.MsgVote = exports.QueryParamsResponse = exports.DepositParams = exports.TallyResult = exports.QueryVotesResponse = exports.QueryProposalsRequest = exports.QueryDepositsResponse = exports.QueryDepositsRequest = exports.QueryProposalsResponse = exports.QueryProposalRequest = exports.MsgSubmitProposal = exports.QueryDepositResponse = exports.Vote = exports.MsgVoteWeighted = exports.MsgSubmitProposalResponse = exports.QueryVotesRequest = exports.QueryVoteResponse = exports.MsgVoteWeightedResponse = exports.QueryDepositRequest = exports.QueryParamsRequest = exports.QueryVoteRequest = exports.MsgDepositResponse = exports.MsgDeposit = exports.Proposal = exports.TextProposal = exports.WeightedVoteOption = exports.MsgVoteResponse = exports.QueryTallyResultResponse = exports.QueryTallyResultRequest = exports.TallyParams = exports.VotingParams = void 0;
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_8.QueryDepositResponse; } });
...
Object.defineProperty(exports, "QueryProposalRequest", { enumerable: true, get: function () { return query_9.QueryProposalRequest; } });
const query_10 = require("./types/cosmos/gov/v1beta1/query");
Object.defineProperty(exports, "QueryProposalsResponse", { enumerable: true, get: function () { return query_10.QueryProposalsResponse; } });
const query_11 = require("./types/cosmos/gov/v1beta1/query");
Object.defineProperty(exports, "QueryDepositsRequest", { enumerable: true, get: function () { return query_11.QueryDepositsRequest; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_13.QueryProposalsRequest; } });
const query_14 = require("./types/cosmos/gov/v1beta1/query");
Object.defineProperty(exports, "QueryVotesResponse", { enumerable: true, get: function () { return query_14.QueryVotesResponse; } });
    ...
    return {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_8.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalRequest({ value: query_9.QueryProposalRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsResponse({ value: query_10.QueryProposalsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDepositsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsRequest({ value: query_11.QueryDepositsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_13.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesResponse({ value: query_14.QueryVotesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryTallyResultResponse", value: query_2.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteResponse", value: tx_1.MsgVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.WeightedVoteOption", value: gov_3.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        proposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Proposal", value: gov_5.Proposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgDeposit", value: tx_2.MsgDeposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteRequest", value: query_3.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsRequest", value: query_4.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositRequest", value: query_5.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeightedResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeightedResponse", value: tx_4.MsgVoteWeightedResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteResponse", value: query_6.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesRequest", value: query_7.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgSubmitProposalResponse", value: tx_5.MsgSubmitProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeighted({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeighted", value: tx_6.MsgVoteWeighted.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Vote", value: gov_6.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositResponse", value: query_8.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgSubmitProposal", value: tx_7.MsgSubmitProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalRequest", value: query_9.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsResponse", value: query_10.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsRequest", value: query_11.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsRequest", value: query_13.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesResponse", value: query_14.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyResult({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TallyResult", value: gov_7.TallyResult.fromPartial(value) };
            }
            catch (e) {
        ...
        depositParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.DepositParams", value: gov_8.DepositParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsResponse", value: query_15.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVote", value: tx_8.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        deposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Deposit", value: gov_9.Deposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalResponse", value: query_16.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
