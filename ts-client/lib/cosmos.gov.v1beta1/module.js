...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSubmitProposal = exports.DepositParams = exports.QueryVoteResponse = exports.QueryProposalResponse = exports.TextProposal = exports.WeightedVoteOption = exports.QueryTallyResultRequest = exports.QueryDepositRequest = exports.QueryParamsRequest = exports.MsgVoteResponse = exports.TallyParams = exports.QueryDepositsResponse = exports.QueryDepositResponse = exports.QueryVoteRequest = exports.MsgDepositResponse = exports.Proposal = exports.GenesisState = exports.QueryTallyResultResponse = exports.MsgDeposit = exports.QueryProposalRequest = exports.Deposit = exports.MsgVoteWeightedResponse = exports.QueryVotesResponse = exports.Vote = exports.MsgVote = exports.MsgVoteWeighted = exports.QueryProposalsRequest = exports.TallyResult = exports.QueryDepositsRequest = exports.QueryParamsResponse = exports.QueryVotesRequest = exports.QueryProposalsResponse = exports.MsgSubmitProposalResponse = exports.VotingParams = void 0;
...
Object.defineProperty(exports, "QueryDepositsResponse", { enumerable: true, get: function () { return query_11.QueryDepositsResponse; } });
    ...
    return {
        ...
        async sendQueryDepositsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositsResponse({ value: query_11.QueryDepositsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsResponse", value: query_1.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        vote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Vote", value: gov_3.Vote.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositResponse", value: query_10.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsResponse", value: query_11.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TallyParams", value: gov_6.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsRequest", value: query_12.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryTallyResultRequest", value: query_14.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteResponse", value: query_16.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
