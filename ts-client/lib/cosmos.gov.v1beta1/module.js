...
exports.queryClient = exports.txClient = exports.registry = exports.Proposal = exports.MsgVoteWeighted = exports.QueryTallyResultResponse = exports.QueryVoteRequest = exports.QueryParamsRequest = exports.TallyParams = exports.DepositParams = exports.Deposit = exports.QueryVotesRequest = exports.Vote = exports.MsgVoteWeightedResponse = exports.MsgVote = exports.QueryProposalResponse = exports.VotingParams = exports.MsgDeposit = exports.MsgVoteResponse = exports.QueryParamsResponse = exports.QueryProposalsRequest = exports.TallyResult = exports.QueryVoteResponse = exports.MsgSubmitProposalResponse = exports.MsgSubmitProposal = exports.QueryDepositsResponse = exports.QueryDepositRequest = exports.QueryVotesResponse = exports.WeightedVoteOption = exports.TextProposal = exports.GenesisState = exports.MsgDepositResponse = exports.QueryTallyResultRequest = exports.QueryDepositsRequest = exports.QueryDepositResponse = exports.QueryProposalsResponse = exports.QueryProposalRequest = void 0;
...
Object.defineProperty(exports, "QueryDepositResponse", { enumerable: true, get: function () { return query_3.QueryDepositResponse; } });
...
Object.defineProperty(exports, "TextProposal", { enumerable: true, get: function () { return gov_1.TextProposal; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_10.QueryProposalsRequest; } });
...
Object.defineProperty(exports, "QueryVotesRequest", { enumerable: true, get: function () { return query_13.QueryVotesRequest; } });
    ...
    return {
        ...
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositResponse({ value: query_3.QueryDepositResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendTextProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.textProposal({ value: gov_1.TextProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_10.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryVotesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVotesRequest({ value: query_13.QueryVotesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositResponse", value: query_3.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsRequest", value: query_4.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgDepositResponse", value: tx_1.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        textProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TextProposal", value: gov_1.TextProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsResponse", value: query_8.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteResponse", value: query_9.QueryVoteResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsRequest", value: query_10.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalResponse", value: query_12.QueryProposalResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVote({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVote", value: tx_6.MsgVote.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesRequest", value: query_13.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        deposit({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.Deposit", value: gov_6.Deposit.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteRequest", value: query_15.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryTallyResultResponse", value: query_16.QueryTallyResultResponse.fromPartial(value) };
            }
            catch (e) {
