...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDepositsRequest = exports.QueryParamsResponse = exports.QueryVotesRequest = exports.MsgVoteWeighted = exports.MsgSubmitProposalResponse = exports.Proposal = exports.MsgSubmitProposal = exports.QueryVotesResponse = exports.TallyParams = exports.TallyResult = exports.TextProposal = exports.QueryProposalsRequest = exports.QueryProposalResponse = exports.MsgVoteWeightedResponse = exports.MsgVoteResponse = exports.WeightedVoteOption = exports.QueryProposalsResponse = exports.QueryVoteResponse = exports.QueryProposalRequest = exports.VotingParams = exports.QueryTallyResultResponse = exports.QueryTallyResultRequest = exports.QueryParamsRequest = exports.QueryVoteRequest = exports.MsgVote = exports.DepositParams = exports.Deposit = exports.GenesisState = exports.Vote = exports.QueryDepositResponse = exports.QueryDepositRequest = exports.MsgDepositResponse = exports.MsgDeposit = exports.QueryDepositsResponse = void 0;
...
Object.defineProperty(exports, "QueryVoteRequest", { enumerable: true, get: function () { return query_4.QueryVoteRequest; } });
    ...
    return {
        ...
        async sendQueryVoteRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryVoteRequest({ value: query_4.QueryVoteRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsResponse", value: query_1.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgDepositResponse", value: tx_2.MsgDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositRequest", value: query_2.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVoteRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVoteRequest", value: query_4.QueryVoteRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsRequest", value: query_5.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTallyResultRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryTallyResultRequest", value: query_6.QueryTallyResultRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalRequest", value: query_8.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsRequest", value: query_16.QueryDepositsRequest.fromPartial(value) };
            }
            catch (e) {
