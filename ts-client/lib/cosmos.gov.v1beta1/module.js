...
exports.queryClient = exports.txClient = exports.registry = exports.QueryProposalsResponse = exports.QueryProposalResponse = exports.QueryVotesRequest = exports.MsgDepositResponse = exports.MsgSubmitProposal = exports.WeightedVoteOption = exports.QueryParamsRequest = exports.QueryProposalRequest = exports.MsgVoteResponse = exports.MsgVote = exports.MsgSubmitProposalResponse = exports.VotingParams = exports.DepositParams = exports.QueryTallyResultResponse = exports.QueryDepositsRequest = exports.QueryProposalsRequest = exports.TextProposal = exports.QueryVoteResponse = exports.Vote = exports.TallyParams = exports.MsgVoteWeightedResponse = exports.TallyResult = exports.QueryTallyResultRequest = exports.QueryDepositsResponse = exports.QueryParamsResponse = exports.QueryVotesResponse = exports.MsgDeposit = exports.MsgVoteWeighted = exports.QueryDepositRequest = exports.QueryVoteRequest = exports.Proposal = exports.GenesisState = exports.Deposit = exports.QueryDepositResponse = void 0;
...
Object.defineProperty(exports, "QueryDepositRequest", { enumerable: true, get: function () { return query_3.QueryDepositRequest; } });
...
Object.defineProperty(exports, "QueryProposalsRequest", { enumerable: true, get: function () { return query_9.QueryProposalsRequest; } });
    ...
    return {
        async sendQueryDepositResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryDepositResponse({ value: query_1.QueryDepositResponse.fromPartial(value) });
        ...
        async sendQueryDepositRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDepositRequest({ value: query_3.QueryDepositRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVoteWeighted({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVoteWeighted({ value: tx_1.MsgVoteWeighted.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryProposalsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryProposalsRequest({ value: query_9.QueryProposalsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDepositResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositResponse", value: query_1.QueryDepositResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositRequest", value: query_3.QueryDepositRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVoteWeighted({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeighted", value: tx_1.MsgVoteWeighted.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesResponse", value: query_4.QueryVotesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDepositsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryDepositsResponse", value: query_6.QueryDepositsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        tallyParams({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.TallyParams", value: gov_4.TallyParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsRequest", value: query_9.QueryProposalsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalRequest", value: query_12.QueryProposalRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryParamsRequest", value: query_13.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        weightedVoteOption({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.WeightedVoteOption", value: gov_9.WeightedVoteOption.fromPartial(value) };
            }
            catch (e) {
        ...
        queryVotesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryVotesRequest", value: query_14.QueryVotesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryProposalsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.gov.v1beta1.QueryProposalsResponse", value: query_16.QueryProposalsResponse.fromPartial(value) };
            }
            catch (e) {
