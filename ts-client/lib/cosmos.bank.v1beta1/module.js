...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSetSendEnabledResponse = exports.Metadata = exports.Output = exports.QuerySpendableBalancesRequest = exports.MsgUpdateParamsResponse = exports.QueryTotalSupplyRequest = exports.Supply = exports.QueryDenomOwnersByQueryResponse = exports.QueryAllBalancesResponse = exports.DenomUnit = exports.Input = exports.QuerySendEnabledResponse = exports.QuerySupplyOfRequest = exports.QuerySpendableBalanceByDenomRequest = exports.MsgSetSendEnabled = exports.QueryDenomMetadataByQueryStringRequest = exports.QueryDenomsMetadataRequest = exports.QueryAllBalancesRequest = exports.QueryBalanceResponse = exports.DenomOwner = exports.QuerySpendableBalanceByDenomResponse = exports.QuerySpendableBalancesResponse = exports.QueryDenomOwnersRequest = exports.QueryTotalSupplyResponse = exports.MsgSend = exports.GenesisState = exports.SendEnabled = exports.QueryParamsResponse = exports.QueryBalanceRequest = exports.MsgMultiSend = exports.QuerySendEnabledRequest = exports.QueryDenomMetadataByQueryStringResponse = exports.MsgMultiSendResponse = exports.QueryDenomOwnersByQueryRequest = exports.SendAuthorization = exports.QueryDenomsMetadataResponse = exports.Balance = exports.QueryDenomOwnersResponse = exports.QueryDenomMetadataResponse = exports.QueryDenomMetadataRequest = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.MsgSendResponse = exports.QuerySupplyOfResponse = exports.Params = void 0;
...
Object.defineProperty(exports, "QueryDenomMetadataResponse", { enumerable: true, get: function () { return query_4.QueryDenomMetadataResponse; } });
...
Object.defineProperty(exports, "QueryDenomOwnersByQueryRequest", { enumerable: true, get: function () { return query_7.QueryDenomOwnersByQueryRequest; } });
...
Object.defineProperty(exports, "QueryDenomMetadataByQueryStringResponse", { enumerable: true, get: function () { return query_8.QueryDenomMetadataByQueryStringResponse; } });
...
Object.defineProperty(exports, "QueryDenomOwnersRequest", { enumerable: true, get: function () { return query_13.QueryDenomOwnersRequest; } });
const query_14 = require("./types/cosmos/bank/v1beta1/query");
Object.defineProperty(exports, "QuerySpendableBalancesResponse", { enumerable: true, get: function () { return query_14.QuerySpendableBalancesResponse; } });
const query_15 = require("./types/cosmos/bank/v1beta1/query");
Object.defineProperty(exports, "QuerySpendableBalanceByDenomResponse", { enumerable: true, get: function () { return query_15.QuerySpendableBalanceByDenomResponse; } });
...
Object.defineProperty(exports, "QueryDenomsMetadataRequest", { enumerable: true, get: function () { return query_19.QueryDenomsMetadataRequest; } });
...
Object.defineProperty(exports, "QueryTotalSupplyRequest", { enumerable: true, get: function () { return query_26.QueryTotalSupplyRequest; } });
    ...
    return {
        ...
        async sendQueryDenomMetadataResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomMetadataResponse({ value: query_4.QueryDenomMetadataResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomOwnersByQueryRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomOwnersByQueryRequest({ value: query_7.QueryDenomOwnersByQueryRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomMetadataByQueryStringResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomMetadataByQueryStringResponse({ value: query_8.QueryDenomMetadataByQueryStringResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomOwnersRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomOwnersRequest({ value: query_13.QueryDenomOwnersRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySpendableBalancesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySpendableBalancesResponse({ value: query_14.QuerySpendableBalancesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySpendableBalanceByDenomResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySpendableBalanceByDenomResponse({ value: query_15.QuerySpendableBalanceByDenomResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDenomsMetadataRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDenomsMetadataRequest({ value: query_19.QueryDenomsMetadataRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendInput({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.input({ value: bank_3.Input.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSupply({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.supply({ value: bank_5.Supply.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalSupplyRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalSupplyRequest({ value: query_26.QueryTotalSupplyRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomMetadataResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryDenomMetadataResponse", value: query_4.QueryDenomMetadataResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomOwnersByQueryRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryDenomOwnersByQueryRequest", value: query_7.QueryDenomOwnersByQueryRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomMetadataByQueryStringResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryDenomMetadataByQueryStringResponse", value: query_8.QueryDenomMetadataByQueryStringResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryParamsResponse", value: query_11.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomOwnersRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryDenomOwnersRequest", value: query_13.QueryDenomOwnersRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySpendableBalancesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QuerySpendableBalancesResponse", value: query_14.QuerySpendableBalancesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySpendableBalanceByDenomResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QuerySpendableBalanceByDenomResponse", value: query_15.QuerySpendableBalanceByDenomResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDenomsMetadataRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryDenomsMetadataRequest", value: query_19.QueryDenomsMetadataRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        input({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.Input", value: bank_3.Input.fromPartial(value) };
            }
            catch (e) {
        ...
        supply({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.Supply", value: bank_5.Supply.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalSupplyRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.bank.v1beta1.QueryTotalSupplyRequest", value: query_26.QueryTotalSupplyRequest.fromPartial(value) };
            }
            catch (e) {
