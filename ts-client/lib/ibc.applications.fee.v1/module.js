...
exports.queryClient = exports.txClient = exports.registry = exports.QueryIncentivizedPacketsRequest = exports.PacketFees = exports.MsgRegisterCounterpartyPayeeResponse = exports.RegisteredPayee = exports.MsgPayPacketFee = exports.QueryFeeEnabledChannelsRequest = exports.QueryIncentivizedPacketsForChannelResponse = exports.QueryIncentivizedPacketRequest = exports.QueryIncentivizedPacketsResponse = exports.QueryTotalAckFeesResponse = exports.MsgPayPacketFeeAsyncResponse = exports.IncentivizedAcknowledgement = exports.QueryIncentivizedPacketResponse = exports.PacketFee = exports.MsgPayPacketFeeResponse = exports.FeeEnabledChannel = exports.Fee = exports.QueryCounterpartyPayeeRequest = exports.QueryTotalRecvFeesResponse = exports.QueryFeeEnabledChannelRequest = exports.MsgRegisterPayeeResponse = exports.MsgRegisterPayee = exports.GenesisState = exports.QueryCounterpartyPayeeResponse = exports.QueryPayeeRequest = exports.QueryTotalTimeoutFeesResponse = exports.QueryTotalAckFeesRequest = exports.QueryFeeEnabledChannelResponse = exports.IdentifiedPacketFees = exports.MsgPayPacketFeeAsync = exports.Metadata = exports.QueryPayeeResponse = exports.QueryTotalTimeoutFeesRequest = exports.QueryTotalRecvFeesRequest = exports.ForwardRelayerAddress = exports.RegisteredCounterpartyPayee = exports.QueryFeeEnabledChannelsResponse = exports.QueryIncentivizedPacketsForChannelRequest = exports.MsgRegisterCounterpartyPayee = void 0;
...
Object.defineProperty(exports, "QueryFeeEnabledChannelsResponse", { enumerable: true, get: function () { return query_2.QueryFeeEnabledChannelsResponse; } });
...
Object.defineProperty(exports, "QueryTotalRecvFeesRequest", { enumerable: true, get: function () { return query_3.QueryTotalRecvFeesRequest; } });
const query_4 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalTimeoutFeesRequest", { enumerable: true, get: function () { return query_4.QueryTotalTimeoutFeesRequest; } });
const query_5 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryPayeeResponse", { enumerable: true, get: function () { return query_5.QueryPayeeResponse; } });
...
Object.defineProperty(exports, "QueryFeeEnabledChannelResponse", { enumerable: true, get: function () { return query_6.QueryFeeEnabledChannelResponse; } });
const query_7 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalAckFeesRequest", { enumerable: true, get: function () { return query_7.QueryTotalAckFeesRequest; } });
...
Object.defineProperty(exports, "QueryPayeeRequest", { enumerable: true, get: function () { return query_9.QueryPayeeRequest; } });
const query_10 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryCounterpartyPayeeResponse", { enumerable: true, get: function () { return query_10.QueryCounterpartyPayeeResponse; } });
...
Object.defineProperty(exports, "MsgRegisterPayee", { enumerable: true, get: function () { return tx_3.MsgRegisterPayee; } });
...
Object.defineProperty(exports, "QueryTotalRecvFeesResponse", { enumerable: true, get: function () { return query_12.QueryTotalRecvFeesResponse; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsResponse", { enumerable: true, get: function () { return query_16.QueryIncentivizedPacketsResponse; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsRequest", { enumerable: true, get: function () { return query_20.QueryIncentivizedPacketsRequest; } });
    ...
    return {
        async sendMsgRegisterCounterpartyPayee({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgRegisterCounterpartyPayee({ value: tx_1.MsgRegisterCounterpartyPayee.fromPartial(value) });
        ...
        async sendQueryIncentivizedPacketsForChannelRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsForChannelRequest({ value: query_1.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelsResponse({ value: query_2.QueryFeeEnabledChannelsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesRequest({ value: query_3.QueryTotalRecvFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalTimeoutFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalTimeoutFeesRequest({ value: query_4.QueryTotalTimeoutFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeResponse({ value: query_5.QueryPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelResponse({ value: query_6.QueryFeeEnabledChannelResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalAckFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalAckFeesRequest({ value: query_7.QueryTotalAckFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeRequest({ value: query_9.QueryPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeResponse({ value: query_10.QueryCounterpartyPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterPayee({ value: tx_3.MsgRegisterPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesResponse({ value: query_12.QueryTotalRecvFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsResponse({ value: query_16.QueryIncentivizedPacketsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsRequest({ value: query_20.QueryIncentivizedPacketsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRegisterCounterpartyPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterCounterpartyPayee", value: tx_1.MsgRegisterCounterpartyPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsForChannelRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsForChannelRequest", value: query_1.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelsResponse", value: query_2.QueryFeeEnabledChannelsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesRequest", value: query_3.QueryTotalRecvFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesRequest", value: query_4.QueryTotalTimeoutFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeResponse", value: query_5.QueryPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelResponse", value: query_6.QueryFeeEnabledChannelResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalAckFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalAckFeesRequest", value: query_7.QueryTotalAckFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeRequest", value: query_9.QueryPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeResponse", value: query_10.QueryCounterpartyPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterPayee", value: tx_3.MsgRegisterPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesResponse", value: query_12.QueryTotalRecvFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsResponse", value: query_16.QueryIncentivizedPacketsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsRequest", value: query_20.QueryIncentivizedPacketsRequest.fromPartial(value) };
            }
            catch (e) {
