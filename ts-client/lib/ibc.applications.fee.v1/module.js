...
exports.queryClient = exports.txClient = exports.registry = exports.QueryIncentivizedPacketResponse = exports.IncentivizedAcknowledgement = exports.RegisteredCounterpartyPayee = exports.QueryCounterpartyPayeeResponse = exports.PacketFee = exports.FeeEnabledChannel = exports.Metadata = exports.QueryPayeeResponse = exports.QueryTotalAckFeesResponse = exports.QueryTotalAckFeesRequest = exports.QueryCounterpartyPayeeRequest = exports.QueryTotalTimeoutFeesRequest = exports.QueryTotalRecvFeesResponse = exports.QueryIncentivizedPacketsForChannelResponse = exports.PacketFees = exports.MsgRegisterCounterpartyPayeeResponse = exports.MsgRegisterPayeeResponse = exports.MsgPayPacketFeeAsync = exports.QueryFeeEnabledChannelRequest = exports.QueryTotalRecvFeesRequest = exports.ForwardRelayerAddress = exports.GenesisState = exports.QueryTotalTimeoutFeesResponse = exports.MsgPayPacketFeeResponse = exports.MsgPayPacketFee = exports.RegisteredPayee = exports.QueryFeeEnabledChannelsRequest = exports.QueryIncentivizedPacketRequest = exports.IdentifiedPacketFees = exports.Fee = exports.QueryFeeEnabledChannelResponse = exports.QueryFeeEnabledChannelsResponse = exports.QueryPayeeRequest = exports.QueryIncentivizedPacketsForChannelRequest = exports.QueryIncentivizedPacketsResponse = exports.QueryIncentivizedPacketsRequest = exports.MsgPayPacketFeeAsyncResponse = exports.MsgRegisterCounterpartyPayee = exports.MsgRegisterPayee = void 0;
...
Object.defineProperty(exports, "QueryIncentivizedPacketsForChannelRequest", { enumerable: true, get: function () { return query_3.QueryIncentivizedPacketsForChannelRequest; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketRequest", { enumerable: true, get: function () { return query_7.QueryIncentivizedPacketRequest; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsForChannelResponse", { enumerable: true, get: function () { return query_12.QueryIncentivizedPacketsForChannelResponse; } });
const query_13 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalRecvFeesResponse", { enumerable: true, get: function () { return query_13.QueryTotalRecvFeesResponse; } });
...
Object.defineProperty(exports, "QueryCounterpartyPayeeRequest", { enumerable: true, get: function () { return query_15.QueryCounterpartyPayeeRequest; } });
    ...
    return {
        ...
        async sendQueryIncentivizedPacketsForChannelRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsForChannelRequest({ value: query_3.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketRequest({ value: query_7.QueryIncentivizedPacketRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsForChannelResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsForChannelResponse({ value: query_12.QueryIncentivizedPacketsForChannelResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesResponse({ value: query_13.QueryTotalRecvFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeRequest({ value: query_15.QueryCounterpartyPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryIncentivizedPacketsForChannelRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsForChannelRequest", value: query_3.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketRequest", value: query_7.QueryIncentivizedPacketRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsForChannelResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsForChannelResponse", value: query_12.QueryIncentivizedPacketsForChannelResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesResponse", value: query_13.QueryTotalRecvFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeRequest", value: query_15.QueryCounterpartyPayeeRequest.fromPartial(value) };
            }
            catch (e) {
