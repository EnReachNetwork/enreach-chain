...
exports.queryClient = exports.txClient = exports.registry = exports.MsgPayPacketFeeResponse = exports.MsgRegisterCounterpartyPayee = exports.ForwardRelayerAddress = exports.RegisteredCounterpartyPayee = exports.QueryFeeEnabledChannelsResponse = exports.QueryCounterpartyPayeeResponse = exports.QueryTotalRecvFeesResponse = exports.QueryIncentivizedPacketRequest = exports.QueryIncentivizedPacketsRequest = exports.Fee = exports.QueryTotalRecvFeesRequest = exports.IdentifiedPacketFees = exports.MsgRegisterCounterpartyPayeeResponse = exports.MsgRegisterPayeeResponse = exports.QueryPayeeRequest = exports.QueryIncentivizedPacketsResponse = exports.MsgPayPacketFee = exports.GenesisState = exports.QueryFeeEnabledChannelResponse = exports.QueryTotalTimeoutFeesRequest = exports.QueryTotalAckFeesResponse = exports.QueryIncentivizedPacketsForChannelResponse = exports.QueryCounterpartyPayeeRequest = exports.Metadata = exports.PacketFee = exports.MsgPayPacketFeeAsyncResponse = exports.IncentivizedAcknowledgement = exports.QueryFeeEnabledChannelRequest = exports.QueryIncentivizedPacketResponse = exports.MsgRegisterPayee = exports.PacketFees = exports.MsgPayPacketFeeAsync = exports.RegisteredPayee = exports.FeeEnabledChannel = exports.QueryFeeEnabledChannelsRequest = exports.QueryPayeeResponse = exports.QueryTotalTimeoutFeesResponse = exports.QueryIncentivizedPacketsForChannelRequest = exports.QueryTotalAckFeesRequest = void 0;
...
Object.defineProperty(exports, "QueryIncentivizedPacketsForChannelRequest", { enumerable: true, get: function () { return query_2.QueryIncentivizedPacketsForChannelRequest; } });
...
Object.defineProperty(exports, "QueryPayeeResponse", { enumerable: true, get: function () { return query_4.QueryPayeeResponse; } });
...
Object.defineProperty(exports, "RegisteredPayee", { enumerable: true, get: function () { return genesis_2.RegisteredPayee; } });
...
Object.defineProperty(exports, "MsgRegisterPayee", { enumerable: true, get: function () { return tx_2.MsgRegisterPayee; } });
...
Object.defineProperty(exports, "QueryFeeEnabledChannelRequest", { enumerable: true, get: function () { return query_7.QueryFeeEnabledChannelRequest; } });
...
Object.defineProperty(exports, "MsgPayPacketFeeAsyncResponse", { enumerable: true, get: function () { return tx_3.MsgPayPacketFeeAsyncResponse; } });
...
Object.defineProperty(exports, "QueryCounterpartyPayeeRequest", { enumerable: true, get: function () { return query_8.QueryCounterpartyPayeeRequest; } });
...
Object.defineProperty(exports, "QueryTotalAckFeesResponse", { enumerable: true, get: function () { return query_10.QueryTotalAckFeesResponse; } });
const query_11 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalTimeoutFeesRequest", { enumerable: true, get: function () { return query_11.QueryTotalTimeoutFeesRequest; } });
const query_12 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryFeeEnabledChannelResponse", { enumerable: true, get: function () { return query_12.QueryFeeEnabledChannelResponse; } });
...
Object.defineProperty(exports, "MsgPayPacketFee", { enumerable: true, get: function () { return tx_4.MsgPayPacketFee; } });
...
Object.defineProperty(exports, "QueryPayeeRequest", { enumerable: true, get: function () { return query_14.QueryPayeeRequest; } });
const tx_5 = require("./types/ibc/applications/fee/v1/tx");
Object.defineProperty(exports, "MsgRegisterPayeeResponse", { enumerable: true, get: function () { return tx_5.MsgRegisterPayeeResponse; } });
...
Object.defineProperty(exports, "QueryTotalRecvFeesResponse", { enumerable: true, get: function () { return query_18.QueryTotalRecvFeesResponse; } });
const query_19 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryCounterpartyPayeeResponse", { enumerable: true, get: function () { return query_19.QueryCounterpartyPayeeResponse; } });
    ...
    return {
        ...
        async sendQueryIncentivizedPacketsForChannelRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsForChannelRequest({ value: query_2.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeResponse({ value: query_4.QueryPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendRegisteredPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.registeredPayee({ value: genesis_2.RegisteredPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPayPacketFeeAsync({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPayPacketFeeAsync({ value: tx_1.MsgPayPacketFeeAsync.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterPayee({ value: tx_2.MsgRegisterPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelRequest({ value: query_7.QueryFeeEnabledChannelRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPayPacketFeeAsyncResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPayPacketFeeAsyncResponse({ value: tx_3.MsgPayPacketFeeAsyncResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeRequest({ value: query_8.QueryCounterpartyPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalAckFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalAckFeesResponse({ value: query_10.QueryTotalAckFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalTimeoutFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalTimeoutFeesRequest({ value: query_11.QueryTotalTimeoutFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelResponse({ value: query_12.QueryFeeEnabledChannelResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPayPacketFee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPayPacketFee({ value: tx_4.MsgPayPacketFee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeRequest({ value: query_14.QueryPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterPayeeResponse({ value: tx_5.MsgRegisterPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesResponse({ value: query_18.QueryTotalRecvFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeResponse({ value: query_19.QueryCounterpartyPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryIncentivizedPacketsForChannelRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsForChannelRequest", value: query_2.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeResponse", value: query_4.QueryPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        registeredPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.RegisteredPayee", value: genesis_2.RegisteredPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPayPacketFeeAsync({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgPayPacketFeeAsync", value: tx_1.MsgPayPacketFeeAsync.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterPayee", value: tx_2.MsgRegisterPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelRequest", value: query_7.QueryFeeEnabledChannelRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPayPacketFeeAsyncResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgPayPacketFeeAsyncResponse", value: tx_3.MsgPayPacketFeeAsyncResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeRequest", value: query_8.QueryCounterpartyPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalAckFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalAckFeesResponse", value: query_10.QueryTotalAckFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesRequest", value: query_11.QueryTotalTimeoutFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelResponse", value: query_12.QueryFeeEnabledChannelResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPayPacketFee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgPayPacketFee", value: tx_4.MsgPayPacketFee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeRequest", value: query_14.QueryPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterPayeeResponse", value: tx_5.MsgRegisterPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesResponse", value: query_18.QueryTotalRecvFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeResponse", value: query_19.QueryCounterpartyPayeeResponse.fromPartial(value) };
            }
            catch (e) {
