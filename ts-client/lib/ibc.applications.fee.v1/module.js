...
exports.queryClient = exports.txClient = exports.registry = exports.QueryCounterpartyPayeeRequest = exports.QueryPayeeRequest = exports.QueryTotalAckFeesResponse = exports.QueryTotalRecvFeesResponse = exports.QueryTotalRecvFeesRequest = exports.RegisteredCounterpartyPayee = exports.RegisteredPayee = exports.FeeEnabledChannel = exports.MsgRegisterPayeeResponse = exports.QueryFeeEnabledChannelsResponse = exports.QueryPayeeResponse = exports.IncentivizedAcknowledgement = exports.ForwardRelayerAddress = exports.MsgPayPacketFeeAsync = exports.MsgRegisterCounterpartyPayeeResponse = exports.GenesisState = exports.MsgRegisterPayee = exports.Metadata = exports.QueryCounterpartyPayeeResponse = exports.QueryTotalTimeoutFeesRequest = exports.QueryIncentivizedPacketsForChannelResponse = exports.MsgPayPacketFeeResponse = exports.QueryFeeEnabledChannelsRequest = exports.QueryIncentivizedPacketsForChannelRequest = exports.QueryIncentivizedPacketsResponse = exports.PacketFees = exports.Fee = exports.MsgPayPacketFeeAsyncResponse = exports.IdentifiedPacketFees = exports.QueryFeeEnabledChannelResponse = exports.QueryFeeEnabledChannelRequest = exports.QueryTotalTimeoutFeesResponse = exports.QueryIncentivizedPacketRequest = exports.QueryIncentivizedPacketsRequest = exports.QueryTotalAckFeesRequest = exports.QueryIncentivizedPacketResponse = exports.MsgPayPacketFee = exports.MsgRegisterCounterpartyPayee = exports.PacketFee = void 0;
...
Object.defineProperty(exports, "QueryIncentivizedPacketsRequest", { enumerable: true, get: function () { return query_3.QueryIncentivizedPacketsRequest; } });
...
Object.defineProperty(exports, "QueryFeeEnabledChannelsRequest", { enumerable: true, get: function () { return query_10.QueryFeeEnabledChannelsRequest; } });
const tx_4 = require("./types/ibc/applications/fee/v1/tx");
Object.defineProperty(exports, "MsgPayPacketFeeResponse", { enumerable: true, get: function () { return tx_4.MsgPayPacketFeeResponse; } });
...
Object.defineProperty(exports, "QueryTotalTimeoutFeesRequest", { enumerable: true, get: function () { return query_12.QueryTotalTimeoutFeesRequest; } });
const query_13 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryCounterpartyPayeeResponse", { enumerable: true, get: function () { return query_13.QueryCounterpartyPayeeResponse; } });
...
Object.defineProperty(exports, "QueryPayeeResponse", { enumerable: true, get: function () { return query_14.QueryPayeeResponse; } });
const query_15 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryFeeEnabledChannelsResponse", { enumerable: true, get: function () { return query_15.QueryFeeEnabledChannelsResponse; } });
...
Object.defineProperty(exports, "QueryTotalRecvFeesRequest", { enumerable: true, get: function () { return query_16.QueryTotalRecvFeesRequest; } });
...
Object.defineProperty(exports, "QueryCounterpartyPayeeRequest", { enumerable: true, get: function () { return query_20.QueryCounterpartyPayeeRequest; } });
    ...
    return {
        async sendPacketFee({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.packetFee({ value: fee_1.PacketFee.fromPartial(value) });
        ...
        async sendQueryIncentivizedPacketsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsRequest({ value: query_3.QueryIncentivizedPacketsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelsRequest({ value: query_10.QueryFeeEnabledChannelsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPayPacketFeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPayPacketFeeResponse({ value: tx_4.MsgPayPacketFeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalTimeoutFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalTimeoutFeesRequest({ value: query_12.QueryTotalTimeoutFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeResponse({ value: query_13.QueryCounterpartyPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeResponse({ value: query_14.QueryPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelsResponse({ value: query_15.QueryFeeEnabledChannelsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesRequest({ value: query_16.QueryTotalRecvFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeRequest({ value: query_20.QueryCounterpartyPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        packetFee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.PacketFee", value: fee_1.PacketFee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsRequest", value: query_3.QueryIncentivizedPacketsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelsRequest", value: query_10.QueryFeeEnabledChannelsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPayPacketFeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgPayPacketFeeResponse", value: tx_4.MsgPayPacketFeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesRequest", value: query_12.QueryTotalTimeoutFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeResponse", value: query_13.QueryCounterpartyPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeResponse", value: query_14.QueryPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelsResponse", value: query_15.QueryFeeEnabledChannelsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesRequest", value: query_16.QueryTotalRecvFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeRequest", value: query_20.QueryCounterpartyPayeeRequest.fromPartial(value) };
            }
            catch (e) {
