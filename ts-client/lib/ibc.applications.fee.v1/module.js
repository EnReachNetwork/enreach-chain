...
exports.queryClient = exports.txClient = exports.registry = exports.MsgPayPacketFeeAsync = exports.MsgPayPacketFee = exports.QueryFeeEnabledChannelsRequest = exports.QueryTotalRecvFeesResponse = exports.ForwardRelayerAddress = exports.QueryFeeEnabledChannelRequest = exports.QueryTotalAckFeesResponse = exports.QueryTotalAckFeesRequest = exports.QueryIncentivizedPacketResponse = exports.QueryIncentivizedPacketsRequest = exports.IncentivizedAcknowledgement = exports.FeeEnabledChannel = exports.GenesisState = exports.QueryCounterpartyPayeeResponse = exports.QueryPayeeResponse = exports.QueryTotalRecvFeesRequest = exports.QueryIncentivizedPacketsForChannelResponse = exports.QueryIncentivizedPacketsForChannelRequest = exports.QueryIncentivizedPacketRequest = exports.Metadata = exports.MsgRegisterCounterpartyPayee = exports.MsgRegisterPayeeResponse = exports.QueryFeeEnabledChannelsResponse = exports.MsgPayPacketFeeResponse = exports.QueryFeeEnabledChannelResponse = exports.QueryCounterpartyPayeeRequest = exports.QueryTotalTimeoutFeesRequest = exports.IdentifiedPacketFees = exports.PacketFees = exports.MsgPayPacketFeeAsyncResponse = exports.MsgRegisterCounterpartyPayeeResponse = exports.MsgRegisterPayee = exports.RegisteredPayee = exports.PacketFee = exports.Fee = exports.QueryPayeeRequest = exports.QueryTotalTimeoutFeesResponse = exports.RegisteredCounterpartyPayee = exports.QueryIncentivizedPacketsResponse = void 0;
...
Object.defineProperty(exports, "QueryTotalTimeoutFeesResponse", { enumerable: true, get: function () { return query_2.QueryTotalTimeoutFeesResponse; } });
...
Object.defineProperty(exports, "PacketFees", { enumerable: true, get: function () { return fee_3.PacketFees; } });
...
Object.defineProperty(exports, "QueryFeeEnabledChannelsResponse", { enumerable: true, get: function () { return query_7.QueryFeeEnabledChannelsResponse; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketRequest", { enumerable: true, get: function () { return query_8.QueryIncentivizedPacketRequest; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketResponse", { enumerable: true, get: function () { return query_15.QueryIncentivizedPacketResponse; } });
const query_16 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalAckFeesRequest", { enumerable: true, get: function () { return query_16.QueryTotalAckFeesRequest; } });
const query_17 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalAckFeesResponse", { enumerable: true, get: function () { return query_17.QueryTotalAckFeesResponse; } });
...
Object.defineProperty(exports, "MsgPayPacketFeeAsync", { enumerable: true, get: function () { return tx_8.MsgPayPacketFeeAsync; } });
    ...
    return {
        async sendQueryIncentivizedPacketsResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryIncentivizedPacketsResponse({ value: query_1.QueryIncentivizedPacketsResponse.fromPartial(value) });
        ...
        async sendQueryTotalTimeoutFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalTimeoutFeesResponse({ value: query_2.QueryTotalTimeoutFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPacketFees({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.packetFees({ value: fee_3.PacketFees.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelsResponse({ value: query_7.QueryFeeEnabledChannelsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketRequest({ value: query_8.QueryIncentivizedPacketRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketResponse({ value: query_15.QueryIncentivizedPacketResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalAckFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalAckFeesRequest({ value: query_16.QueryTotalAckFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalAckFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalAckFeesResponse({ value: query_17.QueryTotalAckFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgPayPacketFeeAsync({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPayPacketFeeAsync({ value: tx_8.MsgPayPacketFeeAsync.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryIncentivizedPacketsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsResponse", value: query_1.QueryIncentivizedPacketsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesResponse", value: query_2.QueryTotalTimeoutFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        packetFees({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.PacketFees", value: fee_3.PacketFees.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelsResponse", value: query_7.QueryFeeEnabledChannelsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketRequest", value: query_8.QueryIncentivizedPacketRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketResponse", value: query_15.QueryIncentivizedPacketResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalAckFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalAckFeesRequest", value: query_16.QueryTotalAckFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalAckFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalAckFeesResponse", value: query_17.QueryTotalAckFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPayPacketFeeAsync({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgPayPacketFeeAsync", value: tx_8.MsgPayPacketFeeAsync.fromPartial(value) };
            }
            catch (e) {
