...
exports.queryClient = exports.txClient = exports.registry = exports.Fee = exports.MsgRegisterCounterpartyPayee = exports.QueryTotalAckFeesResponse = exports.QueryIncentivizedPacketsResponse = exports.Metadata = exports.QueryFeeEnabledChannelResponse = exports.QueryFeeEnabledChannelsRequest = exports.QueryCounterpartyPayeeRequest = exports.QueryTotalRecvFeesResponse = exports.QueryTotalRecvFeesRequest = exports.QueryIncentivizedPacketResponse = exports.QueryIncentivizedPacketsRequest = exports.RegisteredCounterpartyPayee = exports.RegisteredPayee = exports.MsgPayPacketFeeAsync = exports.QueryFeeEnabledChannelRequest = exports.PacketFee = exports.QueryFeeEnabledChannelsResponse = exports.QueryCounterpartyPayeeResponse = exports.QueryIncentivizedPacketsForChannelResponse = exports.QueryIncentivizedPacketsForChannelRequest = exports.PacketFees = exports.QueryTotalAckFeesRequest = exports.ForwardRelayerAddress = exports.GenesisState = exports.MsgPayPacketFeeAsyncResponse = exports.MsgRegisterPayee = exports.QueryTotalTimeoutFeesRequest = exports.IdentifiedPacketFees = exports.MsgPayPacketFee = exports.QueryPayeeResponse = exports.QueryPayeeRequest = exports.FeeEnabledChannel = exports.MsgRegisterPayeeResponse = exports.QueryIncentivizedPacketRequest = exports.MsgPayPacketFeeResponse = exports.MsgRegisterCounterpartyPayeeResponse = exports.IncentivizedAcknowledgement = exports.QueryTotalTimeoutFeesResponse = void 0;
...
Object.defineProperty(exports, "MsgPayPacketFeeResponse", { enumerable: true, get: function () { return tx_2.MsgPayPacketFeeResponse; } });
const query_2 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryIncentivizedPacketRequest", { enumerable: true, get: function () { return query_2.QueryIncentivizedPacketRequest; } });
...
Object.defineProperty(exports, "QueryPayeeRequest", { enumerable: true, get: function () { return query_3.QueryPayeeRequest; } });
...
Object.defineProperty(exports, "QueryTotalTimeoutFeesRequest", { enumerable: true, get: function () { return query_5.QueryTotalTimeoutFeesRequest; } });
const tx_5 = require("./types/ibc/applications/fee/v1/tx");
Object.defineProperty(exports, "MsgRegisterPayee", { enumerable: true, get: function () { return tx_5.MsgRegisterPayee; } });
...
Object.defineProperty(exports, "QueryCounterpartyPayeeResponse", { enumerable: true, get: function () { return query_9.QueryCounterpartyPayeeResponse; } });
...
Object.defineProperty(exports, "RegisteredCounterpartyPayee", { enumerable: true, get: function () { return genesis_5.RegisteredCounterpartyPayee; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketResponse", { enumerable: true, get: function () { return query_13.QueryIncentivizedPacketResponse; } });
const query_14 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalRecvFeesRequest", { enumerable: true, get: function () { return query_14.QueryTotalRecvFeesRequest; } });
const query_15 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalRecvFeesResponse", { enumerable: true, get: function () { return query_15.QueryTotalRecvFeesResponse; } });
...
Object.defineProperty(exports, "QueryFeeEnabledChannelsRequest", { enumerable: true, get: function () { return query_17.QueryFeeEnabledChannelsRequest; } });
...
Object.defineProperty(exports, "QueryTotalAckFeesResponse", { enumerable: true, get: function () { return query_20.QueryTotalAckFeesResponse; } });
    ...
    return {
        async sendQueryTotalTimeoutFeesResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryTotalTimeoutFeesResponse({ value: query_1.QueryTotalTimeoutFeesResponse.fromPartial(value) });
        ...
        async sendMsgPayPacketFeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgPayPacketFeeResponse({ value: tx_2.MsgPayPacketFeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketRequest({ value: query_2.QueryIncentivizedPacketRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeRequest({ value: query_3.QueryPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalTimeoutFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalTimeoutFeesRequest({ value: query_5.QueryTotalTimeoutFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterPayee({ value: tx_5.MsgRegisterPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeResponse({ value: query_9.QueryCounterpartyPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendRegisteredCounterpartyPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.registeredCounterpartyPayee({ value: genesis_5.RegisteredCounterpartyPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketResponse({ value: query_13.QueryIncentivizedPacketResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesRequest({ value: query_14.QueryTotalRecvFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesResponse({ value: query_15.QueryTotalRecvFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelsRequest({ value: query_17.QueryFeeEnabledChannelsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalAckFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalAckFeesResponse({ value: query_20.QueryTotalAckFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesResponse", value: query_1.QueryTotalTimeoutFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgPayPacketFeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgPayPacketFeeResponse", value: tx_2.MsgPayPacketFeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketRequest", value: query_2.QueryIncentivizedPacketRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeRequest", value: query_3.QueryPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesRequest", value: query_5.QueryTotalTimeoutFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterPayee", value: tx_5.MsgRegisterPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeResponse", value: query_9.QueryCounterpartyPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        registeredCounterpartyPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.RegisteredCounterpartyPayee", value: genesis_5.RegisteredCounterpartyPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketResponse", value: query_13.QueryIncentivizedPacketResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesRequest", value: query_14.QueryTotalRecvFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesResponse", value: query_15.QueryTotalRecvFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelsRequest", value: query_17.QueryFeeEnabledChannelsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalAckFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalAckFeesResponse", value: query_20.QueryTotalAckFeesResponse.fromPartial(value) };
            }
            catch (e) {
