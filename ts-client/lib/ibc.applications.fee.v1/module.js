...
exports.queryClient = exports.txClient = exports.registry = exports.QueryIncentivizedPacketsForChannelResponse = exports.QueryIncentivizedPacketResponse = exports.QueryIncentivizedPacketRequest = exports.QueryIncentivizedPacketsRequest = exports.QueryCounterpartyPayeeResponse = exports.QueryTotalTimeoutFeesResponse = exports.QueryTotalRecvFeesResponse = exports.QueryPayeeResponse = exports.QueryTotalAckFeesResponse = exports.QueryTotalAckFeesRequest = exports.QueryIncentivizedPacketsResponse = exports.MsgPayPacketFeeAsyncResponse = exports.MsgPayPacketFeeResponse = exports.MsgRegisterCounterpartyPayee = exports.QueryFeeEnabledChannelsRequest = exports.QueryIncentivizedPacketsForChannelRequest = exports.IdentifiedPacketFees = exports.Fee = exports.MsgRegisterPayeeResponse = exports.QueryFeeEnabledChannelRequest = exports.QueryPayeeRequest = exports.QueryTotalTimeoutFeesRequest = exports.MsgPayPacketFee = exports.MsgRegisterCounterpartyPayeeResponse = exports.PacketFees = exports.IncentivizedAcknowledgement = exports.MsgRegisterPayee = exports.QueryFeeEnabledChannelResponse = exports.QueryCounterpartyPayeeRequest = exports.QueryTotalRecvFeesRequest = exports.RegisteredCounterpartyPayee = exports.RegisteredPayee = exports.PacketFee = exports.GenesisState = exports.QueryFeeEnabledChannelsResponse = exports.Metadata = exports.ForwardRelayerAddress = exports.FeeEnabledChannel = exports.MsgPayPacketFeeAsync = void 0;
...
Object.defineProperty(exports, "QueryTotalRecvFeesRequest", { enumerable: true, get: function () { return query_2.QueryTotalRecvFeesRequest; } });
const query_3 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryCounterpartyPayeeRequest", { enumerable: true, get: function () { return query_3.QueryCounterpartyPayeeRequest; } });
...
Object.defineProperty(exports, "MsgRegisterCounterpartyPayeeResponse", { enumerable: true, get: function () { return tx_3.MsgRegisterCounterpartyPayeeResponse; } });
...
Object.defineProperty(exports, "QueryPayeeRequest", { enumerable: true, get: function () { return query_6.QueryPayeeRequest; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsForChannelRequest", { enumerable: true, get: function () { return query_8.QueryIncentivizedPacketsForChannelRequest; } });
...
Object.defineProperty(exports, "MsgRegisterCounterpartyPayee", { enumerable: true, get: function () { return tx_6.MsgRegisterCounterpartyPayee; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsResponse", { enumerable: true, get: function () { return query_10.QueryIncentivizedPacketsResponse; } });
...
Object.defineProperty(exports, "QueryPayeeResponse", { enumerable: true, get: function () { return query_13.QueryPayeeResponse; } });
const query_14 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalRecvFeesResponse", { enumerable: true, get: function () { return query_14.QueryTotalRecvFeesResponse; } });
const query_15 = require("./types/ibc/applications/fee/v1/query");
Object.defineProperty(exports, "QueryTotalTimeoutFeesResponse", { enumerable: true, get: function () { return query_15.QueryTotalTimeoutFeesResponse; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketRequest", { enumerable: true, get: function () { return query_18.QueryIncentivizedPacketRequest; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsForChannelResponse", { enumerable: true, get: function () { return query_20.QueryIncentivizedPacketsForChannelResponse; } });
    ...
    return {
        ...
        async sendQueryTotalRecvFeesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesRequest({ value: query_2.QueryTotalRecvFeesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeRequest({ value: query_3.QueryCounterpartyPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterCounterpartyPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterCounterpartyPayeeResponse({ value: tx_3.MsgRegisterCounterpartyPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeRequest({ value: query_6.QueryPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsForChannelRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsForChannelRequest({ value: query_8.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterCounterpartyPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterCounterpartyPayee({ value: tx_6.MsgRegisterCounterpartyPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsResponse({ value: query_10.QueryIncentivizedPacketsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryPayeeResponse({ value: query_13.QueryPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalRecvFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalRecvFeesResponse({ value: query_14.QueryTotalRecvFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalTimeoutFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalTimeoutFeesResponse({ value: query_15.QueryTotalTimeoutFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketRequest({ value: query_18.QueryIncentivizedPacketRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsForChannelResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsForChannelResponse({ value: query_20.QueryIncentivizedPacketsForChannelResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryTotalRecvFeesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesRequest", value: query_2.QueryTotalRecvFeesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeRequest", value: query_3.QueryCounterpartyPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterCounterpartyPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterCounterpartyPayeeResponse", value: tx_3.MsgRegisterCounterpartyPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeRequest", value: query_6.QueryPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsForChannelRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsForChannelRequest", value: query_8.QueryIncentivizedPacketsForChannelRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterCounterpartyPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterCounterpartyPayee", value: tx_6.MsgRegisterCounterpartyPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsResponse", value: query_10.QueryIncentivizedPacketsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryPayeeResponse", value: query_13.QueryPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalRecvFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalRecvFeesResponse", value: query_14.QueryTotalRecvFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalTimeoutFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalTimeoutFeesResponse", value: query_15.QueryTotalTimeoutFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketRequest", value: query_18.QueryIncentivizedPacketRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsForChannelResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsForChannelResponse", value: query_20.QueryIncentivizedPacketsForChannelResponse.fromPartial(value) };
            }
            catch (e) {
