...
exports.queryClient = exports.txClient = exports.registry = exports.QueryIncentivizedPacketResponse = exports.IdentifiedPacketFees = exports.MsgPayPacketFeeAsyncResponse = exports.QueryFeeEnabledChannelsResponse = exports.QueryFeeEnabledChannelsRequest = exports.QueryPayeeResponse = exports.QueryTotalTimeoutFeesResponse = exports.QueryTotalAckFeesRequest = exports.MsgPayPacketFeeAsync = exports.MsgRegisterCounterpartyPayeeResponse = exports.QueryPayeeRequest = exports.QueryTotalAckFeesResponse = exports.QueryTotalRecvFeesRequest = exports.RegisteredPayee = exports.QueryCounterpartyPayeeResponse = exports.QueryIncentivizedPacketRequest = exports.MsgPayPacketFeeResponse = exports.PacketFee = exports.MsgRegisterPayee = exports.IncentivizedAcknowledgement = exports.QueryIncentivizedPacketsRequest = exports.FeeEnabledChannel = exports.QueryIncentivizedPacketsResponse = exports.RegisteredCounterpartyPayee = exports.PacketFees = exports.QueryFeeEnabledChannelResponse = exports.QueryFeeEnabledChannelRequest = exports.QueryTotalTimeoutFeesRequest = exports.QueryIncentivizedPacketsForChannelRequest = exports.Metadata = exports.ForwardRelayerAddress = exports.MsgRegisterCounterpartyPayee = exports.QueryTotalRecvFeesResponse = exports.QueryIncentivizedPacketsForChannelResponse = exports.Fee = exports.QueryCounterpartyPayeeRequest = exports.MsgPayPacketFee = exports.MsgRegisterPayeeResponse = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "MsgRegisterCounterpartyPayee", { enumerable: true, get: function () { return tx_3.MsgRegisterCounterpartyPayee; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketsRequest", { enumerable: true, get: function () { return query_9.QueryIncentivizedPacketsRequest; } });
...
Object.defineProperty(exports, "QueryCounterpartyPayeeResponse", { enumerable: true, get: function () { return query_11.QueryCounterpartyPayeeResponse; } });
...
Object.defineProperty(exports, "QueryTotalAckFeesResponse", { enumerable: true, get: function () { return query_13.QueryTotalAckFeesResponse; } });
...
Object.defineProperty(exports, "QueryFeeEnabledChannelsRequest", { enumerable: true, get: function () { return query_18.QueryFeeEnabledChannelsRequest; } });
...
Object.defineProperty(exports, "QueryIncentivizedPacketResponse", { enumerable: true, get: function () { return query_20.QueryIncentivizedPacketResponse; } });
    ...
    return {
        ...
        async sendQueryCounterpartyPayeeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeRequest({ value: query_1.QueryCounterpartyPayeeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterCounterpartyPayee({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterCounterpartyPayee({ value: tx_3.MsgRegisterCounterpartyPayee.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketsRequest({ value: query_9.QueryIncentivizedPacketsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCounterpartyPayeeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCounterpartyPayeeResponse({ value: query_11.QueryCounterpartyPayeeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryTotalAckFeesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryTotalAckFeesResponse({ value: query_13.QueryTotalAckFeesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryFeeEnabledChannelsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryFeeEnabledChannelsRequest({ value: query_18.QueryFeeEnabledChannelsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryIncentivizedPacketResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryIncentivizedPacketResponse({ value: query_20.QueryIncentivizedPacketResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryCounterpartyPayeeRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeRequest", value: query_1.QueryCounterpartyPayeeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterCounterpartyPayee({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.MsgRegisterCounterpartyPayee", value: tx_3.MsgRegisterCounterpartyPayee.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketsRequest", value: query_9.QueryIncentivizedPacketsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCounterpartyPayeeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryCounterpartyPayeeResponse", value: query_11.QueryCounterpartyPayeeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryTotalAckFeesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryTotalAckFeesResponse", value: query_13.QueryTotalAckFeesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryFeeEnabledChannelsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryFeeEnabledChannelsRequest", value: query_18.QueryFeeEnabledChannelsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryIncentivizedPacketResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.fee.v1.QueryIncentivizedPacketResponse", value: query_20.QueryIncentivizedPacketResponse.fromPartial(value) };
            }
            catch (e) {
