...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllNodeRequest = exports.QueryAllUserResponse = exports.MsgBindUserEVMAccountResponse = exports.MsgBindUserEVMAccount = exports.MsgCreateSuperior = exports.QueryGetNodeResponse = exports.QueryGetNodeRequest = exports.MsgUpdateParams = exports.QueryGetSuperiorRequest = exports.QueryGetUserResponse = exports.QueryParamsResponse = exports.MsgUnbindNode = exports.MsgBindAndActivateNodeResponse = exports.MsgBindAndActivateNode = exports.MsgCreateUser = exports.QueryAllNodeResponse = exports.QueryAllUserRequest = exports.GenesisState = exports.MsgUpdateSuperiorResponse = exports.MsgUnbindNodeResponse = exports.MsgRegisterNodeResponse = exports.MsgUpdateParamsResponse = exports.Params = exports.QueryGetSuperiorResponse = exports.QueryGetUserRequest = exports.QueryParamsRequest = exports.User = exports.Superior = exports.Node = exports.MsgCreateSuperiorResponse = exports.MsgRegisterNode = exports.MsgCreateUserResponse = exports.MsgUpdateSuperior = void 0;
...
Object.defineProperty(exports, "MsgRegisterNode", { enumerable: true, get: function () { return tx_3.MsgRegisterNode; } });
...
Object.defineProperty(exports, "MsgCreateUser", { enumerable: true, get: function () { return tx_9.MsgCreateUser; } });
...
Object.defineProperty(exports, "MsgUnbindNode", { enumerable: true, get: function () { return tx_12.MsgUnbindNode; } });
...
Object.defineProperty(exports, "MsgBindUserEVMAccountResponse", { enumerable: true, get: function () { return tx_16.MsgBindUserEVMAccountResponse; } });
...
Object.defineProperty(exports, "QueryAllNodeRequest", { enumerable: true, get: function () { return query_12.QueryAllNodeRequest; } });
    ...
    return {
        ...
        async sendMsgRegisterNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNode({ value: tx_3.MsgRegisterNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUser({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUser({ value: tx_9.MsgCreateUser.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNode({ value: tx_12.MsgUnbindNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccountResponse({ value: tx_16.MsgBindUserEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllNodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllNodeRequest({ value: query_12.QueryAllNodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRegisterNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNode", value: tx_3.MsgRegisterNode.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateParamsResponse", value: tx_5.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUser({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUser", value: tx_9.MsgCreateUser.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNode", value: tx_12.MsgUnbindNode.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetSuperiorRequest", value: query_8.QueryGetSuperiorRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateSuperior", value: tx_14.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccountResponse", value: tx_16.MsgBindUserEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllNodeRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllNodeRequest", value: query_12.QueryAllNodeRequest.fromPartial(value) };
            }
            catch (e) {
