...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetUserRequest = exports.MsgRegisterNode = exports.MsgCreateUserResponse = exports.Superior = exports.User = exports.QueryParamsResponse = exports.MsgUnbindNode = exports.QueryAllNodeRequest = exports.QueryGetNodeResponse = exports.QueryAllUserResponse = exports.Node = exports.MsgCreateSuperior = exports.MsgRegisterNodeResponse = exports.QueryAllUserRequest = exports.MsgUpdateSuperiorResponse = exports.MsgCreateSuperiorResponse = exports.QueryGetSuperiorResponse = exports.GenesisState = exports.MsgBindAndActivateNode = exports.MsgBindUserEVMAccountResponse = exports.MsgBindUserEVMAccount = exports.MsgCreateUser = exports.QueryParamsRequest = exports.Params = exports.MsgUpdateSuperior = exports.MsgBindAndActivateNodeResponse = exports.QueryAllNodeResponse = exports.QueryGetNodeRequest = exports.QueryGetUserResponse = exports.MsgUnbindNodeResponse = exports.MsgUpdateParams = exports.QueryGetSuperiorRequest = exports.MsgUpdateParamsResponse = void 0;
...
Object.defineProperty(exports, "MsgBindAndActivateNodeResponse", { enumerable: true, get: function () { return tx_4.MsgBindAndActivateNodeResponse; } });
...
Object.defineProperty(exports, "MsgBindUserEVMAccount", { enumerable: true, get: function () { return tx_7.MsgBindUserEVMAccount; } });
const tx_8 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgBindUserEVMAccountResponse", { enumerable: true, get: function () { return tx_8.MsgBindUserEVMAccountResponse; } });
...
Object.defineProperty(exports, "MsgRegisterNodeResponse", { enumerable: true, get: function () { return tx_12.MsgRegisterNodeResponse; } });
const tx_13 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgCreateSuperior", { enumerable: true, get: function () { return tx_13.MsgCreateSuperior; } });
...
Object.defineProperty(exports, "QueryAllNodeRequest", { enumerable: true, get: function () { return query_10.QueryAllNodeRequest; } });
const tx_14 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgUnbindNode", { enumerable: true, get: function () { return tx_14.MsgUnbindNode; } });
    ...
    return {
        ...
        async sendMsgBindAndActivateNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindAndActivateNodeResponse({ value: tx_4.MsgBindAndActivateNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccount({ value: tx_7.MsgBindUserEVMAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccountResponse({ value: tx_8.MsgBindUserEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNodeResponse({ value: tx_12.MsgRegisterNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateSuperior({ value: tx_13.MsgCreateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllNodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllNodeRequest({ value: query_10.QueryAllNodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNode({ value: tx_14.MsgUnbindNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateParams", value: tx_2.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindAndActivateNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindAndActivateNodeResponse", value: tx_4.MsgBindAndActivateNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryParamsRequest", value: query_5.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUser({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUser", value: tx_6.MsgCreateUser.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccount({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccount", value: tx_7.MsgBindUserEVMAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccountResponse", value: tx_8.MsgBindUserEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNodeResponse", value: tx_12.MsgRegisterNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateSuperior", value: tx_13.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllNodeRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllNodeRequest", value: query_10.QueryAllNodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNode", value: tx_14.MsgUnbindNode.fromPartial(value) };
            }
            catch (e) {
