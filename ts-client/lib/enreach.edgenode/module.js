...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.QueryGetUserResponse = exports.User = exports.MsgUnbindNodeResponse = exports.MsgBindUserEVMAccount = exports.MsgCreateUser = exports.MsgBindUserEVMAccountResponse = exports.QueryGetSuperiorRequest = exports.QueryAllUserResponse = exports.QueryGetUserRequest = exports.MsgBindAndActivateNode = exports.QueryGetNodeResponse = exports.MsgUpdateParamsResponse = exports.QueryGetNodeRequest = exports.MsgCreateUserResponse = exports.QueryParamsResponse = exports.MsgUpdateSuperiorResponse = exports.MsgUpdateSuperior = exports.MsgUnbindNode = exports.Params = exports.QueryAllUserRequest = exports.MsgCreateSuperior = exports.MsgRegisterNode = exports.QueryGetSuperiorResponse = exports.Node = exports.MsgBindAndActivateNodeResponse = exports.MsgRegisterNodeResponse = exports.MsgCreateSuperiorResponse = exports.QueryAllNodeResponse = exports.QueryAllNodeRequest = exports.QueryParamsRequest = exports.GenesisState = exports.Superior = void 0;
...
Object.defineProperty(exports, "MsgCreateSuperiorResponse", { enumerable: true, get: function () { return tx_1.MsgCreateSuperiorResponse; } });
const tx_2 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgRegisterNodeResponse", { enumerable: true, get: function () { return tx_2.MsgRegisterNodeResponse; } });
...
Object.defineProperty(exports, "MsgRegisterNode", { enumerable: true, get: function () { return tx_4.MsgRegisterNode; } });
...
Object.defineProperty(exports, "MsgUnbindNode", { enumerable: true, get: function () { return tx_6.MsgUnbindNode; } });
...
Object.defineProperty(exports, "MsgCreateUserResponse", { enumerable: true, get: function () { return tx_9.MsgCreateUserResponse; } });
...
Object.defineProperty(exports, "QueryAllUserResponse", { enumerable: true, get: function () { return query_10.QueryAllUserResponse; } });
...
Object.defineProperty(exports, "MsgBindUserEVMAccountResponse", { enumerable: true, get: function () { return tx_12.MsgBindUserEVMAccountResponse; } });
...
Object.defineProperty(exports, "MsgBindUserEVMAccount", { enumerable: true, get: function () { return tx_14.MsgBindUserEVMAccount; } });
const tx_15 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgUnbindNodeResponse", { enumerable: true, get: function () { return tx_15.MsgUnbindNodeResponse; } });
const user_1 = require("./types/enreach/edgenode/user");
Object.defineProperty(exports, "User", { enumerable: true, get: function () { return user_1.User; } });
const query_12 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryGetUserResponse", { enumerable: true, get: function () { return query_12.QueryGetUserResponse; } });
    ...
    return {
        ...
        async sendMsgCreateSuperiorResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateSuperiorResponse({ value: tx_1.MsgCreateSuperiorResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNodeResponse({ value: tx_2.MsgRegisterNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNode({ value: tx_4.MsgRegisterNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNode({ value: tx_6.MsgUnbindNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUserResponse({ value: tx_9.MsgCreateUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllUserResponse({ value: query_10.QueryAllUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccountResponse({ value: tx_12.MsgBindUserEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccount({ value: tx_14.MsgBindUserEVMAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNodeResponse({ value: tx_15.MsgUnbindNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetUserResponse({ value: query_12.QueryGetUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryParamsRequest", value: query_1.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateSuperiorResponse", value: tx_1.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNodeResponse", value: tx_2.MsgRegisterNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetSuperiorResponse", value: query_4.QueryGetSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNode", value: tx_4.MsgRegisterNode.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNode", value: tx_6.MsgUnbindNode.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryParamsResponse", value: query_6.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUserResponse", value: tx_9.MsgCreateUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateParamsResponse", value: tx_10.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllUserResponse", value: query_10.QueryAllUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccountResponse", value: tx_12.MsgBindUserEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccount({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccount", value: tx_14.MsgBindUserEVMAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNodeResponse", value: tx_15.MsgUnbindNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetUserResponse", value: query_12.QueryGetUserResponse.fromPartial(value) };
            }
            catch (e) {
