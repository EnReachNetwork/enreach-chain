...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetSuperiorRequest = exports.QueryAllUserRequest = exports.QueryAllNodeResponse = exports.QueryGetNodeResponse = exports.QueryGetUserRequest = exports.MsgUpdateParams = exports.MsgCreateSuperiorResponse = exports.MsgRegisterNode = exports.MsgBindAndActivateNodeResponse = exports.MsgUpdateParamsResponse = exports.QueryParamsRequest = exports.GenesisState = exports.MsgUnbindNode = exports.MsgUpdateSuperiorResponse = exports.MsgUnbindNodeResponse = exports.MsgBindUserEVMAccount = exports.QueryGetNodeRequest = exports.QueryGetUserResponse = exports.QueryParamsResponse = exports.Params = exports.MsgUpdateSuperior = exports.User = exports.MsgRegisterNodeResponse = exports.QueryAllUserResponse = exports.MsgCreateUserResponse = exports.Node = exports.MsgCreateUser = exports.QueryGetSuperiorResponse = exports.MsgBindUserEVMAccountResponse = exports.MsgBindAndActivateNode = exports.QueryAllNodeRequest = exports.MsgCreateSuperior = exports.Superior = void 0;
...
Object.defineProperty(exports, "MsgCreateSuperior", { enumerable: true, get: function () { return tx_1.MsgCreateSuperior; } });
...
Object.defineProperty(exports, "MsgCreateUser", { enumerable: true, get: function () { return tx_4.MsgCreateUser; } });
const node_1 = require("./types/enreach/edgenode/node");
Object.defineProperty(exports, "Node", { enumerable: true, get: function () { return node_1.Node; } });
const tx_5 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgCreateUserResponse", { enumerable: true, get: function () { return tx_5.MsgCreateUserResponse; } });
const query_3 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryAllUserResponse", { enumerable: true, get: function () { return query_3.QueryAllUserResponse; } });
const tx_6 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgRegisterNodeResponse", { enumerable: true, get: function () { return tx_6.MsgRegisterNodeResponse; } });
...
Object.defineProperty(exports, "QueryGetUserResponse", { enumerable: true, get: function () { return query_5.QueryGetUserResponse; } });
const query_6 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryGetNodeRequest", { enumerable: true, get: function () { return query_6.QueryGetNodeRequest; } });
...
Object.defineProperty(exports, "MsgUnbindNodeResponse", { enumerable: true, get: function () { return tx_9.MsgUnbindNodeResponse; } });
...
Object.defineProperty(exports, "MsgUnbindNode", { enumerable: true, get: function () { return tx_11.MsgUnbindNode; } });
...
Object.defineProperty(exports, "QueryGetNodeResponse", { enumerable: true, get: function () { return query_9.QueryGetNodeResponse; } });
const query_10 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryAllNodeResponse", { enumerable: true, get: function () { return query_10.QueryAllNodeResponse; } });
    ...
    return {
        ...
        async sendMsgCreateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateSuperior({ value: tx_1.MsgCreateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUser({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUser({ value: tx_4.MsgCreateUser.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUserResponse({ value: tx_5.MsgCreateUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllUserResponse({ value: query_3.QueryAllUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNodeResponse({ value: tx_6.MsgRegisterNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetUserResponse({ value: query_5.QueryGetUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetNodeRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetNodeRequest({ value: query_6.QueryGetNodeRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNodeResponse({ value: tx_9.MsgUnbindNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNode({ value: tx_11.MsgUnbindNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetNodeResponse({ value: query_9.QueryGetNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllNodeResponse({ value: query_10.QueryAllNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateSuperior", value: tx_1.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUser({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUser", value: tx_4.MsgCreateUser.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUserResponse", value: tx_5.MsgCreateUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllUserResponse", value: query_3.QueryAllUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNodeResponse", value: tx_6.MsgRegisterNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetUserResponse", value: query_5.QueryGetUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetNodeRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetNodeRequest", value: query_6.QueryGetNodeRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNodeResponse", value: tx_9.MsgUnbindNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNode", value: tx_11.MsgUnbindNode.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetNodeResponse", value: query_9.QueryGetNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllNodeResponse", value: query_10.QueryAllNodeResponse.fromPartial(value) };
            }
            catch (e) {
