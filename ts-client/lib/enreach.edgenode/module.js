...
exports.queryClient = exports.txClient = exports.registry = exports.MsgBindAndActivateNodeResponse = exports.MsgCreateUserResponse = exports.QueryGetUserResponse = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.MsgBindAndActivateNode = exports.MsgUnbindNode = exports.MsgCreateUser = exports.QueryAllUserResponse = exports.QueryAllUserRequest = exports.GenesisState = exports.Params = exports.MsgUpdateNodeTrafficTypeBatchResponse = exports.MsgBindUserEVMAccountResponse = exports.Superior = exports.MsgUpdateSuperior = exports.MsgCreateSuperior = exports.MsgUpdateParams = exports.MsgUpdateSuperiorResponse = exports.MsgRegisterNodeResponse = exports.Node = exports.MsgRegisterNode = exports.User = exports.MsgBindUserEVMAccount = exports.QueryAllNodeRequest = exports.QueryGetNodeResponse = exports.QueryGetNodeRequest = exports.QueryGetUserRequest = exports.MsgCreateSuperiorResponse = exports.MsgUnbindNodeResponse = exports.MsgUpdateNodeTrafficTypeBatch = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorResponse = exports.QueryGetSuperiorRequest = exports.QueryAllNodeResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryAllNodeResponse", { enumerable: true, get: function () { return query_1.QueryAllNodeResponse; } });
...
Object.defineProperty(exports, "MsgUpdateNodeTrafficTypeBatch", { enumerable: true, get: function () { return tx_2.MsgUpdateNodeTrafficTypeBatch; } });
...
Object.defineProperty(exports, "QueryGetUserRequest", { enumerable: true, get: function () { return query_4.QueryGetUserRequest; } });
...
Object.defineProperty(exports, "MsgRegisterNodeResponse", { enumerable: true, get: function () { return tx_7.MsgRegisterNodeResponse; } });
...
Object.defineProperty(exports, "MsgUpdateNodeTrafficTypeBatchResponse", { enumerable: true, get: function () { return tx_13.MsgUpdateNodeTrafficTypeBatchResponse; } });
...
Object.defineProperty(exports, "QueryAllUserRequest", { enumerable: true, get: function () { return query_8.QueryAllUserRequest; } });
const query_9 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryAllUserResponse", { enumerable: true, get: function () { return query_9.QueryAllUserResponse; } });
const tx_14 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgCreateUser", { enumerable: true, get: function () { return tx_14.MsgCreateUser; } });
...
Object.defineProperty(exports, "MsgCreateUserResponse", { enumerable: true, get: function () { return tx_17.MsgCreateUserResponse; } });
const tx_18 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgBindAndActivateNodeResponse", { enumerable: true, get: function () { return tx_18.MsgBindAndActivateNodeResponse; } });
    ...
    return {
        async sendQueryAllNodeResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryAllNodeResponse({ value: query_1.QueryAllNodeResponse.fromPartial(value) });
        ...
        async sendMsgUpdateNodeTrafficTypeBatch({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateNodeTrafficTypeBatch({ value: tx_2.MsgUpdateNodeTrafficTypeBatch.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetUserRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetUserRequest({ value: query_4.QueryGetUserRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRegisterNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNodeResponse({ value: tx_7.MsgRegisterNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateNodeTrafficTypeBatchResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateNodeTrafficTypeBatchResponse({ value: tx_13.MsgUpdateNodeTrafficTypeBatchResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllUserRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllUserRequest({ value: query_8.QueryAllUserRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllUserResponse({ value: query_9.QueryAllUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUser({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUser({ value: tx_14.MsgCreateUser.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUserResponse({ value: tx_17.MsgCreateUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindAndActivateNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindAndActivateNodeResponse({ value: tx_18.MsgBindAndActivateNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllNodeResponse", value: query_1.QueryAllNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetSuperiorResponse", value: query_3.QueryGetSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateNodeTrafficTypeBatch({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateNodeTrafficTypeBatch", value: tx_2.MsgUpdateNodeTrafficTypeBatch.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetUserRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetUserRequest", value: query_4.QueryGetUserRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRegisterNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNodeResponse", value: tx_7.MsgRegisterNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateParams", value: tx_9.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateNodeTrafficTypeBatchResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateNodeTrafficTypeBatchResponse", value: tx_13.MsgUpdateNodeTrafficTypeBatchResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllUserRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllUserRequest", value: query_8.QueryAllUserRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllUserResponse", value: query_9.QueryAllUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUser({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUser", value: tx_14.MsgCreateUser.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryParamsRequest", value: query_10.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryParamsResponse", value: query_11.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUserResponse", value: tx_17.MsgCreateUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindAndActivateNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindAndActivateNodeResponse", value: tx_18.MsgBindAndActivateNodeResponse.fromPartial(value) };
            }
            catch (e) {
