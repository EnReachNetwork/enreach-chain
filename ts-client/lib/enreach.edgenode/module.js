...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetSuperiorRequest = exports.QueryAllNodeResponse = exports.QueryGetNodeRequest = exports.QueryParamsRequest = exports.MsgUpdateSuperiorResponse = exports.MsgUnbindNode = exports.QueryGetSuperiorResponse = exports.QueryAllNodeRequest = exports.Superior = exports.Node = exports.Params = exports.MsgRegisterNodeResponse = exports.MsgUpdateParams = exports.MsgCreateSuperior = exports.MsgCreateUserResponse = exports.MsgBindAndActivateNodeResponse = exports.QueryGetUserResponse = exports.QueryGetUserRequest = exports.QueryParamsResponse = exports.MsgBindAndActivateNode = exports.MsgBindUserEVMAccount = exports.MsgCreateUser = exports.GenesisState = exports.MsgCreateSuperiorResponse = exports.MsgBindUserEVMAccountResponse = exports.MsgUpdateSuperior = exports.QueryAllUserRequest = exports.MsgUnbindNodeResponse = exports.QueryAllUserResponse = exports.MsgRegisterNode = exports.MsgUpdateParamsResponse = exports.QueryGetNodeResponse = exports.User = void 0;
...
Object.defineProperty(exports, "MsgRegisterNode", { enumerable: true, get: function () { return tx_2.MsgRegisterNode; } });
const query_2 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryAllUserResponse", { enumerable: true, get: function () { return query_2.QueryAllUserResponse; } });
const tx_3 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgUnbindNodeResponse", { enumerable: true, get: function () { return tx_3.MsgUnbindNodeResponse; } });
...
Object.defineProperty(exports, "MsgUpdateSuperior", { enumerable: true, get: function () { return tx_4.MsgUpdateSuperior; } });
const tx_5 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgBindUserEVMAccountResponse", { enumerable: true, get: function () { return tx_5.MsgBindUserEVMAccountResponse; } });
...
Object.defineProperty(exports, "MsgCreateUser", { enumerable: true, get: function () { return tx_7.MsgCreateUser; } });
...
Object.defineProperty(exports, "MsgBindAndActivateNode", { enumerable: true, get: function () { return tx_9.MsgBindAndActivateNode; } });
...
Object.defineProperty(exports, "MsgBindAndActivateNodeResponse", { enumerable: true, get: function () { return tx_10.MsgBindAndActivateNodeResponse; } });
const tx_11 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgCreateUserResponse", { enumerable: true, get: function () { return tx_11.MsgCreateUserResponse; } });
...
Object.defineProperty(exports, "QueryAllNodeResponse", { enumerable: true, get: function () { return query_11.QueryAllNodeResponse; } });
    ...
    return {
        ...
        async sendMsgRegisterNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRegisterNode({ value: tx_2.MsgRegisterNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllUserResponse({ value: query_2.QueryAllUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUnbindNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUnbindNodeResponse({ value: tx_3.MsgUnbindNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateSuperior({ value: tx_4.MsgUpdateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccountResponse({ value: tx_5.MsgBindUserEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUser({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUser({ value: tx_7.MsgCreateUser.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindAndActivateNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindAndActivateNode({ value: tx_9.MsgBindAndActivateNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindAndActivateNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindAndActivateNodeResponse({ value: tx_10.MsgBindAndActivateNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateUserResponse({ value: tx_11.MsgCreateUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllNodeResponse({ value: query_11.QueryAllNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRegisterNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgRegisterNode", value: tx_2.MsgRegisterNode.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllUserResponse", value: query_2.QueryAllUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUnbindNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUnbindNodeResponse", value: tx_3.MsgUnbindNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateSuperior", value: tx_4.MsgUpdateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccountResponse", value: tx_5.MsgBindUserEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUser({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUser", value: tx_7.MsgCreateUser.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindAndActivateNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindAndActivateNode", value: tx_9.MsgBindAndActivateNode.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindAndActivateNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindAndActivateNodeResponse", value: tx_10.MsgBindAndActivateNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateUserResponse", value: tx_11.MsgCreateUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateSuperior", value: tx_12.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateParams", value: tx_13.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllNodeResponse", value: query_11.QueryAllNodeResponse.fromPartial(value) };
            }
            catch (e) {
