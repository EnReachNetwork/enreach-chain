...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetNodeResponse = exports.QueryGetUserResponse = exports.MsgUnbindNodeResponse = exports.MsgBindAndActivateNodeResponse = exports.QueryGetSuperiorResponse = exports.QueryAllNodeResponse = exports.MsgBindAndActivateNode = exports.MsgCreateUser = exports.MsgUpdateParams = exports.Node = exports.QueryGetUserRequest = exports.MsgCreateSuperior = exports.QueryAllUserResponse = exports.MsgBindUserEVMAccountResponse = exports.QueryAllUserRequest = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorRequest = exports.MsgCreateSuperiorResponse = exports.MsgUnbindNode = exports.MsgRegisterNode = exports.Superior = exports.QueryParamsRequest = exports.MsgUpdateSuperior = exports.User = exports.QueryAllNodeRequest = exports.MsgBindUserEVMAccount = exports.MsgRegisterNodeResponse = exports.MsgCreateUserResponse = exports.Params = exports.GenesisState = exports.QueryGetNodeRequest = exports.MsgUpdateSuperiorResponse = void 0;
...
Object.defineProperty(exports, "MsgBindUserEVMAccount", { enumerable: true, get: function () { return tx_4.MsgBindUserEVMAccount; } });
...
Object.defineProperty(exports, "QueryAllUserRequest", { enumerable: true, get: function () { return query_6.QueryAllUserRequest; } });
const tx_10 = require("./types/enreach/edgenode/tx");
Object.defineProperty(exports, "MsgBindUserEVMAccountResponse", { enumerable: true, get: function () { return tx_10.MsgBindUserEVMAccountResponse; } });
...
Object.defineProperty(exports, "QueryGetUserRequest", { enumerable: true, get: function () { return query_8.QueryGetUserRequest; } });
...
Object.defineProperty(exports, "MsgBindAndActivateNode", { enumerable: true, get: function () { return tx_14.MsgBindAndActivateNode; } });
...
Object.defineProperty(exports, "MsgBindAndActivateNodeResponse", { enumerable: true, get: function () { return tx_15.MsgBindAndActivateNodeResponse; } });
...
Object.defineProperty(exports, "QueryGetUserResponse", { enumerable: true, get: function () { return query_11.QueryGetUserResponse; } });
const query_12 = require("./types/enreach/edgenode/query");
Object.defineProperty(exports, "QueryGetNodeResponse", { enumerable: true, get: function () { return query_12.QueryGetNodeResponse; } });
    ...
    return {
        ...
        async sendMsgBindUserEVMAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccount({ value: tx_4.MsgBindUserEVMAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllUserRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllUserRequest({ value: query_6.QueryAllUserRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindUserEVMAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindUserEvmaccountResponse({ value: tx_10.MsgBindUserEVMAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetUserRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetUserRequest({ value: query_8.QueryGetUserRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindAndActivateNode({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindAndActivateNode({ value: tx_14.MsgBindAndActivateNode.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgBindAndActivateNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgBindAndActivateNodeResponse({ value: tx_15.MsgBindAndActivateNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetUserResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetUserResponse({ value: query_11.QueryGetUserResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetNodeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetNodeResponse({ value: query_12.QueryGetNodeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateSuperiorResponse", value: tx_1.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccount({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccount", value: tx_4.MsgBindUserEVMAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgCreateSuperiorResponse", value: tx_8.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgUpdateParamsResponse", value: tx_9.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllUserRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryAllUserRequest", value: query_6.QueryAllUserRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindUserEvmaccountResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindUserEVMAccountResponse", value: tx_10.MsgBindUserEVMAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetUserRequest({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetUserRequest", value: query_8.QueryGetUserRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindAndActivateNode({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindAndActivateNode", value: tx_14.MsgBindAndActivateNode.fromPartial(value) };
            }
            catch (e) {
        ...
        msgBindAndActivateNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.MsgBindAndActivateNodeResponse", value: tx_15.MsgBindAndActivateNodeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetUserResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetUserResponse", value: query_11.QueryGetUserResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetNodeResponse({ value }) {
            try {
                return { typeUrl: "/enreach.edgenode.QueryGetNodeResponse", value: query_12.QueryGetNodeResponse.fromPartial(value) };
            }
            catch (e) {
