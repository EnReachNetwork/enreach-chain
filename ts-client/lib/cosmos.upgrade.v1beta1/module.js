...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelUpgradeResponse = exports.MsgCancelUpgrade = exports.QueryModuleVersionsResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryCurrentPlanRequest = exports.MsgSoftwareUpgradeResponse = exports.CancelSoftwareUpgradeProposal = exports.SoftwareUpgradeProposal = exports.Plan = exports.MsgSoftwareUpgrade = exports.QueryAuthorityRequest = exports.QueryModuleVersionsRequest = exports.QueryUpgradedConsensusStateResponse = exports.QueryAppliedPlanResponse = exports.ModuleVersion = exports.QueryAuthorityResponse = exports.QueryAppliedPlanRequest = exports.QueryCurrentPlanResponse = void 0;
...
Object.defineProperty(exports, "QueryAppliedPlanRequest", { enumerable: true, get: function () { return query_2.QueryAppliedPlanRequest; } });
    ...
    return {
        async sendQueryCurrentPlanResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryCurrentPlanResponse({ value: query_1.QueryCurrentPlanResponse.fromPartial(value) });
        ...
        async sendQueryAppliedPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanRequest({ value: query_2.QueryAppliedPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryCurrentPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanResponse", value: query_1.QueryCurrentPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanRequest", value: query_2.QueryAppliedPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateResponse", value: query_5.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_9.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
