...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelUpgradeResponse = exports.QueryAuthorityRequest = exports.QueryModuleVersionsResponse = exports.QueryUpgradedConsensusStateResponse = exports.QueryCurrentPlanResponse = exports.Plan = exports.QueryAuthorityResponse = exports.QueryAppliedPlanResponse = exports.QueryAppliedPlanRequest = exports.QueryCurrentPlanRequest = exports.CancelSoftwareUpgradeProposal = exports.MsgCancelUpgrade = exports.SoftwareUpgradeProposal = exports.MsgSoftwareUpgradeResponse = exports.MsgSoftwareUpgrade = exports.ModuleVersion = exports.QueryModuleVersionsRequest = exports.QueryUpgradedConsensusStateRequest = void 0;
...
Object.defineProperty(exports, "QueryAuthorityResponse", { enumerable: true, get: function () { return query_6.QueryAuthorityResponse; } });
    ...
    return {
        ...
        async sendQueryAuthorityResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityResponse({ value: query_6.QueryAuthorityResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAuthorityResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityResponse", value: query_6.QueryAuthorityResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateResponse", value: query_8.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
