...
exports.queryClient = exports.txClient = exports.registry = exports.ModuleVersion = exports.CancelSoftwareUpgradeProposal = exports.QueryUpgradedConsensusStateRequest = exports.Plan = exports.MsgCancelUpgradeResponse = exports.MsgSoftwareUpgrade = exports.QueryAuthorityResponse = exports.QueryCurrentPlanRequest = exports.SoftwareUpgradeProposal = exports.QueryAuthorityRequest = exports.QueryUpgradedConsensusStateResponse = exports.QueryAppliedPlanResponse = exports.QueryAppliedPlanRequest = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgradeResponse = exports.QueryModuleVersionsResponse = exports.QueryModuleVersionsRequest = exports.QueryCurrentPlanResponse = void 0;
...
Object.defineProperty(exports, "QueryModuleVersionsRequest", { enumerable: true, get: function () { return query_2.QueryModuleVersionsRequest; } });
...
Object.defineProperty(exports, "QueryAppliedPlanRequest", { enumerable: true, get: function () { return query_4.QueryAppliedPlanRequest; } });
...
Object.defineProperty(exports, "QueryAuthorityResponse", { enumerable: true, get: function () { return query_9.QueryAuthorityResponse; } });
    ...
    return {
        ...
        async sendQueryModuleVersionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsRequest({ value: query_2.QueryModuleVersionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanRequest({ value: query_4.QueryAppliedPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAuthorityResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityResponse({ value: query_9.QueryAuthorityResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryModuleVersionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsRequest", value: query_2.QueryModuleVersionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanRequest", value: query_4.QueryAppliedPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityResponse", value: query_9.QueryAuthorityResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_10.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
