...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAppliedPlanRequest = exports.QueryUpgradedConsensusStateResponse = exports.MsgCancelUpgrade = exports.QueryAuthorityResponse = exports.QueryModuleVersionsRequest = exports.ModuleVersion = exports.SoftwareUpgradeProposal = exports.Plan = exports.MsgSoftwareUpgradeResponse = exports.QueryAppliedPlanResponse = exports.QueryCurrentPlanRequest = exports.MsgCancelUpgradeResponse = exports.MsgSoftwareUpgrade = exports.QueryAuthorityRequest = exports.QueryModuleVersionsResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryCurrentPlanResponse = exports.CancelSoftwareUpgradeProposal = void 0;
...
Object.defineProperty(exports, "QueryModuleVersionsResponse", { enumerable: true, get: function () { return query_3.QueryModuleVersionsResponse; } });
const query_4 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryAuthorityRequest", { enumerable: true, get: function () { return query_4.QueryAuthorityRequest; } });
...
Object.defineProperty(exports, "QueryAppliedPlanResponse", { enumerable: true, get: function () { return query_6.QueryAppliedPlanResponse; } });
...
Object.defineProperty(exports, "QueryAppliedPlanRequest", { enumerable: true, get: function () { return query_10.QueryAppliedPlanRequest; } });
    ...
    return {
        async sendCancelSoftwareUpgradeProposal({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.cancelSoftwareUpgradeProposal({ value: upgrade_1.CancelSoftwareUpgradeProposal.fromPartial(value) });
        ...
        async sendQueryModuleVersionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsResponse({ value: query_3.QueryModuleVersionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAuthorityRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityRequest({ value: query_4.QueryAuthorityRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanResponse({ value: query_6.QueryAppliedPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanRequest({ value: query_10.QueryAppliedPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        cancelSoftwareUpgradeProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal", value: upgrade_1.CancelSoftwareUpgradeProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsResponse", value: query_3.QueryModuleVersionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityRequest", value: query_4.QueryAuthorityRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanResponse", value: query_6.QueryAppliedPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateResponse", value: query_9.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanRequest", value: query_10.QueryAppliedPlanRequest.fromPartial(value) };
            }
            catch (e) {
