...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgradeResponse = exports.CancelSoftwareUpgradeProposal = exports.QueryModuleVersionsResponse = exports.QueryAppliedPlanResponse = exports.MsgCancelUpgradeResponse = exports.ModuleVersion = exports.MsgSoftwareUpgrade = exports.SoftwareUpgradeProposal = exports.QueryAuthorityRequest = exports.QueryAppliedPlanRequest = exports.QueryCurrentPlanResponse = exports.Plan = exports.QueryUpgradedConsensusStateResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryCurrentPlanRequest = exports.QueryAuthorityResponse = exports.QueryModuleVersionsRequest = void 0;
...
Object.defineProperty(exports, "QueryAuthorityRequest", { enumerable: true, get: function () { return query_8.QueryAuthorityRequest; } });
...
Object.defineProperty(exports, "QueryAppliedPlanResponse", { enumerable: true, get: function () { return query_9.QueryAppliedPlanResponse; } });
    ...
    return {
        async sendQueryModuleVersionsRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryModuleVersionsRequest({ value: query_1.QueryModuleVersionsRequest.fromPartial(value) });
        ...
        async sendQueryAuthorityRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityRequest({ value: query_8.QueryAuthorityRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanResponse({ value: query_9.QueryAppliedPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryModuleVersionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsRequest", value: query_1.QueryModuleVersionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_4.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityRequest", value: query_8.QueryAuthorityRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanResponse", value: query_9.QueryAppliedPlanResponse.fromPartial(value) };
            }
            catch (e) {
