...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSoftwareUpgradeResponse = exports.CancelSoftwareUpgradeProposal = exports.SoftwareUpgradeProposal = exports.QueryModuleVersionsRequest = exports.QueryAuthorityRequest = exports.QueryAppliedPlanRequest = exports.QueryCurrentPlanResponse = exports.MsgCancelUpgrade = exports.Plan = exports.ModuleVersion = exports.QueryModuleVersionsResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanResponse = exports.QueryCurrentPlanRequest = exports.MsgCancelUpgradeResponse = exports.MsgSoftwareUpgrade = exports.QueryAuthorityResponse = exports.QueryUpgradedConsensusStateResponse = void 0;
...
Object.defineProperty(exports, "QueryCurrentPlanRequest", { enumerable: true, get: function () { return query_3.QueryCurrentPlanRequest; } });
...
Object.defineProperty(exports, "QueryModuleVersionsResponse", { enumerable: true, get: function () { return query_6.QueryModuleVersionsResponse; } });
...
Object.defineProperty(exports, "QueryModuleVersionsRequest", { enumerable: true, get: function () { return query_10.QueryModuleVersionsRequest; } });
    ...
    return {
        ...
        async sendQueryCurrentPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanRequest({ value: query_3.QueryCurrentPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleVersionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsResponse({ value: query_6.QueryModuleVersionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleVersionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsRequest({ value: query_10.QueryModuleVersionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryCurrentPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanRequest", value: query_3.QueryCurrentPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_5.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsResponse", value: query_6.QueryModuleVersionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsRequest", value: query_10.QueryModuleVersionsRequest.fromPartial(value) };
            }
            catch (e) {
