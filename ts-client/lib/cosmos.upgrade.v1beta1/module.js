...
exports.queryClient = exports.txClient = exports.registry = exports.MsgSoftwareUpgrade = exports.QueryModuleVersionsResponse = exports.QueryModuleVersionsRequest = exports.QueryAppliedPlanResponse = exports.CancelSoftwareUpgradeProposal = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgradeResponse = exports.QueryAuthorityRequest = exports.QueryUpgradedConsensusStateResponse = exports.QueryCurrentPlanResponse = exports.QueryCurrentPlanRequest = exports.SoftwareUpgradeProposal = exports.Plan = exports.MsgCancelUpgradeResponse = exports.ModuleVersion = exports.QueryAuthorityResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanRequest = void 0;
...
Object.defineProperty(exports, "QueryAuthorityResponse", { enumerable: true, get: function () { return query_3.QueryAuthorityResponse; } });
...
Object.defineProperty(exports, "Plan", { enumerable: true, get: function () { return upgrade_2.Plan; } });
...
Object.defineProperty(exports, "QueryCurrentPlanRequest", { enumerable: true, get: function () { return query_4.QueryCurrentPlanRequest; } });
const query_5 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryCurrentPlanResponse", { enumerable: true, get: function () { return query_5.QueryCurrentPlanResponse; } });
...
Object.defineProperty(exports, "QueryAuthorityRequest", { enumerable: true, get: function () { return query_7.QueryAuthorityRequest; } });
const tx_2 = require("./types/cosmos/upgrade/v1beta1/tx");
Object.defineProperty(exports, "MsgSoftwareUpgradeResponse", { enumerable: true, get: function () { return tx_2.MsgSoftwareUpgradeResponse; } });
...
Object.defineProperty(exports, "QueryAppliedPlanResponse", { enumerable: true, get: function () { return query_8.QueryAppliedPlanResponse; } });
...
Object.defineProperty(exports, "QueryModuleVersionsResponse", { enumerable: true, get: function () { return query_10.QueryModuleVersionsResponse; } });
    ...
    return {
        async sendQueryAppliedPlanRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryAppliedPlanRequest({ value: query_1.QueryAppliedPlanRequest.fromPartial(value) });
        ...
        async sendQueryAuthorityResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityResponse({ value: query_3.QueryAuthorityResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModuleVersion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.moduleVersion({ value: upgrade_1.ModuleVersion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelUpgradeResponse({ value: tx_1.MsgCancelUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPlan({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.plan({ value: upgrade_2.Plan.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCurrentPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanRequest({ value: query_4.QueryCurrentPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCurrentPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanResponse({ value: query_5.QueryCurrentPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAuthorityRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityRequest({ value: query_7.QueryAuthorityRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSoftwareUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSoftwareUpgradeResponse({ value: tx_2.MsgSoftwareUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanResponse({ value: query_8.QueryAppliedPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleVersionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsResponse({ value: query_10.QueryModuleVersionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAppliedPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanRequest", value: query_1.QueryAppliedPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityResponse", value: query_3.QueryAuthorityResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        moduleVersion({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.ModuleVersion", value: upgrade_1.ModuleVersion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.MsgCancelUpgradeResponse", value: tx_1.MsgCancelUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        plan({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.Plan", value: upgrade_2.Plan.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanRequest", value: query_4.QueryCurrentPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanResponse", value: query_5.QueryCurrentPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityRequest", value: query_7.QueryAuthorityRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSoftwareUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.MsgSoftwareUpgradeResponse", value: tx_2.MsgSoftwareUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanResponse", value: query_8.QueryAppliedPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsResponse", value: query_10.QueryModuleVersionsResponse.fromPartial(value) };
            }
            catch (e) {
