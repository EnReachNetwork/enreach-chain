...
exports.queryClient = exports.txClient = exports.registry = exports.QueryModuleVersionsResponse = exports.QueryModuleVersionsRequest = exports.QueryCurrentPlanRequest = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgrade = exports.QueryAuthorityRequest = exports.QueryCurrentPlanResponse = exports.ModuleVersion = exports.SoftwareUpgradeProposal = exports.MsgCancelUpgradeResponse = exports.QueryUpgradedConsensusStateRequest = exports.MsgSoftwareUpgradeResponse = exports.CancelSoftwareUpgradeProposal = exports.QueryAppliedPlanResponse = exports.QueryAppliedPlanRequest = exports.Plan = exports.QueryAuthorityResponse = exports.QueryUpgradedConsensusStateResponse = void 0;
...
Object.defineProperty(exports, "QueryCurrentPlanResponse", { enumerable: true, get: function () { return query_6.QueryCurrentPlanResponse; } });
...
Object.defineProperty(exports, "MsgCancelUpgrade", { enumerable: true, get: function () { return tx_4.MsgCancelUpgrade; } });
const query_8 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryCurrentPlanRequest", { enumerable: true, get: function () { return query_8.QueryCurrentPlanRequest; } });
    ...
    return {
        ...
        async sendModuleVersion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.moduleVersion({ value: upgrade_4.ModuleVersion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCurrentPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanResponse({ value: query_6.QueryCurrentPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelUpgrade({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelUpgrade({ value: tx_4.MsgCancelUpgrade.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCurrentPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanRequest({ value: query_8.QueryCurrentPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        moduleVersion({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.ModuleVersion", value: upgrade_4.ModuleVersion.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanResponse", value: query_6.QueryCurrentPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelUpgrade({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.MsgCancelUpgrade", value: tx_4.MsgCancelUpgrade.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanRequest", value: query_8.QueryCurrentPlanRequest.fromPartial(value) };
            }
            catch (e) {
