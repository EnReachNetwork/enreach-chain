...
exports.queryClient = exports.txClient = exports.registry = exports.QueryCurrentPlanResponse = exports.SoftwareUpgradeProposal = exports.MsgSoftwareUpgrade = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanRequest = exports.CancelSoftwareUpgradeProposal = exports.QueryUpgradedConsensusStateResponse = exports.QueryAppliedPlanResponse = exports.MsgSoftwareUpgradeResponse = exports.ModuleVersion = exports.QueryAuthorityResponse = exports.QueryModuleVersionsResponse = exports.QueryCurrentPlanRequest = exports.Plan = exports.MsgCancelUpgradeResponse = exports.MsgCancelUpgrade = exports.QueryAuthorityRequest = exports.QueryModuleVersionsRequest = void 0;
...
Object.defineProperty(exports, "QueryAuthorityResponse", { enumerable: true, get: function () { return query_5.QueryAuthorityResponse; } });
    ...
    return {
        ...
        async sendQueryAuthorityResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityResponse({ value: query_5.QueryAuthorityResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAuthorityResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityResponse", value: query_5.QueryAuthorityResponse.fromPartial(value) };
            }
            catch (e) {
