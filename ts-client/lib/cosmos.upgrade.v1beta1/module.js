...
exports.queryClient = exports.txClient = exports.registry = exports.CancelSoftwareUpgradeProposal = exports.QueryUpgradedConsensusStateResponse = exports.QueryCurrentPlanResponse = exports.Plan = exports.SoftwareUpgradeProposal = exports.QueryAuthorityResponse = exports.QueryModuleVersionsRequest = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanRequest = exports.QueryCurrentPlanRequest = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgradeResponse = exports.QueryAppliedPlanResponse = exports.ModuleVersion = exports.MsgSoftwareUpgrade = exports.QueryAuthorityRequest = exports.QueryModuleVersionsResponse = exports.MsgCancelUpgradeResponse = void 0;
...
Object.defineProperty(exports, "QueryAuthorityRequest", { enumerable: true, get: function () { return query_2.QueryAuthorityRequest; } });
const tx_2 = require("./types/cosmos/upgrade/v1beta1/tx");
Object.defineProperty(exports, "MsgSoftwareUpgrade", { enumerable: true, get: function () { return tx_2.MsgSoftwareUpgrade; } });
...
Object.defineProperty(exports, "QueryAppliedPlanResponse", { enumerable: true, get: function () { return query_3.QueryAppliedPlanResponse; } });
...
Object.defineProperty(exports, "QueryAppliedPlanRequest", { enumerable: true, get: function () { return query_5.QueryAppliedPlanRequest; } });
const query_6 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_6.QueryUpgradedConsensusStateRequest; } });
const query_7 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryModuleVersionsRequest", { enumerable: true, get: function () { return query_7.QueryModuleVersionsRequest; } });
const query_8 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryAuthorityResponse", { enumerable: true, get: function () { return query_8.QueryAuthorityResponse; } });
...
Object.defineProperty(exports, "Plan", { enumerable: true, get: function () { return upgrade_3.Plan; } });
const query_9 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryCurrentPlanResponse", { enumerable: true, get: function () { return query_9.QueryCurrentPlanResponse; } });
    ...
    return {
        ...
        async sendQueryModuleVersionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsResponse({ value: query_1.QueryModuleVersionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAuthorityRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityRequest({ value: query_2.QueryAuthorityRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSoftwareUpgrade({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSoftwareUpgrade({ value: tx_2.MsgSoftwareUpgrade.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanResponse({ value: query_3.QueryAppliedPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanRequest({ value: query_5.QueryAppliedPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_6.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleVersionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsRequest({ value: query_7.QueryModuleVersionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAuthorityResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityResponse({ value: query_8.QueryAuthorityResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSoftwareUpgradeProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.softwareUpgradeProposal({ value: upgrade_2.SoftwareUpgradeProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPlan({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.plan({ value: upgrade_3.Plan.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryCurrentPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanResponse({ value: query_9.QueryCurrentPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryModuleVersionsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsResponse", value: query_1.QueryModuleVersionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityRequest", value: query_2.QueryAuthorityRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSoftwareUpgrade({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.MsgSoftwareUpgrade", value: tx_2.MsgSoftwareUpgrade.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanResponse", value: query_3.QueryAppliedPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanRequest", value: query_5.QueryAppliedPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_6.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsRequest", value: query_7.QueryModuleVersionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityResponse", value: query_8.QueryAuthorityResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        softwareUpgradeProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.SoftwareUpgradeProposal", value: upgrade_2.SoftwareUpgradeProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        plan({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.Plan", value: upgrade_3.Plan.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanResponse", value: query_9.QueryCurrentPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateResponse", value: query_10.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
