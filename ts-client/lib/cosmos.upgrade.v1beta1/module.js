...
exports.queryClient = exports.txClient = exports.registry = exports.QueryUpgradedConsensusStateResponse = exports.QueryCurrentPlanResponse = exports.CancelSoftwareUpgradeProposal = exports.SoftwareUpgradeProposal = exports.QueryAppliedPlanRequest = exports.MsgSoftwareUpgradeResponse = exports.QueryAuthorityResponse = exports.QueryAuthorityRequest = exports.QueryModuleVersionsResponse = exports.QueryModuleVersionsRequest = exports.MsgCancelUpgradeResponse = exports.QueryAppliedPlanResponse = exports.QueryCurrentPlanRequest = exports.ModuleVersion = exports.Plan = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgrade = exports.QueryUpgradedConsensusStateRequest = void 0;
...
Object.defineProperty(exports, "QueryCurrentPlanRequest", { enumerable: true, get: function () { return query_2.QueryCurrentPlanRequest; } });
...
Object.defineProperty(exports, "MsgCancelUpgradeResponse", { enumerable: true, get: function () { return tx_3.MsgCancelUpgradeResponse; } });
const query_4 = require("./types/cosmos/upgrade/v1beta1/query");
Object.defineProperty(exports, "QueryModuleVersionsRequest", { enumerable: true, get: function () { return query_4.QueryModuleVersionsRequest; } });
...
Object.defineProperty(exports, "QueryAuthorityResponse", { enumerable: true, get: function () { return query_7.QueryAuthorityResponse; } });
    ...
    return {
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_1.QueryUpgradedConsensusStateRequest.fromPartial(value) });
        ...
        async sendQueryCurrentPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanRequest({ value: query_2.QueryCurrentPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCancelUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCancelUpgradeResponse({ value: tx_3.MsgCancelUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleVersionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsRequest({ value: query_4.QueryModuleVersionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAuthorityResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityResponse({ value: query_7.QueryAuthorityResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_1.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanRequest", value: query_2.QueryCurrentPlanRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCancelUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.MsgCancelUpgradeResponse", value: tx_3.MsgCancelUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsRequest", value: query_4.QueryModuleVersionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityResponse", value: query_7.QueryAuthorityResponse.fromPartial(value) };
            }
            catch (e) {
