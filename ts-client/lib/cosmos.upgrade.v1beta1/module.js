...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelUpgradeResponse = exports.QueryModuleVersionsResponse = exports.QueryAppliedPlanRequest = exports.SoftwareUpgradeProposal = exports.MsgSoftwareUpgrade = exports.QueryAuthorityResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanResponse = exports.CancelSoftwareUpgradeProposal = exports.MsgSoftwareUpgradeResponse = exports.MsgCancelUpgrade = exports.QueryModuleVersionsRequest = exports.QueryCurrentPlanResponse = exports.ModuleVersion = exports.Plan = exports.QueryAuthorityRequest = exports.QueryUpgradedConsensusStateResponse = exports.QueryCurrentPlanRequest = void 0;
...
Object.defineProperty(exports, "QueryAuthorityRequest", { enumerable: true, get: function () { return query_3.QueryAuthorityRequest; } });
...
Object.defineProperty(exports, "QueryModuleVersionsRequest", { enumerable: true, get: function () { return query_5.QueryModuleVersionsRequest; } });
...
Object.defineProperty(exports, "QueryAppliedPlanRequest", { enumerable: true, get: function () { return query_9.QueryAppliedPlanRequest; } });
    ...
    return {
        ...
        async sendQueryAuthorityRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAuthorityRequest({ value: query_3.QueryAuthorityRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleVersionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleVersionsRequest({ value: query_5.QueryModuleVersionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAppliedPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanRequest({ value: query_9.QueryAppliedPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateResponse", value: query_2.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAuthorityRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAuthorityRequest", value: query_3.QueryAuthorityRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleVersionsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryModuleVersionsRequest", value: query_5.QueryModuleVersionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", value: query_7.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAppliedPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanRequest", value: query_9.QueryAppliedPlanRequest.fromPartial(value) };
            }
            catch (e) {
