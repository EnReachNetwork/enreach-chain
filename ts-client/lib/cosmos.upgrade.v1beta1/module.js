...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAuthorityResponse = exports.QueryAuthorityRequest = exports.QueryModuleVersionsRequest = exports.ModuleVersion = exports.SoftwareUpgradeProposal = exports.MsgCancelUpgradeResponse = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgradeResponse = exports.QueryAppliedPlanResponse = exports.QueryCurrentPlanResponse = exports.QueryCurrentPlanRequest = exports.CancelSoftwareUpgradeProposal = exports.Plan = exports.QueryModuleVersionsResponse = exports.MsgSoftwareUpgrade = exports.QueryUpgradedConsensusStateResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanRequest = void 0;
...
Object.defineProperty(exports, "QueryAppliedPlanResponse", { enumerable: true, get: function () { return query_7.QueryAppliedPlanResponse; } });
    ...
    return {
        ...
        async sendQueryAppliedPlanResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAppliedPlanResponse({ value: query_7.QueryAppliedPlanResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAppliedPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanResponse", value: query_7.QueryAppliedPlanResponse.fromPartial(value) };
            }
            catch (e) {
