...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCancelUpgradeResponse = exports.QueryCurrentPlanResponse = exports.SoftwareUpgradeProposal = exports.QueryCurrentPlanRequest = exports.MsgSoftwareUpgradeResponse = exports.MsgSoftwareUpgrade = exports.QueryAuthorityResponse = exports.QueryAuthorityRequest = exports.QueryModuleVersionsResponse = exports.QueryModuleVersionsRequest = exports.QueryAppliedPlanRequest = exports.Plan = exports.ModuleVersion = exports.CancelSoftwareUpgradeProposal = exports.MsgCancelUpgrade = exports.QueryUpgradedConsensusStateResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanResponse = void 0;
...
Object.defineProperty(exports, "QueryCurrentPlanRequest", { enumerable: true, get: function () { return query_9.QueryCurrentPlanRequest; } });
    ...
    return {
        async sendQueryAppliedPlanResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryAppliedPlanResponse({ value: query_1.QueryAppliedPlanResponse.fromPartial(value) });
        ...
        async sendQueryCurrentPlanRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryCurrentPlanRequest({ value: query_9.QueryCurrentPlanRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAppliedPlanResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryAppliedPlanResponse", value: query_1.QueryAppliedPlanResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryCurrentPlanRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryCurrentPlanRequest", value: query_9.QueryCurrentPlanRequest.fromPartial(value) };
            }
            catch (e) {
