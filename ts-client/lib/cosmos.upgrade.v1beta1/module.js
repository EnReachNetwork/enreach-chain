...
exports.queryClient = exports.txClient = exports.registry = exports.SoftwareUpgradeProposal = exports.QueryAuthorityResponse = exports.QueryModuleVersionsRequest = exports.MsgSoftwareUpgradeResponse = exports.CancelSoftwareUpgradeProposal = exports.Plan = exports.QueryAuthorityRequest = exports.QueryUpgradedConsensusStateResponse = exports.QueryAppliedPlanResponse = exports.MsgCancelUpgradeResponse = exports.QueryModuleVersionsResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryAppliedPlanRequest = exports.QueryCurrentPlanRequest = exports.ModuleVersion = exports.MsgCancelUpgrade = exports.MsgSoftwareUpgrade = exports.QueryCurrentPlanResponse = void 0;
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_7.QueryUpgradedConsensusStateResponse; } });
    ...
    return {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_7.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateResponse", value: query_7.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
