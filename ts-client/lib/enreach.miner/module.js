...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllMinerResponse = exports.MsgUpdateParamsResponse = exports.MsgCreateMiner = exports.Params = exports.QueryAllMinerRequest = exports.MsgDeleteMinerResponse = exports.MsgDeleteMiner = exports.MsgUpdateMiner = exports.GenesisState = exports.QueryParamsRequest = exports.QueryGetMinerResponse = exports.QueryGetMinerRequest = exports.QueryParamsResponse = exports.MsgUpdateMinerResponse = exports.MsgCreateMinerResponse = exports.MsgUpdateParams = exports.Miner = void 0;
...
Object.defineProperty(exports, "MsgCreateMinerResponse", { enumerable: true, get: function () { return tx_2.MsgCreateMinerResponse; } });
const tx_3 = require("./types/enreach/miner/tx");
Object.defineProperty(exports, "MsgUpdateMinerResponse", { enumerable: true, get: function () { return tx_3.MsgUpdateMinerResponse; } });
...
Object.defineProperty(exports, "QueryGetMinerRequest", { enumerable: true, get: function () { return query_2.QueryGetMinerRequest; } });
const query_3 = require("./types/enreach/miner/query");
Object.defineProperty(exports, "QueryGetMinerResponse", { enumerable: true, get: function () { return query_3.QueryGetMinerResponse; } });
...
Object.defineProperty(exports, "MsgUpdateMiner", { enumerable: true, get: function () { return tx_4.MsgUpdateMiner; } });
const tx_5 = require("./types/enreach/miner/tx");
Object.defineProperty(exports, "MsgDeleteMiner", { enumerable: true, get: function () { return tx_5.MsgDeleteMiner; } });
const tx_6 = require("./types/enreach/miner/tx");
Object.defineProperty(exports, "MsgDeleteMinerResponse", { enumerable: true, get: function () { return tx_6.MsgDeleteMinerResponse; } });
const query_5 = require("./types/enreach/miner/query");
Object.defineProperty(exports, "QueryAllMinerRequest", { enumerable: true, get: function () { return query_5.QueryAllMinerRequest; } });
...
Object.defineProperty(exports, "MsgCreateMiner", { enumerable: true, get: function () { return tx_7.MsgCreateMiner; } });
    ...
    return {
        ...
        async sendMsgCreateMinerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateMinerResponse({ value: tx_2.MsgCreateMinerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateMinerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateMinerResponse({ value: tx_3.MsgUpdateMinerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetMinerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetMinerRequest({ value: query_2.QueryGetMinerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetMinerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetMinerResponse({ value: query_3.QueryGetMinerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateMiner({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateMiner({ value: tx_4.MsgUpdateMiner.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteMiner({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteMiner({ value: tx_5.MsgDeleteMiner.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteMinerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteMinerResponse({ value: tx_6.MsgDeleteMinerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllMinerRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllMinerRequest({ value: query_5.QueryAllMinerRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateMiner({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateMiner({ value: tx_7.MsgCreateMiner.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgUpdateParams", value: tx_1.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateMinerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgCreateMinerResponse", value: tx_2.MsgCreateMinerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateMinerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgUpdateMinerResponse", value: tx_3.MsgUpdateMinerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetMinerRequest({ value }) {
            try {
                return { typeUrl: "/enreach.miner.QueryGetMinerRequest", value: query_2.QueryGetMinerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetMinerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.miner.QueryGetMinerResponse", value: query_3.QueryGetMinerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.miner.QueryParamsRequest", value: query_4.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateMiner({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgUpdateMiner", value: tx_4.MsgUpdateMiner.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteMiner({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgDeleteMiner", value: tx_5.MsgDeleteMiner.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteMinerResponse({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgDeleteMinerResponse", value: tx_6.MsgDeleteMinerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllMinerRequest({ value }) {
            try {
                return { typeUrl: "/enreach.miner.QueryAllMinerRequest", value: query_5.QueryAllMinerRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateMiner({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgCreateMiner", value: tx_7.MsgCreateMiner.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.miner.MsgUpdateParamsResponse", value: tx_8.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
