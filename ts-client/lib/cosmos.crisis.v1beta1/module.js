...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgVerifyInvariantResponse = exports.MsgVerifyInvariant = void 0;
...
Object.defineProperty(exports, "MsgVerifyInvariantResponse", { enumerable: true, get: function () { return tx_2.MsgVerifyInvariantResponse; } });
    ...
    return {
        async sendMsgVerifyInvariant({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgVerifyInvariant({ value: tx_1.MsgVerifyInvariant.fromPartial(value) });
        ...
        async sendMsgVerifyInvariantResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVerifyInvariantResponse({ value: tx_2.MsgVerifyInvariantResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgVerifyInvariant({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariant", value: tx_1.MsgVerifyInvariant.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVerifyInvariantResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariantResponse", value: tx_2.MsgVerifyInvariantResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgUpdateParams", value: tx_3.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgUpdateParamsResponse", value: tx_4.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
