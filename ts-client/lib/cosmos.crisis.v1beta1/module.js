...
exports.queryClient = exports.txClient = exports.registry = exports.MsgVerifyInvariant = exports.GenesisState = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgVerifyInvariantResponse = void 0;
...
Object.defineProperty(exports, "MsgVerifyInvariant", { enumerable: true, get: function () { return tx_4.MsgVerifyInvariant; } });
    ...
    return {
        async sendMsgVerifyInvariantResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgVerifyInvariantResponse({ value: tx_1.MsgVerifyInvariantResponse.fromPartial(value) });
        ...
        async sendMsgVerifyInvariant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVerifyInvariant({ value: tx_4.MsgVerifyInvariant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgVerifyInvariantResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariantResponse", value: tx_1.MsgVerifyInvariantResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgUpdateParams", value: tx_2.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgUpdateParamsResponse", value: tx_3.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVerifyInvariant({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariant", value: tx_4.MsgVerifyInvariant.fromPartial(value) };
            }
            catch (e) {
