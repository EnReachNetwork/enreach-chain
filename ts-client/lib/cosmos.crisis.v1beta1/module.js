...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.MsgVerifyInvariantResponse = exports.MsgVerifyInvariant = exports.GenesisState = exports.MsgUpdateParamsResponse = void 0;
...
Object.defineProperty(exports, "MsgVerifyInvariant", { enumerable: true, get: function () { return tx_2.MsgVerifyInvariant; } });
const tx_3 = require("./types/cosmos/crisis/v1beta1/tx");
Object.defineProperty(exports, "MsgVerifyInvariantResponse", { enumerable: true, get: function () { return tx_3.MsgVerifyInvariantResponse; } });
    ...
    return {
        ...
        async sendMsgVerifyInvariant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVerifyInvariant({ value: tx_2.MsgVerifyInvariant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgVerifyInvariantResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgVerifyInvariantResponse({ value: tx_3.MsgVerifyInvariantResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgUpdateParamsResponse", value: tx_1.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVerifyInvariant({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariant", value: tx_2.MsgVerifyInvariant.fromPartial(value) };
            }
            catch (e) {
        ...
        msgVerifyInvariantResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariantResponse", value: tx_3.MsgVerifyInvariantResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/cosmos.crisis.v1beta1.MsgUpdateParams", value: tx_4.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
