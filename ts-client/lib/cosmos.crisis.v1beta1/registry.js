...
const msgTypes = [
    ["/cosmos.crisis.v1beta1.MsgUpdateParams", tx_1.MsgUpdateParams],
    ["/cosmos.crisis.v1beta1.MsgUpdateParamsResponse", tx_2.MsgUpdateParamsResponse],
    ...
    ["/cosmos.crisis.v1beta1.MsgVerifyInvariantResponse", tx_4.MsgVerifyInvariantResponse],
];
