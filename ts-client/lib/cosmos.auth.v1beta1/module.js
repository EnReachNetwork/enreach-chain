...
exports.queryClient = exports.txClient = exports.registry = exports.Bech32PrefixResponse = exports.QueryModuleAccountByNameRequest = exports.AddressStringToBytesRequest = exports.Bech32PrefixRequest = exports.QueryModuleAccountByNameResponse = exports.QueryAccountsResponse = exports.QueryAccountsRequest = exports.MsgUpdateParamsResponse = exports.ModuleCredential = exports.AddressBytesToStringResponse = exports.QueryParamsResponse = exports.GenesisState = exports.QueryAccountAddressByIDRequest = exports.AddressStringToBytesResponse = exports.BaseAccount = exports.QueryAccountRequest = exports.QueryAccountInfoResponse = exports.QueryAccountAddressByIDResponse = exports.QueryAccountResponse = exports.QueryAccountInfoRequest = exports.AddressBytesToStringRequest = exports.QueryModuleAccountsResponse = exports.QueryModuleAccountsRequest = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.ModuleAccount = exports.Params = void 0;
...
Object.defineProperty(exports, "QueryModuleAccountsRequest", { enumerable: true, get: function () { return query_2.QueryModuleAccountsRequest; } });
...
Object.defineProperty(exports, "AddressBytesToStringRequest", { enumerable: true, get: function () { return query_4.AddressBytesToStringRequest; } });
...
Object.defineProperty(exports, "QueryAccountInfoResponse", { enumerable: true, get: function () { return query_8.QueryAccountInfoResponse; } });
...
Object.defineProperty(exports, "AddressStringToBytesResponse", { enumerable: true, get: function () { return query_10.AddressStringToBytesResponse; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameResponse", { enumerable: true, get: function () { return query_16.QueryModuleAccountByNameResponse; } });
const query_17 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "Bech32PrefixRequest", { enumerable: true, get: function () { return query_17.Bech32PrefixRequest; } });
const query_18 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressStringToBytesRequest", { enumerable: true, get: function () { return query_18.AddressStringToBytesRequest; } });
    ...
    return {
        ...
        async sendQueryModuleAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsRequest({ value: query_2.QueryModuleAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringRequest({ value: query_4.AddressBytesToStringRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoResponse({ value: query_8.QueryAccountInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesResponse({ value: query_10.AddressStringToBytesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameResponse({ value: query_16.QueryModuleAccountByNameResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBech32PrefixRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.bech32PrefixRequest({ value: query_17.Bech32PrefixRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesRequest({ value: query_18.AddressStringToBytesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsRequest", value: query_1.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsRequest", value: query_2.QueryModuleAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringRequest", value: query_4.AddressBytesToStringRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoResponse", value: query_8.QueryAccountInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesResponse", value: query_10.AddressStringToBytesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", value: query_16.QueryModuleAccountByNameResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        bech32PrefixRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Bech32PrefixRequest", value: query_17.Bech32PrefixRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesRequest", value: query_18.AddressStringToBytesRequest.fromPartial(value) };
            }
            catch (e) {
