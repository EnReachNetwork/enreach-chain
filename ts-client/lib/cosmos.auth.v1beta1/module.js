...
exports.queryClient = exports.txClient = exports.registry = exports.AddressBytesToStringRequest = exports.Bech32PrefixRequest = exports.QueryParamsResponse = exports.QueryAccountAddressByIDRequest = exports.AddressStringToBytesRequest = exports.QueryModuleAccountsResponse = exports.QueryAccountsRequest = exports.ModuleAccount = exports.BaseAccount = exports.Bech32PrefixResponse = exports.QueryModuleAccountsRequest = exports.MsgUpdateParams = exports.QueryAccountInfoResponse = exports.MsgUpdateParamsResponse = exports.GenesisState = exports.QueryAccountAddressByIDResponse = exports.QueryModuleAccountByNameRequest = exports.QueryParamsRequest = exports.Params = exports.ModuleCredential = exports.AddressBytesToStringResponse = exports.QueryAccountRequest = exports.QueryAccountInfoRequest = exports.AddressStringToBytesResponse = exports.QueryModuleAccountByNameResponse = exports.QueryAccountResponse = exports.QueryAccountsResponse = void 0;
...
Object.defineProperty(exports, "QueryAccountResponse", { enumerable: true, get: function () { return query_2.QueryAccountResponse; } });
const query_3 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountByNameResponse", { enumerable: true, get: function () { return query_3.QueryModuleAccountByNameResponse; } });
const query_4 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressStringToBytesResponse", { enumerable: true, get: function () { return query_4.AddressStringToBytesResponse; } });
const query_5 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountInfoRequest", { enumerable: true, get: function () { return query_5.QueryAccountInfoRequest; } });
const query_6 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountRequest", { enumerable: true, get: function () { return query_6.QueryAccountRequest; } });
...
Object.defineProperty(exports, "ModuleCredential", { enumerable: true, get: function () { return auth_1.ModuleCredential; } });
const auth_2 = require("./types/cosmos/auth/v1beta1/auth");
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return auth_2.Params; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameRequest", { enumerable: true, get: function () { return query_9.QueryModuleAccountByNameRequest; } });
const query_10 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDResponse", { enumerable: true, get: function () { return query_10.QueryAccountAddressByIDResponse; } });
...
Object.defineProperty(exports, "QueryAccountInfoResponse", { enumerable: true, get: function () { return query_11.QueryAccountInfoResponse; } });
...
Object.defineProperty(exports, "QueryModuleAccountsRequest", { enumerable: true, get: function () { return query_12.QueryModuleAccountsRequest; } });
...
Object.defineProperty(exports, "BaseAccount", { enumerable: true, get: function () { return auth_3.BaseAccount; } });
const auth_4 = require("./types/cosmos/auth/v1beta1/auth");
Object.defineProperty(exports, "ModuleAccount", { enumerable: true, get: function () { return auth_4.ModuleAccount; } });
const query_14 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountsRequest", { enumerable: true, get: function () { return query_14.QueryAccountsRequest; } });
const query_15 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountsResponse", { enumerable: true, get: function () { return query_15.QueryModuleAccountsResponse; } });
const query_16 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressStringToBytesRequest", { enumerable: true, get: function () { return query_16.AddressStringToBytesRequest; } });
const query_17 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDRequest", { enumerable: true, get: function () { return query_17.QueryAccountAddressByIDRequest; } });
...
Object.defineProperty(exports, "Bech32PrefixRequest", { enumerable: true, get: function () { return query_19.Bech32PrefixRequest; } });
const query_20 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressBytesToStringRequest", { enumerable: true, get: function () { return query_20.AddressBytesToStringRequest; } });
    ...
    return {
        ...
        async sendQueryAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountResponse({ value: query_2.QueryAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameResponse({ value: query_3.QueryModuleAccountByNameResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesResponse({ value: query_4.AddressStringToBytesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoRequest({ value: query_5.QueryAccountInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountRequest({ value: query_6.QueryAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModuleCredential({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.moduleCredential({ value: auth_1.ModuleCredential.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: auth_2.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameRequest({ value: query_9.QueryModuleAccountByNameRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdresponse({ value: query_10.QueryAccountAddressByIDResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoResponse({ value: query_11.QueryAccountInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsRequest({ value: query_12.QueryModuleAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBaseAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.baseAccount({ value: auth_3.BaseAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendModuleAccount({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.moduleAccount({ value: auth_4.ModuleAccount.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountsRequest({ value: query_14.QueryAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsResponse({ value: query_15.QueryModuleAccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesRequest({ value: query_16.AddressStringToBytesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdrequest({ value: query_17.QueryAccountAddressByIDRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBech32PrefixRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.bech32PrefixRequest({ value: query_19.Bech32PrefixRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringRequest({ value: query_20.AddressBytesToStringRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountResponse", value: query_2.QueryAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", value: query_3.QueryModuleAccountByNameResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesResponse", value: query_4.AddressStringToBytesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoRequest", value: query_5.QueryAccountInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountRequest", value: query_6.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        moduleCredential({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.ModuleCredential", value: auth_1.ModuleCredential.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Params", value: auth_2.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsRequest", value: query_8.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameRequest", value: query_9.QueryModuleAccountByNameRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDResponse", value: query_10.QueryAccountAddressByIDResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoResponse", value: query_11.QueryAccountInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsRequest", value: query_12.QueryModuleAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        baseAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.BaseAccount", value: auth_3.BaseAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        moduleAccount({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.ModuleAccount", value: auth_4.ModuleAccount.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountsRequest", value: query_14.QueryAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsResponse", value: query_15.QueryModuleAccountsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesRequest", value: query_16.AddressStringToBytesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDRequest", value: query_17.QueryAccountAddressByIDRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsResponse", value: query_18.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        bech32PrefixRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Bech32PrefixRequest", value: query_19.Bech32PrefixRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringRequest", value: query_20.AddressBytesToStringRequest.fromPartial(value) };
            }
            catch (e) {
