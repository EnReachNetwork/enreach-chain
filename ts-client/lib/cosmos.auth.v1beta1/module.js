...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAccountInfoRequest = exports.Bech32PrefixRequest = exports.QueryModuleAccountsResponse = exports.QueryModuleAccountsRequest = exports.QueryAccountRequest = exports.AddressStringToBytesResponse = exports.QueryParamsResponse = exports.QueryAccountResponse = exports.MsgUpdateParamsResponse = exports.ModuleAccount = exports.QueryAccountAddressByIDRequest = exports.Params = exports.BaseAccount = exports.QueryAccountAddressByIDResponse = exports.QueryModuleAccountByNameRequest = exports.QueryParamsRequest = exports.ModuleCredential = exports.AddressStringToBytesRequest = exports.AddressBytesToStringRequest = exports.QueryModuleAccountByNameResponse = exports.QueryAccountsRequest = exports.GenesisState = exports.AddressBytesToStringResponse = exports.QueryAccountInfoResponse = exports.Bech32PrefixResponse = exports.QueryAccountsResponse = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "AddressBytesToStringResponse", { enumerable: true, get: function () { return query_4.AddressBytesToStringResponse; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameResponse", { enumerable: true, get: function () { return query_6.QueryModuleAccountByNameResponse; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameRequest", { enumerable: true, get: function () { return query_10.QueryModuleAccountByNameRequest; } });
const query_11 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDResponse", { enumerable: true, get: function () { return query_11.QueryAccountAddressByIDResponse; } });
...
Object.defineProperty(exports, "QueryAccountResponse", { enumerable: true, get: function () { return query_13.QueryAccountResponse; } });
...
Object.defineProperty(exports, "AddressStringToBytesResponse", { enumerable: true, get: function () { return query_15.AddressStringToBytesResponse; } });
const query_16 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountRequest", { enumerable: true, get: function () { return query_16.QueryAccountRequest; } });
    ...
    return {
        ...
        async sendAddressBytesToStringResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringResponse({ value: query_4.AddressBytesToStringResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameResponse({ value: query_6.QueryModuleAccountByNameResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameRequest({ value: query_10.QueryModuleAccountByNameRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdresponse({ value: query_11.QueryAccountAddressByIDResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountResponse({ value: query_13.QueryAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesResponse({ value: query_15.AddressStringToBytesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountRequest({ value: query_16.QueryAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        addressBytesToStringResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringResponse", value: query_4.AddressBytesToStringResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", value: query_6.QueryModuleAccountByNameResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameRequest", value: query_10.QueryModuleAccountByNameRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDResponse", value: query_11.QueryAccountAddressByIDResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountResponse", value: query_13.QueryAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesResponse", value: query_15.AddressStringToBytesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountRequest", value: query_16.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
