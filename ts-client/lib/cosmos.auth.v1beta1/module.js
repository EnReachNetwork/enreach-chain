...
exports.queryClient = exports.txClient = exports.registry = exports.Params = exports.ModuleAccount = exports.QueryAccountResponse = exports.QueryAccountsResponse = exports.QueryModuleAccountByNameResponse = exports.QueryModuleAccountsResponse = exports.QueryModuleAccountsRequest = exports.QueryAccountsRequest = exports.MsgUpdateParams = exports.BaseAccount = exports.QueryAccountInfoResponse = exports.AddressBytesToStringResponse = exports.Bech32PrefixRequest = exports.QueryParamsResponse = exports.QueryAccountAddressByIDRequest = exports.Bech32PrefixResponse = exports.QueryModuleAccountByNameRequest = exports.ModuleCredential = exports.GenesisState = exports.AddressBytesToStringRequest = exports.QueryParamsRequest = exports.QueryAccountAddressByIDResponse = exports.QueryAccountInfoRequest = exports.QueryAccountRequest = exports.MsgUpdateParamsResponse = exports.AddressStringToBytesResponse = exports.AddressStringToBytesRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressStringToBytesRequest", { enumerable: true, get: function () { return query_1.AddressStringToBytesRequest; } });
const query_2 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressStringToBytesResponse", { enumerable: true, get: function () { return query_2.AddressStringToBytesResponse; } });
...
Object.defineProperty(exports, "QueryAccountRequest", { enumerable: true, get: function () { return query_3.QueryAccountRequest; } });
...
Object.defineProperty(exports, "QueryAccountAddressByIDResponse", { enumerable: true, get: function () { return query_5.QueryAccountAddressByIDResponse; } });
...
Object.defineProperty(exports, "AddressBytesToStringRequest", { enumerable: true, get: function () { return query_7.AddressBytesToStringRequest; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameRequest", { enumerable: true, get: function () { return query_8.QueryModuleAccountByNameRequest; } });
const query_9 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "Bech32PrefixResponse", { enumerable: true, get: function () { return query_9.Bech32PrefixResponse; } });
const query_10 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDRequest", { enumerable: true, get: function () { return query_10.QueryAccountAddressByIDRequest; } });
...
Object.defineProperty(exports, "Bech32PrefixRequest", { enumerable: true, get: function () { return query_12.Bech32PrefixRequest; } });
const query_13 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressBytesToStringResponse", { enumerable: true, get: function () { return query_13.AddressBytesToStringResponse; } });
const query_14 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountInfoResponse", { enumerable: true, get: function () { return query_14.QueryAccountInfoResponse; } });
...
Object.defineProperty(exports, "QueryModuleAccountsRequest", { enumerable: true, get: function () { return query_16.QueryModuleAccountsRequest; } });
const query_17 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountsResponse", { enumerable: true, get: function () { return query_17.QueryModuleAccountsResponse; } });
const query_18 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountByNameResponse", { enumerable: true, get: function () { return query_18.QueryModuleAccountByNameResponse; } });
    ...
    return {
        async sendAddressStringToBytesRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.addressStringToBytesRequest({ value: query_1.AddressStringToBytesRequest.fromPartial(value) });
        ...
        async sendAddressStringToBytesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesResponse({ value: query_2.AddressStringToBytesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountRequest({ value: query_3.QueryAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdresponse({ value: query_5.QueryAccountAddressByIDResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringRequest({ value: query_7.AddressBytesToStringRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameRequest({ value: query_8.QueryModuleAccountByNameRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBech32PrefixResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.bech32PrefixResponse({ value: query_9.Bech32PrefixResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdrequest({ value: query_10.QueryAccountAddressByIDRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBech32PrefixRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.bech32PrefixRequest({ value: query_12.Bech32PrefixRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringResponse({ value: query_13.AddressBytesToStringResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoResponse({ value: query_14.QueryAccountInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsRequest({ value: query_16.QueryModuleAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsResponse({ value: query_17.QueryModuleAccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameResponse({ value: query_18.QueryModuleAccountByNameResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        addressStringToBytesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesRequest", value: query_1.AddressStringToBytesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesResponse", value: query_2.AddressStringToBytesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountRequest", value: query_3.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDResponse", value: query_5.QueryAccountAddressByIDResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsRequest", value: query_6.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringRequest", value: query_7.AddressBytesToStringRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameRequest", value: query_8.QueryModuleAccountByNameRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        bech32PrefixResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Bech32PrefixResponse", value: query_9.Bech32PrefixResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDRequest", value: query_10.QueryAccountAddressByIDRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsResponse", value: query_11.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        bech32PrefixRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Bech32PrefixRequest", value: query_12.Bech32PrefixRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringResponse", value: query_13.AddressBytesToStringResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoResponse", value: query_14.QueryAccountInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsRequest", value: query_16.QueryModuleAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsResponse", value: query_17.QueryModuleAccountsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", value: query_18.QueryModuleAccountByNameResponse.fromPartial(value) };
            }
            catch (e) {
