...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAccountResponse = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.ModuleAccount = exports.BaseAccount = exports.Params = exports.QueryAccountAddressByIDResponse = exports.AddressStringToBytesRequest = exports.QueryModuleAccountByNameRequest = exports.QueryAccountsRequest = exports.QueryModuleAccountByNameResponse = exports.AddressStringToBytesResponse = exports.QueryParamsRequest = exports.QueryAccountRequest = exports.QueryAccountsResponse = exports.MsgUpdateParams = exports.Bech32PrefixRequest = exports.QueryModuleAccountsRequest = exports.QueryAccountInfoRequest = exports.QueryAccountAddressByIDRequest = exports.AddressBytesToStringRequest = exports.QueryAccountInfoResponse = exports.QueryModuleAccountsResponse = exports.AddressBytesToStringResponse = exports.Bech32PrefixResponse = exports.GenesisState = exports.ModuleCredential = void 0;
...
Object.defineProperty(exports, "Bech32PrefixResponse", { enumerable: true, get: function () { return query_1.Bech32PrefixResponse; } });
const query_2 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressBytesToStringResponse", { enumerable: true, get: function () { return query_2.AddressBytesToStringResponse; } });
const query_3 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountsResponse", { enumerable: true, get: function () { return query_3.QueryModuleAccountsResponse; } });
const query_4 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountInfoResponse", { enumerable: true, get: function () { return query_4.QueryAccountInfoResponse; } });
const query_5 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressBytesToStringRequest", { enumerable: true, get: function () { return query_5.AddressBytesToStringRequest; } });
const query_6 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDRequest", { enumerable: true, get: function () { return query_6.QueryAccountAddressByIDRequest; } });
const query_7 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountInfoRequest", { enumerable: true, get: function () { return query_7.QueryAccountInfoRequest; } });
const query_8 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountsRequest", { enumerable: true, get: function () { return query_8.QueryModuleAccountsRequest; } });
const query_9 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "Bech32PrefixRequest", { enumerable: true, get: function () { return query_9.Bech32PrefixRequest; } });
...
Object.defineProperty(exports, "QueryAccountsResponse", { enumerable: true, get: function () { return query_10.QueryAccountsResponse; } });
const query_11 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountRequest", { enumerable: true, get: function () { return query_11.QueryAccountRequest; } });
...
Object.defineProperty(exports, "AddressStringToBytesResponse", { enumerable: true, get: function () { return query_13.AddressStringToBytesResponse; } });
const query_14 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountByNameResponse", { enumerable: true, get: function () { return query_14.QueryModuleAccountByNameResponse; } });
const query_15 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountsRequest", { enumerable: true, get: function () { return query_15.QueryAccountsRequest; } });
const query_16 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryModuleAccountByNameRequest", { enumerable: true, get: function () { return query_16.QueryModuleAccountByNameRequest; } });
const query_17 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "AddressStringToBytesRequest", { enumerable: true, get: function () { return query_17.AddressStringToBytesRequest; } });
const query_18 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDResponse", { enumerable: true, get: function () { return query_18.QueryAccountAddressByIDResponse; } });
...
Object.defineProperty(exports, "QueryAccountResponse", { enumerable: true, get: function () { return query_20.QueryAccountResponse; } });
    ...
    return {
        ...
        async sendBech32PrefixResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.bech32PrefixResponse({ value: query_1.Bech32PrefixResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringResponse({ value: query_2.AddressBytesToStringResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsResponse({ value: query_3.QueryModuleAccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountInfoResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoResponse({ value: query_4.QueryAccountInfoResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringRequest({ value: query_5.AddressBytesToStringRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdrequest({ value: query_6.QueryAccountAddressByIDRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoRequest({ value: query_7.QueryAccountInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountsRequest({ value: query_8.QueryModuleAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendBech32PrefixRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.bech32PrefixRequest({ value: query_9.Bech32PrefixRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountsResponse({ value: query_10.QueryAccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountRequest({ value: query_11.QueryAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesResponse({ value: query_13.AddressStringToBytesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameResponse({ value: query_14.QueryModuleAccountByNameResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountsRequest({ value: query_15.QueryAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameRequest({ value: query_16.QueryModuleAccountByNameRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressStringToBytesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressStringToBytesRequest({ value: query_17.AddressStringToBytesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdresponse({ value: query_18.QueryAccountAddressByIDResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountResponse({ value: query_20.QueryAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        bech32PrefixResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Bech32PrefixResponse", value: query_1.Bech32PrefixResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringResponse", value: query_2.AddressBytesToStringResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsResponse", value: query_3.QueryModuleAccountsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountInfoResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoResponse", value: query_4.QueryAccountInfoResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringRequest", value: query_5.AddressBytesToStringRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDRequest", value: query_6.QueryAccountAddressByIDRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoRequest", value: query_7.QueryAccountInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountsRequest", value: query_8.QueryModuleAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        bech32PrefixRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.Bech32PrefixRequest", value: query_9.Bech32PrefixRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountsResponse", value: query_10.QueryAccountsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountRequest", value: query_11.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsRequest", value: query_12.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesResponse", value: query_13.AddressStringToBytesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", value: query_14.QueryModuleAccountByNameResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountsRequest", value: query_15.QueryAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameRequest", value: query_16.QueryModuleAccountByNameRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        addressStringToBytesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressStringToBytesRequest", value: query_17.AddressStringToBytesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDResponse", value: query_18.QueryAccountAddressByIDResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountResponse", value: query_20.QueryAccountResponse.fromPartial(value) };
            }
            catch (e) {
