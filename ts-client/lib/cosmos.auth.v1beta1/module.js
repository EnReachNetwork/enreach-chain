...
exports.queryClient = exports.txClient = exports.registry = exports.Bech32PrefixResponse = exports.QueryParamsResponse = exports.QueryAccountRequest = exports.MsgUpdateParamsResponse = exports.AddressBytesToStringRequest = exports.Params = exports.AddressStringToBytesRequest = exports.AddressBytesToStringResponse = exports.GenesisState = exports.QueryAccountInfoResponse = exports.QueryAccountAddressByIDResponse = exports.QueryModuleAccountByNameRequest = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.QueryAccountResponse = exports.QueryAccountAddressByIDRequest = exports.Bech32PrefixRequest = exports.QueryModuleAccountsResponse = exports.QueryModuleAccountsRequest = exports.QueryAccountsResponse = exports.QueryModuleAccountByNameResponse = exports.ModuleAccount = exports.QueryAccountInfoRequest = exports.AddressStringToBytesResponse = exports.QueryAccountsRequest = exports.ModuleCredential = exports.BaseAccount = void 0;
...
Object.defineProperty(exports, "QueryAccountInfoRequest", { enumerable: true, get: function () { return query_3.QueryAccountInfoRequest; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameResponse", { enumerable: true, get: function () { return query_4.QueryModuleAccountByNameResponse; } });
...
Object.defineProperty(exports, "QueryAccountAddressByIDRequest", { enumerable: true, get: function () { return query_9.QueryAccountAddressByIDRequest; } });
const query_10 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountResponse", { enumerable: true, get: function () { return query_10.QueryAccountResponse; } });
...
Object.defineProperty(exports, "QueryModuleAccountByNameRequest", { enumerable: true, get: function () { return query_12.QueryModuleAccountByNameRequest; } });
const query_13 = require("./types/cosmos/auth/v1beta1/query");
Object.defineProperty(exports, "QueryAccountAddressByIDResponse", { enumerable: true, get: function () { return query_13.QueryAccountAddressByIDResponse; } });
...
Object.defineProperty(exports, "AddressBytesToStringResponse", { enumerable: true, get: function () { return query_15.AddressBytesToStringResponse; } });
...
Object.defineProperty(exports, "QueryAccountRequest", { enumerable: true, get: function () { return query_18.QueryAccountRequest; } });
    ...
    return {
        ...
        async sendQueryAccountInfoRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountInfoRequest({ value: query_3.QueryAccountInfoRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameResponse({ value: query_4.QueryModuleAccountByNameResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdrequest({ value: query_9.QueryAccountAddressByIDRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountResponse({ value: query_10.QueryAccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryModuleAccountByNameRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryModuleAccountByNameRequest({ value: query_12.QueryModuleAccountByNameRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountAddressByIDResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountAddressByIdresponse({ value: query_13.QueryAccountAddressByIDResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAddressBytesToStringResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.addressBytesToStringResponse({ value: query_15.AddressBytesToStringResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountRequest({ value: query_18.QueryAccountRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAccountInfoRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountInfoRequest", value: query_3.QueryAccountInfoRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", value: query_4.QueryModuleAccountByNameResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdrequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDRequest", value: query_9.QueryAccountAddressByIDRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountResponse", value: query_10.QueryAccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryParamsRequest", value: query_11.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryModuleAccountByNameRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryModuleAccountByNameRequest", value: query_12.QueryModuleAccountByNameRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountAddressByIdresponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountAddressByIDResponse", value: query_13.QueryAccountAddressByIDResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        addressBytesToStringResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.AddressBytesToStringResponse", value: query_15.AddressBytesToStringResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.auth.v1beta1.QueryAccountRequest", value: query_18.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
