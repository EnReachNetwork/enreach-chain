...
const msgTypes = [
    ["/cosmos.auth.v1beta1.QueryModuleAccountsRequest", query_1.QueryModuleAccountsRequest],
    ["/cosmos.auth.v1beta1.AddressStringToBytesResponse", query_2.AddressStringToBytesResponse],
    ["/cosmos.auth.v1beta1.QueryAccountAddressByIDRequest", query_3.QueryAccountAddressByIDRequest],
    ["/cosmos.auth.v1beta1.GenesisState", genesis_1.GenesisState],
    ["/cosmos.auth.v1beta1.QueryAccountsRequest", query_4.QueryAccountsRequest],
    ["/cosmos.auth.v1beta1.QueryParamsRequest", query_5.QueryParamsRequest],
    ["/cosmos.auth.v1beta1.QueryAccountInfoResponse", query_6.QueryAccountInfoResponse],
    ["/cosmos.auth.v1beta1.QueryAccountRequest", query_7.QueryAccountRequest],
    ["/cosmos.auth.v1beta1.AddressBytesToStringRequest", query_8.AddressBytesToStringRequest],
    ["/cosmos.auth.v1beta1.QueryAccountInfoRequest", query_9.QueryAccountInfoRequest],
    ["/cosmos.auth.v1beta1.ModuleAccount", auth_1.ModuleAccount],
    ["/cosmos.auth.v1beta1.QueryModuleAccountsResponse", query_10.QueryModuleAccountsResponse],
    ["/cosmos.auth.v1beta1.Bech32PrefixRequest", query_11.Bech32PrefixRequest],
    ["/cosmos.auth.v1beta1.BaseAccount", auth_2.BaseAccount],
    ["/cosmos.auth.v1beta1.QueryModuleAccountByNameResponse", query_12.QueryModuleAccountByNameResponse],
    ["/cosmos.auth.v1beta1.MsgUpdateParams", tx_1.MsgUpdateParams],
    ["/cosmos.auth.v1beta1.AddressBytesToStringResponse", query_13.AddressBytesToStringResponse],
    ["/cosmos.auth.v1beta1.QueryAccountAddressByIDResponse", query_14.QueryAccountAddressByIDResponse],
    ["/cosmos.auth.v1beta1.ModuleCredential", auth_3.ModuleCredential],
    ["/cosmos.auth.v1beta1.AddressStringToBytesRequest", query_15.AddressStringToBytesRequest],
    ...
    ["/cosmos.auth.v1beta1.QueryParamsResponse", query_17.QueryParamsResponse],
    ["/cosmos.auth.v1beta1.QueryModuleAccountByNameRequest", query_18.QueryModuleAccountByNameRequest],
    ["/cosmos.auth.v1beta1.Params", auth_4.Params],
    ["/cosmos.auth.v1beta1.QueryAccountsResponse", query_19.QueryAccountsResponse],
    ["/cosmos.auth.v1beta1.Bech32PrefixResponse", query_20.Bech32PrefixResponse],
];
