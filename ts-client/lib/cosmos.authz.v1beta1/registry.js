...
const msgTypes = [
    ...
    ["/cosmos.authz.v1beta1.GrantAuthorization", authz_2.GrantAuthorization],
    ["/cosmos.authz.v1beta1.MsgGrant", tx_3.MsgGrant],
    ["/cosmos.authz.v1beta1.MsgRevoke", tx_4.MsgRevoke],
    ["/cosmos.authz.v1beta1.QueryGranteeGrantsRequest", query_1.QueryGranteeGrantsRequest],
    ["/cosmos.authz.v1beta1.QueryGranteeGrantsResponse", query_2.QueryGranteeGrantsResponse],
