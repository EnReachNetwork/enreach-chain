...
exports.queryClient = exports.txClient = exports.registry = exports.MsgRevokeResponse = exports.GenesisState = exports.GrantQueueItem = exports.MsgGrant = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsRequest = exports.QueryGrantsRequest = exports.GenericAuthorization = exports.EventGrant = exports.MsgExecResponse = exports.MsgExec = exports.QueryGranterGrantsResponse = exports.Grant = exports.EventRevoke = exports.MsgRevoke = exports.MsgGrantResponse = exports.QueryGranteeGrantsResponse = exports.QueryGrantsResponse = exports.GrantAuthorization = void 0;
...
Object.defineProperty(exports, "QueryGranteeGrantsResponse", { enumerable: true, get: function () { return query_2.QueryGranteeGrantsResponse; } });
...
Object.defineProperty(exports, "MsgExec", { enumerable: true, get: function () { return tx_3.MsgExec; } });
...
Object.defineProperty(exports, "MsgGrant", { enumerable: true, get: function () { return tx_5.MsgGrant; } });
    ...
    return {
        async sendGrantAuthorization({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.grantAuthorization({ value: authz_1.GrantAuthorization.fromPartial(value) });
        ...
        async sendQueryGranteeGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsResponse({ value: query_2.QueryGranteeGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgExec({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExec({ value: tx_3.MsgExec.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrant({ value: tx_5.MsgGrant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGrantQueueItem({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.grantQueueItem({ value: authz_4.GrantQueueItem.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        grantAuthorization({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.GrantAuthorization", value: authz_1.GrantAuthorization.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsResponse", value: query_2.QueryGranteeGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExec({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgExec", value: tx_3.MsgExec.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExecResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgExecResponse", value: tx_4.MsgExecResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrant({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgGrant", value: tx_5.MsgGrant.fromPartial(value) };
            }
            catch (e) {
        ...
        grantQueueItem({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.GrantQueueItem", value: authz_4.GrantQueueItem.fromPartial(value) };
            }
            catch (e) {
