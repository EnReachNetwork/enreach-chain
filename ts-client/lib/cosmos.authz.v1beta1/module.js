...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGranteeGrantsResponse = exports.QueryGranterGrantsResponse = exports.QueryGranterGrantsRequest = exports.EventRevoke = exports.GenesisState = exports.MsgRevokeResponse = exports.MsgExecResponse = exports.QueryGranteeGrantsRequest = exports.EventGrant = exports.GenericAuthorization = exports.GrantAuthorization = exports.Grant = exports.MsgExec = exports.MsgGrant = exports.MsgRevoke = exports.MsgGrantResponse = exports.QueryGrantsResponse = exports.QueryGrantsRequest = exports.GrantQueueItem = void 0;
...
Object.defineProperty(exports, "QueryGranterGrantsRequest", { enumerable: true, get: function () { return query_4.QueryGranterGrantsRequest; } });
const query_5 = require("./types/cosmos/authz/v1beta1/query");
Object.defineProperty(exports, "QueryGranterGrantsResponse", { enumerable: true, get: function () { return query_5.QueryGranterGrantsResponse; } });
    ...
    return {
        ...
        async sendQueryGranterGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranterGrantsRequest({ value: query_4.QueryGranterGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranterGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranterGrantsResponse({ value: query_5.QueryGranterGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGranterGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranterGrantsRequest", value: query_4.QueryGranterGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranterGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranterGrantsResponse", value: query_5.QueryGranterGrantsResponse.fromPartial(value) };
            }
            catch (e) {
