...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisState = exports.GenericAuthorization = exports.QueryGranteeGrantsResponse = exports.QueryGranteeGrantsRequest = exports.QueryGrantsRequest = exports.MsgRevoke = exports.MsgExecResponse = exports.GrantAuthorization = exports.Grant = exports.MsgGrantResponse = exports.EventRevoke = exports.MsgGrant = exports.QueryGranterGrantsResponse = exports.QueryGrantsResponse = exports.EventGrant = exports.MsgExec = exports.MsgRevokeResponse = exports.GrantQueueItem = exports.QueryGranterGrantsRequest = void 0;
    ...
    return {
        ...
        async sendMsgRevokeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeResponse({ value: tx_1.MsgRevokeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRevokeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgRevokeResponse", value: tx_1.MsgRevokeResponse.fromPartial(value) };
            }
            catch (e) {
