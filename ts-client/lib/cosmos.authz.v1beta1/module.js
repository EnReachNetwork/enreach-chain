...
exports.queryClient = exports.txClient = exports.registry = exports.MsgGrant = exports.MsgRevoke = exports.QueryGrantsRequest = exports.EventRevoke = exports.EventGrant = exports.GenericAuthorization = exports.Grant = exports.MsgGrantResponse = exports.QueryGranterGrantsRequest = exports.GrantQueueItem = exports.MsgExec = exports.MsgRevokeResponse = exports.MsgExecResponse = exports.GrantAuthorization = exports.GenesisState = exports.QueryGranteeGrantsResponse = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsResponse = exports.QueryGrantsResponse = void 0;
...
Object.defineProperty(exports, "MsgRevokeResponse", { enumerable: true, get: function () { return tx_2.MsgRevokeResponse; } });
...
Object.defineProperty(exports, "MsgRevoke", { enumerable: true, get: function () { return tx_5.MsgRevoke; } });
    ...
    return {
        ...
        async sendMsgRevokeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeResponse({ value: tx_2.MsgRevokeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevoke({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevoke({ value: tx_5.MsgRevoke.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgRevokeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgRevokeResponse", value: tx_2.MsgRevokeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevoke({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgRevoke", value: tx_5.MsgRevoke.fromPartial(value) };
            }
            catch (e) {
