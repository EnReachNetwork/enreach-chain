...
exports.queryClient = exports.txClient = exports.registry = exports.EventRevoke = exports.GrantQueueItem = exports.QueryGranterGrantsResponse = exports.QueryGranterGrantsRequest = exports.QueryGrantsResponse = exports.MsgRevokeResponse = exports.MsgExecResponse = exports.QueryGrantsRequest = exports.GenesisState = exports.Grant = exports.EventGrant = exports.QueryGranteeGrantsResponse = exports.QueryGranteeGrantsRequest = exports.MsgRevoke = exports.MsgGrant = exports.GrantAuthorization = exports.GenericAuthorization = exports.MsgExec = exports.MsgGrantResponse = void 0;
...
Object.defineProperty(exports, "GrantAuthorization", { enumerable: true, get: function () { return authz_2.GrantAuthorization; } });
...
Object.defineProperty(exports, "Grant", { enumerable: true, get: function () { return authz_3.Grant; } });
    ...
    return {
        ...
        async sendGenericAuthorization({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.genericAuthorization({ value: authz_1.GenericAuthorization.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGrantAuthorization({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.grantAuthorization({ value: authz_2.GrantAuthorization.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranteeGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsRequest({ value: query_1.QueryGranteeGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.grant({ value: authz_3.Grant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        genericAuthorization({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.GenericAuthorization", value: authz_1.GenericAuthorization.fromPartial(value) };
            }
            catch (e) {
        ...
        grantAuthorization({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.GrantAuthorization", value: authz_2.GrantAuthorization.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsRequest", value: query_1.QueryGranteeGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        grant({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.Grant", value: authz_3.Grant.fromPartial(value) };
            }
            catch (e) {
