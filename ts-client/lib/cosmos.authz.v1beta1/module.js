...
exports.queryClient = exports.txClient = exports.registry = exports.GrantQueueItem = exports.Grant = exports.GrantAuthorization = exports.MsgExec = exports.QueryGranterGrantsRequest = exports.MsgGrantResponse = exports.QueryGrantsResponse = exports.GenericAuthorization = exports.GenesisState = exports.MsgRevokeResponse = exports.MsgRevoke = exports.MsgGrant = exports.QueryGranteeGrantsResponse = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsResponse = exports.EventRevoke = exports.EventGrant = exports.MsgExecResponse = exports.QueryGrantsRequest = void 0;
...
Object.defineProperty(exports, "QueryGranterGrantsResponse", { enumerable: true, get: function () { return query_2.QueryGranterGrantsResponse; } });
const query_3 = require("./types/cosmos/authz/v1beta1/query");
Object.defineProperty(exports, "QueryGranteeGrantsRequest", { enumerable: true, get: function () { return query_3.QueryGranteeGrantsRequest; } });
...
Object.defineProperty(exports, "MsgGrant", { enumerable: true, get: function () { return tx_2.MsgGrant; } });
const tx_3 = require("./types/cosmos/authz/v1beta1/tx");
Object.defineProperty(exports, "MsgRevoke", { enumerable: true, get: function () { return tx_3.MsgRevoke; } });
const tx_4 = require("./types/cosmos/authz/v1beta1/tx");
Object.defineProperty(exports, "MsgRevokeResponse", { enumerable: true, get: function () { return tx_4.MsgRevokeResponse; } });
...
Object.defineProperty(exports, "MsgGrantResponse", { enumerable: true, get: function () { return tx_5.MsgGrantResponse; } });
    ...
    return {
        async sendQueryGrantsRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryGrantsRequest({ value: query_1.QueryGrantsRequest.fromPartial(value) });
        ...
        async sendQueryGranterGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranterGrantsResponse({ value: query_2.QueryGranterGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranteeGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsRequest({ value: query_3.QueryGranteeGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrant({ value: tx_2.MsgGrant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevoke({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevoke({ value: tx_3.MsgRevoke.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevokeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevokeResponse({ value: tx_4.MsgRevokeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrantResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantResponse({ value: tx_5.MsgGrantResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGrantsRequest", value: query_1.QueryGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranterGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranterGrantsResponse", value: query_2.QueryGranterGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsRequest", value: query_3.QueryGranteeGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrant({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgGrant", value: tx_2.MsgGrant.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevoke({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgRevoke", value: tx_3.MsgRevoke.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevokeResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgRevokeResponse", value: tx_4.MsgRevokeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrantResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgGrantResponse", value: tx_5.MsgGrantResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExec({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgExec", value: tx_6.MsgExec.fromPartial(value) };
            }
            catch (e) {
