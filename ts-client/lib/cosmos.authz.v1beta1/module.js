...
exports.queryClient = exports.txClient = exports.registry = exports.EventRevoke = exports.MsgRevoke = exports.MsgGrantResponse = exports.Grant = exports.EventGrant = exports.MsgRevokeResponse = exports.MsgExec = exports.MsgGrant = exports.GenericAuthorization = exports.QueryGrantsRequest = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsResponse = exports.QueryGranterGrantsRequest = exports.QueryGrantsResponse = exports.GenesisState = exports.MsgExecResponse = exports.QueryGranteeGrantsResponse = exports.GrantQueueItem = exports.GrantAuthorization = void 0;
...
Object.defineProperty(exports, "QueryGranterGrantsResponse", { enumerable: true, get: function () { return query_4.QueryGranterGrantsResponse; } });
const query_5 = require("./types/cosmos/authz/v1beta1/query");
Object.defineProperty(exports, "QueryGranteeGrantsRequest", { enumerable: true, get: function () { return query_5.QueryGranteeGrantsRequest; } });
const query_6 = require("./types/cosmos/authz/v1beta1/query");
Object.defineProperty(exports, "QueryGrantsRequest", { enumerable: true, get: function () { return query_6.QueryGrantsRequest; } });
...
Object.defineProperty(exports, "Grant", { enumerable: true, get: function () { return authz_4.Grant; } });
    ...
    return {
        ...
        async sendQueryGranterGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranterGrantsResponse({ value: query_4.QueryGranterGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranteeGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsRequest({ value: query_5.QueryGranteeGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGrantsRequest({ value: query_6.QueryGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.grant({ value: authz_4.Grant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGranterGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranterGrantsResponse", value: query_4.QueryGranterGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsRequest", value: query_5.QueryGranteeGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGrantsRequest", value: query_6.QueryGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        grant({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.Grant", value: authz_4.Grant.fromPartial(value) };
            }
            catch (e) {
