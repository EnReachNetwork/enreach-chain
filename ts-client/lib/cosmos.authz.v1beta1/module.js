...
exports.queryClient = exports.txClient = exports.registry = exports.GrantAuthorization = exports.GenesisState = exports.EventRevoke = exports.EventGrant = exports.MsgRevokeResponse = exports.MsgExec = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsRequest = exports.QueryGrantsResponse = exports.GrantQueueItem = exports.GenericAuthorization = exports.MsgGrantResponse = exports.MsgGrant = exports.QueryGranteeGrantsResponse = exports.QueryGrantsRequest = exports.MsgRevoke = exports.MsgExecResponse = exports.QueryGranterGrantsResponse = exports.Grant = void 0;
...
Object.defineProperty(exports, "QueryGrantsRequest", { enumerable: true, get: function () { return query_2.QueryGrantsRequest; } });
const query_3 = require("./types/cosmos/authz/v1beta1/query");
Object.defineProperty(exports, "QueryGranteeGrantsResponse", { enumerable: true, get: function () { return query_3.QueryGranteeGrantsResponse; } });
...
Object.defineProperty(exports, "QueryGrantsResponse", { enumerable: true, get: function () { return query_4.QueryGrantsResponse; } });
...
Object.defineProperty(exports, "QueryGranteeGrantsRequest", { enumerable: true, get: function () { return query_6.QueryGranteeGrantsRequest; } });
    ...
    return {
        ...
        async sendMsgExecResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecResponse({ value: tx_1.MsgExecResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGrantsRequest({ value: query_2.QueryGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranteeGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsResponse({ value: query_3.QueryGranteeGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGrantsResponse({ value: query_4.QueryGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranteeGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsRequest({ value: query_6.QueryGranteeGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgExecResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgExecResponse", value: tx_1.MsgExecResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGrantsRequest", value: query_2.QueryGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsResponse", value: query_3.QueryGranteeGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGrantsResponse", value: query_4.QueryGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsRequest", value: query_6.QueryGranteeGrantsRequest.fromPartial(value) };
            }
            catch (e) {
