...
exports.queryClient = exports.txClient = exports.registry = exports.MsgExec = exports.MsgGrantResponse = exports.GrantAuthorization = exports.MsgGrant = exports.QueryGranteeGrantsResponse = exports.QueryGrantsRequest = exports.EventRevoke = exports.EventGrant = exports.MsgRevokeResponse = exports.MsgRevoke = exports.MsgExecResponse = exports.Grant = exports.GenericAuthorization = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsResponse = exports.QueryGranterGrantsRequest = exports.QueryGrantsResponse = exports.GenesisState = exports.GrantQueueItem = void 0;
...
Object.defineProperty(exports, "QueryGranterGrantsRequest", { enumerable: true, get: function () { return query_2.QueryGranterGrantsRequest; } });
...
Object.defineProperty(exports, "MsgGrant", { enumerable: true, get: function () { return tx_4.MsgGrant; } });
    ...
    return {
        ...
        async sendQueryGranterGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranterGrantsRequest({ value: query_2.QueryGranterGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrant({ value: tx_4.MsgGrant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGranterGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranterGrantsRequest", value: query_2.QueryGranterGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrant({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgGrant", value: tx_4.MsgGrant.fromPartial(value) };
            }
            catch (e) {
