...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGranterGrantsResponse = exports.EventGrant = exports.MsgRevoke = exports.GrantAuthorization = exports.QueryGranteeGrantsResponse = exports.GrantQueueItem = exports.MsgExecResponse = exports.MsgExec = exports.GenesisState = exports.GenericAuthorization = exports.QueryGranteeGrantsRequest = exports.QueryGrantsResponse = exports.QueryGrantsRequest = exports.QueryGranterGrantsRequest = exports.MsgRevokeResponse = exports.MsgGrantResponse = exports.MsgGrant = exports.EventRevoke = exports.Grant = void 0;
...
Object.defineProperty(exports, "MsgGrantResponse", { enumerable: true, get: function () { return tx_2.MsgGrantResponse; } });
...
Object.defineProperty(exports, "QueryGrantsResponse", { enumerable: true, get: function () { return query_3.QueryGrantsResponse; } });
...
Object.defineProperty(exports, "QueryGranteeGrantsResponse", { enumerable: true, get: function () { return query_5.QueryGranteeGrantsResponse; } });
...
Object.defineProperty(exports, "MsgRevoke", { enumerable: true, get: function () { return tx_6.MsgRevoke; } });
const event_2 = require("./types/cosmos/authz/v1beta1/event");
Object.defineProperty(exports, "EventGrant", { enumerable: true, get: function () { return event_2.EventGrant; } });
    ...
    return {
        ...
        async sendEventRevoke({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.eventRevoke({ value: event_1.EventRevoke.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgGrantResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgGrantResponse({ value: tx_2.MsgGrantResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranterGrantsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranterGrantsRequest({ value: query_1.QueryGranterGrantsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGrantsResponse({ value: query_3.QueryGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGranteeGrantsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGranteeGrantsResponse({ value: query_5.QueryGranteeGrantsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRevoke({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRevoke({ value: tx_6.MsgRevoke.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendEventGrant({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.eventGrant({ value: event_2.EventGrant.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        eventRevoke({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.EventRevoke", value: event_1.EventRevoke.fromPartial(value) };
            }
            catch (e) {
        ...
        msgGrantResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgGrantResponse", value: tx_2.MsgGrantResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranterGrantsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranterGrantsRequest", value: query_1.QueryGranterGrantsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGrantsResponse", value: query_3.QueryGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgExec({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgExec", value: tx_4.MsgExec.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGranteeGrantsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.QueryGranteeGrantsResponse", value: query_5.QueryGranteeGrantsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRevoke({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgRevoke", value: tx_6.MsgRevoke.fromPartial(value) };
            }
            catch (e) {
        ...
        eventGrant({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.EventGrant", value: event_2.EventGrant.fromPartial(value) };
            }
            catch (e) {
