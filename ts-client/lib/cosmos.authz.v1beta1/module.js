...
exports.queryClient = exports.txClient = exports.registry = exports.MsgRevokeResponse = exports.QueryGranteeGrantsResponse = exports.GenesisState = exports.EventRevoke = exports.EventGrant = exports.GrantQueueItem = exports.MsgGrant = exports.QueryGrantsResponse = exports.GrantAuthorization = exports.MsgRevoke = exports.GenericAuthorization = exports.Grant = exports.QueryGranterGrantsResponse = exports.QueryGrantsRequest = exports.MsgExecResponse = exports.MsgGrantResponse = exports.MsgExec = exports.QueryGranteeGrantsRequest = exports.QueryGranterGrantsRequest = void 0;
...
Object.defineProperty(exports, "MsgExecResponse", { enumerable: true, get: function () { return tx_3.MsgExecResponse; } });
    ...
    return {
        ...
        async sendMsgExecResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgExecResponse({ value: tx_3.MsgExecResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgExecResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.authz.v1beta1.MsgExecResponse", value: tx_3.MsgExecResponse.fromPartial(value) };
            }
            catch (e) {
