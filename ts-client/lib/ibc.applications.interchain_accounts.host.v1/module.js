...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.QueryParamsRequest = exports.MsgUpdateParamsResponse = exports.QueryParamsResponse = exports.Params = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.host.v1.MsgUpdateParamsResponse", value: tx_1.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.applications.interchain_accounts.host.v1.MsgUpdateParams", value: tx_2.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
