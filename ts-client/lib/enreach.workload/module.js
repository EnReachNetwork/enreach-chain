...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgCreateWorkload = exports.QueryGetWorkloadResponse = exports.GenesisState = exports.MsgCreateWorkloadResponse = exports.QueryParamsResponse = exports.Workload = exports.Params = exports.QueryAllWorkloadRequest = exports.QueryGetWorkloadRequest = exports.QueryParamsRequest = exports.QueryAllWorkloadResponse = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.workload.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
