...
exports.queryClient = exports.txClient = exports.registry = exports.Params = exports.QueryGetWorkloadRequest = exports.MsgCreateWorkload = exports.Workload = exports.QueryGetWorkloadResponse = exports.QueryParamsResponse = exports.QueryAllWorkloadRequest = exports.MsgCreateWorkloadResponse = exports.QueryAllWorkloadResponse = exports.GenesisState = exports.MsgUpdateParamsResponse = exports.QueryParamsRequest = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "QueryGetWorkloadResponse", { enumerable: true, get: function () { return query_5.QueryGetWorkloadResponse; } });
...
Object.defineProperty(exports, "MsgCreateWorkload", { enumerable: true, get: function () { return tx_4.MsgCreateWorkload; } });
    ...
    return {
        ...
        async sendQueryGetWorkloadResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetWorkloadResponse({ value: query_5.QueryGetWorkloadResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateWorkload({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateWorkload({ value: tx_4.MsgCreateWorkload.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGetWorkloadResponse({ value }) {
            try {
                return { typeUrl: "/enreach.workload.QueryGetWorkloadResponse", value: query_5.QueryGetWorkloadResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateWorkload({ value }) {
            try {
                return { typeUrl: "/enreach.workload.MsgCreateWorkload", value: tx_4.MsgCreateWorkload.fromPartial(value) };
            }
            catch (e) {
