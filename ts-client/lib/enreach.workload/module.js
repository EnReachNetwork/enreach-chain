...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreateWorkloadResponse = exports.QueryAllWorkloadResponse = exports.MsgCreateWorkload = exports.MsgUpdateParams = exports.QueryGetWorkloadRequest = exports.GenesisState = exports.QueryParamsResponse = exports.Params = exports.MsgUpdateParamsResponse = exports.QueryAllWorkloadRequest = exports.QueryGetWorkloadResponse = exports.QueryParamsRequest = exports.Workload = void 0;
...
Object.defineProperty(exports, "QueryGetWorkloadRequest", { enumerable: true, get: function () { return query_5.QueryGetWorkloadRequest; } });
    ...
    return {
        ...
        async sendQueryGetWorkloadRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetWorkloadRequest({ value: query_5.QueryGetWorkloadRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGetWorkloadRequest({ value }) {
            try {
                return { typeUrl: "/enreach.workload.QueryGetWorkloadRequest", value: query_5.QueryGetWorkloadRequest.fromPartial(value) };
            }
            catch (e) {
