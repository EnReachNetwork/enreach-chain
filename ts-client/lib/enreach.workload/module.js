...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAllWorkloadResponse = exports.QueryAllWorkloadRequest = exports.QueryGetWorkloadResponse = exports.QueryGetWorkloadRequest = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgCreateWorkload = exports.Workload = exports.Params = exports.MsgCreateWorkloadResponse = exports.QueryParamsRequest = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "MsgCreateWorkloadResponse", { enumerable: true, get: function () { return tx_1.MsgCreateWorkloadResponse; } });
...
Object.defineProperty(exports, "MsgCreateWorkload", { enumerable: true, get: function () { return tx_2.MsgCreateWorkload; } });
...
Object.defineProperty(exports, "QueryGetWorkloadRequest", { enumerable: true, get: function () { return query_3.QueryGetWorkloadRequest; } });
const query_4 = require("./types/enreach/workload/query");
Object.defineProperty(exports, "QueryGetWorkloadResponse", { enumerable: true, get: function () { return query_4.QueryGetWorkloadResponse; } });
    ...
    return {
        ...
        async sendMsgCreateWorkloadResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateWorkloadResponse({ value: tx_1.MsgCreateWorkloadResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateWorkload({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateWorkload({ value: tx_2.MsgCreateWorkload.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetWorkloadRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetWorkloadRequest({ value: query_3.QueryGetWorkloadRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetWorkloadResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetWorkloadResponse({ value: query_4.QueryGetWorkloadResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreateWorkloadResponse({ value }) {
            try {
                return { typeUrl: "/enreach.workload.MsgCreateWorkloadResponse", value: tx_1.MsgCreateWorkloadResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateWorkload({ value }) {
            try {
                return { typeUrl: "/enreach.workload.MsgCreateWorkload", value: tx_2.MsgCreateWorkload.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.workload.QueryParamsResponse", value: query_2.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetWorkloadRequest({ value }) {
            try {
                return { typeUrl: "/enreach.workload.QueryGetWorkloadRequest", value: query_3.QueryGetWorkloadRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetWorkloadResponse({ value }) {
            try {
                return { typeUrl: "/enreach.workload.QueryGetWorkloadResponse", value: query_4.QueryGetWorkloadResponse.fromPartial(value) };
            }
            catch (e) {
