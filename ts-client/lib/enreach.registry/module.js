...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreateSuperiorResponse = exports.QueryAllRegionRequest = exports.MsgUpdateSuperiorResponse = exports.MsgDeleteRegionResponse = exports.MsgUpdateRegion = exports.MsgCreateRegion = exports.MsgUpdateParamsResponse = exports.QueryAllRegionResponse = exports.QueryParamsRequest = exports.MsgUpdateParams = exports.MsgUpdateSuperior = exports.QueryGetSuperiorResponse = exports.MsgDeleteRegion = exports.MsgCreateSuperior = exports.QueryGetSuperiorRequest = exports.QueryParamsResponse = exports.MsgUpdateRegionResponse = exports.MsgCreateRegionResponse = exports.QueryGetRegionResponse = exports.GenesisState = exports.Superior = exports.Params = exports.QueryGetRegionRequest = exports.Region = void 0;
...
Object.defineProperty(exports, "QueryGetRegionRequest", { enumerable: true, get: function () { return query_1.QueryGetRegionRequest; } });
...
Object.defineProperty(exports, "MsgCreateSuperior", { enumerable: true, get: function () { return tx_3.MsgCreateSuperior; } });
const tx_4 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgDeleteRegion", { enumerable: true, get: function () { return tx_4.MsgDeleteRegion; } });
...
Object.defineProperty(exports, "QueryAllRegionResponse", { enumerable: true, get: function () { return query_7.QueryAllRegionResponse; } });
...
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_10.MsgDeleteRegionResponse; } });
...
Object.defineProperty(exports, "QueryAllRegionRequest", { enumerable: true, get: function () { return query_8.QueryAllRegionRequest; } });
    ...
    return {
        ...
        async sendQueryGetRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetRegionRequest({ value: query_1.QueryGetRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateSuperior({ value: tx_3.MsgCreateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegion({ value: tx_4.MsgDeleteRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionResponse({ value: query_7.QueryAllRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_10.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionRequest({ value: query_8.QueryAllRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGetRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetRegionRequest", value: query_1.QueryGetRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryParamsResponse", value: query_3.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorRequest", value: query_4.QueryGetSuperiorRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperior", value: tx_3.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegion", value: tx_4.MsgDeleteRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperior", value: tx_5.MsgUpdateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryParamsRequest", value: query_6.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionResponse", value: query_7.QueryAllRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateParamsResponse", value: tx_7.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_10.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperiorResponse", value: tx_11.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionRequest", value: query_8.QueryAllRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperiorResponse", value: tx_12.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
