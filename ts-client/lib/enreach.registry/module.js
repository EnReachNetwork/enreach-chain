...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetRegionRequest = exports.QueryParamsResponse = exports.MsgDeleteRegion = exports.MsgCreateSuperior = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorRequest = exports.QueryGetSuperiorResponse = exports.QueryParamsRequest = exports.Superior = exports.Params = exports.GenesisState = exports.MsgDeleteRegionResponse = exports.MsgCreateRegionResponse = exports.QueryAllRegionResponse = exports.MsgUpdateSuperior = exports.MsgCreateSuperiorResponse = exports.MsgUpdateParams = exports.MsgCreateRegion = exports.MsgUpdateSuperiorResponse = exports.Region = exports.MsgUpdateRegionResponse = exports.QueryAllRegionRequest = exports.QueryGetRegionResponse = exports.MsgUpdateRegion = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgUpdateRegion", { enumerable: true, get: function () { return tx_1.MsgUpdateRegion; } });
...
Object.defineProperty(exports, "QueryAllRegionRequest", { enumerable: true, get: function () { return query_2.QueryAllRegionRequest; } });
const tx_2 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgUpdateRegionResponse", { enumerable: true, get: function () { return tx_2.MsgUpdateRegionResponse; } });
...
Object.defineProperty(exports, "MsgCreateRegion", { enumerable: true, get: function () { return tx_4.MsgCreateRegion; } });
...
Object.defineProperty(exports, "QueryAllRegionResponse", { enumerable: true, get: function () { return query_3.QueryAllRegionResponse; } });
const tx_8 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgCreateRegionResponse", { enumerable: true, get: function () { return tx_8.MsgCreateRegionResponse; } });
const tx_9 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_9.MsgDeleteRegionResponse; } });
...
Object.defineProperty(exports, "MsgDeleteRegion", { enumerable: true, get: function () { return tx_12.MsgDeleteRegion; } });
    ...
    return {
        async sendMsgUpdateRegion({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgUpdateRegion({ value: tx_1.MsgUpdateRegion.fromPartial(value) });
        ...
        async sendQueryAllRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionRequest({ value: query_2.QueryAllRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegionResponse({ value: tx_2.MsgUpdateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegion({ value: tx_4.MsgCreateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionResponse({ value: query_3.QueryAllRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegionResponse({ value: tx_8.MsgCreateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_9.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegion({ value: tx_12.MsgDeleteRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegion", value: tx_1.MsgUpdateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionRequest", value: query_2.QueryAllRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegionResponse", value: tx_2.MsgUpdateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperiorResponse", value: tx_3.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegion", value: tx_4.MsgCreateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperiorResponse", value: tx_6.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperior", value: tx_7.MsgUpdateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionResponse", value: query_3.QueryAllRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegionResponse", value: tx_8.MsgCreateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_9.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorResponse", value: query_5.QueryGetSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorRequest", value: query_6.QueryGetSuperiorRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperior", value: tx_11.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegion", value: tx_12.MsgDeleteRegion.fromPartial(value) };
            }
            catch (e) {
