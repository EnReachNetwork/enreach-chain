...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetSuperiorRequest = exports.MsgCreateSuperior = exports.MsgUpdateRegionResponse = exports.MsgUpdateParams = exports.MsgUpdateSuperiorResponse = exports.GenesisState = exports.MsgCreateRegionResponse = exports.QueryGetRegionResponse = exports.MsgCreateSuperiorResponse = exports.MsgDeleteRegionResponse = exports.Params = exports.QueryGetRegionRequest = exports.QueryParamsResponse = exports.MsgUpdateSuperior = exports.MsgDeleteRegion = exports.MsgUpdateRegion = exports.Superior = exports.QueryAllRegionResponse = exports.QueryAllRegionRequest = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorResponse = exports.QueryParamsRequest = exports.Region = exports.MsgCreateRegion = void 0;
...
Object.defineProperty(exports, "QueryGetRegionRequest", { enumerable: true, get: function () { return query_6.QueryGetRegionRequest; } });
...
Object.defineProperty(exports, "MsgUpdateRegionResponse", { enumerable: true, get: function () { return tx_11.MsgUpdateRegionResponse; } });
    ...
    return {
        ...
        async sendQueryGetRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetRegionRequest({ value: query_6.QueryGetRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegionResponse({ value: tx_11.MsgUpdateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryGetRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetRegionRequest", value: query_6.QueryGetRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperiorResponse", value: tx_7.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperiorResponse", value: tx_9.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateParams", value: tx_10.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegionResponse", value: tx_11.MsgUpdateRegionResponse.fromPartial(value) };
            }
            catch (e) {
