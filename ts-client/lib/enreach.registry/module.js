...
exports.queryClient = exports.txClient = exports.registry = exports.MsgDeleteRegion = exports.MsgUpdateParamsResponse = exports.MsgCreateSuperior = exports.MsgUpdateParams = exports.QueryParamsResponse = exports.Region = exports.MsgCreateRegionResponse = exports.Superior = exports.QueryGetSuperiorResponse = exports.QueryGetSuperiorRequest = exports.QueryGetRegionResponse = exports.QueryParamsRequest = exports.Params = exports.MsgUpdateSuperiorResponse = exports.MsgUpdateSuperior = exports.MsgCreateSuperiorResponse = exports.MsgDeleteRegionResponse = exports.MsgUpdateRegionResponse = exports.MsgCreateRegion = exports.QueryGetRegionRequest = exports.MsgUpdateRegion = exports.QueryAllRegionResponse = exports.QueryAllRegionRequest = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "QueryAllRegionRequest", { enumerable: true, get: function () { return query_1.QueryAllRegionRequest; } });
...
Object.defineProperty(exports, "QueryGetRegionRequest", { enumerable: true, get: function () { return query_3.QueryGetRegionRequest; } });
const tx_2 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgCreateRegion", { enumerable: true, get: function () { return tx_2.MsgCreateRegion; } });
const tx_3 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgUpdateRegionResponse", { enumerable: true, get: function () { return tx_3.MsgUpdateRegionResponse; } });
const tx_4 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_4.MsgDeleteRegionResponse; } });
...
Object.defineProperty(exports, "MsgUpdateSuperior", { enumerable: true, get: function () { return tx_6.MsgUpdateSuperior; } });
    ...
    return {
        ...
        async sendQueryAllRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionRequest({ value: query_1.QueryAllRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetRegionRequest({ value: query_3.QueryGetRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegion({ value: tx_2.MsgCreateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegionResponse({ value: tx_3.MsgUpdateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_4.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateSuperior({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateSuperior({ value: tx_6.MsgUpdateSuperior.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionRequest", value: query_1.QueryAllRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetRegionRequest", value: query_3.QueryGetRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegion", value: tx_2.MsgCreateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegionResponse", value: tx_3.MsgUpdateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_4.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperiorResponse", value: tx_5.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperior", value: tx_6.MsgUpdateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorResponse", value: query_7.QueryGetSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryParamsResponse", value: query_8.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateParams", value: tx_9.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateParamsResponse", value: tx_11.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
