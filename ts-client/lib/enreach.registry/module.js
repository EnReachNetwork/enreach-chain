...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetSuperiorRequest = exports.MsgUpdateSuperiorResponse = exports.MsgUpdateSuperior = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorResponse = exports.QueryAllRegionRequest = exports.QueryGetRegionRequest = exports.MsgUpdateParams = exports.QueryParamsResponse = exports.Params = exports.QueryParamsRequest = exports.MsgCreateSuperiorResponse = exports.MsgUpdateRegionResponse = exports.MsgCreateRegionResponse = exports.GenesisState = exports.MsgCreateSuperior = exports.MsgCreateRegion = exports.QueryAllRegionResponse = exports.QueryGetRegionResponse = exports.MsgUpdateRegion = exports.Superior = exports.MsgDeleteRegionResponse = exports.Region = exports.MsgDeleteRegion = void 0;
...
Object.defineProperty(exports, "MsgUpdateRegion", { enumerable: true, get: function () { return tx_3.MsgUpdateRegion; } });
...
Object.defineProperty(exports, "MsgCreateRegionResponse", { enumerable: true, get: function () { return tx_6.MsgCreateRegionResponse; } });
    ...
    return {
        ...
        async sendMsgUpdateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegion({ value: tx_3.MsgUpdateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegionResponse({ value: tx_6.MsgCreateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegion", value: tx_3.MsgUpdateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegionResponse", value: tx_6.MsgCreateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperiorResponse", value: tx_8.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryParamsResponse", value: query_4.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperiorResponse", value: tx_12.MsgUpdateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
