...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetSuperiorRequest = exports.MsgDeleteRegionResponse = exports.MsgUpdateRegionResponse = exports.MsgUpdateSuperior = exports.MsgCreateSuperiorResponse = exports.QueryGetRegionResponse = exports.GenesisState = exports.MsgCreateSuperior = exports.MsgCreateRegionResponse = exports.QueryParamsRequest = exports.Superior = exports.MsgUpdateParams = exports.QueryAllRegionRequest = exports.MsgUpdateSuperiorResponse = exports.QueryParamsResponse = exports.MsgUpdateRegion = exports.MsgCreateRegion = exports.MsgUpdateParamsResponse = exports.QueryGetSuperiorResponse = exports.QueryGetRegionRequest = exports.QueryAllRegionResponse = exports.Params = exports.MsgDeleteRegion = exports.Region = void 0;
...
Object.defineProperty(exports, "QueryAllRegionResponse", { enumerable: true, get: function () { return query_1.QueryAllRegionResponse; } });
const query_2 = require("./types/enreach/registry/query");
Object.defineProperty(exports, "QueryGetRegionRequest", { enumerable: true, get: function () { return query_2.QueryGetRegionRequest; } });
...
Object.defineProperty(exports, "MsgCreateRegion", { enumerable: true, get: function () { return tx_3.MsgCreateRegion; } });
const tx_4 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgUpdateRegion", { enumerable: true, get: function () { return tx_4.MsgUpdateRegion; } });
...
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_12.MsgDeleteRegionResponse; } });
    ...
    return {
        ...
        async sendQueryAllRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionResponse({ value: query_1.QueryAllRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryGetRegionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryGetRegionRequest({ value: query_2.QueryGetRegionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegion({ value: tx_3.MsgCreateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegion({ value: tx_4.MsgUpdateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_12.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAllRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionResponse", value: query_1.QueryAllRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetRegionRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetRegionRequest", value: query_2.QueryGetRegionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegion", value: tx_3.MsgCreateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegion", value: tx_4.MsgUpdateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperior", value: tx_8.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_12.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
