...
exports.queryClient = exports.txClient = exports.registry = exports.QueryGetSuperiorRequest = exports.MsgDeleteRegionResponse = exports.MsgUpdateRegion = exports.QueryGetRegionResponse = exports.QueryParamsRequest = exports.MsgUpdateSuperior = exports.MsgUpdateRegionResponse = exports.Params = exports.Superior = exports.QueryGetRegionRequest = exports.MsgCreateSuperiorResponse = exports.MsgDeleteRegion = exports.Region = exports.MsgCreateSuperior = exports.GenesisState = exports.MsgCreateRegion = exports.QueryAllRegionRequest = exports.MsgUpdateSuperiorResponse = exports.MsgCreateRegionResponse = exports.QueryGetSuperiorResponse = exports.QueryAllRegionResponse = exports.QueryParamsResponse = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = void 0;
...
Object.defineProperty(exports, "MsgCreateRegionResponse", { enumerable: true, get: function () { return tx_3.MsgCreateRegionResponse; } });
...
Object.defineProperty(exports, "MsgCreateRegion", { enumerable: true, get: function () { return tx_5.MsgCreateRegion; } });
...
Object.defineProperty(exports, "MsgDeleteRegion", { enumerable: true, get: function () { return tx_7.MsgDeleteRegion; } });
...
Object.defineProperty(exports, "MsgUpdateRegion", { enumerable: true, get: function () { return tx_11.MsgUpdateRegion; } });
    ...
    return {
        ...
        async sendMsgCreateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegionResponse({ value: tx_3.MsgCreateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegion({ value: tx_5.MsgCreateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegion({ value: tx_7.MsgDeleteRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegion({ value: tx_11.MsgUpdateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgCreateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegionResponse", value: tx_3.MsgCreateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegion", value: tx_5.MsgCreateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperior", value: tx_6.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegion", value: tx_7.MsgDeleteRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegion", value: tx_11.MsgUpdateRegion.fromPartial(value) };
            }
            catch (e) {
