...
exports.queryClient = exports.txClient = exports.registry = exports.MsgDeleteRegion = exports.MsgUpdateSuperiorResponse = exports.MsgCreateSuperiorResponse = exports.MsgUpdateRegionResponse = exports.MsgCreateRegionResponse = exports.QueryAllRegionResponse = exports.QueryGetRegionResponse = exports.Superior = exports.QueryGetSuperiorResponse = exports.QueryAllRegionRequest = exports.QueryGetRegionRequest = exports.GenesisState = exports.Region = exports.QueryGetSuperiorRequest = exports.MsgDeleteRegionResponse = exports.MsgUpdateParams = exports.QueryParamsResponse = exports.Params = exports.MsgUpdateParamsResponse = exports.MsgCreateRegion = exports.MsgUpdateSuperior = exports.MsgCreateSuperior = exports.MsgUpdateRegion = exports.QueryParamsRequest = void 0;
...
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_7.MsgDeleteRegionResponse; } });
...
Object.defineProperty(exports, "QueryAllRegionResponse", { enumerable: true, get: function () { return query_8.QueryAllRegionResponse; } });
...
Object.defineProperty(exports, "MsgUpdateRegionResponse", { enumerable: true, get: function () { return tx_9.MsgUpdateRegionResponse; } });
    ...
    return {
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_7.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAllRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAllRegionResponse({ value: query_8.QueryAllRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegionResponse({ value: tx_9.MsgUpdateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateSuperior", value: tx_3.MsgUpdateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateParamsResponse", value: tx_5.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_7.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorRequest", value: query_3.QueryGetSuperiorRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAllRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryAllRegionResponse", value: query_8.QueryAllRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegionResponse", value: tx_9.MsgUpdateRegionResponse.fromPartial(value) };
            }
            catch (e) {
