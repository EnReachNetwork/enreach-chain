...
exports.queryClient = exports.txClient = exports.registry = exports.Params = exports.QueryGetSuperiorResponse = exports.QueryGetSuperiorRequest = exports.MsgUpdateSuperior = exports.MsgCreateRegion = exports.GenesisState = exports.MsgCreateSuperiorResponse = exports.QueryAllRegionRequest = exports.MsgCreateSuperior = exports.MsgUpdateParams = exports.Superior = exports.MsgCreateRegionResponse = exports.Region = exports.QueryAllRegionResponse = exports.QueryGetRegionResponse = exports.MsgUpdateRegion = exports.MsgDeleteRegionResponse = exports.MsgUpdateRegionResponse = exports.MsgUpdateSuperiorResponse = exports.MsgUpdateParamsResponse = exports.QueryGetRegionRequest = exports.QueryParamsRequest = exports.QueryParamsResponse = exports.MsgDeleteRegion = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgDeleteRegion", { enumerable: true, get: function () { return tx_1.MsgDeleteRegion; } });
...
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_5.MsgDeleteRegionResponse; } });
const tx_6 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgUpdateRegion", { enumerable: true, get: function () { return tx_6.MsgUpdateRegion; } });
...
Object.defineProperty(exports, "MsgCreateRegion", { enumerable: true, get: function () { return tx_11.MsgCreateRegion; } });
    ...
    return {
        async sendMsgDeleteRegion({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgDeleteRegion({ value: tx_1.MsgDeleteRegion.fromPartial(value) });
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_5.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegion({ value: tx_6.MsgUpdateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateRegion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegion({ value: tx_11.MsgCreateRegion.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgDeleteRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegion", value: tx_1.MsgDeleteRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_5.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegion", value: tx_6.MsgUpdateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperior({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperior", value: tx_9.MsgCreateSuperior.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateSuperiorResponse", value: tx_10.MsgCreateSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegion({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegion", value: tx_11.MsgCreateRegion.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorRequest({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorRequest", value: query_7.QueryGetSuperiorRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryGetSuperiorResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.QueryGetSuperiorResponse", value: query_8.QueryGetSuperiorResponse.fromPartial(value) };
            }
            catch (e) {
