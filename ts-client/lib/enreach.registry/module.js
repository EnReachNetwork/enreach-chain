...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsRequest = exports.Region = exports.GenesisState = exports.MsgDeleteRegionResponse = exports.QueryGetRegionResponse = exports.QueryAllRegionResponse = exports.QueryAllRegionRequest = exports.MsgCreateRegion = exports.QueryParamsResponse = exports.Params = exports.MsgUpdateRegionResponse = exports.MsgCreateRegionResponse = exports.MsgUpdateParamsResponse = exports.QueryGetRegionRequest = exports.MsgUpdateParams = exports.MsgDeleteRegion = exports.MsgUpdateRegion = void 0;
...
Object.defineProperty(exports, "MsgCreateRegionResponse", { enumerable: true, get: function () { return tx_5.MsgCreateRegionResponse; } });
const tx_6 = require("./types/enreach/registry/tx");
Object.defineProperty(exports, "MsgUpdateRegionResponse", { enumerable: true, get: function () { return tx_6.MsgUpdateRegionResponse; } });
...
Object.defineProperty(exports, "MsgDeleteRegionResponse", { enumerable: true, get: function () { return tx_8.MsgDeleteRegionResponse; } });
    ...
    return {
        ...
        async sendMsgCreateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateRegionResponse({ value: tx_5.MsgCreateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateRegionResponse({ value: tx_6.MsgUpdateRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgDeleteRegionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgDeleteRegionResponse({ value: tx_8.MsgDeleteRegionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateParams", value: tx_3.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgCreateRegionResponse", value: tx_5.MsgCreateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgUpdateRegionResponse", value: tx_6.MsgUpdateRegionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgDeleteRegionResponse({ value }) {
            try {
                return { typeUrl: "/enreach.registry.MsgDeleteRegionResponse", value: tx_8.MsgDeleteRegionResponse.fromPartial(value) };
            }
            catch (e) {
