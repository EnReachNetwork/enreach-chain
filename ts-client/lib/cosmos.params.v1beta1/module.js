...
exports.queryClient = exports.txClient = exports.registry = exports.ParamChange = exports.QueryParamsRequest = exports.Subspace = exports.QuerySubspacesResponse = exports.QuerySubspacesRequest = exports.QueryParamsResponse = exports.ParameterChangeProposal = void 0;
...
const txClient = ({ signer, prefix, addr } = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
    return {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QueryParamsResponse", value: query_1.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
