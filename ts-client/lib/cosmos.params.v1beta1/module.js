...
exports.queryClient = exports.txClient = exports.registry = exports.Subspace = exports.QuerySubspacesResponse = exports.ParameterChangeProposal = exports.QuerySubspacesRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.ParamChange = void 0;
...
Object.defineProperty(exports, "QuerySubspacesRequest", { enumerable: true, get: function () { return query_3.QuerySubspacesRequest; } });
...
Object.defineProperty(exports, "QuerySubspacesResponse", { enumerable: true, get: function () { return query_4.QuerySubspacesResponse; } });
const query_5 = require("./types/cosmos/params/v1beta1/query");
Object.defineProperty(exports, "Subspace", { enumerable: true, get: function () { return query_5.Subspace; } });
    ...
    return {
        ...
        async sendQuerySubspacesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesRequest({ value: query_3.QuerySubspacesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySubspacesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesResponse({ value: query_4.QuerySubspacesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSubspace({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.subspace({ value: query_5.Subspace.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QueryParamsRequest", value: query_1.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QueryParamsResponse", value: query_2.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySubspacesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesRequest", value: query_3.QuerySubspacesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySubspacesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesResponse", value: query_4.QuerySubspacesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        subspace({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.Subspace", value: query_5.Subspace.fromPartial(value) };
            }
            catch (e) {
