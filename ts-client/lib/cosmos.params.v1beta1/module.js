...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySubspacesResponse = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.ParamChange = exports.Subspace = exports.QuerySubspacesRequest = exports.ParameterChangeProposal = void 0;
...
Object.defineProperty(exports, "QuerySubspacesResponse", { enumerable: true, get: function () { return query_5.QuerySubspacesResponse; } });
    ...
    return {
        ...
        async sendQuerySubspacesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesResponse({ value: query_5.QuerySubspacesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySubspacesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesResponse", value: query_5.QuerySubspacesResponse.fromPartial(value) };
            }
            catch (e) {
