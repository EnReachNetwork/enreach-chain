...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.ParameterChangeProposal = exports.Subspace = exports.QuerySubspacesResponse = exports.QueryParamsRequest = exports.ParamChange = exports.QuerySubspacesRequest = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/params/v1beta1/query");
Object.defineProperty(exports, "QuerySubspacesRequest", { enumerable: true, get: function () { return query_1.QuerySubspacesRequest; } });
...
Object.defineProperty(exports, "QuerySubspacesResponse", { enumerable: true, get: function () { return query_3.QuerySubspacesResponse; } });
const query_4 = require("./types/cosmos/params/v1beta1/query");
Object.defineProperty(exports, "Subspace", { enumerable: true, get: function () { return query_4.Subspace; } });
    ...
    return {
        async sendQuerySubspacesRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.querySubspacesRequest({ value: query_1.QuerySubspacesRequest.fromPartial(value) });
        ...
        async sendQuerySubspacesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesResponse({ value: query_3.QuerySubspacesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendSubspace({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.subspace({ value: query_4.Subspace.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySubspacesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesRequest", value: query_1.QuerySubspacesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QueryParamsRequest", value: query_2.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        querySubspacesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesResponse", value: query_3.QuerySubspacesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        subspace({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.Subspace", value: query_4.Subspace.fromPartial(value) };
            }
            catch (e) {
