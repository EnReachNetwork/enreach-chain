...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.ParamChange = exports.ParameterChangeProposal = exports.Subspace = exports.QuerySubspacesResponse = exports.QuerySubspacesRequest = void 0;
...
Object.defineProperty(exports, "Subspace", { enumerable: true, get: function () { return query_3.Subspace; } });
    ...
    return {
        ...
        async sendSubspace({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.subspace({ value: query_3.Subspace.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParameterChangeProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.parameterChangeProposal({ value: params_1.ParameterChangeProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParamChange({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.paramChange({ value: params_2.ParamChange.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        subspace({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.Subspace", value: query_3.Subspace.fromPartial(value) };
            }
            catch (e) {
        ...
        parameterChangeProposal({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.ParameterChangeProposal", value: params_1.ParameterChangeProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        paramChange({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.ParamChange", value: params_2.ParamChange.fromPartial(value) };
            }
            catch (e) {
