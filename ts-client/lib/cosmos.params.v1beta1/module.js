...
exports.queryClient = exports.txClient = exports.registry = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.ParameterChangeProposal = exports.QuerySubspacesResponse = exports.QuerySubspacesRequest = exports.ParamChange = exports.Subspace = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/cosmos/params/v1beta1/query");
Object.defineProperty(exports, "Subspace", { enumerable: true, get: function () { return query_1.Subspace; } });
...
Object.defineProperty(exports, "QuerySubspacesRequest", { enumerable: true, get: function () { return query_2.QuerySubspacesRequest; } });
    ...
    return {
        async sendSubspace({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.subspace({ value: query_1.Subspace.fromPartial(value) });
        ...
        async sendQuerySubspacesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesRequest({ value: query_2.QuerySubspacesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        subspace({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.Subspace", value: query_1.Subspace.fromPartial(value) };
            }
            catch (e) {
        ...
        querySubspacesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesRequest", value: query_2.QuerySubspacesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QueryParamsRequest", value: query_4.QueryParamsRequest.fromPartial(value) };
            }
            catch (e) {
