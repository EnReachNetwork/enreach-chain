...
exports.queryClient = exports.txClient = exports.registry = exports.QuerySubspacesRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.ParameterChangeProposal = exports.QuerySubspacesResponse = exports.Subspace = exports.ParamChange = void 0;
...
Object.defineProperty(exports, "QuerySubspacesResponse", { enumerable: true, get: function () { return query_2.QuerySubspacesResponse; } });
...
Object.defineProperty(exports, "QuerySubspacesRequest", { enumerable: true, get: function () { return query_5.QuerySubspacesRequest; } });
    ...
    return {
        ...
        async sendQuerySubspacesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesResponse({ value: query_2.QuerySubspacesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQuerySubspacesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.querySubspacesRequest({ value: query_5.QuerySubspacesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        querySubspacesResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesResponse", value: query_2.QuerySubspacesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryParamsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QueryParamsResponse", value: query_4.QueryParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        querySubspacesRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.params.v1beta1.QuerySubspacesRequest", value: query_5.QuerySubspacesRequest.fromPartial(value) };
            }
            catch (e) {
