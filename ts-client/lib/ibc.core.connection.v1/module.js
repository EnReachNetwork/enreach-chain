...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.QueryClientConnectionsRequest = exports.QueryConnectionsResponse = exports.ConnectionPaths = exports.QueryConnectionClientStateResponse = exports.IdentifiedConnection = exports.QueryConnectionParamsResponse = exports.ClientPaths = exports.Version = exports.MsgConnectionOpenInit = exports.Params = exports.Counterparty = exports.QueryConnectionClientStateRequest = exports.QueryConnectionResponse = exports.MsgConnectionOpenConfirm = exports.ConnectionEnd = exports.QueryClientConnectionsResponse = exports.QueryConnectionsRequest = exports.MsgConnectionOpenTry = exports.QueryConnectionConsensusStateResponse = exports.QueryConnectionConsensusStateRequest = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenAckResponse = exports.MsgConnectionOpenAck = exports.QueryConnectionParamsRequest = exports.GenesisState = exports.MsgConnectionOpenTryResponse = exports.QueryConnectionRequest = exports.MsgConnectionOpenConfirmResponse = exports.MsgConnectionOpenInitResponse = void 0;
...
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_2.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenTry", { enumerable: true, get: function () { return tx_7.MsgConnectionOpenTry; } });
...
Object.defineProperty(exports, "MsgConnectionOpenConfirm", { enumerable: true, get: function () { return tx_8.MsgConnectionOpenConfirm; } });
...
Object.defineProperty(exports, "QueryConnectionClientStateRequest", { enumerable: true, get: function () { return query_8.QueryConnectionClientStateRequest; } });
...
Object.defineProperty(exports, "Version", { enumerable: true, get: function () { return connection_4.Version; } });
...
Object.defineProperty(exports, "QueryConnectionParamsResponse", { enumerable: true, get: function () { return query_9.QueryConnectionParamsResponse; } });
...
Object.defineProperty(exports, "QueryConnectionsResponse", { enumerable: true, get: function () { return query_11.QueryConnectionsResponse; } });
    ...
    return {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_2.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTry({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTry({ value: tx_7.MsgConnectionOpenTry.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenConfirm({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenConfirm({ value: tx_8.MsgConnectionOpenConfirm.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateRequest({ value: query_8.QueryConnectionClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.version({ value: connection_4.Version.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsResponse({ value: query_9.QueryConnectionParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionsResponse({ value: query_11.QueryConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_2.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTry({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTry", value: tx_7.MsgConnectionOpenTry.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenConfirm({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenConfirm", value: tx_8.MsgConnectionOpenConfirm.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateRequest", value: query_8.QueryConnectionClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        version({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Version", value: connection_4.Version.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsResponse", value: query_9.QueryConnectionParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionsResponse", value: query_11.QueryConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParams", value: tx_10.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
