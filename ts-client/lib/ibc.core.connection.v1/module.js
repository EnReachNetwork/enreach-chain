...
exports.queryClient = exports.txClient = exports.registry = exports.QueryClientConnectionsRequest = exports.MsgConnectionOpenConfirm = exports.ConnectionPaths = exports.QueryConnectionParamsResponse = exports.QueryConnectionClientStateRequest = exports.MsgConnectionOpenInitResponse = exports.MsgConnectionOpenAckResponse = exports.QueryConnectionResponse = exports.IdentifiedConnection = exports.MsgConnectionOpenInit = exports.MsgConnectionOpenConfirmResponse = exports.QueryConnectionParamsRequest = exports.QueryConnectionConsensusStateRequest = exports.QueryConnectionConsensusStateResponse = exports.QueryConnectionClientStateResponse = exports.QueryConnectionsResponse = exports.GenesisState = exports.ClientPaths = exports.ConnectionEnd = exports.MsgConnectionOpenTry = exports.Version = exports.QueryConnectionsRequest = exports.Params = exports.MsgUpdateParams = exports.MsgConnectionOpenAck = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenTryResponse = exports.QueryClientConnectionsResponse = exports.QueryConnectionRequest = exports.Counterparty = void 0;
...
Object.defineProperty(exports, "QueryConnectionRequest", { enumerable: true, get: function () { return query_1.QueryConnectionRequest; } });
const query_2 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryClientConnectionsResponse", { enumerable: true, get: function () { return query_2.QueryClientConnectionsResponse; } });
...
Object.defineProperty(exports, "QueryConnectionConsensusStateRequest", { enumerable: true, get: function () { return query_7.QueryConnectionConsensusStateRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenInitResponse", { enumerable: true, get: function () { return tx_9.MsgConnectionOpenInitResponse; } });
const query_10 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionClientStateRequest", { enumerable: true, get: function () { return query_10.QueryConnectionClientStateRequest; } });
    ...
    return {
        ...
        async sendQueryConnectionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionRequest({ value: query_1.QueryConnectionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsResponse({ value: query_2.QueryClientConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTryResponse({ value: tx_1.MsgConnectionOpenTryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateRequest({ value: query_7.QueryConnectionConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInitResponse({ value: tx_9.MsgConnectionOpenInitResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateRequest({ value: query_10.QueryConnectionClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryConnectionRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionRequest", value: query_1.QueryConnectionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsResponse", value: query_2.QueryClientConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTryResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTryResponse", value: tx_1.MsgConnectionOpenTryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParamsResponse", value: tx_2.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParams", value: tx_4.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateRequest", value: query_7.QueryConnectionConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_9.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateRequest", value: query_10.QueryConnectionClientStateRequest.fromPartial(value) };
            }
            catch (e) {
