...
exports.queryClient = exports.txClient = exports.registry = exports.QueryClientConnectionsResponse = exports.QueryClientConnectionsRequest = exports.MsgConnectionOpenConfirmResponse = exports.MsgConnectionOpenInit = exports.QueryConnectionClientStateResponse = exports.QueryConnectionsResponse = exports.QueryConnectionsRequest = exports.ConnectionEnd = exports.MsgUpdateParamsResponse = exports.GenesisState = exports.QueryConnectionParamsResponse = exports.QueryConnectionConsensusStateResponse = exports.QueryConnectionResponse = exports.Version = exports.MsgUpdateParams = exports.MsgConnectionOpenTry = exports.MsgConnectionOpenAck = exports.MsgConnectionOpenInitResponse = exports.QueryConnectionConsensusStateRequest = exports.IdentifiedConnection = exports.MsgConnectionOpenConfirm = exports.QueryConnectionParamsRequest = exports.MsgConnectionOpenAckResponse = exports.MsgConnectionOpenTryResponse = exports.Params = exports.Counterparty = exports.QueryConnectionClientStateRequest = exports.QueryConnectionRequest = exports.ConnectionPaths = exports.ClientPaths = void 0;
...
Object.defineProperty(exports, "ConnectionPaths", { enumerable: true, get: function () { return connection_2.ConnectionPaths; } });
...
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_3.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenConfirmResponse", { enumerable: true, get: function () { return tx_10.MsgConnectionOpenConfirmResponse; } });
...
Object.defineProperty(exports, "QueryClientConnectionsResponse", { enumerable: true, get: function () { return query_12.QueryClientConnectionsResponse; } });
    ...
    return {
        ...
        async sendConnectionPaths({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.connectionPaths({ value: connection_2.ConnectionPaths.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_3.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenConfirmResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenConfirmResponse({ value: tx_10.MsgConnectionOpenConfirmResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsResponse({ value: query_12.QueryClientConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        connectionPaths({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ConnectionPaths", value: connection_2.ConnectionPaths.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_3.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenConfirmResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenConfirmResponse", value: tx_10.MsgConnectionOpenConfirmResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsResponse", value: query_12.QueryClientConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
