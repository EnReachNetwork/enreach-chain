...
exports.queryClient = exports.txClient = exports.registry = exports.ClientPaths = exports.Params = exports.MsgConnectionOpenAckResponse = exports.MsgConnectionOpenTryResponse = exports.MsgConnectionOpenTry = exports.QueryClientConnectionsRequest = exports.QueryConnectionsRequest = exports.ConnectionEnd = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenInit = exports.ConnectionPaths = exports.Version = exports.QueryConnectionRequest = exports.Counterparty = exports.QueryConnectionClientStateResponse = exports.MsgUpdateParams = exports.QueryConnectionParamsRequest = exports.QueryConnectionsResponse = exports.MsgConnectionOpenConfirm = exports.MsgConnectionOpenAck = exports.GenesisState = exports.IdentifiedConnection = exports.QueryConnectionConsensusStateResponse = exports.QueryConnectionClientStateRequest = exports.QueryClientConnectionsResponse = exports.QueryConnectionResponse = exports.MsgConnectionOpenConfirmResponse = exports.QueryConnectionParamsResponse = exports.QueryConnectionConsensusStateRequest = exports.MsgConnectionOpenInitResponse = void 0;
...
Object.defineProperty(exports, "MsgConnectionOpenConfirmResponse", { enumerable: true, get: function () { return tx_2.MsgConnectionOpenConfirmResponse; } });
...
Object.defineProperty(exports, "QueryClientConnectionsResponse", { enumerable: true, get: function () { return query_4.QueryClientConnectionsResponse; } });
const query_5 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionClientStateRequest", { enumerable: true, get: function () { return query_5.QueryConnectionClientStateRequest; } });
const query_6 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionConsensusStateResponse", { enumerable: true, get: function () { return query_6.QueryConnectionConsensusStateResponse; } });
...
Object.defineProperty(exports, "MsgConnectionOpenAck", { enumerable: true, get: function () { return tx_3.MsgConnectionOpenAck; } });
const tx_4 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenConfirm", { enumerable: true, get: function () { return tx_4.MsgConnectionOpenConfirm; } });
...
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_8.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "QueryConnectionClientStateResponse", { enumerable: true, get: function () { return query_9.QueryConnectionClientStateResponse; } });
const connection_2 = require("./types/ibc/core/connection/v1/connection");
Object.defineProperty(exports, "Counterparty", { enumerable: true, get: function () { return connection_2.Counterparty; } });
const query_10 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionRequest", { enumerable: true, get: function () { return query_10.QueryConnectionRequest; } });
const connection_3 = require("./types/ibc/core/connection/v1/connection");
Object.defineProperty(exports, "Version", { enumerable: true, get: function () { return connection_3.Version; } });
const connection_4 = require("./types/ibc/core/connection/v1/connection");
Object.defineProperty(exports, "ConnectionPaths", { enumerable: true, get: function () { return connection_4.ConnectionPaths; } });
const tx_6 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenInit", { enumerable: true, get: function () { return tx_6.MsgConnectionOpenInit; } });
...
Object.defineProperty(exports, "ConnectionEnd", { enumerable: true, get: function () { return connection_5.ConnectionEnd; } });
...
Object.defineProperty(exports, "QueryClientConnectionsRequest", { enumerable: true, get: function () { return query_12.QueryClientConnectionsRequest; } });
const tx_8 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenTry", { enumerable: true, get: function () { return tx_8.MsgConnectionOpenTry; } });
const tx_9 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenTryResponse", { enumerable: true, get: function () { return tx_9.MsgConnectionOpenTryResponse; } });
const tx_10 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenAckResponse", { enumerable: true, get: function () { return tx_10.MsgConnectionOpenAckResponse; } });
const connection_6 = require("./types/ibc/core/connection/v1/connection");
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return connection_6.Params; } });
const connection_7 = require("./types/ibc/core/connection/v1/connection");
Object.defineProperty(exports, "ClientPaths", { enumerable: true, get: function () { return connection_7.ClientPaths; } });
    ...
    return {
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgConnectionOpenInitResponse({ value: tx_1.MsgConnectionOpenInitResponse.fromPartial(value) });
        ...
        async sendQueryConnectionConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateRequest({ value: query_1.QueryConnectionConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenConfirmResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenConfirmResponse({ value: tx_2.MsgConnectionOpenConfirmResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsResponse({ value: query_4.QueryClientConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateRequest({ value: query_5.QueryConnectionClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateResponse({ value: query_6.QueryConnectionConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendIdentifiedConnection({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.identifiedConnection({ value: connection_1.IdentifiedConnection.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAck({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAck({ value: tx_3.MsgConnectionOpenAck.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenConfirm({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenConfirm({ value: tx_4.MsgConnectionOpenConfirm.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_8.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateResponse({ value: query_9.QueryConnectionClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendCounterparty({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.counterparty({ value: connection_2.Counterparty.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionRequest({ value: query_10.QueryConnectionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.version({ value: connection_3.Version.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConnectionPaths({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.connectionPaths({ value: connection_4.ConnectionPaths.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInit({ value: tx_6.MsgConnectionOpenInit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConnectionEnd({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.connectionEnd({ value: connection_5.ConnectionEnd.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsRequest({ value: query_12.QueryClientConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTry({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTry({ value: tx_8.MsgConnectionOpenTry.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTryResponse({ value: tx_9.MsgConnectionOpenTryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAckResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAckResponse({ value: tx_10.MsgConnectionOpenAckResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: connection_6.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendClientPaths({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.clientPaths({ value: connection_7.ClientPaths.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_1.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateRequest", value: query_1.QueryConnectionConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenConfirmResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenConfirmResponse", value: tx_2.MsgConnectionOpenConfirmResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsResponse", value: query_4.QueryClientConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateRequest", value: query_5.QueryConnectionClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateResponse", value: query_6.QueryConnectionConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        identifiedConnection({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.IdentifiedConnection", value: connection_1.IdentifiedConnection.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAck({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAck", value: tx_3.MsgConnectionOpenAck.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenConfirm({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenConfirm", value: tx_4.MsgConnectionOpenConfirm.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_8.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParams", value: tx_5.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateResponse", value: query_9.QueryConnectionClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        counterparty({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Counterparty", value: connection_2.Counterparty.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionRequest", value: query_10.QueryConnectionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        version({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Version", value: connection_3.Version.fromPartial(value) };
            }
            catch (e) {
        ...
        connectionPaths({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ConnectionPaths", value: connection_4.ConnectionPaths.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInit({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInit", value: tx_6.MsgConnectionOpenInit.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParamsResponse", value: tx_7.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        connectionEnd({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ConnectionEnd", value: connection_5.ConnectionEnd.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsRequest", value: query_12.QueryClientConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTry({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTry", value: tx_8.MsgConnectionOpenTry.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTryResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTryResponse", value: tx_9.MsgConnectionOpenTryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAckResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAckResponse", value: tx_10.MsgConnectionOpenAckResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Params", value: connection_6.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        clientPaths({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ClientPaths", value: connection_7.ClientPaths.fromPartial(value) };
            }
            catch (e) {
