...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenTry = exports.GenesisState = exports.QueryConnectionResponse = exports.QueryConnectionParamsResponse = exports.QueryConnectionClientStateRequest = exports.IdentifiedConnection = exports.MsgConnectionOpenConfirmResponse = exports.MsgConnectionOpenTryResponse = exports.MsgConnectionOpenAck = exports.MsgConnectionOpenInit = exports.QueryConnectionsResponse = exports.QueryConnectionConsensusStateRequest = exports.ConnectionEnd = exports.Version = exports.MsgConnectionOpenAckResponse = exports.QueryConnectionRequest = exports.ClientPaths = exports.QueryClientConnectionsResponse = exports.MsgUpdateParams = exports.MsgConnectionOpenConfirm = exports.QueryConnectionParamsRequest = exports.QueryClientConnectionsRequest = exports.QueryConnectionsRequest = exports.ConnectionPaths = exports.Counterparty = exports.MsgConnectionOpenInitResponse = exports.Params = exports.QueryConnectionConsensusStateResponse = exports.QueryConnectionClientStateResponse = void 0;
...
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return connection_1.Params; } });
...
Object.defineProperty(exports, "QueryClientConnectionsRequest", { enumerable: true, get: function () { return query_4.QueryClientConnectionsRequest; } });
const query_5 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_5.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "QueryConnectionRequest", { enumerable: true, get: function () { return query_7.QueryConnectionRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenInit", { enumerable: true, get: function () { return tx_5.MsgConnectionOpenInit; } });
const tx_6 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenAck", { enumerable: true, get: function () { return tx_6.MsgConnectionOpenAck; } });
...
Object.defineProperty(exports, "QueryConnectionResponse", { enumerable: true, get: function () { return query_12.QueryConnectionResponse; } });
    ...
    return {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: connection_1.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsRequest({ value: query_4.QueryClientConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_5.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionRequest({ value: query_7.QueryConnectionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInit({ value: tx_5.MsgConnectionOpenInit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAck({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAck({ value: tx_6.MsgConnectionOpenAck.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionResponse({ value: query_12.QueryConnectionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Params", value: connection_1.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsRequest", value: query_4.QueryClientConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_5.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionRequest", value: query_7.QueryConnectionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInit({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInit", value: tx_5.MsgConnectionOpenInit.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAck({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAck", value: tx_6.MsgConnectionOpenAck.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionResponse", value: query_12.QueryConnectionResponse.fromPartial(value) };
            }
            catch (e) {
