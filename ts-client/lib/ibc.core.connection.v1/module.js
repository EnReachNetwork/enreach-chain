...
exports.queryClient = exports.txClient = exports.registry = exports.MsgConnectionOpenConfirmResponse = exports.QueryConnectionsRequest = exports.MsgConnectionOpenAckResponse = exports.Params = exports.ConnectionEnd = exports.QueryConnectionsResponse = exports.ConnectionPaths = exports.IdentifiedConnection = exports.Counterparty = exports.MsgConnectionOpenInit = exports.MsgUpdateParams = exports.Version = exports.QueryConnectionParamsRequest = exports.QueryClientConnectionsResponse = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenInitResponse = exports.QueryConnectionResponse = exports.MsgConnectionOpenConfirm = exports.QueryConnectionClientStateResponse = exports.QueryConnectionClientStateRequest = exports.ClientPaths = exports.QueryConnectionParamsResponse = exports.QueryConnectionConsensusStateResponse = exports.GenesisState = exports.MsgConnectionOpenAck = exports.QueryConnectionConsensusStateRequest = exports.QueryClientConnectionsRequest = exports.QueryConnectionRequest = exports.MsgConnectionOpenTryResponse = exports.MsgConnectionOpenTry = void 0;
...
Object.defineProperty(exports, "QueryClientConnectionsRequest", { enumerable: true, get: function () { return query_2.QueryClientConnectionsRequest; } });
...
Object.defineProperty(exports, "QueryConnectionClientStateResponse", { enumerable: true, get: function () { return query_7.QueryConnectionClientStateResponse; } });
...
Object.defineProperty(exports, "QueryConnectionResponse", { enumerable: true, get: function () { return query_8.QueryConnectionResponse; } });
...
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_10.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenInit", { enumerable: true, get: function () { return tx_8.MsgConnectionOpenInit; } });
...
Object.defineProperty(exports, "MsgConnectionOpenAckResponse", { enumerable: true, get: function () { return tx_9.MsgConnectionOpenAckResponse; } });
const query_12 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionsRequest", { enumerable: true, get: function () { return query_12.QueryConnectionsRequest; } });
    ...
    return {
        ...
        async sendQueryClientConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsRequest({ value: query_2.QueryClientConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateResponse({ value: query_7.QueryConnectionClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionResponse({ value: query_8.QueryConnectionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_10.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInit({ value: tx_8.MsgConnectionOpenInit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: connection_7.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAckResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAckResponse({ value: tx_9.MsgConnectionOpenAckResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionsRequest({ value: query_12.QueryConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryClientConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsRequest", value: query_2.QueryClientConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateResponse", value: query_7.QueryConnectionClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionResponse", value: query_8.QueryConnectionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_10.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInit({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInit", value: tx_8.MsgConnectionOpenInit.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Params", value: connection_7.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAckResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAckResponse", value: tx_9.MsgConnectionOpenAckResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionsRequest", value: query_12.QueryConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
