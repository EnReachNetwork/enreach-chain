...
exports.queryClient = exports.txClient = exports.registry = exports.QueryConnectionParamsRequest = exports.MsgConnectionOpenAck = exports.ClientPaths = exports.QueryConnectionsRequest = exports.MsgConnectionOpenInit = exports.QueryClientConnectionsResponse = exports.QueryClientConnectionsRequest = exports.MsgConnectionOpenConfirmResponse = exports.MsgConnectionOpenInitResponse = exports.QueryConnectionResponse = exports.QueryConnectionRequest = exports.Params = exports.MsgConnectionOpenConfirm = exports.GenesisState = exports.Counterparty = exports.Version = exports.QueryConnectionParamsResponse = exports.QueryConnectionsResponse = exports.IdentifiedConnection = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenAckResponse = exports.ConnectionEnd = exports.MsgUpdateParams = exports.ConnectionPaths = exports.QueryConnectionConsensusStateRequest = exports.QueryConnectionClientStateRequest = exports.QueryConnectionConsensusStateResponse = exports.QueryConnectionClientStateResponse = exports.MsgConnectionOpenTryResponse = exports.MsgConnectionOpenTry = void 0;
...
Object.defineProperty(exports, "QueryConnectionClientStateRequest", { enumerable: true, get: function () { return query_3.QueryConnectionClientStateRequest; } });
...
Object.defineProperty(exports, "ConnectionEnd", { enumerable: true, get: function () { return connection_2.ConnectionEnd; } });
...
Object.defineProperty(exports, "QueryConnectionParamsResponse", { enumerable: true, get: function () { return query_6.QueryConnectionParamsResponse; } });
...
Object.defineProperty(exports, "Counterparty", { enumerable: true, get: function () { return connection_5.Counterparty; } });
...
Object.defineProperty(exports, "MsgConnectionOpenInitResponse", { enumerable: true, get: function () { return tx_7.MsgConnectionOpenInitResponse; } });
    ...
    return {
        ...
        async sendQueryConnectionClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateRequest({ value: query_3.QueryConnectionClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConnectionEnd({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.connectionEnd({ value: connection_2.ConnectionEnd.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsResponse({ value: query_6.QueryConnectionParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendCounterparty({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.counterparty({ value: connection_5.Counterparty.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInitResponse({ value: tx_7.MsgConnectionOpenInitResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryConnectionClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateRequest", value: query_3.QueryConnectionClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        connectionEnd({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ConnectionEnd", value: connection_2.ConnectionEnd.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsResponse", value: query_6.QueryConnectionParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        counterparty({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Counterparty", value: connection_5.Counterparty.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_7.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
