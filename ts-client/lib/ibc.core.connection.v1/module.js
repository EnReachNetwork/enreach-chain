...
exports.queryClient = exports.txClient = exports.registry = exports.MsgConnectionOpenInitResponse = exports.MsgConnectionOpenAck = exports.MsgConnectionOpenTry = exports.ConnectionEnd = exports.QueryConnectionClientStateResponse = exports.MsgUpdateParamsResponse = exports.QueryConnectionParamsResponse = exports.Counterparty = exports.GenesisState = exports.QueryConnectionsResponse = exports.MsgConnectionOpenAckResponse = exports.MsgConnectionOpenInit = exports.QueryConnectionConsensusStateRequest = exports.QueryClientConnectionsRequest = exports.MsgUpdateParams = exports.IdentifiedConnection = exports.QueryClientConnectionsResponse = exports.MsgConnectionOpenConfirm = exports.QueryConnectionClientStateRequest = exports.MsgConnectionOpenTryResponse = exports.ClientPaths = exports.QueryConnectionParamsRequest = exports.QueryConnectionConsensusStateResponse = exports.Params = exports.MsgConnectionOpenConfirmResponse = exports.Version = exports.ConnectionPaths = exports.QueryConnectionsRequest = exports.QueryConnectionResponse = exports.QueryConnectionRequest = void 0;
...
Object.defineProperty(exports, "MsgConnectionOpenTryResponse", { enumerable: true, get: function () { return tx_2.MsgConnectionOpenTryResponse; } });
const query_6 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionClientStateRequest", { enumerable: true, get: function () { return query_6.QueryConnectionClientStateRequest; } });
...
Object.defineProperty(exports, "QueryConnectionConsensusStateRequest", { enumerable: true, get: function () { return query_9.QueryConnectionConsensusStateRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenAck", { enumerable: true, get: function () { return tx_9.MsgConnectionOpenAck; } });
const tx_10 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenInitResponse", { enumerable: true, get: function () { return tx_10.MsgConnectionOpenInitResponse; } });
    ...
    return {
        ...
        async sendMsgConnectionOpenTryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTryResponse({ value: tx_2.MsgConnectionOpenTryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateRequest({ value: query_6.QueryConnectionClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateRequest({ value: query_9.QueryConnectionConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAck({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAck({ value: tx_9.MsgConnectionOpenAck.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInitResponse({ value: tx_10.MsgConnectionOpenInitResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgConnectionOpenTryResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTryResponse", value: tx_2.MsgConnectionOpenTryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateRequest", value: query_6.QueryConnectionClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateRequest", value: query_9.QueryConnectionConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAck({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAck", value: tx_9.MsgConnectionOpenAck.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_10.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
