...
exports.queryClient = exports.txClient = exports.registry = exports.IdentifiedConnection = exports.ConnectionEnd = exports.MsgConnectionOpenTryResponse = exports.MsgUpdateParams = exports.QueryConnectionClientStateResponse = exports.QueryClientConnectionsRequest = exports.QueryConnectionsResponse = exports.QueryConnectionResponse = exports.QueryConnectionConsensusStateRequest = exports.Version = exports.Counterparty = exports.MsgConnectionOpenAckResponse = exports.MsgConnectionOpenConfirm = exports.QueryConnectionParamsRequest = exports.QueryConnectionConsensusStateResponse = exports.QueryClientConnectionsResponse = exports.QueryConnectionRequest = exports.ConnectionPaths = exports.Params = exports.ClientPaths = exports.MsgConnectionOpenConfirmResponse = exports.MsgConnectionOpenInitResponse = exports.GenesisState = exports.MsgConnectionOpenTry = exports.MsgConnectionOpenInit = exports.QueryConnectionsRequest = exports.MsgConnectionOpenAck = exports.QueryConnectionParamsResponse = exports.QueryConnectionClientStateRequest = exports.MsgUpdateParamsResponse = void 0;
...
Object.defineProperty(exports, "QueryConnectionClientStateRequest", { enumerable: true, get: function () { return query_1.QueryConnectionClientStateRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenAck", { enumerable: true, get: function () { return tx_2.MsgConnectionOpenAck; } });
const query_3 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionsRequest", { enumerable: true, get: function () { return query_3.QueryConnectionsRequest; } });
const tx_3 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenInit", { enumerable: true, get: function () { return tx_3.MsgConnectionOpenInit; } });
...
Object.defineProperty(exports, "MsgConnectionOpenInitResponse", { enumerable: true, get: function () { return tx_5.MsgConnectionOpenInitResponse; } });
...
Object.defineProperty(exports, "ConnectionPaths", { enumerable: true, get: function () { return connection_3.ConnectionPaths; } });
const query_4 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionRequest", { enumerable: true, get: function () { return query_4.QueryConnectionRequest; } });
const query_5 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryClientConnectionsResponse", { enumerable: true, get: function () { return query_5.QueryClientConnectionsResponse; } });
...
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_7.QueryConnectionParamsRequest; } });
const tx_7 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenConfirm", { enumerable: true, get: function () { return tx_7.MsgConnectionOpenConfirm; } });
const tx_8 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenAckResponse", { enumerable: true, get: function () { return tx_8.MsgConnectionOpenAckResponse; } });
...
Object.defineProperty(exports, "Version", { enumerable: true, get: function () { return connection_5.Version; } });
const query_8 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionConsensusStateRequest", { enumerable: true, get: function () { return query_8.QueryConnectionConsensusStateRequest; } });
const query_9 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionResponse", { enumerable: true, get: function () { return query_9.QueryConnectionResponse; } });
const query_10 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionsResponse", { enumerable: true, get: function () { return query_10.QueryConnectionsResponse; } });
const query_11 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryClientConnectionsRequest", { enumerable: true, get: function () { return query_11.QueryClientConnectionsRequest; } });
const query_12 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionClientStateResponse", { enumerable: true, get: function () { return query_12.QueryConnectionClientStateResponse; } });
...
Object.defineProperty(exports, "MsgConnectionOpenTryResponse", { enumerable: true, get: function () { return tx_10.MsgConnectionOpenTryResponse; } });
...
Object.defineProperty(exports, "IdentifiedConnection", { enumerable: true, get: function () { return connection_7.IdentifiedConnection; } });
    ...
    return {
        ...
        async sendQueryConnectionClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateRequest({ value: query_1.QueryConnectionClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAck({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAck({ value: tx_2.MsgConnectionOpenAck.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionsRequest({ value: query_3.QueryConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInit({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInit({ value: tx_3.MsgConnectionOpenInit.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInitResponse({ value: tx_5.MsgConnectionOpenInitResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConnectionPaths({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.connectionPaths({ value: connection_3.ConnectionPaths.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionRequest({ value: query_4.QueryConnectionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsResponse({ value: query_5.QueryClientConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_7.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenConfirm({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenConfirm({ value: tx_7.MsgConnectionOpenConfirm.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAckResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAckResponse({ value: tx_8.MsgConnectionOpenAckResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.version({ value: connection_5.Version.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateRequest({ value: query_8.QueryConnectionConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionResponse({ value: query_9.QueryConnectionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionsResponse({ value: query_10.QueryConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsRequest({ value: query_11.QueryClientConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateResponse({ value: query_12.QueryConnectionClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTryResponse({ value: tx_10.MsgConnectionOpenTryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendIdentifiedConnection({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.identifiedConnection({ value: connection_7.IdentifiedConnection.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParamsResponse", value: tx_1.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateRequest", value: query_1.QueryConnectionClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAck({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAck", value: tx_2.MsgConnectionOpenAck.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionsRequest", value: query_3.QueryConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInit({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInit", value: tx_3.MsgConnectionOpenInit.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_5.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        connectionPaths({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ConnectionPaths", value: connection_3.ConnectionPaths.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionRequest", value: query_4.QueryConnectionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsResponse", value: query_5.QueryClientConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_7.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenConfirm({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenConfirm", value: tx_7.MsgConnectionOpenConfirm.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAckResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAckResponse", value: tx_8.MsgConnectionOpenAckResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        version({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Version", value: connection_5.Version.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateRequest", value: query_8.QueryConnectionConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionResponse", value: query_9.QueryConnectionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionsResponse", value: query_10.QueryConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsRequest", value: query_11.QueryClientConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateResponse", value: query_12.QueryConnectionClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTryResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTryResponse", value: tx_10.MsgConnectionOpenTryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        identifiedConnection({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.IdentifiedConnection", value: connection_7.IdentifiedConnection.fromPartial(value) };
            }
            catch (e) {
