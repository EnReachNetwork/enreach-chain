...
exports.queryClient = exports.txClient = exports.registry = exports.ConnectionEnd = exports.Version = exports.GenesisState = exports.ClientPaths = exports.QueryClientConnectionsRequest = exports.ConnectionPaths = exports.QueryConnectionConsensusStateRequest = exports.MsgConnectionOpenAck = exports.MsgConnectionOpenInit = exports.QueryConnectionParamsResponse = exports.MsgUpdateParamsResponse = exports.QueryConnectionParamsRequest = exports.QueryConnectionClientStateResponse = exports.MsgConnectionOpenConfirmResponse = exports.MsgConnectionOpenTry = exports.QueryConnectionResponse = exports.QueryConnectionsRequest = exports.Params = exports.QueryConnectionsResponse = exports.MsgUpdateParams = exports.MsgConnectionOpenConfirm = exports.QueryConnectionClientStateRequest = exports.QueryClientConnectionsResponse = exports.QueryConnectionRequest = exports.MsgConnectionOpenTryResponse = exports.MsgConnectionOpenInitResponse = exports.QueryConnectionConsensusStateResponse = exports.Counterparty = exports.IdentifiedConnection = exports.MsgConnectionOpenAckResponse = void 0;
...
Object.defineProperty(exports, "MsgConnectionOpenInitResponse", { enumerable: true, get: function () { return tx_2.MsgConnectionOpenInitResponse; } });
const tx_3 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenTryResponse", { enumerable: true, get: function () { return tx_3.MsgConnectionOpenTryResponse; } });
const query_2 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionRequest", { enumerable: true, get: function () { return query_2.QueryConnectionRequest; } });
const query_3 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryClientConnectionsResponse", { enumerable: true, get: function () { return query_3.QueryClientConnectionsResponse; } });
...
Object.defineProperty(exports, "QueryConnectionsResponse", { enumerable: true, get: function () { return query_5.QueryConnectionsResponse; } });
const connection_3 = require("./types/ibc/core/connection/v1/connection");
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return connection_3.Params; } });
const query_6 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionsRequest", { enumerable: true, get: function () { return query_6.QueryConnectionsRequest; } });
const query_7 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionResponse", { enumerable: true, get: function () { return query_7.QueryConnectionResponse; } });
const tx_6 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenTry", { enumerable: true, get: function () { return tx_6.MsgConnectionOpenTry; } });
const tx_7 = require("./types/ibc/core/connection/v1/tx");
Object.defineProperty(exports, "MsgConnectionOpenConfirmResponse", { enumerable: true, get: function () { return tx_7.MsgConnectionOpenConfirmResponse; } });
const query_8 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionClientStateResponse", { enumerable: true, get: function () { return query_8.QueryConnectionClientStateResponse; } });
const query_9 = require("./types/ibc/core/connection/v1/query");
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_9.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "QueryConnectionParamsResponse", { enumerable: true, get: function () { return query_10.QueryConnectionParamsResponse; } });
...
Object.defineProperty(exports, "QueryConnectionConsensusStateRequest", { enumerable: true, get: function () { return query_11.QueryConnectionConsensusStateRequest; } });
...
Object.defineProperty(exports, "ClientPaths", { enumerable: true, get: function () { return connection_5.ClientPaths; } });
...
Object.defineProperty(exports, "ConnectionEnd", { enumerable: true, get: function () { return connection_7.ConnectionEnd; } });
    ...
    return {
        async sendMsgConnectionOpenAckResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgConnectionOpenAckResponse({ value: tx_1.MsgConnectionOpenAckResponse.fromPartial(value) });
        ...
        async sendQueryConnectionConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateResponse({ value: query_1.QueryConnectionConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInitResponse({ value: tx_2.MsgConnectionOpenInitResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTryResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTryResponse({ value: tx_3.MsgConnectionOpenTryResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionRequest({ value: query_2.QueryConnectionRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientConnectionsResponse({ value: query_3.QueryClientConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionsResponse({ value: query_5.QueryConnectionsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendParams({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.params({ value: connection_3.Params.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionsRequest({ value: query_6.QueryConnectionsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionResponse({ value: query_7.QueryConnectionResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenTry({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenTry({ value: tx_6.MsgConnectionOpenTry.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenConfirmResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenConfirmResponse({ value: tx_7.MsgConnectionOpenConfirmResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionClientStateResponse({ value: query_8.QueryConnectionClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_9.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsResponse({ value: query_10.QueryConnectionParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateRequest({ value: query_11.QueryConnectionConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendClientPaths({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.clientPaths({ value: connection_5.ClientPaths.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendVersion({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.version({ value: connection_6.Version.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConnectionEnd({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.connectionEnd({ value: connection_7.ConnectionEnd.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgConnectionOpenAckResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAckResponse", value: tx_1.MsgConnectionOpenAckResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateResponse", value: query_1.QueryConnectionConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_2.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTryResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTryResponse", value: tx_3.MsgConnectionOpenTryResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionRequest", value: query_2.QueryConnectionRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryClientConnectionsResponse", value: query_3.QueryClientConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionsResponse", value: query_5.QueryConnectionsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Params", value: connection_3.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionsRequest", value: query_6.QueryConnectionsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionResponse", value: query_7.QueryConnectionResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenTry({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenTry", value: tx_6.MsgConnectionOpenTry.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenConfirmResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenConfirmResponse", value: tx_7.MsgConnectionOpenConfirmResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionClientStateResponse", value: query_8.QueryConnectionClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_9.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgUpdateParamsResponse", value: tx_8.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsResponse", value: query_10.QueryConnectionParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateRequest", value: query_11.QueryConnectionConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        clientPaths({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ClientPaths", value: connection_5.ClientPaths.fromPartial(value) };
            }
            catch (e) {
        ...
        version({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.Version", value: connection_6.Version.fromPartial(value) };
            }
            catch (e) {
        ...
        connectionEnd({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.ConnectionEnd", value: connection_7.ConnectionEnd.fromPartial(value) };
            }
            catch (e) {
