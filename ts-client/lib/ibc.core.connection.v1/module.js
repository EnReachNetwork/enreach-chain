...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParamsResponse = exports.MsgConnectionOpenConfirmResponse = exports.QueryClientConnectionsRequest = exports.QueryConnectionResponse = exports.GenesisState = exports.Version = exports.MsgUpdateParams = exports.MsgConnectionOpenConfirm = exports.MsgConnectionOpenInitResponse = exports.QueryConnectionsRequest = exports.QueryConnectionConsensusStateRequest = exports.QueryConnectionClientStateResponse = exports.ConnectionEnd = exports.MsgConnectionOpenAck = exports.MsgConnectionOpenTry = exports.IdentifiedConnection = exports.QueryConnectionParamsResponse = exports.QueryConnectionParamsRequest = exports.ConnectionPaths = exports.Counterparty = exports.MsgConnectionOpenAckResponse = exports.MsgConnectionOpenInit = exports.QueryClientConnectionsResponse = exports.QueryConnectionsResponse = exports.QueryConnectionConsensusStateResponse = exports.ClientPaths = exports.MsgConnectionOpenTryResponse = exports.QueryConnectionClientStateRequest = exports.QueryConnectionRequest = exports.Params = void 0;
...
Object.defineProperty(exports, "QueryConnectionConsensusStateResponse", { enumerable: true, get: function () { return query_3.QueryConnectionConsensusStateResponse; } });
...
Object.defineProperty(exports, "MsgConnectionOpenAckResponse", { enumerable: true, get: function () { return tx_3.MsgConnectionOpenAckResponse; } });
...
Object.defineProperty(exports, "QueryConnectionParamsRequest", { enumerable: true, get: function () { return query_6.QueryConnectionParamsRequest; } });
...
Object.defineProperty(exports, "MsgConnectionOpenInitResponse", { enumerable: true, get: function () { return tx_6.MsgConnectionOpenInitResponse; } });
    ...
    return {
        ...
        async sendQueryConnectionConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionConsensusStateResponse({ value: query_3.QueryConnectionConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenAckResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenAckResponse({ value: tx_3.MsgConnectionOpenAckResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConnectionParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConnectionParamsRequest({ value: query_6.QueryConnectionParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgConnectionOpenInitResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgConnectionOpenInitResponse({ value: tx_6.MsgConnectionOpenInitResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryConnectionConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionConsensusStateResponse", value: query_3.QueryConnectionConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenAckResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenAckResponse", value: tx_3.MsgConnectionOpenAckResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConnectionParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.QueryConnectionParamsRequest", value: query_6.QueryConnectionParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgConnectionOpenInitResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.connection.v1.MsgConnectionOpenInitResponse", value: tx_6.MsgConnectionOpenInitResponse.fromPartial(value) };
            }
            catch (e) {
