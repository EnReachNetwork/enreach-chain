...
export { QueryConnectionClientStateResponse, QueryConnectionConsensusStateResponse, Params, MsgConnectionOpenInitResponse, Counterparty, ConnectionPaths, QueryConnectionsRequest, QueryClientConnectionsRequest, QueryConnectionParamsRequest, MsgConnectionOpenConfirm, MsgUpdateParams, QueryClientConnectionsResponse, ClientPaths, QueryConnectionRequest, MsgConnectionOpenAckResponse, Version, ConnectionEnd, QueryConnectionConsensusStateRequest, QueryConnectionsResponse, MsgConnectionOpenInit, MsgConnectionOpenAck, MsgConnectionOpenTryResponse, MsgConnectionOpenConfirmResponse, IdentifiedConnection, QueryConnectionClientStateRequest, QueryConnectionParamsResponse, QueryConnectionResponse, GenesisState, MsgConnectionOpenTry, MsgUpdateParamsResponse };
