...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryClientConnections: (clientId: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryConnection: (connectionId: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryConnectionClientState: (connectionId: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryConnectionConsensusState: (connectionId: string, revisionNumber: string, revisionHeight: string, params?: RequestParams) => Promise<AxiosResponse<T>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryConnectionParams: (params?: RequestParams) => Promise<AxiosResponse<T>>;
}
