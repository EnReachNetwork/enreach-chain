...
exports.queryClient = exports.txClient = exports.registry = exports.MsgResetCircuitBreakerResponse = exports.DisabledListResponse = exports.AccountResponse = exports.GenesisAccountPermissions = exports.Permissions = exports.QueryAccountRequest = exports.GenesisState = exports.MsgResetCircuitBreaker = exports.QueryDisabledListRequest = exports.AccountsResponse = exports.QueryAccountsRequest = exports.MsgTripCircuitBreakerResponse = exports.MsgTripCircuitBreaker = exports.MsgAuthorizeCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreaker = void 0;
...
Object.defineProperty(exports, "MsgTripCircuitBreakerResponse", { enumerable: true, get: function () { return tx_4.MsgTripCircuitBreakerResponse; } });
    ...
    return {
        ...
        async sendMsgTripCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreakerResponse({ value: tx_4.MsgTripCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgTripCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreakerResponse", value: tx_4.MsgTripCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
