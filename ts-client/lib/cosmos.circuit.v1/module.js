...
exports.queryClient = exports.txClient = exports.registry = exports.MsgResetCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreakerResponse = exports.QueryAccountsRequest = exports.GenesisState = exports.MsgTripCircuitBreaker = exports.AccountResponse = exports.GenesisAccountPermissions = exports.MsgResetCircuitBreaker = exports.MsgAuthorizeCircuitBreaker = exports.DisabledListResponse = exports.QueryDisabledListRequest = exports.Permissions = exports.MsgTripCircuitBreakerResponse = exports.AccountsResponse = exports.QueryAccountRequest = void 0;
...
Object.defineProperty(exports, "MsgTripCircuitBreakerResponse", { enumerable: true, get: function () { return tx_1.MsgTripCircuitBreakerResponse; } });
...
Object.defineProperty(exports, "QueryDisabledListRequest", { enumerable: true, get: function () { return query_3.QueryDisabledListRequest; } });
const query_4 = require("./types/cosmos/circuit/v1/query");
Object.defineProperty(exports, "DisabledListResponse", { enumerable: true, get: function () { return query_4.DisabledListResponse; } });
...
Object.defineProperty(exports, "MsgResetCircuitBreaker", { enumerable: true, get: function () { return tx_3.MsgResetCircuitBreaker; } });
...
Object.defineProperty(exports, "QueryAccountsRequest", { enumerable: true, get: function () { return query_6.QueryAccountsRequest; } });
    ...
    return {
        ...
        async sendMsgTripCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreakerResponse({ value: tx_1.MsgTripCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDisabledListRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDisabledListRequest({ value: query_3.QueryDisabledListRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDisabledListResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.disabledListResponse({ value: query_4.DisabledListResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgResetCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgResetCircuitBreaker({ value: tx_3.MsgResetCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryAccountsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryAccountsRequest({ value: query_6.QueryAccountsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountRequest", value: query_1.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTripCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreakerResponse", value: tx_1.MsgTripCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDisabledListRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryDisabledListRequest", value: query_3.QueryDisabledListRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        disabledListResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.DisabledListResponse", value: query_4.DisabledListResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgResetCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreaker", value: tx_3.MsgResetCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountsRequest", value: query_6.QueryAccountsRequest.fromPartial(value) };
            }
            catch (e) {
