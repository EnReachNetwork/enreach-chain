...
exports.queryClient = exports.txClient = exports.registry = exports.QueryDisabledListRequest = exports.AccountsResponse = exports.QueryAccountsRequest = exports.AccountResponse = exports.MsgAuthorizeCircuitBreaker = exports.QueryAccountRequest = exports.GenesisState = exports.MsgResetCircuitBreakerResponse = exports.MsgResetCircuitBreaker = exports.MsgTripCircuitBreakerResponse = exports.DisabledListResponse = exports.MsgAuthorizeCircuitBreakerResponse = exports.GenesisAccountPermissions = exports.Permissions = exports.MsgTripCircuitBreaker = void 0;
...
Object.defineProperty(exports, "MsgAuthorizeCircuitBreakerResponse", { enumerable: true, get: function () { return tx_2.MsgAuthorizeCircuitBreakerResponse; } });
const query_1 = require("./types/cosmos/circuit/v1/query");
Object.defineProperty(exports, "DisabledListResponse", { enumerable: true, get: function () { return query_1.DisabledListResponse; } });
...
Object.defineProperty(exports, "AccountResponse", { enumerable: true, get: function () { return query_3.AccountResponse; } });
...
Object.defineProperty(exports, "AccountsResponse", { enumerable: true, get: function () { return query_5.AccountsResponse; } });
    ...
    return {
        ...
        async sendMsgAuthorizeCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreakerResponse({ value: tx_2.MsgAuthorizeCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendDisabledListResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.disabledListResponse({ value: query_1.DisabledListResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountResponse({ value: query_3.AccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountsResponse({ value: query_5.AccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreakerResponse", value: tx_2.MsgAuthorizeCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        disabledListResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.DisabledListResponse", value: query_1.DisabledListResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        accountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountResponse", value: query_3.AccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountsRequest", value: query_4.QueryAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        accountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountsResponse", value: query_5.AccountsResponse.fromPartial(value) };
            }
            catch (e) {
