...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisAccountPermissions = exports.MsgTripCircuitBreaker = exports.DisabledListResponse = exports.MsgTripCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreakerResponse = exports.QueryAccountsRequest = exports.QueryAccountRequest = exports.GenesisState = exports.Permissions = exports.MsgResetCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreaker = exports.AccountResponse = exports.MsgResetCircuitBreaker = exports.QueryDisabledListRequest = exports.AccountsResponse = void 0;
...
Object.defineProperty(exports, "MsgResetCircuitBreaker", { enumerable: true, get: function () { return tx_1.MsgResetCircuitBreaker; } });
    ...
    return {
        ...
        async sendMsgResetCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgResetCircuitBreaker({ value: tx_1.MsgResetCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgResetCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreaker", value: tx_1.MsgResetCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
