...
exports.queryClient = exports.txClient = exports.registry = exports.MsgTripCircuitBreaker = exports.QueryDisabledListRequest = exports.GenesisState = exports.QueryAccountsRequest = exports.QueryAccountRequest = exports.GenesisAccountPermissions = exports.Permissions = exports.MsgResetCircuitBreakerResponse = exports.MsgResetCircuitBreaker = exports.MsgTripCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreaker = exports.MsgAuthorizeCircuitBreakerResponse = exports.DisabledListResponse = exports.AccountsResponse = exports.AccountResponse = void 0;
...
Object.defineProperty(exports, "AccountsResponse", { enumerable: true, get: function () { return query_2.AccountsResponse; } });
...
Object.defineProperty(exports, "MsgAuthorizeCircuitBreaker", { enumerable: true, get: function () { return tx_2.MsgAuthorizeCircuitBreaker; } });
...
Object.defineProperty(exports, "QueryDisabledListRequest", { enumerable: true, get: function () { return query_6.QueryDisabledListRequest; } });
const tx_6 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgTripCircuitBreaker", { enumerable: true, get: function () { return tx_6.MsgTripCircuitBreaker; } });
    ...
    return {
        ...
        async sendAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountsResponse({ value: query_2.AccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgAuthorizeCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreaker({ value: tx_2.MsgAuthorizeCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDisabledListRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDisabledListRequest({ value: query_6.QueryDisabledListRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgTripCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreaker({ value: tx_6.MsgTripCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        accountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountsResponse", value: query_2.AccountsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreaker", value: tx_2.MsgAuthorizeCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountsRequest", value: query_5.QueryAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDisabledListRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryDisabledListRequest", value: query_6.QueryDisabledListRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTripCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreaker", value: tx_6.MsgTripCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
