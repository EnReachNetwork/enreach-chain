...
exports.queryClient = exports.txClient = exports.registry = exports.AccountsResponse = exports.MsgAuthorizeCircuitBreaker = exports.MsgAuthorizeCircuitBreakerResponse = exports.QueryDisabledListRequest = exports.GenesisState = exports.GenesisAccountPermissions = exports.MsgResetCircuitBreaker = exports.MsgTripCircuitBreakerResponse = exports.QueryAccountRequest = exports.Permissions = exports.DisabledListResponse = exports.QueryAccountsRequest = exports.AccountResponse = exports.MsgResetCircuitBreakerResponse = exports.MsgTripCircuitBreaker = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgTripCircuitBreaker", { enumerable: true, get: function () { return tx_1.MsgTripCircuitBreaker; } });
const tx_2 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgResetCircuitBreakerResponse", { enumerable: true, get: function () { return tx_2.MsgResetCircuitBreakerResponse; } });
const query_1 = require("./types/cosmos/circuit/v1/query");
Object.defineProperty(exports, "AccountResponse", { enumerable: true, get: function () { return query_1.AccountResponse; } });
...
Object.defineProperty(exports, "QueryDisabledListRequest", { enumerable: true, get: function () { return query_5.QueryDisabledListRequest; } });
const tx_5 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgAuthorizeCircuitBreakerResponse", { enumerable: true, get: function () { return tx_5.MsgAuthorizeCircuitBreakerResponse; } });
...
Object.defineProperty(exports, "AccountsResponse", { enumerable: true, get: function () { return query_6.AccountsResponse; } });
    ...
    return {
        async sendMsgTripCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgTripCircuitBreaker({ value: tx_1.MsgTripCircuitBreaker.fromPartial(value) });
        ...
        async sendMsgResetCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgResetCircuitBreakerResponse({ value: tx_2.MsgResetCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountResponse({ value: query_1.AccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendPermissions({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.permissions({ value: types_1.Permissions.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryDisabledListRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDisabledListRequest({ value: query_5.QueryDisabledListRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgAuthorizeCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreakerResponse({ value: tx_5.MsgAuthorizeCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountsResponse({ value: query_6.AccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgTripCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreaker", value: tx_1.MsgTripCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        msgResetCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreakerResponse", value: tx_2.MsgResetCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        accountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountResponse", value: query_1.AccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        permissions({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.Permissions", value: types_1.Permissions.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountRequest", value: query_4.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryDisabledListRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryDisabledListRequest", value: query_5.QueryDisabledListRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreakerResponse", value: tx_5.MsgAuthorizeCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        accountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountsResponse", value: query_6.AccountsResponse.fromPartial(value) };
            }
            catch (e) {
