...
exports.queryClient = exports.txClient = exports.registry = exports.GenesisAccountPermissions = exports.Permissions = exports.MsgResetCircuitBreaker = exports.MsgTripCircuitBreakerResponse = exports.MsgTripCircuitBreaker = exports.AccountResponse = exports.MsgAuthorizeCircuitBreaker = exports.DisabledListResponse = exports.QueryDisabledListRequest = exports.MsgResetCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreakerResponse = exports.QueryAccountsRequest = exports.AccountsResponse = exports.QueryAccountRequest = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "DisabledListResponse", { enumerable: true, get: function () { return query_5.DisabledListResponse; } });
    ...
    return {
        ...
        async sendDisabledListResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.disabledListResponse({ value: query_5.DisabledListResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        disabledListResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.DisabledListResponse", value: query_5.DisabledListResponse.fromPartial(value) };
            }
            catch (e) {
