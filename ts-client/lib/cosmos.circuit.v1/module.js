...
exports.queryClient = exports.txClient = exports.registry = exports.MsgResetCircuitBreaker = exports.MsgTripCircuitBreaker = exports.MsgAuthorizeCircuitBreaker = exports.DisabledListResponse = exports.QueryDisabledListRequest = exports.AccountsResponse = exports.QueryAccountRequest = exports.GenesisState = exports.Permissions = exports.MsgResetCircuitBreakerResponse = exports.AccountResponse = exports.GenesisAccountPermissions = exports.MsgTripCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreakerResponse = exports.QueryAccountsRequest = void 0;
...
Object.defineProperty(exports, "MsgTripCircuitBreakerResponse", { enumerable: true, get: function () { return tx_2.MsgTripCircuitBreakerResponse; } });
...
Object.defineProperty(exports, "AccountResponse", { enumerable: true, get: function () { return query_2.AccountResponse; } });
...
Object.defineProperty(exports, "MsgTripCircuitBreaker", { enumerable: true, get: function () { return tx_5.MsgTripCircuitBreaker; } });
    ...
    return {
        ...
        async sendMsgTripCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreakerResponse({ value: tx_2.MsgTripCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAccountResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountResponse({ value: query_2.AccountResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgTripCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreaker({ value: tx_5.MsgTripCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryAccountsRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountsRequest", value: query_1.QueryAccountsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTripCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreakerResponse", value: tx_2.MsgTripCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        accountResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountResponse", value: query_2.AccountResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountRequest", value: query_3.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTripCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreaker", value: tx_5.MsgTripCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
