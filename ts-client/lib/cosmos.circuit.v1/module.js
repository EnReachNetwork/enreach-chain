...
exports.queryClient = exports.txClient = exports.registry = exports.MsgResetCircuitBreaker = exports.AccountsResponse = exports.AccountResponse = exports.GenesisAccountPermissions = exports.QueryAccountRequest = exports.MsgTripCircuitBreakerResponse = exports.MsgTripCircuitBreaker = exports.MsgAuthorizeCircuitBreakerResponse = exports.MsgAuthorizeCircuitBreaker = exports.DisabledListResponse = exports.Permissions = exports.MsgResetCircuitBreakerResponse = exports.QueryDisabledListRequest = exports.QueryAccountsRequest = exports.GenesisState = void 0;
...
Object.defineProperty(exports, "MsgAuthorizeCircuitBreakerResponse", { enumerable: true, get: function () { return tx_3.MsgAuthorizeCircuitBreakerResponse; } });
    ...
    return {
        ...
        async sendMsgAuthorizeCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreakerResponse({ value: tx_3.MsgAuthorizeCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreakerResponse", value: tx_3.MsgAuthorizeCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
