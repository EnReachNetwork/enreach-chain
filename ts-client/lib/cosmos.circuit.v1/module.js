...
exports.queryClient = exports.txClient = exports.registry = exports.MsgResetCircuitBreaker = exports.DisabledListResponse = exports.QueryAccountsRequest = exports.GenesisAccountPermissions = exports.MsgAuthorizeCircuitBreaker = exports.AccountsResponse = exports.MsgAuthorizeCircuitBreakerResponse = exports.MsgTripCircuitBreaker = exports.AccountResponse = exports.GenesisState = exports.Permissions = exports.MsgTripCircuitBreakerResponse = exports.QueryDisabledListRequest = exports.QueryAccountRequest = exports.MsgResetCircuitBreakerResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgResetCircuitBreakerResponse", { enumerable: true, get: function () { return tx_1.MsgResetCircuitBreakerResponse; } });
...
Object.defineProperty(exports, "GenesisState", { enumerable: true, get: function () { return types_2.GenesisState; } });
...
Object.defineProperty(exports, "MsgTripCircuitBreaker", { enumerable: true, get: function () { return tx_3.MsgTripCircuitBreaker; } });
...
Object.defineProperty(exports, "MsgAuthorizeCircuitBreaker", { enumerable: true, get: function () { return tx_5.MsgAuthorizeCircuitBreaker; } });
const types_3 = require("./types/cosmos/circuit/v1/types");
Object.defineProperty(exports, "GenesisAccountPermissions", { enumerable: true, get: function () { return types_3.GenesisAccountPermissions; } });
    ...
    return {
        async sendMsgResetCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgResetCircuitBreakerResponse({ value: tx_1.MsgResetCircuitBreakerResponse.fromPartial(value) });
        ...
        async sendGenesisState({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.genesisState({ value: types_2.GenesisState.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgTripCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreaker({ value: tx_3.MsgTripCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgAuthorizeCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreaker({ value: tx_5.MsgAuthorizeCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendGenesisAccountPermissions({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.genesisAccountPermissions({ value: types_3.GenesisAccountPermissions.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgResetCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreakerResponse", value: tx_1.MsgResetCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        genesisState({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.GenesisState", value: types_2.GenesisState.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTripCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreaker", value: tx_3.MsgTripCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreaker", value: tx_5.MsgAuthorizeCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        genesisAccountPermissions({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.GenesisAccountPermissions", value: types_3.GenesisAccountPermissions.fromPartial(value) };
            }
            catch (e) {
