...
exports.queryClient = exports.txClient = exports.registry = exports.MsgResetCircuitBreakerResponse = exports.DisabledListResponse = exports.QueryDisabledListRequest = exports.QueryAccountRequest = exports.GenesisState = exports.GenesisAccountPermissions = exports.MsgResetCircuitBreaker = exports.AccountsResponse = exports.QueryAccountsRequest = exports.AccountResponse = exports.Permissions = exports.MsgAuthorizeCircuitBreaker = exports.MsgTripCircuitBreakerResponse = exports.MsgTripCircuitBreaker = exports.MsgAuthorizeCircuitBreakerResponse = void 0;
...
Object.defineProperty(exports, "MsgAuthorizeCircuitBreaker", { enumerable: true, get: function () { return tx_4.MsgAuthorizeCircuitBreaker; } });
...
Object.defineProperty(exports, "AccountsResponse", { enumerable: true, get: function () { return query_3.AccountsResponse; } });
const tx_5 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgResetCircuitBreaker", { enumerable: true, get: function () { return tx_5.MsgResetCircuitBreaker; } });
    ...
    return {
        ...
        async sendMsgAuthorizeCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreaker({ value: tx_4.MsgAuthorizeCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendAccountsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.accountsResponse({ value: query_3.AccountsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgResetCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgResetCircuitBreaker({ value: tx_5.MsgResetCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreaker", value: tx_4.MsgAuthorizeCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        accountsResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.AccountsResponse", value: query_3.AccountsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgResetCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreaker", value: tx_5.MsgResetCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
