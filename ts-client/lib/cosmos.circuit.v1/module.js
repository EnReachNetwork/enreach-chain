...
exports.queryClient = exports.txClient = exports.registry = exports.QueryAccountRequest = exports.GenesisState = exports.MsgResetCircuitBreakerResponse = exports.MsgTripCircuitBreakerResponse = exports.QueryAccountsRequest = exports.AccountsResponse = exports.GenesisAccountPermissions = exports.MsgTripCircuitBreaker = exports.MsgAuthorizeCircuitBreaker = exports.DisabledListResponse = exports.MsgResetCircuitBreaker = exports.MsgAuthorizeCircuitBreakerResponse = exports.QueryDisabledListRequest = exports.AccountResponse = exports.Permissions = void 0;
...
Object.defineProperty(exports, "QueryDisabledListRequest", { enumerable: true, get: function () { return query_2.QueryDisabledListRequest; } });
...
Object.defineProperty(exports, "MsgResetCircuitBreaker", { enumerable: true, get: function () { return tx_2.MsgResetCircuitBreaker; } });
...
Object.defineProperty(exports, "MsgAuthorizeCircuitBreaker", { enumerable: true, get: function () { return tx_3.MsgAuthorizeCircuitBreaker; } });
const tx_4 = require("./types/cosmos/circuit/v1/tx");
Object.defineProperty(exports, "MsgTripCircuitBreaker", { enumerable: true, get: function () { return tx_4.MsgTripCircuitBreaker; } });
...
Object.defineProperty(exports, "MsgResetCircuitBreakerResponse", { enumerable: true, get: function () { return tx_6.MsgResetCircuitBreakerResponse; } });
    ...
    return {
        ...
        async sendQueryDisabledListRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryDisabledListRequest({ value: query_2.QueryDisabledListRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgResetCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgResetCircuitBreaker({ value: tx_2.MsgResetCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgAuthorizeCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgAuthorizeCircuitBreaker({ value: tx_3.MsgAuthorizeCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgTripCircuitBreaker({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgTripCircuitBreaker({ value: tx_4.MsgTripCircuitBreaker.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgResetCircuitBreakerResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgResetCircuitBreakerResponse({ value: tx_6.MsgResetCircuitBreakerResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryDisabledListRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryDisabledListRequest", value: query_2.QueryDisabledListRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgResetCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreaker", value: tx_2.MsgResetCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        msgAuthorizeCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgAuthorizeCircuitBreaker", value: tx_3.MsgAuthorizeCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        msgTripCircuitBreaker({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgTripCircuitBreaker", value: tx_4.MsgTripCircuitBreaker.fromPartial(value) };
            }
            catch (e) {
        ...
        msgResetCircuitBreakerResponse({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.MsgResetCircuitBreakerResponse", value: tx_6.MsgResetCircuitBreakerResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryAccountRequest({ value }) {
            try {
                return { typeUrl: "/cosmos.circuit.v1.QueryAccountRequest", value: query_6.QueryAccountRequest.fromPartial(value) };
            }
            catch (e) {
