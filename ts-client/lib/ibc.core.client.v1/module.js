...
exports.queryClient = exports.txClient = exports.registry = exports.QueryUpgradedConsensusStateResponse = exports.QueryClientStatusResponse = exports.QueryConsensusStateHeightsRequest = exports.QueryConsensusStatesRequest = exports.MsgRecoverClient = exports.MsgSubmitMisbehaviourResponse = exports.QueryConsensusStateRequest = exports.QueryClientStateResponse = exports.MsgIBCSoftwareUpgradeResponse = exports.MsgRecoverClientResponse = exports.ClientUpdateProposal = exports.Height = exports.QueryClientParamsResponse = exports.QueryConsensusStateResponse = exports.MsgUpgradeClientResponse = exports.GenesisMetadata = exports.GenesisState = exports.ClientConsensusStates = exports.ConsensusStateWithHeight = exports.QueryConsensusStatesResponse = exports.MsgUpgradeClient = exports.MsgUpdateClientResponse = exports.MsgCreateClientResponse = exports.IdentifiedClientState = exports.QueryClientStatusRequest = exports.QueryUpgradedConsensusStateRequest = exports.MsgUpdateParamsResponse = exports.MsgCreateClient = exports.Params = exports.QueryClientParamsRequest = exports.QueryClientStatesRequest = exports.QueryClientStateRequest = exports.MsgUpdateParams = exports.MsgSubmitMisbehaviour = exports.MsgUpdateClient = exports.UpgradeProposal = exports.QueryConsensusStateHeightsResponse = exports.IdentifiedGenesisMetadata = exports.QueryUpgradedClientStateResponse = exports.QueryUpgradedClientStateRequest = exports.QueryClientStatesResponse = exports.MsgIBCSoftwareUpgrade = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const tx_1 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgIBCSoftwareUpgrade", { enumerable: true, get: function () { return tx_1.MsgIBCSoftwareUpgrade; } });
...
Object.defineProperty(exports, "QueryUpgradedClientStateRequest", { enumerable: true, get: function () { return query_2.QueryUpgradedClientStateRequest; } });
...
Object.defineProperty(exports, "QueryConsensusStateHeightsResponse", { enumerable: true, get: function () { return query_4.QueryConsensusStateHeightsResponse; } });
...
Object.defineProperty(exports, "QueryClientStateRequest", { enumerable: true, get: function () { return query_5.QueryClientStateRequest; } });
...
Object.defineProperty(exports, "MsgCreateClient", { enumerable: true, get: function () { return tx_5.MsgCreateClient; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_8.QueryUpgradedConsensusStateRequest; } });
...
Object.defineProperty(exports, "IdentifiedClientState", { enumerable: true, get: function () { return client_3.IdentifiedClientState; } });
...
Object.defineProperty(exports, "QueryConsensusStatesResponse", { enumerable: true, get: function () { return query_10.QueryConsensusStatesResponse; } });
...
Object.defineProperty(exports, "MsgUpgradeClientResponse", { enumerable: true, get: function () { return tx_10.MsgUpgradeClientResponse; } });
...
Object.defineProperty(exports, "QueryClientParamsResponse", { enumerable: true, get: function () { return query_12.QueryClientParamsResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStateHeightsRequest", { enumerable: true, get: function () { return query_16.QueryConsensusStateHeightsRequest; } });
    ...
    return {
        async sendMsgIBCSoftwareUpgrade({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.msgIbcsoftwareUpgrade({ value: tx_1.MsgIBCSoftwareUpgrade.fromPartial(value) });
        ...
        async sendQueryUpgradedClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateRequest({ value: query_2.QueryUpgradedClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsResponse({ value: query_4.QueryConsensusStateHeightsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateRequest({ value: query_5.QueryClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateClient({ value: tx_5.MsgCreateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_8.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendIdentifiedClientState({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.identifiedClientState({ value: client_3.IdentifiedClientState.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesResponse({ value: query_10.QueryConsensusStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpgradeClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClientResponse({ value: tx_10.MsgUpgradeClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsResponse({ value: query_12.QueryClientParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsRequest({ value: query_16.QueryConsensusStateHeightsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgrade({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgrade", value: tx_1.MsgIBCSoftwareUpgrade.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateRequest", value: query_2.QueryUpgradedClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsResponse", value: query_4.QueryConsensusStateHeightsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParams", value: tx_4.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateRequest", value: query_5.QueryClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgCreateClient", value: tx_5.MsgCreateClient.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParamsResponse", value: tx_6.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_8.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        identifiedClientState({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.IdentifiedClientState", value: client_3.IdentifiedClientState.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesResponse", value: query_10.QueryConsensusStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpgradeClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClientResponse", value: tx_10.MsgUpgradeClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsResponse", value: query_12.QueryClientParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsRequest", value: query_16.QueryConsensusStateHeightsRequest.fromPartial(value) };
            }
            catch (e) {
