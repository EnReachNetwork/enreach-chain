...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParamsResponse = exports.MsgUpdateClientResponse = exports.QueryConsensusStateHeightsResponse = exports.Height = exports.QueryConsensusStateHeightsRequest = exports.MsgIBCSoftwareUpgrade = exports.QueryUpgradedConsensusStateRequest = exports.QueryConsensusStatesRequest = exports.ClientUpdateProposal = exports.IdentifiedGenesisMetadata = exports.GenesisState = exports.QueryClientStatusResponse = exports.QueryClientStatesRequest = exports.QueryClientStateRequest = exports.MsgRecoverClient = exports.QueryClientStatesResponse = exports.QueryConsensusStateRequest = exports.GenesisMetadata = exports.MsgRecoverClientResponse = exports.QueryUpgradedConsensusStateResponse = exports.QueryClientParamsRequest = exports.MsgUpgradeClient = exports.QueryClientStateResponse = exports.MsgIBCSoftwareUpgradeResponse = exports.MsgUpgradeClientResponse = exports.QueryUpgradedClientStateRequest = exports.QueryClientParamsResponse = exports.MsgSubmitMisbehaviour = exports.MsgUpdateClient = exports.MsgCreateClient = exports.UpgradeProposal = exports.Params = exports.QueryConsensusStatesResponse = exports.ConsensusStateWithHeight = exports.MsgUpdateParams = exports.QueryUpgradedClientStateResponse = exports.QueryClientStatusRequest = exports.IdentifiedClientState = exports.ClientConsensusStates = exports.QueryConsensusStateResponse = exports.MsgSubmitMisbehaviourResponse = exports.MsgCreateClientResponse = void 0;
...
Object.defineProperty(exports, "MsgSubmitMisbehaviourResponse", { enumerable: true, get: function () { return tx_2.MsgSubmitMisbehaviourResponse; } });
...
Object.defineProperty(exports, "QueryClientStatusRequest", { enumerable: true, get: function () { return query_2.QueryClientStatusRequest; } });
const query_3 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedClientStateResponse", { enumerable: true, get: function () { return query_3.QueryUpgradedClientStateResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStatesResponse", { enumerable: true, get: function () { return query_4.QueryConsensusStatesResponse; } });
...
Object.defineProperty(exports, "QueryClientParamsResponse", { enumerable: true, get: function () { return query_5.QueryClientParamsResponse; } });
...
Object.defineProperty(exports, "MsgIBCSoftwareUpgradeResponse", { enumerable: true, get: function () { return tx_8.MsgIBCSoftwareUpgradeResponse; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_9.QueryUpgradedConsensusStateResponse; } });
const tx_10 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgRecoverClientResponse", { enumerable: true, get: function () { return tx_10.MsgRecoverClientResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStateRequest", { enumerable: true, get: function () { return query_10.QueryConsensusStateRequest; } });
const query_11 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStatesResponse", { enumerable: true, get: function () { return query_11.QueryClientStatesResponse; } });
const tx_11 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgRecoverClient", { enumerable: true, get: function () { return tx_11.MsgRecoverClient; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_16.QueryUpgradedConsensusStateRequest; } });
const tx_12 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgIBCSoftwareUpgrade", { enumerable: true, get: function () { return tx_12.MsgIBCSoftwareUpgrade; } });
...
Object.defineProperty(exports, "MsgUpdateClientResponse", { enumerable: true, get: function () { return tx_13.MsgUpdateClientResponse; } });
    ...
    return {
        ...
        async sendMsgSubmitMisbehaviourResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviourResponse({ value: tx_2.MsgSubmitMisbehaviourResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_1.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusRequest({ value: query_2.QueryClientStatusRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateResponse({ value: query_3.QueryUpgradedClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesResponse({ value: query_4.QueryConsensusStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsResponse({ value: query_5.QueryClientParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgIBCSoftwareUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgIbcsoftwareUpgradeResponse({ value: tx_8.MsgIBCSoftwareUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_9.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClientResponse({ value: tx_10.MsgRecoverClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateRequest({ value: query_10.QueryConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesResponse({ value: query_11.QueryClientStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClient({ value: tx_11.MsgRecoverClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_16.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgIBCSoftwareUpgrade({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgIbcsoftwareUpgrade({ value: tx_12.MsgIBCSoftwareUpgrade.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateClientResponse({ value: tx_13.MsgUpdateClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSubmitMisbehaviourResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviourResponse", value: tx_2.MsgSubmitMisbehaviourResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_1.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusRequest", value: query_2.QueryClientStatusRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateResponse", value: query_3.QueryUpgradedClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesResponse", value: query_4.QueryConsensusStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsResponse", value: query_5.QueryClientParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgradeResponse", value: tx_8.MsgIBCSoftwareUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateResponse", value: query_9.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClientResponse", value: tx_10.MsgRecoverClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateRequest", value: query_10.QueryConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesResponse", value: query_11.QueryClientStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClient", value: tx_11.MsgRecoverClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_16.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgrade({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgrade", value: tx_12.MsgIBCSoftwareUpgrade.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateClientResponse", value: tx_13.MsgUpdateClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParamsResponse", value: tx_14.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
