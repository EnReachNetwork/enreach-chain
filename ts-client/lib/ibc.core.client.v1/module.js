...
exports.queryClient = exports.txClient = exports.registry = exports.QueryUpgradedClientStateRequest = exports.MsgSubmitMisbehaviourResponse = exports.MsgUpdateParams = exports.GenesisState = exports.MsgCreateClient = exports.QueryUpgradedClientStateResponse = exports.QueryClientStatusResponse = exports.QueryClientStatusRequest = exports.QueryClientStateRequest = exports.QueryClientStateResponse = exports.QueryClientStatesResponse = exports.MsgUpgradeClientResponse = exports.MsgUpgradeClient = exports.MsgUpdateClient = exports.QueryConsensusStatesResponse = exports.GenesisMetadata = exports.MsgUpdateParamsResponse = exports.MsgRecoverClientResponse = exports.Height = exports.QueryUpgradedConsensusStateRequest = exports.Params = exports.MsgIBCSoftwareUpgrade = exports.QueryConsensusStateRequest = exports.IdentifiedGenesisMetadata = exports.MsgUpdateClientResponse = exports.MsgRecoverClient = exports.UpgradeProposal = exports.MsgCreateClientResponse = exports.IdentifiedClientState = exports.MsgSubmitMisbehaviour = exports.ClientUpdateProposal = exports.QueryConsensusStateHeightsResponse = exports.QueryConsensusStateResponse = exports.ConsensusStateWithHeight = exports.MsgIBCSoftwareUpgradeResponse = exports.QueryClientStatesRequest = exports.ClientConsensusStates = exports.QueryUpgradedConsensusStateResponse = exports.QueryClientParamsResponse = exports.QueryClientParamsRequest = exports.QueryConsensusStateHeightsRequest = exports.QueryConsensusStatesRequest = void 0;
...
Object.defineProperty(exports, "QueryConsensusStateHeightsRequest", { enumerable: true, get: function () { return query_2.QueryConsensusStateHeightsRequest; } });
const query_3 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientParamsRequest", { enumerable: true, get: function () { return query_3.QueryClientParamsRequest; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_5.QueryUpgradedConsensusStateResponse; } });
...
Object.defineProperty(exports, "QueryClientStatesRequest", { enumerable: true, get: function () { return query_6.QueryClientStatesRequest; } });
...
Object.defineProperty(exports, "QueryConsensusStateResponse", { enumerable: true, get: function () { return query_7.QueryConsensusStateResponse; } });
...
Object.defineProperty(exports, "ClientUpdateProposal", { enumerable: true, get: function () { return client_3.ClientUpdateProposal; } });
...
Object.defineProperty(exports, "MsgCreateClientResponse", { enumerable: true, get: function () { return tx_3.MsgCreateClientResponse; } });
...
Object.defineProperty(exports, "MsgUpdateClientResponse", { enumerable: true, get: function () { return tx_5.MsgUpdateClientResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStateRequest", { enumerable: true, get: function () { return query_9.QueryConsensusStateRequest; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_10.QueryUpgradedConsensusStateRequest; } });
...
Object.defineProperty(exports, "MsgUpdateClient", { enumerable: true, get: function () { return tx_9.MsgUpdateClient; } });
...
Object.defineProperty(exports, "QueryClientStatesResponse", { enumerable: true, get: function () { return query_12.QueryClientStatesResponse; } });
...
Object.defineProperty(exports, "QueryClientStateRequest", { enumerable: true, get: function () { return query_14.QueryClientStateRequest; } });
const query_15 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStatusRequest", { enumerable: true, get: function () { return query_15.QueryClientStatusRequest; } });
...
Object.defineProperty(exports, "QueryUpgradedClientStateRequest", { enumerable: true, get: function () { return query_18.QueryUpgradedClientStateRequest; } });
    ...
    return {
        async sendQueryConsensusStatesRequest({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryConsensusStatesRequest({ value: query_1.QueryConsensusStatesRequest.fromPartial(value) });
        ...
        async sendQueryConsensusStateHeightsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsRequest({ value: query_2.QueryConsensusStateHeightsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsRequest({ value: query_3.QueryClientParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_5.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesRequest({ value: query_6.QueryClientStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_7.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendClientUpdateProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.clientUpdateProposal({ value: client_3.ClientUpdateProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateClientResponse({ value: tx_3.MsgCreateClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateClientResponse({ value: tx_5.MsgUpdateClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateRequest({ value: query_9.QueryConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_10.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateClient({ value: tx_9.MsgUpdateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesResponse({ value: query_12.QueryClientStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateRequest({ value: query_14.QueryClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusRequest({ value: query_15.QueryClientStatusRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateRequest({ value: query_18.QueryUpgradedClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryConsensusStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesRequest", value: query_1.QueryConsensusStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsRequest", value: query_2.QueryConsensusStateHeightsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsRequest", value: query_3.QueryClientParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateResponse", value: query_5.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesRequest", value: query_6.QueryClientStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_7.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        clientUpdateProposal({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.ClientUpdateProposal", value: client_3.ClientUpdateProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgCreateClientResponse", value: tx_3.MsgCreateClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateClientResponse", value: tx_5.MsgUpdateClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateRequest", value: query_9.QueryConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_10.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateClient", value: tx_9.MsgUpdateClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesResponse", value: query_12.QueryClientStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateRequest", value: query_14.QueryClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusRequest", value: query_15.QueryClientStatusRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateRequest", value: query_18.QueryUpgradedClientStateRequest.fromPartial(value) };
            }
            catch (e) {
