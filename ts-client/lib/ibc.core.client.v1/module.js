...
exports.queryClient = exports.txClient = exports.registry = exports.MsgUpdateParams = exports.MsgIBCSoftwareUpgrade = exports.MsgUpgradeClientResponse = exports.MsgUpdateClientResponse = exports.IdentifiedClientState = exports.QueryUpgradedClientStateResponse = exports.QueryConsensusStateResponse = exports.QueryClientStatesResponse = exports.GenesisMetadata = exports.ConsensusStateWithHeight = exports.QueryConsensusStateHeightsResponse = exports.QueryConsensusStateHeightsRequest = exports.QueryClientStatusResponse = exports.ClientConsensusStates = exports.MsgIBCSoftwareUpgradeResponse = exports.QueryClientStateRequest = exports.UpgradeProposal = exports.MsgUpgradeClient = exports.MsgUpdateClient = exports.MsgCreateClient = exports.QueryUpgradedConsensusStateResponse = exports.QueryConsensusStatesRequest = exports.MsgRecoverClientResponse = exports.MsgCreateClientResponse = exports.Params = exports.QueryConsensusStatesResponse = exports.QueryClientParamsRequest = exports.QueryConsensusStateRequest = exports.QueryClientStatesRequest = exports.ClientUpdateProposal = exports.MsgSubmitMisbehaviourResponse = exports.Height = exports.QueryClientParamsResponse = exports.QueryClientStatusRequest = exports.QueryClientStateResponse = exports.MsgRecoverClient = exports.GenesisState = exports.QueryUpgradedConsensusStateRequest = exports.QueryUpgradedClientStateRequest = exports.MsgUpdateParamsResponse = exports.MsgSubmitMisbehaviour = exports.IdentifiedGenesisMetadata = void 0;
...
Object.defineProperty(exports, "MsgSubmitMisbehaviour", { enumerable: true, get: function () { return tx_1.MsgSubmitMisbehaviour; } });
...
Object.defineProperty(exports, "QueryUpgradedClientStateRequest", { enumerable: true, get: function () { return query_1.QueryUpgradedClientStateRequest; } });
...
Object.defineProperty(exports, "MsgRecoverClient", { enumerable: true, get: function () { return tx_3.MsgRecoverClient; } });
const query_3 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStateResponse", { enumerable: true, get: function () { return query_3.QueryClientStateResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStatesResponse", { enumerable: true, get: function () { return query_9.QueryConsensusStatesResponse; } });
...
Object.defineProperty(exports, "MsgRecoverClientResponse", { enumerable: true, get: function () { return tx_6.MsgRecoverClientResponse; } });
const query_10 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStatesRequest", { enumerable: true, get: function () { return query_10.QueryConsensusStatesRequest; } });
const query_11 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_11.QueryUpgradedConsensusStateResponse; } });
const tx_7 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgCreateClient", { enumerable: true, get: function () { return tx_7.MsgCreateClient; } });
...
Object.defineProperty(exports, "ClientConsensusStates", { enumerable: true, get: function () { return client_5.ClientConsensusStates; } });
const query_13 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStatusResponse", { enumerable: true, get: function () { return query_13.QueryClientStatusResponse; } });
const query_14 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateHeightsRequest", { enumerable: true, get: function () { return query_14.QueryConsensusStateHeightsRequest; } });
...
Object.defineProperty(exports, "QueryClientStatesResponse", { enumerable: true, get: function () { return query_16.QueryClientStatesResponse; } });
const query_17 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateResponse", { enumerable: true, get: function () { return query_17.QueryConsensusStateResponse; } });
const query_18 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedClientStateResponse", { enumerable: true, get: function () { return query_18.QueryUpgradedClientStateResponse; } });
    ...
    return {
        ...
        async sendMsgSubmitMisbehaviour({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviour({ value: tx_1.MsgSubmitMisbehaviour.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateRequest({ value: query_1.QueryUpgradedClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClient({ value: tx_3.MsgRecoverClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateResponse({ value: query_3.QueryClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesResponse({ value: query_9.QueryConsensusStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClientResponse({ value: tx_6.MsgRecoverClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesRequest({ value: query_10.QueryConsensusStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_11.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateClient({ value: tx_7.MsgCreateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendClientConsensusStates({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.clientConsensusStates({ value: client_5.ClientConsensusStates.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusResponse({ value: query_13.QueryClientStatusResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsRequest({ value: query_14.QueryConsensusStateHeightsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesResponse({ value: query_16.QueryClientStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_17.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateResponse({ value: query_18.QueryUpgradedClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgSubmitMisbehaviour({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviour", value: tx_1.MsgSubmitMisbehaviour.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateRequest", value: query_1.QueryUpgradedClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_2.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClient", value: tx_3.MsgRecoverClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateResponse", value: query_3.QueryClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesResponse", value: query_9.QueryConsensusStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClientResponse", value: tx_6.MsgRecoverClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesRequest", value: query_10.QueryConsensusStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateResponse", value: query_11.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgCreateClient", value: tx_7.MsgCreateClient.fromPartial(value) };
            }
            catch (e) {
        ...
        clientConsensusStates({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.ClientConsensusStates", value: client_5.ClientConsensusStates.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusResponse", value: query_13.QueryClientStatusResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsRequest", value: query_14.QueryConsensusStateHeightsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesResponse", value: query_16.QueryClientStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_17.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateResponse", value: query_18.QueryUpgradedClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParams", value: tx_14.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
