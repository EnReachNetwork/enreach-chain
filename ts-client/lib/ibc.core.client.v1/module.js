...
exports.queryClient = exports.txClient = exports.registry = exports.QueryUpgradedConsensusStateResponse = exports.QueryConsensusStatesRequest = exports.MsgCreateClient = exports.QueryClientStatusResponse = exports.QueryClientStatesRequest = exports.QueryUpgradedClientStateRequest = exports.MsgUpdateParams = exports.MsgRecoverClient = exports.MsgCreateClientResponse = exports.Height = exports.IdentifiedClientState = exports.QueryConsensusStateResponse = exports.ClientUpdateProposal = exports.MsgUpdateParamsResponse = exports.MsgIBCSoftwareUpgradeResponse = exports.QueryClientStatesResponse = exports.UpgradeProposal = exports.MsgSubmitMisbehaviour = exports.ClientConsensusStates = exports.MsgSubmitMisbehaviourResponse = exports.QueryUpgradedClientStateResponse = exports.QueryClientParamsRequest = exports.Params = exports.QueryUpgradedConsensusStateRequest = exports.QueryClientParamsResponse = exports.GenesisState = exports.MsgRecoverClientResponse = exports.MsgUpdateClientResponse = exports.QueryConsensusStateHeightsResponse = exports.QueryConsensusStateHeightsRequest = exports.QueryConsensusStateRequest = exports.QueryClientStateRequest = exports.QueryClientStateResponse = exports.QueryClientStatusRequest = exports.IdentifiedGenesisMetadata = exports.ConsensusStateWithHeight = exports.MsgUpgradeClientResponse = exports.MsgUpgradeClient = exports.MsgUpdateClient = exports.QueryConsensusStatesResponse = exports.GenesisMetadata = exports.MsgIBCSoftwareUpgrade = void 0;
...
Object.defineProperty(exports, "MsgUpgradeClient", { enumerable: true, get: function () { return tx_3.MsgUpgradeClient; } });
const tx_4 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgUpgradeClientResponse", { enumerable: true, get: function () { return tx_4.MsgUpgradeClientResponse; } });
...
Object.defineProperty(exports, "QueryClientStateRequest", { enumerable: true, get: function () { return query_4.QueryClientStateRequest; } });
...
Object.defineProperty(exports, "MsgSubmitMisbehaviourResponse", { enumerable: true, get: function () { return tx_7.MsgSubmitMisbehaviourResponse; } });
...
Object.defineProperty(exports, "MsgSubmitMisbehaviour", { enumerable: true, get: function () { return tx_8.MsgSubmitMisbehaviour; } });
...
Object.defineProperty(exports, "QueryClientStatesRequest", { enumerable: true, get: function () { return query_15.QueryClientStatesRequest; } });
    ...
    return {
        ...
        async sendMsgUpgradeClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClient({ value: tx_3.MsgUpgradeClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpgradeClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClientResponse({ value: tx_4.MsgUpgradeClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateRequest({ value: query_4.QueryClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitMisbehaviourResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviourResponse({ value: tx_7.MsgSubmitMisbehaviourResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitMisbehaviour({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviour({ value: tx_8.MsgSubmitMisbehaviour.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesRequest({ value: query_15.QueryClientStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpgradeClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClient", value: tx_3.MsgUpgradeClient.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpgradeClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClientResponse", value: tx_4.MsgUpgradeClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateRequest", value: query_4.QueryClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitMisbehaviourResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviourResponse", value: tx_7.MsgSubmitMisbehaviourResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitMisbehaviour({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviour", value: tx_8.MsgSubmitMisbehaviour.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesRequest", value: query_15.QueryClientStatesRequest.fromPartial(value) };
            }
            catch (e) {
