...
exports.queryClient = exports.txClient = exports.registry = exports.MsgCreateClient = exports.GenesisMetadata = exports.MsgUpdateParamsResponse = exports.QueryClientParamsResponse = exports.QueryConsensusStateHeightsRequest = exports.QueryConsensusStatesResponse = exports.QueryConsensusStateRequest = exports.MsgSubmitMisbehaviour = exports.QueryClientParamsRequest = exports.QueryConsensusStateResponse = exports.MsgSubmitMisbehaviourResponse = exports.Params = exports.QueryConsensusStateHeightsResponse = exports.MsgRecoverClientResponse = exports.MsgIBCSoftwareUpgradeResponse = exports.QueryUpgradedClientStateResponse = exports.QueryClientStatesResponse = exports.QueryClientStateResponse = exports.IdentifiedClientState = exports.QueryUpgradedConsensusStateResponse = exports.IdentifiedGenesisMetadata = exports.ClientConsensusStates = exports.MsgUpdateClientResponse = exports.QueryUpgradedConsensusStateRequest = exports.QueryClientStatusRequest = exports.QueryConsensusStatesRequest = exports.QueryClientStatesRequest = exports.QueryClientStateRequest = exports.MsgUpgradeClientResponse = exports.MsgUpgradeClient = exports.MsgUpdateClient = exports.GenesisState = exports.QueryUpgradedClientStateRequest = exports.QueryClientStatusResponse = exports.ConsensusStateWithHeight = exports.MsgUpdateParams = exports.MsgRecoverClient = exports.MsgCreateClientResponse = exports.UpgradeProposal = exports.ClientUpdateProposal = exports.Height = exports.MsgIBCSoftwareUpgrade = void 0;
...
Object.defineProperty(exports, "QueryClientStateRequest", { enumerable: true, get: function () { return query_3.QueryClientStateRequest; } });
...
Object.defineProperty(exports, "QueryConsensusStatesRequest", { enumerable: true, get: function () { return query_5.QueryConsensusStatesRequest; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_7.QueryUpgradedConsensusStateRequest; } });
...
Object.defineProperty(exports, "QueryClientStateResponse", { enumerable: true, get: function () { return query_9.QueryClientStateResponse; } });
...
Object.defineProperty(exports, "MsgIBCSoftwareUpgradeResponse", { enumerable: true, get: function () { return tx_9.MsgIBCSoftwareUpgradeResponse; } });
...
Object.defineProperty(exports, "MsgSubmitMisbehaviourResponse", { enumerable: true, get: function () { return tx_11.MsgSubmitMisbehaviourResponse; } });
const query_13 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateResponse", { enumerable: true, get: function () { return query_13.QueryConsensusStateResponse; } });
const query_14 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientParamsRequest", { enumerable: true, get: function () { return query_14.QueryClientParamsRequest; } });
...
Object.defineProperty(exports, "QueryConsensusStatesResponse", { enumerable: true, get: function () { return query_16.QueryConsensusStatesResponse; } });
...
Object.defineProperty(exports, "MsgCreateClient", { enumerable: true, get: function () { return tx_14.MsgCreateClient; } });
    ...
    return {
        ...
        async sendQueryClientStatusResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusResponse({ value: query_1.QueryClientStatusResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateRequest({ value: query_3.QueryClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesRequest({ value: query_5.QueryConsensusStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_7.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateResponse({ value: query_9.QueryClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgIBCSoftwareUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgIbcsoftwareUpgradeResponse({ value: tx_9.MsgIBCSoftwareUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitMisbehaviourResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviourResponse({ value: tx_11.MsgSubmitMisbehaviourResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_13.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsRequest({ value: query_14.QueryClientParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesResponse({ value: query_16.QueryConsensusStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateClient({ value: tx_14.MsgCreateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryClientStatusResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusResponse", value: query_1.QueryClientStatusResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateRequest", value: query_3.QueryClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesRequest", value: query_5.QueryConsensusStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_7.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateResponse", value: query_9.QueryClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgradeResponse", value: tx_9.MsgIBCSoftwareUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitMisbehaviourResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviourResponse", value: tx_11.MsgSubmitMisbehaviourResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_13.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsRequest", value: query_14.QueryClientParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesResponse", value: query_16.QueryConsensusStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParamsResponse", value: tx_13.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgCreateClient", value: tx_14.MsgCreateClient.fromPartial(value) };
            }
            catch (e) {
