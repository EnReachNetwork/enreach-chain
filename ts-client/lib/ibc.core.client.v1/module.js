...
exports.queryClient = exports.txClient = exports.registry = exports.QueryConsensusStateHeightsResponse = exports.QueryClientStateRequest = exports.IdentifiedClientState = exports.MsgRecoverClientResponse = exports.QueryClientStateResponse = exports.ClientUpdateProposal = exports.MsgUpdateParams = exports.QueryClientStatusResponse = exports.QueryClientStatesRequest = exports.QueryUpgradedClientStateResponse = exports.QueryUpgradedClientStateRequest = exports.QueryConsensusStateResponse = exports.MsgUpgradeClientResponse = exports.IdentifiedGenesisMetadata = exports.QueryUpgradedConsensusStateResponse = exports.QueryUpgradedConsensusStateRequest = exports.MsgIBCSoftwareUpgrade = exports.MsgSubmitMisbehaviourResponse = exports.MsgSubmitMisbehaviour = exports.QueryClientParamsResponse = exports.QueryClientParamsRequest = exports.QueryClientStatusRequest = exports.Height = exports.ConsensusStateWithHeight = exports.MsgUpdateParamsResponse = exports.MsgIBCSoftwareUpgradeResponse = exports.UpgradeProposal = exports.MsgUpdateClient = exports.MsgCreateClientResponse = exports.MsgCreateClient = exports.QueryConsensusStateHeightsRequest = exports.QueryConsensusStatesRequest = exports.QueryConsensusStatesResponse = exports.MsgUpdateClientResponse = exports.GenesisMetadata = exports.QueryClientStatesResponse = exports.MsgRecoverClient = exports.MsgUpgradeClient = exports.GenesisState = exports.ClientConsensusStates = exports.QueryConsensusStateRequest = exports.Params = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const client_1 = require("./types/ibc/core/client/v1/client");
Object.defineProperty(exports, "Params", { enumerable: true, get: function () { return client_1.Params; } });
const query_1 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateRequest", { enumerable: true, get: function () { return query_1.QueryConsensusStateRequest; } });
...
Object.defineProperty(exports, "MsgUpgradeClient", { enumerable: true, get: function () { return tx_1.MsgUpgradeClient; } });
const tx_2 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgRecoverClient", { enumerable: true, get: function () { return tx_2.MsgRecoverClient; } });
const query_2 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStatesResponse", { enumerable: true, get: function () { return query_2.QueryClientStatesResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStatesResponse", { enumerable: true, get: function () { return query_3.QueryConsensusStatesResponse; } });
const query_4 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStatesRequest", { enumerable: true, get: function () { return query_4.QueryConsensusStatesRequest; } });
...
Object.defineProperty(exports, "MsgCreateClient", { enumerable: true, get: function () { return tx_4.MsgCreateClient; } });
...
Object.defineProperty(exports, "MsgUpdateClient", { enumerable: true, get: function () { return tx_6.MsgUpdateClient; } });
...
Object.defineProperty(exports, "MsgIBCSoftwareUpgradeResponse", { enumerable: true, get: function () { return tx_7.MsgIBCSoftwareUpgradeResponse; } });
...
Object.defineProperty(exports, "Height", { enumerable: true, get: function () { return client_5.Height; } });
...
Object.defineProperty(exports, "MsgSubmitMisbehaviour", { enumerable: true, get: function () { return tx_9.MsgSubmitMisbehaviour; } });
...
Object.defineProperty(exports, "MsgIBCSoftwareUpgrade", { enumerable: true, get: function () { return tx_11.MsgIBCSoftwareUpgrade; } });
const query_9 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_9.QueryUpgradedConsensusStateRequest; } });
const query_10 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_10.QueryUpgradedConsensusStateResponse; } });
const genesis_3 = require("./types/ibc/core/client/v1/genesis");
Object.defineProperty(exports, "IdentifiedGenesisMetadata", { enumerable: true, get: function () { return genesis_3.IdentifiedGenesisMetadata; } });
...
Object.defineProperty(exports, "QueryConsensusStateResponse", { enumerable: true, get: function () { return query_11.QueryConsensusStateResponse; } });
const query_12 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedClientStateRequest", { enumerable: true, get: function () { return query_12.QueryUpgradedClientStateRequest; } });
const query_13 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedClientStateResponse", { enumerable: true, get: function () { return query_13.QueryUpgradedClientStateResponse; } });
...
Object.defineProperty(exports, "IdentifiedClientState", { enumerable: true, get: function () { return client_7.IdentifiedClientState; } });
const query_17 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStateRequest", { enumerable: true, get: function () { return query_17.QueryClientStateRequest; } });
const query_18 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateHeightsResponse", { enumerable: true, get: function () { return query_18.QueryConsensusStateHeightsResponse; } });
    ...
    return {
        async sendParams({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.params({ value: client_1.Params.fromPartial(value) });
        ...
        async sendQueryConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateRequest({ value: query_1.QueryConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpgradeClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClient({ value: tx_1.MsgUpgradeClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClient({ value: tx_2.MsgRecoverClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesResponse({ value: query_2.QueryClientStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesResponse({ value: query_3.QueryConsensusStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesRequest({ value: query_4.QueryConsensusStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateClient({ value: tx_4.MsgCreateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateClient({ value: tx_6.MsgUpdateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgIBCSoftwareUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgIbcsoftwareUpgradeResponse({ value: tx_7.MsgIBCSoftwareUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendHeight({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.height({ value: client_5.Height.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitMisbehaviour({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviour({ value: tx_9.MsgSubmitMisbehaviour.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgIBCSoftwareUpgrade({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgIbcsoftwareUpgrade({ value: tx_11.MsgIBCSoftwareUpgrade.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_9.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_10.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendIdentifiedGenesisMetadata({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.identifiedGenesisMetadata({ value: genesis_3.IdentifiedGenesisMetadata.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_11.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateRequest({ value: query_12.QueryUpgradedClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateResponse({ value: query_13.QueryUpgradedClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendIdentifiedClientState({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.identifiedClientState({ value: client_7.IdentifiedClientState.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateRequest({ value: query_17.QueryClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsResponse({ value: query_18.QueryConsensusStateHeightsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        params({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.Params", value: client_1.Params.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateRequest", value: query_1.QueryConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpgradeClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClient", value: tx_1.MsgUpgradeClient.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClient", value: tx_2.MsgRecoverClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesResponse", value: query_2.QueryClientStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesResponse", value: query_3.QueryConsensusStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesRequest", value: query_4.QueryConsensusStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgCreateClient", value: tx_4.MsgCreateClient.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateClient", value: tx_6.MsgUpdateClient.fromPartial(value) };
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgradeResponse", value: tx_7.MsgIBCSoftwareUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParamsResponse", value: tx_8.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        height({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.Height", value: client_5.Height.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitMisbehaviour({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviour", value: tx_9.MsgSubmitMisbehaviour.fromPartial(value) };
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgrade({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgrade", value: tx_11.MsgIBCSoftwareUpgrade.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_9.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateResponse", value: query_10.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        identifiedGenesisMetadata({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.IdentifiedGenesisMetadata", value: genesis_3.IdentifiedGenesisMetadata.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_11.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateRequest", value: query_12.QueryUpgradedClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateResponse", value: query_13.QueryUpgradedClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParams", value: tx_13.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        identifiedClientState({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.IdentifiedClientState", value: client_7.IdentifiedClientState.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateRequest", value: query_17.QueryClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsResponse", value: query_18.QueryConsensusStateHeightsResponse.fromPartial(value) };
            }
            catch (e) {
