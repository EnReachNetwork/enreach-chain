...
exports.queryClient = exports.txClient = exports.registry = exports.IdentifiedGenesisMetadata = exports.ClientConsensusStates = exports.QueryUpgradedConsensusStateRequest = exports.UpgradeProposal = exports.QueryClientStatusResponse = exports.ClientUpdateProposal = exports.GenesisMetadata = exports.QueryUpgradedClientStateRequest = exports.QueryConsensusStatesRequest = exports.Params = exports.MsgIBCSoftwareUpgradeResponse = exports.MsgSubmitMisbehaviourResponse = exports.MsgUpgradeClientResponse = exports.GenesisState = exports.QueryUpgradedConsensusStateResponse = exports.QueryClientStatesResponse = exports.ConsensusStateWithHeight = exports.MsgSubmitMisbehaviour = exports.MsgCreateClient = exports.QueryConsensusStateHeightsResponse = exports.QueryClientStatesRequest = exports.QueryClientStateRequest = exports.IdentifiedClientState = exports.MsgRecoverClientResponse = exports.MsgUpdateClientResponse = exports.QueryUpgradedClientStateResponse = exports.QueryClientParamsRequest = exports.QueryConsensusStateRequest = exports.MsgRecoverClient = exports.QueryConsensusStatesResponse = exports.QueryConsensusStateResponse = exports.QueryClientStateResponse = exports.MsgIBCSoftwareUpgrade = exports.MsgCreateClientResponse = exports.Height = exports.QueryClientStatusRequest = exports.QueryClientParamsResponse = exports.QueryConsensusStateHeightsRequest = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgUpgradeClient = exports.MsgUpdateClient = void 0;
...
Object.defineProperty(exports, "QueryClientParamsResponse", { enumerable: true, get: function () { return query_2.QueryClientParamsResponse; } });
...
Object.defineProperty(exports, "QueryClientStateResponse", { enumerable: true, get: function () { return query_4.QueryClientStateResponse; } });
const query_5 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateResponse", { enumerable: true, get: function () { return query_5.QueryConsensusStateResponse; } });
const query_6 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStatesResponse", { enumerable: true, get: function () { return query_6.QueryConsensusStatesResponse; } });
const tx_7 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgRecoverClient", { enumerable: true, get: function () { return tx_7.MsgRecoverClient; } });
const query_7 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateRequest", { enumerable: true, get: function () { return query_7.QueryConsensusStateRequest; } });
...
Object.defineProperty(exports, "QueryUpgradedClientStateResponse", { enumerable: true, get: function () { return query_9.QueryUpgradedClientStateResponse; } });
...
Object.defineProperty(exports, "QueryClientStatesRequest", { enumerable: true, get: function () { return query_11.QueryClientStatesRequest; } });
const query_12 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateHeightsResponse", { enumerable: true, get: function () { return query_12.QueryConsensusStateHeightsResponse; } });
...
Object.defineProperty(exports, "QueryClientStatesResponse", { enumerable: true, get: function () { return query_13.QueryClientStatesResponse; } });
const query_14 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_14.QueryUpgradedConsensusStateResponse; } });
...
Object.defineProperty(exports, "QueryClientStatusResponse", { enumerable: true, get: function () { return query_17.QueryClientStatusResponse; } });
...
Object.defineProperty(exports, "QueryUpgradedConsensusStateRequest", { enumerable: true, get: function () { return query_18.QueryUpgradedConsensusStateRequest; } });
    ...
    return {
        ...
        async sendQueryConsensusStateHeightsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsRequest({ value: query_1.QueryConsensusStateHeightsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsResponse({ value: query_2.QueryClientParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendHeight({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.height({ value: client_1.Height.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateResponse({ value: query_4.QueryClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_5.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesResponse({ value: query_6.QueryConsensusStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClient({ value: tx_7.MsgRecoverClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateRequest({ value: query_7.QueryConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateResponse({ value: query_9.QueryUpgradedClientStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesRequest({ value: query_11.QueryClientStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsResponse({ value: query_12.QueryConsensusStateHeightsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesResponse({ value: query_13.QueryClientStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_14.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusResponse({ value: query_17.QueryClientStatusResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateRequest({ value: query_18.QueryUpgradedConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgUpdateParams({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParams", value: tx_3.MsgUpdateParams.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsRequest", value: query_1.QueryConsensusStateHeightsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsResponse", value: query_2.QueryClientParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        height({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.Height", value: client_1.Height.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateResponse", value: query_4.QueryClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_5.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesResponse", value: query_6.QueryConsensusStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClient", value: tx_7.MsgRecoverClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateRequest", value: query_7.QueryConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateResponse", value: query_9.QueryUpgradedClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesRequest", value: query_11.QueryClientStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsResponse", value: query_12.QueryConsensusStateHeightsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesResponse", value: query_13.QueryClientStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateResponse", value: query_14.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusResponse", value: query_17.QueryClientStatusResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateRequest", value: query_18.QueryUpgradedConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
