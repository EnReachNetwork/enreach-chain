...
exports.queryClient = exports.txClient = exports.registry = exports.QueryUpgradedConsensusStateRequest = exports.QueryClientStatusRequest = exports.IdentifiedGenesisMetadata = exports.MsgIBCSoftwareUpgradeResponse = exports.MsgSubmitMisbehaviourResponse = exports.ClientUpdateProposal = exports.Params = exports.MsgUpdateParamsResponse = exports.MsgCreateClientResponse = exports.QueryConsensusStateRequest = exports.QueryConsensusStateResponse = exports.QueryClientStatesRequest = exports.QueryClientStateResponse = exports.IdentifiedClientState = exports.QueryUpgradedConsensusStateResponse = exports.QueryConsensusStatesResponse = exports.QueryClientStateRequest = exports.MsgSubmitMisbehaviour = exports.MsgUpgradeClientResponse = exports.UpgradeProposal = exports.MsgUpdateParams = exports.MsgRecoverClientResponse = exports.QueryUpgradedClientStateRequest = exports.QueryClientStatusResponse = exports.QueryConsensusStateHeightsResponse = exports.MsgIBCSoftwareUpgrade = exports.MsgUpgradeClient = exports.MsgUpdateClientResponse = exports.MsgUpdateClient = exports.QueryConsensusStatesRequest = exports.GenesisMetadata = exports.Height = exports.QueryConsensusStateHeightsRequest = exports.QueryClientStatesResponse = exports.ConsensusStateWithHeight = exports.MsgRecoverClient = exports.MsgCreateClient = exports.QueryUpgradedClientStateResponse = exports.QueryClientParamsRequest = exports.QueryClientParamsResponse = exports.GenesisState = exports.ClientConsensusStates = void 0;
...
Object.defineProperty(exports, "QueryClientParamsResponse", { enumerable: true, get: function () { return query_1.QueryClientParamsResponse; } });
const query_2 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientParamsRequest", { enumerable: true, get: function () { return query_2.QueryClientParamsRequest; } });
...
Object.defineProperty(exports, "QueryClientStatesResponse", { enumerable: true, get: function () { return query_4.QueryClientStatesResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStatesRequest", { enumerable: true, get: function () { return query_6.QueryConsensusStatesRequest; } });
const tx_3 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgUpdateClient", { enumerable: true, get: function () { return tx_3.MsgUpdateClient; } });
...
Object.defineProperty(exports, "MsgUpgradeClient", { enumerable: true, get: function () { return tx_5.MsgUpgradeClient; } });
...
Object.defineProperty(exports, "QueryConsensusStateHeightsResponse", { enumerable: true, get: function () { return query_7.QueryConsensusStateHeightsResponse; } });
const query_8 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStatusResponse", { enumerable: true, get: function () { return query_8.QueryClientStatusResponse; } });
const query_9 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedClientStateRequest", { enumerable: true, get: function () { return query_9.QueryUpgradedClientStateRequest; } });
...
Object.defineProperty(exports, "UpgradeProposal", { enumerable: true, get: function () { return client_4.UpgradeProposal; } });
...
Object.defineProperty(exports, "MsgSubmitMisbehaviour", { enumerable: true, get: function () { return tx_10.MsgSubmitMisbehaviour; } });
...
Object.defineProperty(exports, "QueryConsensusStateResponse", { enumerable: true, get: function () { return query_15.QueryConsensusStateResponse; } });
const query_16 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateRequest", { enumerable: true, get: function () { return query_16.QueryConsensusStateRequest; } });
...
Object.defineProperty(exports, "QueryClientStatusRequest", { enumerable: true, get: function () { return query_17.QueryClientStatusRequest; } });
    ...
    return {
        ...
        async sendQueryClientParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsResponse({ value: query_1.QueryClientParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsRequest({ value: query_2.QueryClientParamsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesResponse({ value: query_4.QueryClientStatesResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesRequest({ value: query_6.QueryConsensusStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateClient({ value: tx_3.MsgUpdateClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpgradeClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClient({ value: tx_5.MsgUpgradeClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsResponse({ value: query_7.QueryConsensusStateHeightsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusResponse({ value: query_8.QueryClientStatusResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedClientStateRequest({ value: query_9.QueryUpgradedClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendUpgradeProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.upgradeProposal({ value: client_4.UpgradeProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitMisbehaviour({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviour({ value: tx_10.MsgSubmitMisbehaviour.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateResponse({ value: query_15.QueryConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateRequest({ value: query_16.QueryConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusRequest({ value: query_17.QueryClientStatusRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryClientParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsResponse", value: query_1.QueryClientParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsRequest", value: query_2.QueryClientParamsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesResponse", value: query_4.QueryClientStatesResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesRequest", value: query_6.QueryConsensusStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateClient", value: tx_3.MsgUpdateClient.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpgradeClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClient", value: tx_5.MsgUpgradeClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsResponse", value: query_7.QueryConsensusStateHeightsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusResponse", value: query_8.QueryClientStatusResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateRequest", value: query_9.QueryUpgradedClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        upgradeProposal({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.UpgradeProposal", value: client_4.UpgradeProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitMisbehaviour({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviour", value: tx_10.MsgSubmitMisbehaviour.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateResponse", value: query_15.QueryConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateRequest", value: query_16.QueryConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParamsResponse", value: tx_12.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusRequest", value: query_17.QueryClientStatusRequest.fromPartial(value) };
            }
            catch (e) {
