...
exports.queryClient = exports.txClient = exports.registry = exports.MsgIBCSoftwareUpgrade = exports.MsgRecoverClient = exports.QueryConsensusStateResponse = exports.UpgradeProposal = exports.MsgSubmitMisbehaviourResponse = exports.QueryClientStatusResponse = exports.QueryConsensusStatesRequest = exports.MsgUpdateParams = exports.MsgUpdateParamsResponse = exports.QueryClientStateRequest = exports.MsgUpgradeClientResponse = exports.QueryConsensusStateRequest = exports.MsgUpgradeClient = exports.QueryClientStateResponse = exports.IdentifiedGenesisMetadata = exports.MsgCreateClientResponse = exports.QueryClientStatusRequest = exports.QueryConsensusStateHeightsResponse = exports.QueryClientParamsRequest = exports.MsgUpdateClient = exports.Height = exports.MsgIBCSoftwareUpgradeResponse = exports.QueryClientParamsResponse = exports.GenesisMetadata = exports.GenesisState = exports.ClientUpdateProposal = exports.MsgUpdateClientResponse = exports.QueryUpgradedConsensusStateResponse = exports.QueryClientStatesRequest = exports.QueryUpgradedClientStateRequest = exports.MsgCreateClient = exports.Params = exports.ClientConsensusStates = exports.QueryUpgradedConsensusStateRequest = exports.ConsensusStateWithHeight = exports.IdentifiedClientState = exports.QueryConsensusStateHeightsRequest = exports.MsgSubmitMisbehaviour = exports.QueryConsensusStatesResponse = exports.QueryClientStatesResponse = exports.MsgRecoverClientResponse = exports.QueryUpgradedClientStateResponse = void 0;
const stargate_1 = require("@cosmjs/stargate");
const proto_signing_1 = require("@cosmjs/proto-signing");
const registry_1 = require("./registry");
const rest_1 = require("./rest");
const query_1 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedClientStateResponse", { enumerable: true, get: function () { return query_1.QueryUpgradedClientStateResponse; } });
const tx_1 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgRecoverClientResponse", { enumerable: true, get: function () { return tx_1.MsgRecoverClientResponse; } });
...
Object.defineProperty(exports, "QueryConsensusStateHeightsRequest", { enumerable: true, get: function () { return query_4.QueryConsensusStateHeightsRequest; } });
...
Object.defineProperty(exports, "QueryClientStatesRequest", { enumerable: true, get: function () { return query_7.QueryClientStatesRequest; } });
const query_8 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryUpgradedConsensusStateResponse", { enumerable: true, get: function () { return query_8.QueryUpgradedConsensusStateResponse; } });
const tx_4 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgUpdateClientResponse", { enumerable: true, get: function () { return tx_4.MsgUpdateClientResponse; } });
...
Object.defineProperty(exports, "QueryClientParamsResponse", { enumerable: true, get: function () { return query_9.QueryClientParamsResponse; } });
const tx_5 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgIBCSoftwareUpgradeResponse", { enumerable: true, get: function () { return tx_5.MsgIBCSoftwareUpgradeResponse; } });
...
Object.defineProperty(exports, "QueryClientStatusRequest", { enumerable: true, get: function () { return query_12.QueryClientStatusRequest; } });
const tx_7 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgCreateClientResponse", { enumerable: true, get: function () { return tx_7.MsgCreateClientResponse; } });
...
Object.defineProperty(exports, "MsgUpgradeClient", { enumerable: true, get: function () { return tx_8.MsgUpgradeClient; } });
const query_14 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryConsensusStateRequest", { enumerable: true, get: function () { return query_14.QueryConsensusStateRequest; } });
const tx_9 = require("./types/ibc/core/client/v1/tx");
Object.defineProperty(exports, "MsgUpgradeClientResponse", { enumerable: true, get: function () { return tx_9.MsgUpgradeClientResponse; } });
const query_15 = require("./types/ibc/core/client/v1/query");
Object.defineProperty(exports, "QueryClientStateRequest", { enumerable: true, get: function () { return query_15.QueryClientStateRequest; } });
...
Object.defineProperty(exports, "QueryConsensusStatesRequest", { enumerable: true, get: function () { return query_16.QueryConsensusStatesRequest; } });
...
Object.defineProperty(exports, "MsgSubmitMisbehaviourResponse", { enumerable: true, get: function () { return tx_12.MsgSubmitMisbehaviourResponse; } });
const client_7 = require("./types/ibc/core/client/v1/client");
Object.defineProperty(exports, "UpgradeProposal", { enumerable: true, get: function () { return client_7.UpgradeProposal; } });
...
Object.defineProperty(exports, "MsgRecoverClient", { enumerable: true, get: function () { return tx_13.MsgRecoverClient; } });
    ...
    return {
        async sendQueryUpgradedClientStateResponse({ value, fee, memo }) {
            ...
            try {
                ...
                let msg = this.queryUpgradedClientStateResponse({ value: query_1.QueryUpgradedClientStateResponse.fromPartial(value) });
        ...
        async sendMsgRecoverClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClientResponse({ value: tx_1.MsgRecoverClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateHeightsRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateHeightsRequest({ value: query_4.QueryConsensusStateHeightsRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendConsensusStateWithHeight({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.consensusStateWithHeight({ value: client_2.ConsensusStateWithHeight.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatesRequest({ value: query_7.QueryClientStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryUpgradedConsensusStateResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryUpgradedConsensusStateResponse({ value: query_8.QueryUpgradedConsensusStateResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpdateClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpdateClientResponse({ value: tx_4.MsgUpdateClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientParamsResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientParamsResponse({ value: query_9.QueryClientParamsResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgIBCSoftwareUpgradeResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgIbcsoftwareUpgradeResponse({ value: tx_5.MsgIBCSoftwareUpgradeResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendHeight({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.height({ value: client_6.Height.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStatusRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStatusRequest({ value: query_12.QueryClientStatusRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgCreateClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgCreateClientResponse({ value: tx_7.MsgCreateClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpgradeClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClient({ value: tx_8.MsgUpgradeClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStateRequest({ value: query_14.QueryConsensusStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgUpgradeClientResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgUpgradeClientResponse({ value: tx_9.MsgUpgradeClientResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryClientStateRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryClientStateRequest({ value: query_15.QueryClientStateRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendQueryConsensusStatesRequest({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.queryConsensusStatesRequest({ value: query_16.QueryConsensusStatesRequest.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgSubmitMisbehaviourResponse({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgSubmitMisbehaviourResponse({ value: tx_12.MsgSubmitMisbehaviourResponse.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendUpgradeProposal({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.upgradeProposal({ value: client_7.UpgradeProposal.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        async sendMsgRecoverClient({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry });
                let msg = this.msgRecoverClient({ value: tx_13.MsgRecoverClient.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        queryUpgradedClientStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedClientStateResponse", value: query_1.QueryUpgradedClientStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClientResponse", value: tx_1.MsgRecoverClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateHeightsRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateHeightsRequest", value: query_4.QueryConsensusStateHeightsRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        consensusStateWithHeight({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.ConsensusStateWithHeight", value: client_2.ConsensusStateWithHeight.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatesRequest", value: query_7.QueryClientStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        queryUpgradedConsensusStateResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryUpgradedConsensusStateResponse", value: query_8.QueryUpgradedConsensusStateResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateClientResponse", value: tx_4.MsgUpdateClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientParamsResponse", value: query_9.QueryClientParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgIbcsoftwareUpgradeResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgIBCSoftwareUpgradeResponse", value: tx_5.MsgIBCSoftwareUpgradeResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        height({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.Height", value: client_6.Height.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStatusRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStatusRequest", value: query_12.QueryClientStatusRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgCreateClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgCreateClientResponse", value: tx_7.MsgCreateClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpgradeClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClient", value: tx_8.MsgUpgradeClient.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStateRequest", value: query_14.QueryConsensusStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpgradeClientResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpgradeClientResponse", value: tx_9.MsgUpgradeClientResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryClientStateRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryClientStateRequest", value: query_15.QueryClientStateRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgUpdateParamsResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgUpdateParamsResponse", value: tx_10.MsgUpdateParamsResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        queryConsensusStatesRequest({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.QueryConsensusStatesRequest", value: query_16.QueryConsensusStatesRequest.fromPartial(value) };
            }
            catch (e) {
        ...
        msgSubmitMisbehaviourResponse({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviourResponse", value: tx_12.MsgSubmitMisbehaviourResponse.fromPartial(value) };
            }
            catch (e) {
        ...
        upgradeProposal({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.UpgradeProposal", value: client_7.UpgradeProposal.fromPartial(value) };
            }
            catch (e) {
        ...
        msgRecoverClient({ value }) {
            try {
                return { typeUrl: "/ibc.core.client.v1.MsgRecoverClient", value: tx_13.MsgRecoverClient.fromPartial(value) };
            }
            catch (e) {
