...
import { Workload as typeWorkload} from "./types"

export { QueryParamsRequest, Params, MsgUpdateParamsResponse, MsgUpdateParams, QueryParamsResponse, GenesisState };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						Workload: getStructure(typeWorkload.fromPartial({})),
