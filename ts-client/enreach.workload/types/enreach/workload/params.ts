...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.data).forEach(([key, value]) => {
      Params_DataEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          const entry1 = Params_DataEntry.decode(reader, reader.uint32());
...
function createBaseParams_DataEntry(): Params_DataEntry {
  return { key: "", value: "" };
}

export const Params_DataEntry = {
  encode(message: Params_DataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  create<I extends Exact<DeepPartial<Params_DataEntry>, I>>(base?: I): Params_DataEntry {
    return Params_DataEntry.fromPartial(base ?? ({} as any));
  },
