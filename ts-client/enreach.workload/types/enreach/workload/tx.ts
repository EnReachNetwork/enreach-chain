...
export const MsgCreateWorkload: MessageFns<MsgCreateWorkload> = {
  encode(message: MsgCreateWorkload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateWorkload {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgCreateWorkloadResponse: MessageFns<MsgCreateWorkloadResponse> = {
  encode(message: MsgCreateWorkloadResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateWorkloadResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateWorkload: MessageFns<MsgUpdateWorkload> = {
  encode(message: MsgUpdateWorkload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateWorkload {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateWorkloadResponse: MessageFns<MsgUpdateWorkloadResponse> = {
  encode(_: MsgUpdateWorkloadResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateWorkloadResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDeleteWorkload: MessageFns<MsgDeleteWorkload> = {
  encode(message: MsgDeleteWorkload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteWorkload {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDeleteWorkloadResponse: MessageFns<MsgDeleteWorkloadResponse> = {
  encode(_: MsgDeleteWorkloadResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeleteWorkloadResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgClientImpl implements Msg {
  ...
  CreateWorkload(request: MsgCreateWorkload): Promise<MsgCreateWorkloadResponse> {
    ...
    return promise.then((data) => MsgCreateWorkloadResponse.decode(new BinaryReader(data)));
  }

  UpdateWorkload(request: MsgUpdateWorkload): Promise<MsgUpdateWorkloadResponse> {
    const data = MsgUpdateWorkload.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateWorkload", data);
    return promise.then((data) => MsgUpdateWorkloadResponse.decode(new BinaryReader(data)));
  }

  DeleteWorkload(request: MsgDeleteWorkload): Promise<MsgDeleteWorkloadResponse> {
    const data = MsgDeleteWorkload.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteWorkload", data);
    return promise.then((data) => MsgDeleteWorkloadResponse.decode(new BinaryReader(data)));
  }
}
